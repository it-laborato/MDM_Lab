...
import (
	...
	orbittable "github.com:it-laborato/MDM_Lab/orbit/pkg/table"
...
func main() {
	...
	op := func() error {
		s, err := osquery.NewExtensionManagerServer("com.mdmlabdm.mdmlabd_tables.osquery_extension.v1", *socket, serverTimeout, serverPingInterval)
		if err != nil {
