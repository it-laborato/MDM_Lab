...
func ApplyNudgeConfigReceiverMiddleware(opt NudgeConfigFetcherOptions) mdmlab.OrbitConfigReceiver {
...
// provided config.
func (n *NudgeConfigReceiver) Run(cfg *mdmlab.OrbitConfig) error {
...
func (n *NudgeConfigReceiver) configure(nudgeCfg mdmlab.NudgeConfig) error {
