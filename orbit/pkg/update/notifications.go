...
func (w *windowsMDMEnrollmentConfigReceiver) attemptEnrollment(notifs mdmlab.OrbitConfigNotifications) {
...
) (mdmlab.OrbitConfigReceiver, func() bool) {
...
type DiskEncryptionKeySetter interface {
	SetOrUpdateDiskEncryptionKey(diskEncryptionStatus mdmlab.OrbitHostDiskEncryptionKeyPayload) error
}
...
func (w *windowsMDMBitlockerConfigReceiver) attemptBitlockerEncryption(notifs mdmlab.OrbitConfigNotifications) {
