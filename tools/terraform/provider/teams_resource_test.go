...
func TestAccMDMlabdmTeams_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: fmt.Sprintf(`
					resource "mdmlabdm_teams" "test_team" {
						name        = "%s"
						description = "Awesome description"
					}
				`, teamName),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("mdmlabdm_teams.test_team", "name", teamName),
					resource.TestCheckResourceAttr("mdmlabdm_teams.test_team", "description", "Awesome description"),
					resource.TestCheckResourceAttr("mdmlabdm_teams.test_team", "agent_options", defaultAgentOptions),
				),
			},
		},
	})
...
func TestAccMDMlabdmTeams_agent_options(t *testing.T) {
	teamName := fmt.Sprintf("aaa-%s",
		acctest.RandStringFromCharSet(6, acctest.CharSetAlpha))
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("mdmlabdm_teams.test_team", "name", teamName),
					resource.TestCheckResourceAttr("mdmlabdm_teams.test_team", "description", "Awesome description"),
					resource.TestCheckResourceAttr("mdmlabdm_teams.test_team", "agent_options", newAO),
				),
			},
		},
	})
...
func TestAccMDMlabdmTeams_update_all(t *testing.T) {
	teamName := fmt.Sprintf("aaa-%s",
		acctest.RandStringFromCharSet(6, acctest.CharSetAlpha))
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				`, NewTeamName, upAO),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("mdmlabdm_teams.test_team", "name", NewTeamName),
					resource.TestCheckResourceAttr("mdmlabdm_teams.test_team", "description", "Awesomer description"),
					resource.TestCheckResourceAttr("mdmlabdm_teams.test_team", "agent_options", upAO),
				),
			},
		},
	})
...
func TestAccMDMlabdmTeams_update_each(t *testing.T) {
	teamName := fmt.Sprintf("aaa-%s",
		acctest.RandStringFromCharSet(6, acctest.CharSetAlpha))
	NewTeamName := fmt.Sprintf("aaa-%s-new",
		acctest.RandStringFromCharSet(6, acctest.CharSetAlpha))
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("mdmlabdm_teams.test_team", "name", teamName),
					resource.TestCheckResourceAttr("mdmlabdm_teams.test_team", "description", ""),
					resource.TestCheckResourceAttr("mdmlabdm_teams.test_team", "agent_options", defaultAgentOptions),
				),
			},
			{
