...
// cached_mysql in-memory cache properly implements the mdmlab.Cloner interface.
//
...
var cacheableItems = []mdmlab.Cloner{
	&mdmlab.AppConfig{},
	&mdmlab.Pack{},
...
func generateFieldsList(w io.Writer, item mdmlab.Cloner) error {
