...
// https://github.com/mdmlabdm/mdmlab/issues/11531.
package main
...
func main() {
	...
	apiClient, err := service.NewClient(*mdmlabURL, true, "", "")
	if err != nil {
		panic(err)
	}
	...
	for t := 0; t < *teamCount; t++ {
		team, err := apiClient.CreateTeam(mdmlab.TeamPayload{
	...
	for _, team := range teams {
		...
		if err := apiClient.ApplyTeamProfiles(team.Name, profiles, mdmlab.ApplyTeamSpecOptions{}); err != nil {
			log.Fatalf("apply profiles to team %s: %s", team.Name, err)
		}
	}
	printf("3a. Duration: %s\n", time.Since(start))

	waitProfilesAppliedOnTeams := func(teamsToWait []*mdmlab.Team) {
		summaryDone := func(s mdmlab.MDMProfilesSummary) bool {
			return s.Verifying == uint(hostCountPerTeam)
		}
		teamSummaries := make(map[uint]mdmlab.MDMProfilesSummary)
		for {
			doneCount := 0
...
var profiles = []mdmlab.MDMProfileBatchPayload{
	{
...
<dict>
        ...
        <array>
                <dict>
                        ...
                        <string>com.mdmlabdm.cis-1.6.check</string>
                        <key>PayloadUUID</key>
        ...
        <key>PayloadIdentifier</key>
        <string>com.mdmlabdm.cis-1.6</string>
...
<dict>
        ...
        <array>
                <dict>
                        ...
                        <key>PayloadIdentifier</key>
                        <string>com.mdmlabdm.cis-1.7.check</string>
                        <key>PayloadUUID</key>
...
<dict>
        ...
        <array>
                <dict>
                        ...
                        <string>com.apple.SoftwareUpdate</string>
                        <key>PayloadIdentifier</key>
                        <string>com.mdmlabdm.cis-1.2.check</string>
                        <key>PayloadUUID</key>
        ...
        <key>PayloadIdentifier</key>
        <string>com.mdmlabdm.cis-1.2</string>
        <key>PayloadRemovalDisallowed</key>
        <false/>
        <key>PayloadScope</key>
        <string>System</string>
...
<dict>
        ...
        <array>
                <dict>
                        ...
                        <string>com.apple.SoftwareUpdate</string>
                        <key>PayloadIdentifier</key>
                        <string>com.mdmlabdm.cis-1.3.check</string>
                        <key>PayloadUUID</key>
        ...
        <key>PayloadIdentifier</key>
        <string>com.mdmlabdm.cis-1.3</string>
        <key>PayloadRemovalDisallowed</key>
        <false/>
        <key>PayloadScope</key>
        <string>System</string>
...
<dict>
        ...
        <array>
                <dict>
                        ...
                        <string>com.apple.SoftwareUpdate</string>
                        <key>PayloadIdentifier</key>
                        <string>com.mdmlabdm.cis-1.4.check</string>
                        <key>PayloadUUID</key>
        ...
        <key>PayloadIdentifier</key>
        <string>com.mdmlabdm.cis-1.4</string>
        <key>PayloadRemovalDisallowed</key>
        <false/>
        <key>PayloadScope</key>
        <string>System</string>
...
<dict>
        ...
        <array>
                <dict>
                        ...
                        <key>PayloadIdentifier</key>
                        <string>com.mdmlabdm.cis-3.6.check</string>
                        <key>PayloadUUID</key>
        ...
        <key>PayloadIdentifier</key>
        <string>com.mdmlabdm.cis-3.6</string>
        <key>PayloadRemovalDisallowed</key>
        <false/>
        <key>PayloadScope</key>
        <string>System</string>
...
<dict>
        ...
        <array>
                <dict>
                        ...
                        <key>PayloadIdentifier</key>
                        <string>com.mdmlabdm.cis-4.1.check</string>
                        <key>PayloadUUID</key>
        ...
        <key>PayloadIdentifier</key>
        <string>com.mdmlabdm.cis-4.1</string>
        <key>PayloadRemovalDisallowed</key>
        <false/>
        <key>PayloadScope</key>
        <string>System</string>
...
<dict>
        ...
        <array>
                <dict>
                        ...
                        <string>com.apple.SoftwareUpdate</string>
                        <key>PayloadIdentifier</key>
                        <string>com.mdmlabdm.cis-1.5.check</string>
                        <key>PayloadUUID</key>
        ...
        <key>PayloadIdentifier</key>
        <string>com.mdmlabdm.cis-1.5</string>
        <key>PayloadRemovalDisallowed</key>
        <false/>
        <key>PayloadScope</key>
        <string>System</string>
...
<dict>
        ...
        <array>
                <dict>
                        ...
                        <string>com.apple.applicationaccess</string>
                        <key>PayloadIdentifier</key>
                        <string>com.mdmlabdm.cis-2.1.1.2.check-disable</string>
                        <key>PayloadUUID</key>
        ...
        <key>PayloadIdentifier</key>
        <string>com.mdmlabdm.cis-2.1.1.2-disable</string>
        <key>PayloadRemovalDisallowed</key>
        <false/>
        <key>PayloadScope</key>
        <string>System</string>
        ...
        <dict>
                ...
                <array>
                        <dict>
                                ...
                                <key>PayloadIdentifier</key>
                                <string>com.mdmlabdm.cis-6.3.1.check</string>
                                <key>PayloadUUID</key>
                ...
                <key>PayloadIdentifier</key>
                <string>com.mdmlabdm.cis-6.3.1</string>
                <key>PayloadRemovalDisallowed</key>
                <false/>
                <key>PayloadScope</key>
                <string>System</string>
