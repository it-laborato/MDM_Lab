...
//
// Was implemented to test out https://github.com/mdmlabdm/mdmlab/issues/7515#issuecomment-1330889768,
...
func main() {
	...
	serverPrivateKey := flag.String("server-private-key", "", "mdmlab server's private key (to decrypt MDM assets)")
	...
	depClient := godep.NewClient(depStorage, mdmlabhttp.NewClient())
