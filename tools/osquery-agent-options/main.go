...
// "tools/osquery-agent-options/main.go" and run "cd server/mdmlab/ && go generate".
package mdmlab
...
func main() {
	...
	urlStr := fmt.Sprintf("https://tuf.mdmlabctl.com/targets/osqueryd/macos-app/%s/osqueryd.app.tar.gz", osqueryVersion)
	...
	var allOSSpecific struct {
		mdmlab.OsqueryCommandLineFlagsLinux
		mdmlab.OsqueryCommandLineFlagsWindows
		mdmlab.OsqueryCommandLineFlagsMacOS
		mdmlab.OsqueryCommandLineFlagsHidden
	}
