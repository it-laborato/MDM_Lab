...
func TestGetBaseURL(t *testing.T) {
	t.Run("with env variable", func(t *testing.T) {
		t.Setenv("FLEET_DEV_DOWNLOAD_FLEETDM_URL", "https://download-testing.mdmlabdm.com")
		require.Equal(t, "https://download-testing.mdmlabdm.com", getBaseURL())
	})

	t.Run("without env variable", func(t *testing.T) {
		require.Equal(t, "https://download.mdmlabdm.com", getBaseURL())
	})
}

func TestGetMetadata(t *testing.T) {
	expectedMetadata := &Metadata{
		MSIURL:           "https://download-testing.mdmlabdm.com/archive/stable/2024-06-25_03-01-17/mdmlabd-base.msi",
		MSISha256:        "456e4f16c437c54d4cfacb54717450f4be582e572b8a7252a0384ac3118fbd11",
		PKGURL:           "https://download-testing.mdmlabdm.com/archive/stable/2024-06-25_03-01-17/mdmlabd-base.pkg",
		PKGSha256:        "4c914def2af5f4e0f5507e397d1d8af5b5991ea23cf606450787b8377e7bcecd",
		ManifestPlistURL: "https://download-testing.mdmlabdm.com/archive/stable/2024-06-25_03-01-17/mdmlabd-base-manifest.plist",
...
func TestGetPKGManifestURL(t *testing.T) {
	t.Run("with env variable", func(t *testing.T) {
		t.Setenv("FLEET_DEV_DOWNLOAD_FLEETDM_URL", "https://download-test.mdmlabdm.com")
		require.Equal(t, "https://download-test.mdmlabdm.com/stable/mdmlabd-base-manifest.plist", GetPKGManifestURL())
	})

	t.Run("without env variable", func(t *testing.T) {
		require.Equal(t, "https://download.mdmlabdm.com/stable/mdmlabd-base-manifest.plist", GetPKGManifestURL())
	})
}
