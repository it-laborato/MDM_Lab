...
func TestCAKeyPair(t *testing.T) {
	...
	ds.GetAllMDMConfigAssetsByNameFunc = func(ctx context.Context, assetNames []mdmlab.MDMAssetName,
		...
		require.ElementsMatch(t, []mdmlab.MDMAssetName{mdmlab.MDMAssetCACert, mdmlab.MDMAssetCAKey}, assetNames)
		return assets, nil
	}
...
func TestAPNSKeyPair(t *testing.T) {
	...
	assets := map[mdmlab.MDMAssetName]mdmlab.MDMConfigAsset{
		mdmlab.MDMAssetAPNSCert: {Value: certPEM},
		mdmlab.MDMAssetAPNSKey:  {Value: keyPEM},
	}
	ds.GetAllMDMConfigAssetsByNameFunc = func(ctx context.Context, assetNames []mdmlab.MDMAssetName,
		_ sqlx.QueryerContext) (map[mdmlab.MDMAssetName]mdmlab.MDMConfigAsset, error) {
		require.ElementsMatch(t, []mdmlab.MDMAssetName{mdmlab.MDMAssetAPNSCert, mdmlab.MDMAssetAPNSKey}, assetNames)
		return assets, nil
	}
...
func TestX509Cert(t *testing.T) {
	...
	ds.GetAllMDMConfigAssetsByNameFunc = func(ctx context.Context, assetNames []mdmlab.MDMAssetName,
		_ sqlx.QueryerContext) (map[mdmlab.MDMAssetName]mdmlab.MDMConfigAsset, error) {
		require.ElementsMatch(t, []mdmlab.MDMAssetName{mdmlab.MDMAssetAPNSCert}, assetNames)
		return assets, nil
	}
...
func TestABMToken(t *testing.T) {
	...
	assets := map[mdmlab.MDMAssetName]mdmlab.MDMConfigAsset{
		mdmlab.MDMAssetABMCert: {Value: certPEM},
		mdmlab.MDMAssetABMKey:  {Value: keyPEM},
	}
	ds.GetAllMDMConfigAssetsByNameFunc = func(ctx context.Context, assetNames []mdmlab.MDMAssetName,
		_ sqlx.QueryerContext) (map[mdmlab.MDMAssetName]mdmlab.MDMConfigAsset, error) {
		require.ElementsMatch(t, []mdmlab.MDMAssetName{
	...
	ds.GetABMTokenByOrgNameFunc = func(ctx context.Context, orgName string) (*mdmlab.ABMToken, error) {
