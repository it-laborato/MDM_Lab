...
func TestPreassignProfile(t *testing.T) {
	runTest := func(t *testing.T, pool mdmlab.RedisPool) {
		...
		// preassign a profile
		p1 := mdmlab.MDMApplePreassignProfilePayload{
		...
		p2 := mdmlab.MDMApplePreassignProfilePayload{
			ExternalHostIdentifier: "abcd",
			HostUUID:               "1234",
		...
		p3 := mdmlab.MDMApplePreassignProfilePayload{
			ExternalHostIdentifier: "abcd",
			HostUUID:               "1234",
		...
		p4 := mdmlab.MDMApplePreassignProfilePayload{
...
func TestRetrieveProfiles(t *testing.T) {
	runTest := func(t *testing.T, pool mdmlab.RedisPool) {
		...
		require.ElementsMatch(t, []mdmlab.MDMApplePreassignProfile{
	...
	cases := []struct {
		...
		},
		{
			...
			mdmlab.MDMApplePreassignProfilePayload{
				ExternalHostIdentifier: "abcd",
				HostUUID:               "1234",
				Profile:                generateProfile("p1", mobileconfig.MDMlabFileVaultPayloadIdentifier, "Configuration", "p1"),
			},
			"payload identifier com.mdmlabdm.mdmlab.mdm.filevault is not allowed",
		},
		{
			...
			mdmlab.MDMApplePreassignProfilePayload{
				ExternalHostIdentifier: "abcd",
				HostUUID:               "1234",
				Profile:                generateProfile(mdm.MDMlabFileVaultProfileName, "p1", "Configuration", "p1"),
			},
