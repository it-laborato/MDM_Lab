...
func TestMDMlabdProfileTemplate(t *testing.T) {
	cases := []MDMlabdProfileOptions{
		{},
	...
	for _, c := range cases {
		...
		err := MDMlabdProfileTemplate.Execute(&prof, c)
		...
		require.Equal(t, c.ServerURL, pc["MDMlabURL"])
