...
func SetDecryptedABMTokenMetadata(
	...
	if err != nil {
		...
		if errors.As(err, &authErr) {
			...
			if authErr.StatusCode == http.StatusUnauthorized {
				msg = "The Apple Business Manager certificate or server token is invalid. Restart MDMlab with a valid certificate and token. See https://mdmlabdm.com/learn-more-about/setup-abm for help."
			}
	...
	if res.AdminID == "" {
		...
		// https://github.com/mdmlabdm/mdmlab/issues/7515#issuecomment-1346579398
