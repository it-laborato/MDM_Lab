...
type MySQLStorage struct {
	...
	reader        func(ctx context.Context) mdmlab.DBReader
}
...
func WithReaderFunc(readerFunc func(ctx context.Context) mdmlab.DBReader) Option {
...
func New(opts ...Option) (*MySQLStorage, error) {
	...
	if cfg.reader == nil {
		mysqlStore.reader = func(ctx context.Context) mdmlab.DBReader {
