...
const (
	MDMlabBitLockerTargetLocURI = "/Vendor/MSFT/BitLocker"
	MDMlabOSUpdateTargetLocURI  = "/Vendor/MSFT/Policy/Config/Update"
)
...
const (
	...
	DocProvisioningAppProviderID = "MDMlab"
	...
	// MDMlabdWindowsInstallerGUID is the GUID used for mdmlabd on Windows
	MDMlabdWindowsInstallerGUID = "./Device/Vendor/MSFT/EnterpriseDesktopAppManagement/MSI/%7BA427C0AA-E2D5-40DF-ACE8-0D726A6BE096%7D/DownloadInstall"
)
