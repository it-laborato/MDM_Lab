...
// API and updates the MDMlab database with the new information.
func Refresh(ctx context.Context, ds mdmlab.Datastore, logger kitlog.Logger) error {
...
func (i ingester) ingestOne(ctx context.Context, app maintainedApp, client *http.Client) error {
	...
	_, err = i.ds.UpsertMaintainedApp(ctx, &mdmlab.MaintainedApp{
		Name:    cask.Name[0],
		Token:   cask.Token,
