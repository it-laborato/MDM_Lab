...
// mdmlab.MaintainedApps with only a few fields filled - the result of
// unmarshaling the testdata/expected_apps.json file.
func IngestMaintainedApps(t *testing.T, ds mdmlab.Datastore) []mdmlab.MaintainedApp {
	...
	var expected []mdmlab.MaintainedApp
