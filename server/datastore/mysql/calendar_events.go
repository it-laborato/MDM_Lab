...
func getCalendarEventByID(ctx context.Context, q sqlx.QueryerContext, id uint) (*mdmlab.CalendarEvent, error) {
	const calendarEventsQuery = "SELECT " + calendarEventCols + " FROM calendar_events ce WHERE id = ?"
	var calendarEvent mdmlab.CalendarEvent
...
func (ds *Datastore) GetCalendarEvent(ctx context.Context, email string) (*mdmlab.CalendarEvent, error) {
...
func (ds *Datastore) GetCalendarEventDetailsByUUID(ctx context.Context, uuidStr string) (*mdmlab.CalendarEventDetails, error) {
	UUID, err := uuid.Parse(uuidStr)
	if err != nil {
		return nil, ctxerr.Wrap(ctx, err, "invalid uuid")
	}
	const calendarEventsByUUIDQuery = `
		...
		WHERE ce.uuid_bin = ?;
	`
	var calendarEvent mdmlab.CalendarEventDetails
...
func (ds *Datastore) GetHostCalendarEvent(ctx context.Context, hostID uint) (*mdmlab.HostCalendarEvent, *mdmlab.CalendarEvent, error) {
	const hostCalendarEventsQuery = `
		SELECT * FROM host_calendar_events WHERE host_id = ?
	`
	var hostCalendarEvent mdmlab.HostCalendarEvent
...
func (ds *Datastore) GetHostCalendarEventByEmail(ctx context.Context, email string) (*mdmlab.HostCalendarEvent, *mdmlab.CalendarEvent, error) {
	const calendarEventsQuery = `
...
func (ds *Datastore) UpdateHostCalendarWebhookStatus(ctx context.Context, hostID uint, status mdmlab.CalendarWebhookStatus) error {
	const calendarEventsQuery = `
...
func (ds *Datastore) ListCalendarEvents(ctx context.Context, teamID *uint) ([]*mdmlab.CalendarEvent, error) {
	calendarEventsQuery := `
	...
	var calendarEvents []*mdmlab.CalendarEvent
...
func (ds *Datastore) ListOutOfDateCalendarEvents(ctx context.Context, t time.Time) ([]*mdmlab.CalendarEvent, error) {
	calendarEventsQuery := `
