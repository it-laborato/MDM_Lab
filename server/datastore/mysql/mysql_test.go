...
func TestAppendListOptionsToSQL(t *testing.T) {
	...
	sql = "SELECT * FROM my_table"
	opts.OrderDirection = mdmlab.OrderDescending
	actual, _ = appendListOptionsToSQL(sql, &opts)
			...
			filter: mdmlab.TeamFilter{
				User: &mdmlab.User{
					Teams: []mdmlab.UserTeam{
						{Role: mdmlab.RoleObserver, Team: mdmlab.Team{ID: 1}},
					},
				},
			},
			expected: "FALSE",
		...
		},
		{
			filter: mdmlab.TeamFilter{
				User: &mdmlab.User{
					Teams: []mdmlab.UserTeam{
						{Role: mdmlab.RoleObserver, Team: mdmlab.Team{ID: 1}},
						{Role: mdmlab.RoleObserver, Team: mdmlab.Team{ID: 2}},
					},
				},
			},
			expected: "FALSE",
		},
		{
			filter: mdmlab.TeamFilter{
				User: &mdmlab.User{
					Teams: []mdmlab.UserTeam{
						{Role: mdmlab.RoleObserver, Team: mdmlab.Team{ID: 1}},
						{Role: mdmlab.RoleMaintainer, Team: mdmlab.Team{ID: 2}},
					},
				},
			},
			...
			filter: mdmlab.TeamFilter{
				User: &mdmlab.User{
					Teams: []mdmlab.UserTeam{
						...
						{Role: "bad", Team: mdmlab.Team{ID: 37}},
					},
				},
			},
			expected: "hosts.team_id IN (2)",
			...
			filter: mdmlab.TeamFilter{
				User: &mdmlab.User{
					Teams: []mdmlab.UserTeam{
						{Role: mdmlab.RoleObserver, Team: mdmlab.Team{ID: 1}},
						{Role: mdmlab.RoleMaintainer, Team: mdmlab.Team{ID: 2}},
						{Role: mdmlab.RoleAdmin, Team: mdmlab.Team{ID: 3}},
						// Invalid role should be ignored
					},
				},
			},
...
func TestWhereFilterTeams(t *testing.T) {
	...
	testCases := []struct {
		...
		// No teams or global role
		{
			filter:   mdmlab.TeamFilter{User: nil},
			expected: "FALSE",
		},
		{
			filter: mdmlab.TeamFilter{
		...
		{
			filter:   mdmlab.TeamFilter{User: &mdmlab.User{Teams: []mdmlab.UserTeam{{Team: mdmlab.Team{ID: 1}, Role: mdmlab.RoleAdmin}}}},
			expected: "t.id IN (1)",
		},
		{
			filter:   mdmlab.TeamFilter{User: &mdmlab.User{Teams: []mdmlab.UserTeam{{Team: mdmlab.Team{ID: 1}, Role: mdmlab.RoleMaintainer}}}},
			expected: "t.id IN (1)",
		},
		{
			filter:   mdmlab.TeamFilter{User: &mdmlab.User{Teams: []mdmlab.UserTeam{{Team: mdmlab.Team{ID: 1}, Role: mdmlab.RoleObserver}}}},
			expected: "FALSE",
		},
		{
			filter: mdmlab.TeamFilter{
