...
func (ds *Datastore) NewUser(ctx context.Context, user *mdmlab.User) (*mdmlab.User, error) {
	if err := mdmlab.ValidateRole(user.GlobalRole, user.Teams); err != nil {
...
func (ds *Datastore) findUser(ctx context.Context, searchCol string, searchVal interface{}) (*mdmlab.User, error) {
	...
	if err := ds.loadTeamsForUsers(ctx, []*mdmlab.User{user}); err != nil {
...
// UserListOptions.
func (ds *Datastore) ListUsers(ctx context.Context, opt mdmlab.UserListOptions) ([]*mdmlab.User, error) {
	sqlStatement := `
		SELECT * FROM users
		WHERE TRUE
	`
...
func (ds *Datastore) UserByEmail(ctx context.Context, email string) (*mdmlab.User, error) {
	return ds.findUser(ctx, "email", email)
}

func (ds *Datastore) UserByID(ctx context.Context, id uint) (*mdmlab.User, error) {
	return ds.findUser(ctx, "id", id)
}

func (ds *Datastore) SaveUser(ctx context.Context, user *mdmlab.User) error {
	return ds.withTx(ctx, func(tx sqlx.ExtContext) error {
		return saveUserDB(ctx, tx, user)
	})
}

func (ds *Datastore) SaveUsers(ctx context.Context, users []*mdmlab.User) error {
	return ds.withTx(ctx, func(tx sqlx.ExtContext) error {
...
func saveUserDB(ctx context.Context, tx sqlx.ExtContext, user *mdmlab.User) error {
	if err := mdmlab.ValidateRole(user.GlobalRole, user.Teams); err != nil {
...
func (ds *Datastore) loadTeamsForUsers(ctx context.Context, users []*mdmlab.User) error {
...
func saveTeamsForUserDB(ctx context.Context, tx sqlx.ExtContext, user *mdmlab.User) error {
...
func (ds *Datastore) UserSettings(ctx context.Context, userID uint) (*mdmlab.UserSettings, error) {
	settings := &mdmlab.UserSettings{}
	var bytes []byte
	stmt := `
