...
func (ds *Datastore) SetOrUpdateHostDiskEncryptionKey(ctx context.Context, host *mdmlab.Host, encryptedBase64Key, clientError string,
...
func (ds *Datastore) getExistingHostDiskEncryptionKey(ctx context.Context, host *mdmlab.Host) (encryptionKey, error) {
...
func (ds *Datastore) archiveHostDiskEncryptionKey(ctx context.Context, host *mdmlab.Host, incomingKey encryptionKey,
...
func (ds *Datastore) SaveLUKSData(ctx context.Context, host *mdmlab.Host, encryptedBase64Passphrase string, encryptedBase64Salt string,
	keySlot uint) error {
...
func (ds *Datastore) AssertHasNoEncryptionKeyStored(ctx context.Context, hostID uint) error {
	...
	if hasKeyCount > 0 {
		return &mdmlab.BadRequestError{Message: "Key has already been escrowed for this host"}
	}

	return err
}

func (ds *Datastore) GetUnverifiedDiskEncryptionKeys(ctx context.Context) ([]mdmlab.HostDiskEncryptionKey, error) {
	...
	var keys []mdmlab.HostDiskEncryptionKey
...
func (ds *Datastore) GetHostDiskEncryptionKey(ctx context.Context, hostID uint) (*mdmlab.HostDiskEncryptionKey, error) {
...
func cleanupDiskEncryptionKeysOnTeamChangeDB(ctx context.Context, tx sqlx.ExtContext, hostIDs []uint, newTeamID *uint) error {
	...
	_, err := getMDMAppleConfigProfileByTeamAndIdentifierDB(ctx, tx, newTeamID, mobileconfig.MDMlabFileVaultPayloadIdentifier)
	if err != nil {
