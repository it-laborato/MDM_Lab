...
func (ds *Datastore) GetLatestCronStats(ctx context.Context, name string) ([]mdmlab.CronStats, error) {
	stmt := `
(
	SELECT
...
(
	...
	var res []mdmlab.CronStats
	err := sqlx.SelectContext(ctx, ds.reader(ctx), &res, stmt, name, name)
	if err != nil {
		return []mdmlab.CronStats{}, ctxerr.Wrap(ctx, err, "select cron stats")
	}

	return res, nil
}

func (ds *Datastore) InsertCronStats(ctx context.Context, statsType mdmlab.CronStatsType, name string, instance string, status mdmlab.CronStatsStatus) (int, error) {
...
func (ds *Datastore) UpdateCronStats(ctx context.Context, id int, status mdmlab.CronStatsStatus, cronErrors *mdmlab.CronScheduleErrors) error {
...
func (ds *Datastore) UpdateAllCronStatsForInstance(ctx context.Context, instance string, fromStatus mdmlab.CronStatsStatus, toStatus mdmlab.CronStatsStatus) error {
...
func (ds *Datastore) CleanupCronStats(ctx context.Context) error {
	return ds.withRetryTxx(ctx, func(tx sqlx.ExtContext) error {
		...
		if _, err := tx.ExecContext(ctx, updateStmt, mdmlab.CronStatsStatusExpired, mdmlab.CronStatsStatusPending); err != nil {
