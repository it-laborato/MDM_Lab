...
func (ds *Datastore) ListOSVulnerabilitiesByOS(ctx context.Context, osID uint) ([]mdmlab.OSVulnerability, error) {
	r := []mdmlab.OSVulnerability{}
...
func (ds *Datastore) ListVulnsByOsNameAndVersion(ctx context.Context, name, version string, includeCVSS bool) (mdmlab.Vulnerabilities, error) {
	r := mdmlab.Vulnerabilities{}
...
func (ds *Datastore) InsertOSVulnerabilities(ctx context.Context, vulnerabilities []mdmlab.OSVulnerability, source mdmlab.VulnerabilitySource) (int64, error) {
	var args []interface{}
...
func (ds *Datastore) InsertOSVulnerability(ctx context.Context, v mdmlab.OSVulnerability, s mdmlab.VulnerabilitySource) (bool, error) {
	if v.CVE == "" {
...
func (ds *Datastore) DeleteOSVulnerabilities(ctx context.Context, vulnerabilities []mdmlab.OSVulnerability) error {
	if len(vulnerabilities) == 0 {
		return nil
	}
...
func (ds *Datastore) DeleteOutOfDateOSVulnerabilities(ctx context.Context, src mdmlab.VulnerabilitySource, d time.Duration) error {
	deleteStmt := `
