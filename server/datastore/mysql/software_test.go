...
func testSoftwareSaveHost(t *testing.T, ds *Datastore) {
	...
	software1 := []mdmlab.Software{
		{Name: "foo", Version: "0.0.1", Source: "chrome_extensions"},
		{Name: "foo", Version: "0.0.3", Source: "chrome_extensions"},
	}
	software2 := []mdmlab.Software{
	...
	getHostSoftware := func(h *mdmlab.Host) []mdmlab.Software {
...
func testSoftwareCPE(t *testing.T, ds *Datastore) {
	...
	q := mdmlab.SoftwareIterQueryOptions{ExcludedSources: oval.SupportedSoftwareSources}
...
func testSoftwareHostDuplicates(t *testing.T, ds *Datastore) {
	...
	longName := strings.Repeat("a", mdmlab.SoftwareNameMaxLength+5)

	incoming := make(map[string]mdmlab.Software)
	sw, err := mdmlab.SoftwareFromOsqueryRow(longName+"b", "0.0.1", "chrome_extension", "", "", "", "", "", "", "", "")
	require.NoError(t, err)
	...
	incomingByChecksum, existingSoftware, existingTitlesForNewSoftware, err := ds.getExistingSoftware(
		context.Background(), make(map[string]mdmlab.Software), incoming,
	)
	require.NoError(t, err)
	...
	require.Equal(t, strings.Repeat("a", mdmlab.SoftwareNameMaxLength), software[0].Name)

	incoming = make(map[string]mdmlab.Software)
	sw, err = mdmlab.SoftwareFromOsqueryRow(longName+"c", "0.0.1", "chrome_extension", "", "", "", "", "", "", "", "")
	require.NoError(t, err)
	...
	require.Equal(t, strings.Repeat("a", mdmlab.SoftwareNameMaxLength), software2[0].Name)
...
func testSoftwareLoadVulnerabilities(t *testing.T, ds *Datastore) {
	...
	vulns := []mdmlab.SoftwareVulnerability{
		{SoftwareID: host.Software[0].ID, CVE: "CVE-2022-0001"},
		{SoftwareID: host.Software[0].ID, CVE: "CVE-2022-0002"},
	}
	for _, v := range vulns {
		_, err = ds.InsertSoftwareVulnerability(context.Background(), v, mdmlab.NVDSource)
		require.NoError(t, err)
	}
	require.NoError(t, ds.LoadHostSoftware(context.Background(), host, false))
...
func testSoftwareNothingChanged(t *testing.T, ds *Datastore) {
	cases := []struct {
		desc     string
		current  []mdmlab.Software
		incoming []mdmlab.Software
		want     bool
	}{
		{"both nil", nil, nil, true},
		{"different len", nil, []mdmlab.Software{{}}, false},

		{
			"identical",
			[]mdmlab.Software{{Name: "A", Version: "1.0", Source: "ASD"}},
			[]mdmlab.Software{{Name: "A", Version: "1.0", Source: "ASD"}},
			true,
		},
		{
			"different version",
			[]mdmlab.Software{{Name: "A", Version: "1.1", Source: "ASD"}},
			[]mdmlab.Software{{Name: "A", Version: "1.0", Source: "ASD"}},
			false,
		},
		{
			"new software",
			[]mdmlab.Software{{Name: "A", Version: "1.0", Source: "ASD"}},
			[]mdmlab.Software{{Name: "A", Version: "1.0", Source: "ASD"}, {Name: "B", Version: "1.0", Source: "ASD"}},
			false,
		},
		{
			"removed software",
		...
		},
		{
			...
			[]mdmlab.Software{{Name: "A", Version: "1.0", Source: "ASD", LastOpenedAt: ptr.Time(time.Now())}},
			[]mdmlab.Software{{Name: "A", Version: "1.0", Source: "ASD", LastOpenedAt: ptr.Time(time.Now())}},
			true,
		},
		{
		...
		},
		{
			...
			[]mdmlab.Software{{Name: "A", Version: "1.0", Source: "ASD", LastOpenedAt: ptr.Time(time.Now().Add(-365 * 24 * time.Hour))}},
			[]mdmlab.Software{{Name: "A", Version: "1.0", Source: "ASD", LastOpenedAt: ptr.Time(time.Now())}},
			false,
		},
		{
			"identical but insignificantly changed last open",
			[]mdmlab.Software{{Name: "A", Version: "1.0", Source: "ASD", LastOpenedAt: ptr.Time(time.Now().Add(-time.Second))}},
			[]mdmlab.Software{{Name: "A", Version: "1.0", Source: "ASD", LastOpenedAt: ptr.Time(time.Now())}},
			true,
		},
		{
			...
			[]mdmlab.Software{{Name: "A", Version: "1.0", Source: "ASD"}},
			[]mdmlab.Software{{Name: "A", Version: "1.0", Source: "ASD"}, {Name: "A", Version: "1.0", Source: "ASD"}},
			true,
		},
		{
...
func generateCVEMeta(n int) mdmlab.CVEMeta {
...
func testSoftwareList(t *testing.T, ds *Datastore) {
	...
	foo002 := mdmlab.Software{Name: "foo", Version: "v0.0.2", Source: "chrome_extensions"}
	foo003 := mdmlab.Software{Name: "foo", Version: "0.0.3", Source: "chrome_extensions", GenerateCPE: "someothercpewithoutvulns"}
	bar003 := mdmlab.Software{Name: "bar", Version: "0.0.3", Source: "deb_packages"}
	baz001 := mdmlab.Software{
		Name:        "baz",
		Version:     "0.0.1",
		Source:      "deb_packages",
	...
	t.Run("lists everything", func(t *testing.T) {
		opts := mdmlab.SoftwareListOptions{
		...
		expected := []mdmlab.Software{bar003, baz001, foo001, foo002, foo003}
	...
	t.Run("filters by team", func(t *testing.T) {
		...
		expected := []mdmlab.Software{foo001, foo003}
		test.ElementsMatchSkipID(t, software, expected)
		...
		if targetSoftware.Name == "foo" && targetSoftware.Version == "0.0.3" {
			expected = []mdmlab.Software{foo003}
		}
	...
	t.Run("filters by no team (team 0)", func(t *testing.T) {
		...
		expected := []mdmlab.Software{bar003, baz001, foo002, foo003}
		test.ElementsMatchSkipID(t, software, expected)
	})
	...
	t.Run("filters vulnerable software", func(t *testing.T) {
		...
		software := listSoftwareCheckCount(t, ds, 2, 2, opts, true)
		expected := []mdmlab.Software{foo001, baz001}
		test.ElementsMatchSkipID(t, software, expected)
	})
	...
	t.Run("filters by query", func(t *testing.T) {
		...
		software := listSoftwareCheckCount(t, ds, 1, 1, opts, true)
		expected := []mdmlab.Software{bar003}
		test.ElementsMatchSkipID(t, software, expected)

		// query by version
		opts.ListOptions.MatchQuery = "0.0.3"
		software = listSoftwareCheckCount(t, ds, 2, 2, opts, true)
		expected = []mdmlab.Software{foo003, bar003}
		test.ElementsMatchSkipID(t, software, expected)

		// query by version (case insensitive)
		opts.ListOptions.MatchQuery = "V0.0.2"
		software = listSoftwareCheckCount(t, ds, 1, 1, opts, true)
		expected = []mdmlab.Software{foo002}
		test.ElementsMatchSkipID(t, software, expected)
	})
	...
	t.Run("order by hosts_count", func(t *testing.T) {
		software := listSoftwareCheckCount(t, ds, 5, 5, mdmlab.SoftwareListOptions{ListOptions: mdmlab.ListOptions{OrderKey: "hosts_count", OrderDirection: mdmlab.OrderDescending}, WithHostCounts: true}, false)
...
func listSoftwareCheckCount(t *testing.T, ds *Datastore, expectedListCount int, expectedFullCount int, opts mdmlab.SoftwareListOptions, returnSorted bool) []mdmlab.Software {
	t.Helper()
...
func testSoftwareSyncHostsSoftware(t *testing.T, ds *Datastore) {
	...
	cmpNameVersionCount := func(want, got []mdmlab.Software) {
		cmp := make([]mdmlab.Software, len(got))
		for i, sw := range got {
			cmp[i] = mdmlab.Software{Name: sw.Name, Version: sw.Version, HostsCount: sw.HostsCount}
		}
	...
	globalOpts := mdmlab.SoftwareListOptions{
		WithHostCounts: true, ListOptions: mdmlab.ListOptions{OrderKey: "hosts_count", OrderDirection: mdmlab.OrderDescending},
	}
	_ = listSoftwareCheckCount(t, ds, 0, 0, globalOpts, false)

	software0 := []mdmlab.Software{
	...
	softwareTemp := make([]mdmlab.Software, 0, 10)
	for i := 0; i < 10; i++ {
		softwareTemp = append(
			softwareTemp, mdmlab.Software{Name: fmt.Sprintf("foo%d", i), Version: fmt.Sprintf("%d.0.1", i), Source: "deb_packages"},
		)
	}
	...
	allSw := listSoftwareCheckCount(t, ds, 3, 3, mdmlab.SoftwareListOptions{}, false)
	want = []mdmlab.Software{
	...
	team1Opts := mdmlab.SoftwareListOptions{WithHostCounts: true, TeamID: ptr.Uint(team1.ID), ListOptions: mdmlab.ListOptions{OrderKey: "hosts_count", OrderDirection: mdmlab.OrderDescending}}
	...
	require.NoError(t, err)
	test.ElementsMatchSkipIDAndHostCount(t, software1, []mdmlab.Software{*soft1ByID, *soft2ByID})

	team2Opts := mdmlab.SoftwareListOptions{WithHostCounts: true, TeamID: ptr.Uint(team2.ID), ListOptions: mdmlab.ListOptions{OrderKey: "hosts_count", OrderDirection: mdmlab.OrderDescending}}
...
func insertVulnSoftwareForTest(t *testing.T, ds *Datastore) {
	...
	for _, s := range software1 {
		key := fmt.Sprintf("%s%s%s%s%s", fmt.Sprintf("/some/path/%s", s.Name), mdmlab.SoftwareFieldSeparator, "", mdmlab.SoftwareFieldSeparator, s.ToUniqueStr())
		s1Paths[key] = struct{}{}
	}
	...
	inserted, err := ds.InsertSoftwareVulnerability(context.Background(), mdmlab.SoftwareVulnerability{
	...
	for _, v := range vulns {
		inserted, err := ds.InsertSoftwareVulnerability(context.Background(), v, mdmlab.NVDSource)
		require.NoError(t, err)
		require.True(t, inserted)
	}
...
func testDeleteSoftwareVulnerabilities(t *testing.T, ds *Datastore) {
	...
	err = ds.DeleteSoftwareVulnerabilities(ctx, []mdmlab.SoftwareVulnerability{
		{
...
func testHostsByCVE(t *testing.T, ds *Datastore) {
	...
	require.ElementsMatch(t, hosts, []mdmlab.HostVulnerabilitySummary{
		{
			ID:          1,
			Hostname:    "host1",
...
func testHostVulnSummariesBySoftwareIDs(t *testing.T, ds *Datastore) {
	...
	allSoftware, _, err := ds.ListSoftware(ctx, mdmlab.SoftwareListOptions{})
	require.NoError(t, err)

	var fooRpm mdmlab.Software
	var chrome3 mdmlab.Software
	var barRpm mdmlab.Software
...
func testUpdateHostSoftwareUpdatesSoftware(t *testing.T, ds *Datastore) {
	...
	cmpNameVersionCount := func(expected, got []mdmlab.Software) {
		cmp := make([]mdmlab.Software, len(got))
		for i, sw := range got {
			cmp[i] = mdmlab.Software{Name: sw.Name, Version: sw.Version, HostsCount: sw.HostsCount}
		}
	...
	opts := mdmlab.SoftwareListOptions{WithHostCounts: true}
	software := listSoftwareCheckCount(t, ds, 4, 4, opts, false)
	expectedSoftware := []mdmlab.Software{
...
func testUpdateHostSoftware(t *testing.T, ds *Datastore) {
	...
	genSortFn := func(sl []mdmlab.HostSoftwareEntry) func(l, r int) bool {
...
func testListSoftwareVulnerabilitiesByHostIDsSource(t *testing.T, ds *Datastore) {
	...
	for i, s := range host.Software {
		cve, ok := cveMap[i]
		if ok {
			inserted, err := ds.InsertSoftwareVulnerability(ctx, mdmlab.SoftwareVulnerability{
				SoftwareID: s.ID,
				CVE:        cve,
			}, mdmlab.NVDSource)
			require.NoError(t, err)
	...
	result, err := ds.ListSoftwareVulnerabilitiesByHostIDsSource(ctx, []uint{host.ID}, mdmlab.NVDSource)
	require.NoError(t, err)
...
func testInsertSoftwareVulnerability(t *testing.T, ds *Datastore) {
	...
	t.Run("no vulnerabilities to insert", func(t *testing.T) {
		inserted, err := ds.InsertSoftwareVulnerability(ctx, mdmlab.SoftwareVulnerability{}, mdmlab.UbuntuOVALSource)
		require.NoError(t, err)
	...
	t.Run("duplicated vulnerabilities", func(t *testing.T) {
		...
		_, err := ds.UpdateHostSoftware(ctx, host.ID, []mdmlab.Software{software})
		require.NoError(t, err)
		require.NoError(t, ds.LoadHostSoftware(ctx, host, false))
		cpes := []mdmlab.SoftwareCPE{
		...
		}, mdmlab.UbuntuOVALSource)
		require.NoError(t, err)
		require.True(t, inserted)

		// Sleep so that the updated_at timestamp is guaranteed to be updated.
		time.Sleep(1 * time.Second)
		insertedOrUpdated, err := ds.InsertSoftwareVulnerability(ctx, mdmlab.SoftwareVulnerability{
			SoftwareID: host.Software[0].ID, CVE: "cve-1",
		}, mdmlab.UbuntuOVALSource)
		require.NoError(t, err)
		...
		storedVulns, err := ds.ListSoftwareVulnerabilitiesByHostIDsSource(ctx, []uint{host.ID}, mdmlab.UbuntuOVALSource)
		require.NoError(t, err)
	...
	t.Run("a vulnerability already exists", func(t *testing.T) {
		...
		inserted, err := ds.InsertSoftwareVulnerability(ctx, vulns[0], mdmlab.UbuntuOVALSource)
		require.NoError(t, err)
		require.True(t, inserted)

		// Sleep so that the updated_at timestamp is guaranteed to be updated.
		time.Sleep(1 * time.Second)
		insertedOrUpdated, err := ds.InsertSoftwareVulnerability(ctx, vulns[0], mdmlab.UbuntuOVALSource)
		require.NoError(t, err)
		// This will always return true because we always update the timestamp
		assert.True(t, insertedOrUpdated)
	...
	t.Run("vulnerability includes version range", func(t *testing.T) {
		...
		inserted, err := ds.InsertSoftwareVulnerability(ctx, vuln, mdmlab.UbuntuOVALSource)
		require.NoError(t, err)
		require.True(t, inserted)
...
func testListSoftwareForVulnDetection(t *testing.T, ds *Datastore) {
	t.Run("returns software without CPE entries", func(t *testing.T) {
		...
		require.NoError(t, err)
		require.NoError(t, ds.LoadHostSoftware(ctx, host, false))
		_, err = ds.UpsertSoftwareCPEs(ctx, []mdmlab.SoftwareCPE{{SoftwareID: host.Software[0].ID, CPE: "cpe1"}})
		require.NoError(t, err)
		// Load software again so that CPE data is included.
		require.NoError(t, ds.LoadHostSoftware(ctx, host, false))

		filter := mdmlab.VulnSoftwareFilter{HostID: &host.ID}
		...
		// test name filter
		filter = mdmlab.VulnSoftwareFilter{Name: "fo"} // LIKE match
		result, err = ds.ListSoftwareForVulnDetection(ctx, filter)
		require.NoError(t, err)
		...
		// test source filter
		filter = mdmlab.VulnSoftwareFilter{Source: "deb_packages"}
		result, err = ds.ListSoftwareForVulnDetection(ctx, filter)
	...
	t.Run("software.vulnerabilities includes the published date", func(t *testing.T) {
		...
		for _, tC := range testCases {
			...
			if tC.hasMeta {
				...
				meta = append(meta, mdmlab.CVEMeta{
					CVE:              fmt.Sprintf("cve-%s", tC.name),
...
func testAllSoftwareIterator(t *testing.T, ds *Datastore) {
	...
	foo_ce_v1 := slices.IndexFunc(host.Software, func(c mdmlab.HostSoftwareEntry) bool {
		return c.Name == "foo" && c.Version == "0.0.1" && c.Source == "chrome_extensions"
	})
	foo_app_v2 := slices.IndexFunc(host.Software, func(c mdmlab.HostSoftwareEntry) bool {
		return c.Name == "foo" && c.Version == "v0.0.2" && c.Source == "apps"
	})
	bar_v3 := slices.IndexFunc(host.Software, func(c mdmlab.HostSoftwareEntry) bool {
	...
	testCases := []struct {
		name     string
		q        mdmlab.SoftwareIterQueryOptions
		expected []mdmlab.Software
	}{
		{
			...
			q: mdmlab.SoftwareIterQueryOptions{IncludedSources: []string{"apps"}},
		},
		{
			...
			q: mdmlab.SoftwareIterQueryOptions{ExcludedSources: []string{"apps"}},
		},
		{
			name: "no filter",
			expected: []mdmlab.Software{
		...
		},
		{
			...
			q: mdmlab.SoftwareIterQueryOptions{NameMatch: `ba[r|f]`, IncludedSources: []string{"deb_packages"}},
		},
		{
			...
			q: mdmlab.SoftwareIterQueryOptions{NameMatch: "foo\\.*", IncludedSources: []string{"chrome_extensions"}},
		},
		{
			...
			q: mdmlab.SoftwareIterQueryOptions{NameMatch: "foo\\.*", NameExclude: "bar$", IncludedSources: []string{"chrome_extensions"}},
		},
	}

	for _, tC := range testCases {
		t.Run(tC.name, func(t *testing.T) {
			var actual []mdmlab.Software
...
func testSoftwareIteratorForLinuxKernelCustomImages(t *testing.T, ds *Datastore) {
	...
	opts := mdmlab.SoftwareIterQueryOptions{
...
func testDeleteOutOfDateVulnerabilities(t *testing.T, ds *Datastore) {
	...
	inserted, err := ds.InsertSoftwareVulnerability(ctx, vulns[0], mdmlab.NVDSource)
	require.NoError(t, err)
	require.True(t, inserted)

	inserted, err = ds.InsertSoftwareVulnerability(ctx, vulns[1], mdmlab.NVDSource)
	require.NoError(t, err)
	require.True(t, inserted)
	...
	insertedOrUpdated, err := ds.InsertSoftwareVulnerability(ctx, vulns[0], mdmlab.NVDSource)
	require.NoError(t, err)
	assert.True(t, insertedOrUpdated)

	err = ds.DeleteOutOfDateVulnerabilities(ctx, mdmlab.NVDSource, 2*time.Hour)
	require.NoError(t, err)
...
func testDeleteSoftwareCPEs(t *testing.T, ds *Datastore) {
	...
	t.Run("with invalid software id", func(t *testing.T) {
		toDelete := []mdmlab.SoftwareCPE{cpes[0], {
...
func testHostSoftwareInstalledPathsDelta(t *testing.T, ds *Datastore) {
	...
	t.Run("nothing reported from osquery", func(t *testing.T) {
		var stored []mdmlab.HostSoftwareInstalledPath
		for i, s := range software {
			stored = append(stored, mdmlab.HostSoftwareInstalledPath{
				ID:            uint(i),
				HostID:        host.ID,
				SoftwareID:    s.ID,
	...
	t.Run("host has no software but some paths were reported", func(t *testing.T) {
		...
		reported[fmt.Sprintf("/some/path/%d%s%s%s%s", software[0].ID, mdmlab.SoftwareFieldSeparator, "", mdmlab.SoftwareFieldSeparator, software[0].ToUniqueStr())] = struct{}{}
		reported[fmt.Sprintf("/some/path/%d%s%s%s%s", software[1].ID+1, mdmlab.SoftwareFieldSeparator, "", mdmlab.SoftwareFieldSeparator, software[1].ToUniqueStr())] = struct{}{}
		reported[fmt.Sprintf("/some/path/%d%s%s%s%s", software[2].ID, mdmlab.SoftwareFieldSeparator, "", mdmlab.SoftwareFieldSeparator, software[2].ToUniqueStr())] = struct{}{}
	...
	t.Run("we have some deltas", func(t *testing.T) {
		getKey := func(s mdmlab.Software, change uint) string {
			return fmt.Sprintf("/some/path/%d%s%s%s%s", s.ID+change, mdmlab.SoftwareFieldSeparator, "", mdmlab.SoftwareFieldSeparator, s.ToUniqueStr())
		}
		reported := make(map[string]struct{})
...
func testDeleteHostSoftwareInstalledPaths(t *testing.T, ds *Datastore) {
	...
	host1 := mdmlab.Host{ID: 1}
	host2 := mdmlab.Host{ID: 2}
	...
	var actual []mdmlab.HostSoftwareInstalledPath
	...
	expected := []mdmlab.HostSoftwareInstalledPath{
		{
			HostID:        host1.ID,
...
func testInsertHostSoftwareInstalledPaths(t *testing.T, ds *Datastore) {
	...
	toInsert := []mdmlab.HostSoftwareInstalledPath{
		{
			HostID:        1,
			SoftwareID:    1,
			InstalledPath: "1",
...
func TestReconcileSoftwareTitles(t *testing.T) {
	...
	expectedTitlesByNSB := map[string]mdmlab.SoftwareTitle{}
	for _, s := range expectedSoftware {
		expectedTitlesByNSB[s.Name+s.Source+s.Browser] = mdmlab.SoftwareTitle{
			Name:    s.Name,
			Source:  s.Source,
			Browser: s.Browser,
		}
	...
	software1 := []mdmlab.Software{expectedSoftware[0], expectedSoftware[2]}
	software2 := []mdmlab.Software{expectedSoftware[1], expectedSoftware[2], expectedSoftware[3]}
	software3 := []mdmlab.Software{expectedSoftware[4]}
	...
	getSoftware := func() ([]mdmlab.Software, error) {
		var sw []mdmlab.Software
	...
	getTitles := func() ([]mdmlab.SoftwareTitle, error) {
		var swt []mdmlab.SoftwareTitle
	...
	assertSoftware := func(t *testing.T, wantSoftware []mdmlab.Software) {
		gotSoftware, err := getSoftware()
		require.NoError(t, err)
		require.Len(t, gotSoftware, len(wantSoftware))

		byNSBV := map[string]mdmlab.Software{}
	...
	assertTitles := func(t *testing.T, gotTitles []mdmlab.SoftwareTitle, expectMissing []string) {
	...
	require.NoError(t, ds.SyncHostsSoftware(context.Background(), time.Now()))
	assertSoftware(t, []mdmlab.Software{expectedSoftware[0], expectedSoftware[1], expectedSoftware[2], expectedSoftware[4]})
	...
	// add bar to host 3
	_, err = ds.UpdateHostSoftware(context.Background(), host3.ID, []mdmlab.Software{expectedSoftware[3], expectedSoftware[4]})
	require.NoError(t, err)
	require.NoError(t, ds.SyncHostsSoftware(context.Background(), time.Now()))
	gotTitles, err = getTitles()
	require.NoError(t, err)
	...
	expectedSoftware = append(expectedSoftware, mdmlab.Software{Name: "foo", Version: "0.0.4", Source: "chrome_extensions"})
	...
	expectedSoftware = append(expectedSoftware, mdmlab.Software{Name: "foo", Version: "0.0.4", Source: "rpm_packages"})
	_, err = ds.UpdateHostSoftware(ctx, host3.ID, expectedSoftware[3:])
	require.NoError(t, err)
...
func testListHostSoftware(t *testing.T, ds *Datastore) {
	...
	opts := mdmlab.HostSoftwareTitleListOptions{ListOptions: mdmlab.ListOptions{PerPage: 11, IncludeMetadata: true, OrderKey: "name", TestSecondaryOrderKey: "source"}}

	user, err := ds.NewUser(ctx, &mdmlab.User{
	...
	expectStatus := func(s mdmlab.SoftwareInstallerStatus) *mdmlab.SoftwareInstallerStatus {
		return &s
	}
	...
	require.NoError(t, err)
	require.Empty(t, sw)
	require.Equal(t, &mdmlab.PaginationMetadata{}, meta)
	...
	require.NoError(t, err)
	assert.Empty(t, sw)
	assert.Equal(t, &mdmlab.PaginationMetadata{}, meta)
	...
	byNSV := map[string]mdmlab.Software{}
	for _, s := range software {
	...
	otherSoftwareByNSV := map[string]mdmlab.Software{}
	...
	for _, v := range vulns {
		_, err = ds.InsertSoftwareVulnerability(ctx, v, mdmlab.NVDSource)
		require.NoError(t, err)
	}
	...
	for _, s := range software {
		...
		key := fmt.Sprintf("%s%s%s%s%s", path, mdmlab.SoftwareFieldSeparator, "", mdmlab.SoftwareFieldSeparator, s.ToUniqueStr())
		swPaths[key] = struct{}{}
	...
	expected := map[string]mdmlab.HostSoftwareWithInstaller{
		byNSV[a1].Name + byNSV[a1].Source: {Name: byNSV[a1].Name, Source: byNSV[a1].Source, InstalledVersions: []*mdmlab.HostSoftwareInstalledVersion{
		...
		byNSV[a2].Name + byNSV[a2].Source: {Name: byNSV[a2].Name, Source: byNSV[a2].Source, InstalledVersions: []*mdmlab.HostSoftwareInstalledVersion{
			{Version: byNSV[a2].Version, InstalledPaths: []string{installPaths[1]}},
		}},
		byNSV[b].Name + byNSV[b].Source: {Name: byNSV[b].Name, Source: byNSV[b].Source, InstalledVersions: []*mdmlab.HostSoftwareInstalledVersion{
		...
		byNSV[c1].Name + byNSV[c1].Source: {Name: byNSV[c1].Name, Source: byNSV[c1].Source, InstalledVersions: []*mdmlab.HostSoftwareInstalledVersion{
		...
		byNSV[d].Name + byNSV[d].Source: {Name: byNSV[d].Name, Source: byNSV[d].Source, InstalledVersions: []*mdmlab.HostSoftwareInstalledVersion{
			{Version: byNSV[d].Version, InstalledPaths: []string{installPaths[5]}},
		}},
		byNSV[e2].Name + byNSV[e2].Source: {Name: byNSV[e2].Name, Source: byNSV[e2].Source, InstalledVersions: []*mdmlab.HostSoftwareInstalledVersion{
			{Version: byNSV[e2].Version, InstalledPaths: []string{installPaths[6]}},
		}},
	}

	compareResults := func(expected map[string]mdmlab.HostSoftwareWithInstaller, got []*mdmlab.HostSoftwareWithInstaller, expectAsc bool, expectOmitted ...string) {
		...
		for _, g := range got {
			...
			if len(e.InstalledVersions) > 0 {
				byVers := make(map[string]mdmlab.HostSoftwareInstalledVersion, len(e.InstalledVersions))
	...
	sw, meta, err = ds.ListHostSoftware(ctx, host, opts)
	require.NoError(t, err)
	require.Equal(t, &mdmlab.PaginationMetadata{TotalResults: 6}, meta)
	compareResults(expected, sw, true)

	opts.VulnerableOnly = true
	sw, meta, err = ds.ListHostSoftware(ctx, host, opts)
	require.NoError(t, err)
	require.Equal(t, &mdmlab.PaginationMetadata{TotalResults: 2}, meta)
	...
	// create some MDMlab installers and map them to a software title,
	// including one for a team
	tm, err := ds.NewTeam(ctx, &mdmlab.Team{Name: "team1"})
	require.NoError(t, err)
	...
	expected[byNSV[b].Name+byNSV[b].Source] = mdmlab.HostSoftwareWithInstaller{
		Name:            "b",
		Source:          "apps",
		Status:          expectStatus(mdmlab.SoftwareInstallPending),
		SoftwarePackage: &mdmlab.SoftwarePackageOrApp{Name: "installer-0.pkg", Version: "v0.0.0", SelfService: ptr.Bool(true), LastInstall: &mdmlab.HostSoftwareInstall{InstallUUID: "uuid1"}},
		InstalledVersions: []*mdmlab.HostSoftwareInstalledVersion{
			{Version: byNSV[b].Version, Vulnerabilities: []string{vulns[3].CVE}, InstalledPaths: []string{installPaths[2]}},
		},
	}
	i0 := mdmlab.HostSoftwareWithInstaller{
		Name:            "i0",
		Source:          "apps",
		Status:          expectStatus(mdmlab.SoftwareInstalled),
		SoftwarePackage: &mdmlab.SoftwarePackageOrApp{Name: "installer-1.pkg", Version: "v1.0.0", SelfService: ptr.Bool(true), LastInstall: &mdmlab.HostSoftwareInstall{InstallUUID: "uuid2"}},
	}
	expected[i0.Name+i0.Source] = i0

	i1 := mdmlab.HostSoftwareWithInstaller{
		Name:            "i1",
		Source:          "apps",
		Status:          expectStatus(mdmlab.SoftwareInstallFailed),
		SoftwarePackage: &mdmlab.SoftwarePackageOrApp{Name: "installer-2.pkg", Version: "v2.0.0", SelfService: ptr.Bool(false), LastInstall: &mdmlab.HostSoftwareInstall{InstallUUID: "uuid3"}},
	}
	expected[i1.Name+i1.Source] = i1

	i4 := mdmlab.HostSoftwareWithInstaller{
		Name:   "i4",
		Source: "apps",
		Status: expectStatus(mdmlab.SoftwareUninstallPending),
		SoftwarePackage: &mdmlab.SoftwarePackageOrApp{
			Name: "installer-5.pkg", Version: "v5.0.0", SelfService: ptr.Bool(false),
			LastInstall:   &mdmlab.HostSoftwareInstall{InstallUUID: "uuid6-pre"},
			LastUninstall: &mdmlab.HostSoftwareUninstall{ExecutionID: "uuid6"},
		},
	}
	expected[i4.Name+i4.Source] = i4

	i5 := mdmlab.HostSoftwareWithInstaller{
		Name:   "i5",
		Source: "apps",
		Status: expectStatus(mdmlab.SoftwareUninstallFailed),
		SoftwarePackage: &mdmlab.SoftwarePackageOrApp{
			Name: "installer-6.pkg", Version: "v6.0.0", SelfService: ptr.Bool(false),
			LastUninstall: &mdmlab.HostSoftwareUninstall{ExecutionID: "uuid7"},
		},
	}
	expected[i5.Name+i5.Source] = i5

	i6 := mdmlab.HostSoftwareWithInstaller{
		Name:   "i6",
		Source: "apps",
		Status: nil,
		SoftwarePackage: &mdmlab.SoftwarePackageOrApp{
			Name: "installer-7.pkg", Version: "v7.0.0", SelfService: ptr.Bool(false),
			LastUninstall: &mdmlab.HostSoftwareUninstall{ExecutionID: "uuid8"},
		},
	}
	...
	sw, meta, err = ds.ListHostSoftware(ctx, host, opts)
	require.NoError(t, err)
	require.Equal(t, &mdmlab.PaginationMetadata{TotalResults: uint(len(expected))}, meta)
	compareResults(expected, sw, true)

	// request with available software
	i2 := mdmlab.HostSoftwareWithInstaller{
		Name:            "i2",
		Source:          "apps",
		Status:          nil,
		SoftwarePackage: &mdmlab.SoftwarePackageOrApp{Name: "installer-3.pkg", Version: "v3.0.0", SelfService: ptr.Bool(false)},
	}
	expected[i2.Name+i2.Source] = i2

	i3 := mdmlab.HostSoftwareWithInstaller{
		Name:            "i3",
		Source:          "apps",
		Status:          nil,
		SoftwarePackage: &mdmlab.SoftwarePackageOrApp{Name: "installer-4.pkg", Version: "v4.0.0", SelfService: ptr.Bool(false)},
	}
	...
	sw, meta, err = ds.ListHostSoftware(ctx, host, opts)
	require.NoError(t, err)
	require.Equal(t, &mdmlab.PaginationMetadata{TotalResults: uint(len(expected)) - 1}, meta)
	...
	expectedAvailableOnly := map[string]mdmlab.HostSoftwareWithInstaller{}
	...
	sw, meta, err = ds.ListHostSoftware(ctx, host, opts)
	require.NoError(t, err)
	assert.Equal(t, &mdmlab.PaginationMetadata{TotalResults: uint(len(expectedAvailableOnly))}, meta)
	compareResults(expectedAvailableOnly, sw, true)
	opts.OnlyAvailableForInstall = false

	// request in descending order
	opts.ListOptions.OrderDirection = mdmlab.OrderDescending
	opts.ListOptions.TestSecondaryOrderDirection = mdmlab.OrderDescending
	opts.IncludeAvailableForInstall = false
	sw, meta, err = ds.ListHostSoftware(ctx, host, opts)
	require.NoError(t, err)
	require.Equal(t, &mdmlab.PaginationMetadata{TotalResults: uint(len(expected)) - 2}, meta)
	compareResults(expected, sw, false, i2.Name+i2.Source, i3.Name+i3.Source)
	opts.ListOptions.OrderDirection = mdmlab.OrderAscending
	opts.ListOptions.TestSecondaryOrderDirection = mdmlab.OrderAscending
	...
	err = ds.SetHostSoftwareInstallResult(ctx, &mdmlab.HostSoftwareInstallResultPayload{
		HostID:                host.ID,
		InstallUUID:           "uuid1",
	...
	expected[i1.Name+i1.Source] = mdmlab.HostSoftwareWithInstaller{
		Name:            "i1",
		Source:          "apps",
		Status:          expectStatus(mdmlab.SoftwareInstallPending),
		SoftwarePackage: &mdmlab.SoftwarePackageOrApp{Name: "installer-2.pkg", Version: "v2.0.0", SelfService: ptr.Bool(false), LastInstall: &mdmlab.HostSoftwareInstall{InstallUUID: "uuid4"}},
	}
	expectedAvailableOnly[byNSV[b].Name+byNSV[b].Source] = expected[byNSV[b].Name+byNSV[b].Source]
	...
	sw, meta, err = ds.ListHostSoftware(ctx, tmHost, opts)
	require.NoError(t, err)
	require.Equal(t, &mdmlab.PaginationMetadata{TotalResults: 1}, meta)
	compareResults(map[string]mdmlab.HostSoftwareWithInstaller{
	...
	va1, err := ds.InsertVPPAppWithTeam(ctx,
		&mdmlab.VPPApp{
			VPPAppTeam: mdmlab.VPPAppTeam{VPPAppID: mdmlab.VPPAppID{AdamID: "adam_vpp_1", Platform: mdmlab.MacOSPlatform}}, Name: "vpp1",
			BundleIdentifier: "com.app.vpp1",
		}, nil)
	require.NoError(t, err)
	_, err = ds.InsertVPPAppWithTeam(ctx,
		&mdmlab.VPPApp{
			VPPAppTeam: mdmlab.VPPAppTeam{VPPAppID: mdmlab.VPPAppID{AdamID: "adam_vpp_1", Platform: mdmlab.IOSPlatform}}, Name: "vpp1",
			BundleIdentifier: "com.app.vpp1",
		}, nil)
	require.NoError(t, err)
	_, err = ds.InsertVPPAppWithTeam(ctx,
	...
	va2, err := ds.InsertVPPAppWithTeam(ctx,
		&mdmlab.VPPApp{
			VPPAppTeam: mdmlab.VPPAppTeam{VPPAppID: mdmlab.VPPAppID{AdamID: "adam_vpp_2", Platform: mdmlab.MacOSPlatform}}, Name: "vpp2",
	...
	va3, err := ds.InsertVPPAppWithTeam(ctx,
		&mdmlab.VPPApp{
			VPPAppTeam: mdmlab.VPPAppTeam{VPPAppID: mdmlab.VPPAppID{AdamID: "adam_vpp_3", Platform: mdmlab.MacOSPlatform}, SelfService: true}, Name: "vpp3",
	...
	createVPPAppInstallResult(t, ds, host, vpp1CmdUUID, mdmlab.MDMAppleStatusAcknowledged)
	createVPPAppInstallResult(t, ds, host, vpp2CmdUUID, mdmlab.MDMAppleStatusError)
	...
	expected["vpp1apps"] = mdmlab.HostSoftwareWithInstaller{
		Name:        "vpp1",
		Source:      "apps",
		Status:      expectStatus(mdmlab.SoftwareInstalled),
		AppStoreApp: &mdmlab.SoftwarePackageOrApp{AppStoreID: vpp1, SelfService: ptr.Bool(false), LastInstall: &mdmlab.HostSoftwareInstall{CommandUUID: vpp1CmdUUID}},
	}
	expected["vpp2apps"] = mdmlab.HostSoftwareWithInstaller{
		Name:        "vpp2",
		Source:      "apps",
		Status:      expectStatus(mdmlab.SoftwareInstallPending),
		AppStoreApp: &mdmlab.SoftwarePackageOrApp{AppStoreID: vpp2, SelfService: ptr.Bool(false), LastInstall: &mdmlab.HostSoftwareInstall{CommandUUID: vpp2bCmdUUID}},
	}
	...
	expected["vpp3apps"] = mdmlab.HostSoftwareWithInstaller{
		Name:        "vpp3",
		Source:      "apps",
		Status:      nil,
		AppStoreApp: &mdmlab.SoftwarePackageOrApp{AppStoreID: vpp3, SelfService: ptr.Bool(true)},
	}
	...
	sw, meta, err = ds.ListHostSoftware(ctx, host, opts)
	require.NoError(t, err)
	require.Equal(t, &mdmlab.PaginationMetadata{TotalResults: uint(len(expectedAvailableOnly) - 1)}, meta)
	...
	compareResults(map[string]mdmlab.HostSoftwareWithInstaller{
		...
		"vpp1apps": {
			...
			Source:      "apps",
			Status:      expectStatus(mdmlab.SoftwareInstallPending),
			AppStoreApp: &mdmlab.SoftwarePackageOrApp{AppStoreID: vpp1, SelfService: ptr.Bool(false), LastInstall: &mdmlab.HostSoftwareInstall{CommandUUID: vpp1TmCmdUUID}},
		},
	}, sw, true)
	...
	require.NoError(t, err)
	require.Equal(t, &mdmlab.PaginationMetadata{TotalResults: 5}, meta)

	expectedOther := map[string]mdmlab.HostSoftwareWithInstaller{
		otherSoftware[0].Name + otherSoftware[0].Source: {Name: otherSoftware[0].Name, Source: otherSoftware[0].Source, InstalledVersions: []*mdmlab.HostSoftwareInstalledVersion{
			{Version: otherSoftware[0].Version},
		}},
		otherSoftware[1].Name + otherSoftware[1].Source: {Name: otherSoftware[1].Name, Source: otherSoftware[1].Source, InstalledVersions: []*mdmlab.HostSoftwareInstalledVersion{
			{Version: otherSoftware[1].Version},
		}},
		otherSoftware[2].Name + otherSoftware[2].Source: {Name: otherSoftware[2].Name, Source: otherSoftware[2].Source, InstalledVersions: []*mdmlab.HostSoftwareInstalledVersion{
		...
		"i1apps": {
			...
			Source:          "apps",
			Status:          expectStatus(mdmlab.SoftwareInstallPending),
			SoftwarePackage: &mdmlab.SoftwarePackageOrApp{Name: "installer-2.pkg", Version: "v2.0.0", SelfService: ptr.Bool(false), LastInstall: &mdmlab.HostSoftwareInstall{InstallUUID: otherHostI1UUID}},
		},
		"i2apps": {
			Name:            "i2",
			Source:          "apps",
			Status:          expectStatus(mdmlab.SoftwareInstallPending),
			SoftwarePackage: &mdmlab.SoftwarePackageOrApp{Name: "installer-3.pkg", Version: "v3.0.0", SelfService: ptr.Bool(false), LastInstall: &mdmlab.HostSoftwareInstall{InstallUUID: otherHostI2UUID}},
		},
	}
	...
	cases := []struct {
		name      string
		opts      mdmlab.HostSoftwareTitleListOptions
		wantNames []string
		wantMeta  *mdmlab.PaginationMetadata
	}{
		{
			name:      "No available for install software, page 0",
			opts:      mdmlab.HostSoftwareTitleListOptions{ListOptions: mdmlab.ListOptions{PerPage: 5}, IncludeAvailableForInstall: false},
			wantNames: []string{byNSV[a1].Name, byNSV[a2].Name, byNSV[b].Name, byNSV[c1].Name, byNSV[d].Name},
			wantMeta:  &mdmlab.PaginationMetadata{HasNextResults: true, HasPreviousResults: false, TotalResults: 13},
		},
		{
			name:      "No available for install software, page 1",
			opts:      mdmlab.HostSoftwareTitleListOptions{ListOptions: mdmlab.ListOptions{Page: 1, PerPage: 5}, IncludeAvailableForInstall: false},
			wantNames: []string{byNSV[e2].Name, i0.Name, i1.Name, i4.Name, i5.Name},
			wantMeta:  &mdmlab.PaginationMetadata{HasNextResults: true, HasPreviousResults: true, TotalResults: 13},
		},
		{
			name:      "No available for install software, page 2",
			opts:      mdmlab.HostSoftwareTitleListOptions{ListOptions: mdmlab.ListOptions{Page: 2, PerPage: 5}, IncludeAvailableForInstall: false},
			wantNames: []string{i6.Name, "vpp1", "vpp2"},
			wantMeta:  &mdmlab.PaginationMetadata{HasNextResults: false, HasPreviousResults: true, TotalResults: 13},
		},
		{
			name:      "No available for install software, page 3",
			opts:      mdmlab.HostSoftwareTitleListOptions{ListOptions: mdmlab.ListOptions{Page: 3, PerPage: 5}, IncludeAvailableForInstall: false},
			wantNames: []string{},
			wantMeta:  &mdmlab.PaginationMetadata{HasNextResults: false, HasPreviousResults: true, TotalResults: 13},
		},
		{
			name:      "Include Available for install software with MDM on, page 0",
			opts:      mdmlab.HostSoftwareTitleListOptions{ListOptions: mdmlab.ListOptions{PerPage: 5}, IncludeAvailableForInstall: true, IsMDMEnrolled: true},
			wantNames: []string{byNSV[a1].Name, byNSV[a2].Name, byNSV[b].Name, byNSV[c1].Name, byNSV[d].Name},
			wantMeta:  &mdmlab.PaginationMetadata{HasNextResults: true, HasPreviousResults: false, TotalResults: 15},
		},
		{
			name:      "Include Available for install software with MDM on, page 1",
			opts:      mdmlab.HostSoftwareTitleListOptions{ListOptions: mdmlab.ListOptions{Page: 1, PerPage: 5}, IncludeAvailableForInstall: true, IsMDMEnrolled: true},
			wantNames: []string{byNSV[e2].Name, i0.Name, i1.Name, i2.Name, i4.Name},
			wantMeta:  &mdmlab.PaginationMetadata{HasNextResults: true, HasPreviousResults: true, TotalResults: 15},
		},
		{
			name: "Include Available for install software with MDM on, page 2",
			opts: mdmlab.HostSoftwareTitleListOptions{
				ListOptions:                mdmlab.ListOptions{Page: 2, PerPage: 5},
				IncludeAvailableForInstall: true,
				IsMDMEnrolled:              true,
			},
			wantNames: []string{i5.Name, i6.Name, "vpp1", "vpp2", "vpp3"},
			wantMeta:  &mdmlab.PaginationMetadata{HasNextResults: false, HasPreviousResults: true, TotalResults: 15},
		},

		{
			...
			wantMeta:  &mdmlab.PaginationMetadata{HasNextResults: false, HasPreviousResults: true, TotalResults: 14},
		},
		{
			name: "Include Available for install software with MDM on, page 3",
			opts: mdmlab.HostSoftwareTitleListOptions{
				ListOptions:                mdmlab.ListOptions{Page: 3, PerPage: 5},
				IncludeAvailableForInstall: true,
				IsMDMEnrolled:              true,
			},
			wantNames: []string{},
		...
		},
		{
			...
			opts:      mdmlab.HostSoftwareTitleListOptions{ListOptions: mdmlab.ListOptions{PerPage: 3}, IncludeAvailableForInstall: true, SelfServiceOnly: true, IsMDMEnrolled: true},
			wantNames: []string{byNSV[b].Name, i0.Name, "vpp3"},
			wantMeta:  &mdmlab.PaginationMetadata{HasNextResults: false, HasPreviousResults: false, TotalResults: 3},
		},
		{
			name:      "Available for install and self-service only software with MDM on, page 1",
			opts:      mdmlab.HostSoftwareTitleListOptions{ListOptions: mdmlab.ListOptions{Page: 1, PerPage: 3}, IncludeAvailableForInstall: true, SelfServiceOnly: true, IsMDMEnrolled: true},
			wantNames: []string{},
			wantMeta:  &mdmlab.PaginationMetadata{HasNextResults: false, HasPreviousResults: true, TotalResults: 3},
		},
		{
			name:      "Available for install and self-service only software with MDM off, page 0",
			opts:      mdmlab.HostSoftwareTitleListOptions{ListOptions: mdmlab.ListOptions{PerPage: 3}, IncludeAvailableForInstall: true, SelfServiceOnly: true},
			wantNames: []string{byNSV[b].Name, i0.Name},
			wantMeta:  &mdmlab.PaginationMetadata{HasNextResults: false, HasPreviousResults: false, TotalResults: 2},
		},
		{
			name:      "Only available for install software with MDM on, page 0",
			opts:      mdmlab.HostSoftwareTitleListOptions{ListOptions: mdmlab.ListOptions{Page: 0, PerPage: 4}, OnlyAvailableForInstall: true, IsMDMEnrolled: true},
			wantNames: []string{byNSV[b].Name, "i0", "i1", "i2"},
			wantMeta:  &mdmlab.PaginationMetadata{HasNextResults: true, HasPreviousResults: false, TotalResults: 10},
		},
		{
			name: "Only available for install with MDM on, page 2",
			opts: mdmlab.HostSoftwareTitleListOptions{
				ListOptions:             mdmlab.ListOptions{Page: 2, PerPage: 4},
				OnlyAvailableForInstall: true,
				IsMDMEnrolled:           true,
			},
			wantNames: []string{"vpp2", "vpp3"},
			wantMeta:  &mdmlab.PaginationMetadata{HasNextResults: false, HasPreviousResults: true, TotalResults: 10},
		},
	}
	for _, c := range cases {
		t.Run(c.name, func(t *testing.T) {
...
func testListIOSHostSoftware(t *testing.T, ds *Datastore) {
	...
	nanoEnroll(t, ds, host, false)
	opts := mdmlab.HostSoftwareTitleListOptions{ListOptions: mdmlab.ListOptions{
	...
	compareResults := func(expected map[string]mdmlab.HostSoftwareWithInstaller, got []*mdmlab.HostSoftwareWithInstaller, expectAsc bool,
	...
	sw, meta, err = ds.ListHostSoftware(ctx, host, opts)
	require.NoError(t, err)
	assert.Equal(t, &mdmlab.PaginationMetadata{TotalResults: uint(len(expected))}, meta)
	compareResults(expected, sw, true)

	opts.VulnerableOnly = true
	sw, meta, err = ds.ListHostSoftware(ctx, host, opts)
	require.NoError(t, err)
	assert.Equal(t, &mdmlab.PaginationMetadata{TotalResults: uint(len(expected) - 1)}, meta)
	...
	// Create a team
	tm, err := ds.NewTeam(ctx, &mdmlab.Team{Name: "mobile team"})
	require.NoError(t, err)
	...
	_, err = ds.InsertVPPAppWithTeam(ctx,
		&mdmlab.VPPApp{
			VPPAppTeam: mdmlab.VPPAppTeam{VPPAppID: mdmlab.VPPAppID{AdamID: "adam_vpp_1", Platform: mdmlab.IPadOSPlatform}}, Name: "vpp1",
			BundleIdentifier: "com.app.vpp1",
		}, nil)
	require.NoError(t, err)
	_, err = ds.InsertVPPAppWithTeam(ctx,
	...
	va2, err := ds.InsertVPPAppWithTeam(ctx,
		&mdmlab.VPPApp{
			VPPAppTeam: mdmlab.VPPAppTeam{VPPAppID: mdmlab.VPPAppID{AdamID: "adam_vpp_2", Platform: mdmlab.IOSPlatform}}, Name: "vpp2",
			BundleIdentifier: "com.app.vpp2",
		}, nil)
	require.NoError(t, err)
	va3, err := ds.InsertVPPAppWithTeam(ctx,
		&mdmlab.VPPApp{
			VPPAppTeam: mdmlab.VPPAppTeam{VPPAppID: mdmlab.VPPAppID{AdamID: "adam_vpp_3", Platform: mdmlab.IOSPlatform}}, Name: "vpp3",
			BundleIdentifier: "com.app.vpp3",
		}, nil)
	require.NoError(t, err)
	va4, err := ds.InsertVPPAppWithTeam(ctx,
		&mdmlab.VPPApp{
			VPPAppTeam: mdmlab.VPPAppTeam{VPPAppID: mdmlab.VPPAppID{AdamID: "adam_vpp_4", Platform: mdmlab.IOSPlatform}}, Name: "vpp4",
	...
	expected["vpp1ios_apps"] = mdmlab.HostSoftwareWithInstaller{
		Name:        "vpp1",
		Source:      "ios_apps",
		Status:      expectStatus(mdmlab.SoftwareInstalled),
		AppStoreApp: &mdmlab.SoftwarePackageOrApp{AppStoreID: vpp1, SelfService: ptr.Bool(false), LastInstall: &mdmlab.HostSoftwareInstall{CommandUUID: vpp1CmdUUID}},
	}
	expected["vpp2ios_apps"] = mdmlab.HostSoftwareWithInstaller{
		Name:        "vpp2",
		Source:      "ios_apps",
		Status:      expectStatus(mdmlab.SoftwareInstallPending),
		AppStoreApp: &mdmlab.SoftwarePackageOrApp{AppStoreID: vpp2, SelfService: ptr.Bool(false), LastInstall: &mdmlab.HostSoftwareInstall{CommandUUID: vpp2bCmdUUID}},
	...
	expected["vpp3ios_apps"] = mdmlab.HostSoftwareWithInstaller{
		Name:        "vpp3",
		Source:      "ios_apps",
		Status:      nil,
		AppStoreApp: &mdmlab.SoftwarePackageOrApp{AppStoreID: vpp3, SelfService: ptr.Bool(false)},
	}
	expected["vpp4ios_apps"] = mdmlab.HostSoftwareWithInstaller{
		Name:        "vpp4",
		Source:      "ios_apps",
		Status:      nil,
		AppStoreApp: &mdmlab.SoftwarePackageOrApp{AppStoreID: vpp4, SelfService: ptr.Bool(false)},
	}
	expectedAvailableOnly := map[string]mdmlab.HostSoftwareWithInstaller{}
...
func testSetHostSoftwareInstallResult(t *testing.T, ds *Datastore) {
	...
	checkResults := func(want *mdmlab.HostSoftwareInstallResultPayload) {
		type result struct {
	...
	want := &mdmlab.HostSoftwareInstallResultPayload{
		HostID:                    host.ID,
		InstallUUID:               "uuid0",
...
func testListHostSoftwareInstallThenTransferTeam(t *testing.T, ds *Datastore) {
	...
	nanoEnroll(t, ds, host, false)
	opts := mdmlab.HostSoftwareTitleListOptions{
		ListOptions:                mdmlab.ListOptions{PerPage: 10, IncludeMetadata: true, OrderKey: "name", TestSecondaryOrderKey: "source"},
		IncludeAvailableForInstall: true,
	}
	...
	require.NoError(t, err)
	installerTm1, _, err := ds.MatchOrCreateSoftwareInstaller(ctx, &mdmlab.UploadSoftwareInstallerPayload{
		InstallScript:   "hello",
		InstallerFile:   tfr1,
		StorageID:       "storage1",
		Filename:        "file1",
	...
	createVPPAppInstallResult(t, ds, host, vpp1CmdUUID, mdmlab.MDMAppleStatusError)
...
func testListSoftwareVersionsVulnerabilityFilters(t *testing.T, ds *Datastore) {
	...
	_, err = ds.InsertSoftwareVulnerability(ctx, mdmlab.SoftwareVulnerability{
	...
	err = ds.InsertCVEMeta(ctx, []mdmlab.CVEMeta{
		{
			// chrome
			CVE:              "CVE-2024-1234",
	...
	tc := []struct {
	...
	}{
		{
			...
			opts: mdmlab.SoftwareListOptions{
				ListOptions:    mdmlab.ListOptions{OrderKey: "name"},
				VulnerableOnly: true,
			},
			expected: []swVersion{
				{
		...
		},
		{
			...
			opts: mdmlab.SoftwareListOptions{
				ListOptions:      mdmlab.ListOptions{OrderKey: "name", OrderDirection: mdmlab.OrderAscending},
				IncludeCVEScores: true,
				VulnerableOnly:   true,
				KnownExploit:     true,
			},
		...
		},
		{
			...
			err: mdmlab.NewInvalidArgumentError("query", "min_cvss_score, max_cvss_score, and exploit can only be provided with vulnerable=true"),
		},
		{
...
func testListHostSoftwareWithLabelScoping(t *testing.T, ds *Datastore) {
	...
	tfr1, err := mdmlab.NewTempFileReader(strings.NewReader("hello"), t.TempDir)
	require.NoError(t, err)
	installer1 := &mdmlab.UploadSoftwareInstallerPayload{
		InstallScript:     "hello",
	...
	expectedInstallers := map[string]*mdmlab.SoftwarePackageOrApp{
		installer1.Filename: {
	...
	checkSoftware := func(swList []*mdmlab.HostSoftwareWithInstaller, excludeNames ...string) {
	...
	label1, err := ds.NewLabel(ctx, &mdmlab.Label{Name: "label1" + t.Name()})
	require.NoError(t, err)
	...
	err = setOrUpdateSoftwareInstallerLabelsDB(ctx, ds.writer(ctx), installerID1, mdmlab.LabelIdentsWithScope{
		LabelScope: mdmlab.LabelScopeExcludeAny,
		ByName:     map[string]mdmlab.LabelIdent{label1.Name: {LabelName: label1.Name, LabelID: label1.ID}},
	})
	require.NoError(t, err)
	...
	err = setOrUpdateSoftwareInstallerLabelsDB(ctx, ds.writer(ctx), installerID1, mdmlab.LabelIdentsWithScope{
		LabelScope: mdmlab.LabelScopeIncludeAny,
		ByName:     map[string]mdmlab.LabelIdent{label1.Name: {LabelName: label1.Name, LabelID: label1.ID}},
	})
	require.NoError(t, err)
	...
	installer2 := &mdmlab.UploadSoftwareInstallerPayload{
		InstallScript:     "hello",
		PreInstallQuery:   "SELECT 1",
		PostInstallScript: "world",
		UninstallScript:   "goodbye",
	...
	expectedInstallers[installer2.Filename] = &mdmlab.SoftwarePackageOrApp{
	...
	label2, err := ds.NewLabel(ctx, &mdmlab.Label{Name: "label2" + t.Name()})
	require.NoError(t, err)

	label3, err := ds.NewLabel(ctx, &mdmlab.Label{Name: "label3" + t.Name()})
	require.NoError(t, err)

	err = setOrUpdateSoftwareInstallerLabelsDB(ctx, ds.writer(ctx), installerID2, mdmlab.LabelIdentsWithScope{
		LabelScope: mdmlab.LabelScopeExcludeAny,
		ByName: map[string]mdmlab.LabelIdent{
	...
	// Add an installer. No label yet.
	installer3 := &mdmlab.UploadSoftwareInstallerPayload{
		InstallScript:     "hello",
		PreInstallQuery:   "SELECT 1",
		PostInstallScript: "world",
		UninstallScript:   "goodbye",
	...
	time.Sleep(time.Second)
	expectedInstallers[installer3.Filename] = &mdmlab.SoftwarePackageOrApp{
	...
	label4, err := ds.NewLabel(ctx, &mdmlab.Label{Name: "label4" + t.Name()})
	require.NoError(t, err)

	err = setOrUpdateSoftwareInstallerLabelsDB(ctx, ds.writer(ctx), installerID3, mdmlab.LabelIdentsWithScope{
		LabelScope: mdmlab.LabelScopeExcludeAny,
		ByName:     map[string]mdmlab.LabelIdent{label4.Name: {LabelName: label4.Name, LabelID: label4.ID}},
	})
	require.NoError(t, err)
