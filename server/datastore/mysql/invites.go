...
func (ds *Datastore) NewInvite(ctx context.Context, i *mdmlab.Invite) (*mdmlab.Invite, error) {
	if err := mdmlab.ValidateRole(i.GlobalRole.Ptr(), i.Teams); err != nil {
		return nil, err
	}
...
// ListInvites lists all invites in the MDMlab database. Supply query options
// using the opt parameter. See mdmlab.ListOptions
func (ds *Datastore) ListInvites(ctx context.Context, opt mdmlab.ListOptions) ([]*mdmlab.Invite, error) {
...
func (ds *Datastore) Invite(ctx context.Context, id uint) (*mdmlab.Invite, error) {
	var invite mdmlab.Invite
	...
	if err := ds.loadTeamsForInvites(ctx, []*mdmlab.Invite{&invite}); err != nil {
		return nil, ctxerr.Wrap(ctx, err, "load teams")
	}
...
func (ds *Datastore) InviteByEmail(ctx context.Context, email string) (*mdmlab.Invite, error) {
	var invite mdmlab.Invite
...
func (ds *Datastore) InviteByToken(ctx context.Context, token string) (*mdmlab.Invite, error) {
	var invite mdmlab.Invite
...
func (ds *Datastore) loadTeamsForInvites(ctx context.Context, invites []*mdmlab.Invite) error {
	...
	idToInvite := make(map[uint]*mdmlab.Invite, len(invites))
...
func (ds *Datastore) UpdateInvite(ctx context.Context, id uint, i *mdmlab.Invite) (*mdmlab.Invite, error) {
