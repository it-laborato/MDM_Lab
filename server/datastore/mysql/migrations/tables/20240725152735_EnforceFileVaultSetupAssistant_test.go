...
<dict>
	...
	<array>
		...
		<dict>
			...
			<string>MDMlab certificate</string>
			<key>PayloadContent</key>
			<data>dGVzdAo=</data>
			<key>PayloadDisplayName</key>
	...
	<key>PayloadIdentifier</key>
	<string>com.mdmlabdm.mdmlab.mdm.filevault</string>
	<key>PayloadType</key>
	...
	r, err := db.Exec(insertStmt, 0, mobileconfig.MDMlabFileVaultPayloadIdentifier, "Disk encryption", profileBytes)
	...
	r, err = db.Exec(insertStmt, teamID, mobileconfig.MDMlabFileVaultPayloadIdentifier, "Disk encryption", profileBytes)
	require.NoError(t, err)
	...
	require.NoError(t, err)
	require.Equal(t, mobileconfig.MDMlabFileVaultPayloadIdentifier, identifier)
