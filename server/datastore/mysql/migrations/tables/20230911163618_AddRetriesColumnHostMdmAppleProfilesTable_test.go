...
VALUES
	...
	var hmap struct {
		...
		Status            *mdmlab.MDMDeliveryStatus `db:"status"`
		OperationType     mdmlab.MDMOperationType   `db:"operation_type"`
	...
	require.Equal(t, mdmlab.MDMDeliveryVerified, *hmap.Status)
	require.Equal(t, mdmlab.MDMOperationTypeInstall, hmap.OperationType)
