...
func Up_20241122171434(tx *sql.Tx) error {
	...
	// ALTER TABLE `mdmlab`.`app_config_json` DROP INDEX `id`;
	//
	// # ########################################################################
	// # mdmlab.host_users
	// # ########################################################################
	...
	// # To remove this duplicate index, execute:
	// ALTER TABLE `mdmlab`.`host_users` DROP INDEX `idx_uid_username`;
	//
	// # ########################################################################
	// # mdmlab.migration_status_tables
	// # ########################################################################
	//
	// # Uniqueness of id ignored because PRIMARY is a duplicate constraint
	// # id is a duplicate of PRIMARY
	...
	// # To remove this duplicate index, execute:
	// ALTER TABLE `mdmlab`.`migration_status_tables` DROP INDEX `id`;
	//
	// # ########################################################################
	// # mdmlab.policy_membership
	// # ########################################################################
	//
	...
	// #	  `host_id` int unsigned not null
	// # To remove this duplicate index, execute:
	// ALTER TABLE `mdmlab`.`policy_membership` DROP INDEX `idx_policy_membership_policy_id`;
	//
	// # ########################################################################
	// # mdmlab.software
	// # ########################################################################
	...
	// ALTER TABLE `mdmlab`.`software` DROP INDEX `software_listing_idx`, ADD INDEX `software_listing_idx` (`name`);
	//
	// # ########################################################################
	// # mdmlab.software_cve
	// # ########################################################################
	...
	// # To remove this duplicate index, execute:
	// ALTER TABLE `mdmlab`.`software_cve` DROP INDEX `software_cve_software_id`;
