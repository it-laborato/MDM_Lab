...
func TestUp_20240314085226(t *testing.T) {
	...
	sampleEvent := mdmlab.CalendarEvent{
	...
	sampleHostEvent := mdmlab.HostCalendarEvent{
		HostID:          1,
		CalendarEventID: sampleEvent.ID,
		WebhookStatus:   mdmlab.CalendarWebhookStatusPending,
	}
	...
	var event mdmlab.CalendarEvent
	...
	var hostEvent mdmlab.HostCalendarEvent
