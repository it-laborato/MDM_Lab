...
`)
	...
	r, err := db.Exec(stmt, 0, "com.mdmlabdm.mdmlab.mdm.filevault", "Disk encryption", mcBytes)
	...
	r, err = db.Exec(stmt, teamID, "com.mdmlabdm.mdmlab.mdm.filevault", "Disk encryption", mcBytes)
	require.NoError(t, err)
	...
	require.NoError(t, err)
	require.Equal(t, "com.mdmlabdm.mdmlab.mdm.filevault", identifier)
