...
func (ds *Datastore) ListOperatingSystems(ctx context.Context) ([]mdmlab.OperatingSystem, error) {
	return listOperatingSystemsDB(ctx, ds.reader(ctx))
}

func listOperatingSystemsDB(ctx context.Context, tx sqlx.QueryerContext) ([]mdmlab.OperatingSystem, error) {
...
func (ds *Datastore) ListOperatingSystemsForPlatform(ctx context.Context, platform string) ([]mdmlab.OperatingSystem, error) {
	var oses []mdmlab.OperatingSystem
	sqlStatement := `
...
func (ds *Datastore) UpdateHostOperatingSystem(ctx context.Context, hostID uint, hostOS mdmlab.OperatingSystem) error {
...
func (ds *Datastore) GetHostOperatingSystem(ctx context.Context, hostID uint) (*mdmlab.OperatingSystem, error) {
...
func getOrGenerateOperatingSystemDB(ctx context.Context, tx sqlx.ExtContext, hostOS mdmlab.OperatingSystem) (*mdmlab.OperatingSystem, error) {
...
func newOperatingSystemDB(ctx context.Context, tx sqlx.ExtContext, hostOS mdmlab.OperatingSystem) (*mdmlab.OperatingSystem, error) {
...
func getOSVersionID(ctx context.Context, tx sqlx.ExtContext, hostOS mdmlab.OperatingSystem) (uint, error) {
...
func getOperatingSystemDB(ctx context.Context, tx sqlx.ExtContext, hostOS mdmlab.OperatingSystem) (*mdmlab.OperatingSystem, error) {
	var os mdmlab.OperatingSystem
...
func isHostOperatingSystemUpdateNeeded(ctx context.Context, qc sqlx.QueryerContext, hostID uint, hostOS mdmlab.OperatingSystem) (
	bool, error,
) {
...
func getHostOperatingSystemDB(ctx context.Context, tx sqlx.QueryerContext, hostID uint) (*mdmlab.OperatingSystem, error) {
	var os mdmlab.OperatingSystem
