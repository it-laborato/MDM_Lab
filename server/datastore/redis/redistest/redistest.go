...
func (nopRedis) Mode() mdmlab.RedisMode { return mdmlab.RedisStandalone }
...
func NopRedis() mdmlab.RedisPool {
	return nopRedis{}
}

func SetupRedis(tb testing.TB, cleanupKeyPrefix string, cluster, redir, readReplica bool) mdmlab.RedisPool {
	return SetupRedisWithConfig(tb, cleanupKeyPrefix, cluster, redir, readReplica, redis.PoolConfig{})
}

func SetupRedisWithConfig(tb testing.TB, cleanupKeyPrefix string, cluster, redir, readReplica bool, config redis.PoolConfig) mdmlab.RedisPool {
...
func cleanup(tb testing.TB, pool mdmlab.RedisPool, cleanupKeyPrefix string) {
