...
func SeedTestInstallerStore(tb testing.TB, store *InstallerStore, enrollSecret string) []mdmlab.Installer {
	checkEnv(tb)
	installers := []mdmlab.Installer{
...
func mockInstaller(secret, kind string, desktop bool) mdmlab.Installer {
	return mdmlab.Installer{
		EnrollSecret: secret,
		Kind:         kind,
		Desktop:      desktop,
