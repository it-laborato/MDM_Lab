...
var _ mdmlab.MDMAppleStore = (*MDMAppleStore)(nil)
...
type EnqueueDeviceLockCommandFunc func(ctx context.Context, host *mdmlab.Host, cmd *mdm.Command, pin string) error

type EnqueueDeviceWipeCommandFunc func(ctx context.Context, host *mdmlab.Host, cmd *mdm.Command) error
...
func (fs *MDMAppleStore) GetAllMDMConfigAssetsByName(ctx context.Context, assetNames []mdmlab.MDMAssetName, queryerContext sqlx.QueryerContext) (map[mdmlab.MDMAssetName]mdmlab.MDMConfigAsset, error) {
	fs.mu.Lock()
...
func (fs *MDMAppleStore) GetABMTokenByOrgName(ctx context.Context, orgName string) (*mdmlab.ABMToken, error) {
	fs.mu.Lock()
...
func (fs *MDMAppleStore) EnqueueDeviceLockCommand(ctx context.Context, host *mdmlab.Host, cmd *mdm.Command, pin string) error {
	fs.mu.Lock()
...
func (fs *MDMAppleStore) EnqueueDeviceWipeCommand(ctx context.Context, host *mdmlab.Host, cmd *mdm.Command) error {
	fs.mu.Lock()
