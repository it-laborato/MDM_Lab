...
var _ mdmlab.Datastore = (*DataStore)(nil)

type HealthCheckFunc func() error

type NewCarveFunc func(ctx context.Context, metadata *mdmlab.CarveMetadata) (*mdmlab.CarveMetadata, error)

type UpdateCarveFunc func(ctx context.Context, metadata *mdmlab.CarveMetadata) error

type CarveFunc func(ctx context.Context, carveId int64) (*mdmlab.CarveMetadata, error)

type CarveBySessionIdFunc func(ctx context.Context, sessionId string) (*mdmlab.CarveMetadata, error)

type CarveByNameFunc func(ctx context.Context, name string) (*mdmlab.CarveMetadata, error)

type ListCarvesFunc func(ctx context.Context, opt mdmlab.CarveListOptions) ([]*mdmlab.CarveMetadata, error)

type NewBlockFunc func(ctx context.Context, metadata *mdmlab.CarveMetadata, blockId int64, data []byte) error

type GetBlockFunc func(ctx context.Context, metadata *mdmlab.CarveMetadata, blockId int64) ([]byte, error)

type CleanupCarvesFunc func(ctx context.Context, now time.Time) (expired int, err error)

type NewUserFunc func(ctx context.Context, user *mdmlab.User) (*mdmlab.User, error)

type ListUsersFunc func(ctx context.Context, opt mdmlab.UserListOptions) ([]*mdmlab.User, error)

type UserByEmailFunc func(ctx context.Context, email string) (*mdmlab.User, error)

type UserByIDFunc func(ctx context.Context, id uint) (*mdmlab.User, error)

type SaveUserFunc func(ctx context.Context, user *mdmlab.User) error

type SaveUsersFunc func(ctx context.Context, users []*mdmlab.User) error
...
type UserSettingsFunc func(ctx context.Context, userID uint) (*mdmlab.UserSettings, error)

type ApplyQueriesFunc func(ctx context.Context, authorID uint, queries []*mdmlab.Query, queriesToDiscardResults map[uint]struct{}) error

type NewQueryFunc func(ctx context.Context, query *mdmlab.Query, opts ...mdmlab.OptionalArg) (*mdmlab.Query, error)

type SaveQueryFunc func(ctx context.Context, query *mdmlab.Query, shouldDiscardResults bool, shouldDeleteStats bool) error
...
type QueryFunc func(ctx context.Context, id uint) (*mdmlab.Query, error)

type ListQueriesFunc func(ctx context.Context, opt mdmlab.ListQueryOptions) ([]*mdmlab.Query, int, *mdmlab.PaginationMetadata, error)

type ListScheduledQueriesForAgentsFunc func(ctx context.Context, teamID *uint, queryReportsDisabled bool) ([]*mdmlab.Query, error)

type QueryByNameFunc func(ctx context.Context, teamID *uint, name string) (*mdmlab.Query, error)
...
type GetLiveQueryStatsFunc func(ctx context.Context, queryID uint, hostIDs []uint) ([]*mdmlab.LiveQueryStats, error)

type UpdateLiveQueryStatsFunc func(ctx context.Context, queryID uint, stats []*mdmlab.LiveQueryStats) error

type CalculateAggregatedPerfStatsPercentilesFunc func(ctx context.Context, aggregate mdmlab.AggregatedStatsType, queryID uint) error

type NewDistributedQueryCampaignFunc func(ctx context.Context, camp *mdmlab.DistributedQueryCampaign) (*mdmlab.DistributedQueryCampaign, error)

type DistributedQueryCampaignFunc func(ctx context.Context, id uint) (*mdmlab.DistributedQueryCampaign, error)

type SaveDistributedQueryCampaignFunc func(ctx context.Context, camp *mdmlab.DistributedQueryCampaign) error

type DistributedQueryCampaignTargetIDsFunc func(ctx context.Context, id uint) (targets *mdmlab.HostTargets, err error)

type NewDistributedQueryCampaignTargetFunc func(ctx context.Context, target *mdmlab.DistributedQueryCampaignTarget) (*mdmlab.DistributedQueryCampaignTarget, error)
...
type DistributedQueryCampaignsForQueryFunc func(ctx context.Context, queryID uint) ([]*mdmlab.DistributedQueryCampaign, error)

type ApplyPackSpecsFunc func(ctx context.Context, specs []*mdmlab.PackSpec) error

type GetPackSpecsFunc func(ctx context.Context) ([]*mdmlab.PackSpec, error)

type GetPackSpecFunc func(ctx context.Context, name string) (*mdmlab.PackSpec, error)

type NewPackFunc func(ctx context.Context, pack *mdmlab.Pack, opts ...mdmlab.OptionalArg) (*mdmlab.Pack, error)

type SavePackFunc func(ctx context.Context, pack *mdmlab.Pack) error

type DeletePackFunc func(ctx context.Context, name string) error

type PackFunc func(ctx context.Context, pid uint) (*mdmlab.Pack, error)

type ListPacksFunc func(ctx context.Context, opt mdmlab.PackListOptions) ([]*mdmlab.Pack, error)

type PackByNameFunc func(ctx context.Context, name string, opts ...mdmlab.OptionalArg) (*mdmlab.Pack, bool, error)

type ListPacksForHostFunc func(ctx context.Context, hid uint) (packs []*mdmlab.Pack, err error)

type ApplyLabelSpecsFunc func(ctx context.Context, specs []*mdmlab.LabelSpec) error

type GetLabelSpecsFunc func(ctx context.Context) ([]*mdmlab.LabelSpec, error)

type GetLabelSpecFunc func(ctx context.Context, name string) (*mdmlab.LabelSpec, error)
...
type NewLabelFunc func(ctx context.Context, Label *mdmlab.Label, opts ...mdmlab.OptionalArg) (*mdmlab.Label, error)

type SaveLabelFunc func(ctx context.Context, label *mdmlab.Label, teamFilter mdmlab.TeamFilter) (*mdmlab.Label, []uint, error)

type DeleteLabelFunc func(ctx context.Context, name string) error

type LabelFunc func(ctx context.Context, lid uint, teamFilter mdmlab.TeamFilter) (*mdmlab.Label, []uint, error)

type ListLabelsFunc func(ctx context.Context, filter mdmlab.TeamFilter, opt mdmlab.ListOptions) ([]*mdmlab.Label, error)

type LabelsSummaryFunc func(ctx context.Context) ([]*mdmlab.LabelSummary, error)

type GetHostUUIDsWithPendingMDMAppleCommandsFunc func(ctx context.Context) ([]string, error)

type LabelQueriesForHostFunc func(ctx context.Context, host *mdmlab.Host) (map[string]string, error)

type ListLabelsForHostFunc func(ctx context.Context, hid uint) ([]*mdmlab.Label, error)

type ListHostsInLabelFunc func(ctx context.Context, filter mdmlab.TeamFilter, lid uint, opt mdmlab.HostListOptions) ([]*mdmlab.Host, error)

type ListUniqueHostsInLabelsFunc func(ctx context.Context, filter mdmlab.TeamFilter, labels []uint) ([]*mdmlab.Host, error)

type SearchLabelsFunc func(ctx context.Context, filter mdmlab.TeamFilter, query string, omit ...uint) ([]*mdmlab.Label, error)

type LabelIDsByNameFunc func(ctx context.Context, labels []string) (map[string]uint, error)

type LabelsByNameFunc func(ctx context.Context, names []string) (map[string]*mdmlab.Label, error)
...
type NewHostFunc func(ctx context.Context, host *mdmlab.Host) (*mdmlab.Host, error)

type DeleteHostFunc func(ctx context.Context, hid uint) error

type HostFunc func(ctx context.Context, id uint) (*mdmlab.Host, error)

type GetHostHealthFunc func(ctx context.Context, id uint) (*mdmlab.HostHealth, error)

type ListHostsFunc func(ctx context.Context, filter mdmlab.TeamFilter, opt mdmlab.HostListOptions) ([]*mdmlab.Host, error)

type ListHostsLiteByUUIDsFunc func(ctx context.Context, filter mdmlab.TeamFilter, uuids []string) ([]*mdmlab.Host, error)

type ListHostsLiteByIDsFunc func(ctx context.Context, ids []uint) ([]*mdmlab.Host, error)

type ListHostUsersFunc func(ctx context.Context, hostID uint) ([]mdmlab.HostUser, error)

type MarkHostsSeenFunc func(ctx context.Context, hostIDs []uint, t time.Time) error

type SearchHostsFunc func(ctx context.Context, filter mdmlab.TeamFilter, query string, omit ...uint) ([]*mdmlab.Host, error)
...
type GenerateHostStatusStatisticsFunc func(ctx context.Context, filter mdmlab.TeamFilter, now time.Time, platform *string, lowDiskSpace *int) (*mdmlab.HostSummary, error)

type HostIDsByIdentifierFunc func(ctx context.Context, filter mdmlab.TeamFilter, hostnames []string) ([]uint, error)
...
type HostIDsByOSVersionFunc func(ctx context.Context, osVersion mdmlab.OSVersion, offset int, limit int) ([]uint, error)

type HostByIdentifierFunc func(ctx context.Context, identifier string) (*mdmlab.Host, error)

type HostLiteByIdentifierFunc func(ctx context.Context, identifier string) (*mdmlab.HostLite, error)

type HostLiteByIDFunc func(ctx context.Context, id uint) (*mdmlab.HostLite, error)
...
type CountHostsFunc func(ctx context.Context, filter mdmlab.TeamFilter, opt mdmlab.HostListOptions) (int, error)

type CountHostsInLabelFunc func(ctx context.Context, filter mdmlab.TeamFilter, lid uint, opt mdmlab.HostListOptions) (int, error)

type ListHostDeviceMappingFunc func(ctx context.Context, id uint) ([]*mdmlab.HostDeviceMapping, error)

type SetOrUpdateCustomHostDeviceMappingFunc func(ctx context.Context, hostID uint, email string, source string) ([]*mdmlab.HostDeviceMapping, error)

type ListHostBatteriesFunc func(ctx context.Context, id uint) ([]*mdmlab.HostBattery, error)

type ListUpcomingHostMaintenanceWindowsFunc func(ctx context.Context, hid uint) ([]*mdmlab.HostMaintenanceWindow, error)

type LoadHostByDeviceAuthTokenFunc func(ctx context.Context, authToken string, tokenTTL time.Duration) (*mdmlab.Host, error)

type SetOrUpdateDeviceAuthTokenFunc func(ctx context.Context, hostID uint, authToken string) error

type FailingPoliciesCountFunc func(ctx context.Context, host *mdmlab.Host) (uint, error)

type ListPoliciesForHostFunc func(ctx context.Context, host *mdmlab.Host) ([]*mdmlab.HostPolicy, error)

type GetHostMunkiVersionFunc func(ctx context.Context, hostID uint) (string, error)

type GetHostMunkiIssuesFunc func(ctx context.Context, hostID uint) ([]*mdmlab.HostMunkiIssue, error)

type GetHostMDMFunc func(ctx context.Context, hostID uint) (*mdmlab.HostMDM, error)

type GetHostMDMCheckinInfoFunc func(ctx context.Context, hostUUID string) (*mdmlab.HostMDMCheckinInfo, error)

type ListIOSAndIPadOSToRefetchFunc func(ctx context.Context, refetchInterval time.Duration) (devices []mdmlab.AppleDevicesToRefetch, err error)

type AddHostMDMCommandsFunc func(ctx context.Context, commands []mdmlab.HostMDMCommand) error

type GetHostMDMCommandsFunc func(ctx context.Context, hostID uint) (commands []mdmlab.HostMDMCommand, err error)

type RemoveHostMDMCommandFunc func(ctx context.Context, command mdmlab.HostMDMCommand) error
...
type IsHostConnectedToMDMlabMDMFunc func(ctx context.Context, host *mdmlab.Host) (bool, error)

type AreHostsConnectedToMDMlabMDMFunc func(ctx context.Context, hosts []*mdmlab.Host) (map[string]bool, error)

type AggregatedMunkiVersionFunc func(ctx context.Context, teamID *uint) ([]mdmlab.AggregatedMunkiVersion, time.Time, error)

type AggregatedMunkiIssuesFunc func(ctx context.Context, teamID *uint) ([]mdmlab.AggregatedMunkiIssue, time.Time, error)

type AggregatedMDMStatusFunc func(ctx context.Context, teamID *uint, platform string) (mdmlab.AggregatedMDMStatus, time.Time, error)

type AggregatedMDMSolutionsFunc func(ctx context.Context, teamID *uint, platform string) ([]mdmlab.AggregatedMDMSolutions, time.Time, error)

type GenerateAggregatedMunkiAndMDMFunc func(ctx context.Context) error

type GetMunkiIssueFunc func(ctx context.Context, munkiIssueID uint) (*mdmlab.MunkiIssue, error)

type GetMDMSolutionFunc func(ctx context.Context, mdmID uint) (*mdmlab.MDMSolution, error)

type OSVersionsFunc func(ctx context.Context, teamFilter *mdmlab.TeamFilter, platform *string, name *string, version *string) (*mdmlab.OSVersions, error)

type OSVersionsByCVEFunc func(ctx context.Context, cve string, teamID *uint) ([]*mdmlab.VulnerableOS, time.Time, error)

type SoftwareByCVEFunc func(ctx context.Context, cve string, teamID *uint) ([]*mdmlab.VulnerableSoftware, time.Time, error)

type OSVersionFunc func(ctx context.Context, osVersionID uint, teamFilter *mdmlab.TeamFilter) (*mdmlab.OSVersion, *time.Time, error)

type UpdateOSVersionsFunc func(ctx context.Context) error

type CountHostsInTargetsFunc func(ctx context.Context, filter mdmlab.TeamFilter, targets mdmlab.HostTargets, now time.Time) (mdmlab.TargetMetrics, error)

type HostIDsInTargetsFunc func(ctx context.Context, filter mdmlab.TeamFilter, targets mdmlab.HostTargets) ([]uint, error)

type NewPasswordResetRequestFunc func(ctx context.Context, req *mdmlab.PasswordResetRequest) (*mdmlab.PasswordResetRequest, error)

type DeletePasswordResetRequestsForUserFunc func(ctx context.Context, userID uint) error

type FindPasswordResetByTokenFunc func(ctx context.Context, token string) (*mdmlab.PasswordResetRequest, error)

type CleanupExpiredPasswordResetRequestsFunc func(ctx context.Context) error

type SessionByKeyFunc func(ctx context.Context, key string) (*mdmlab.Session, error)

type SessionByIDFunc func(ctx context.Context, id uint) (*mdmlab.Session, error)

type ListSessionsForUserFunc func(ctx context.Context, id uint) ([]*mdmlab.Session, error)

type NewSessionFunc func(ctx context.Context, userID uint, sessionKeySize int) (*mdmlab.Session, error)

type DestroySessionFunc func(ctx context.Context, session *mdmlab.Session) error

type DestroyAllSessionsForUserFunc func(ctx context.Context, id uint) error

type MarkSessionAccessedFunc func(ctx context.Context, session *mdmlab.Session) error

type SessionByMFATokenFunc func(ctx context.Context, token string, sessionKeySize int) (*mdmlab.Session, *mdmlab.User, error)

type NewMFATokenFunc func(ctx context.Context, userID uint) (string, error)

type NewAppConfigFunc func(ctx context.Context, info *mdmlab.AppConfig) (*mdmlab.AppConfig, error)

type AppConfigFunc func(ctx context.Context) (*mdmlab.AppConfig, error)

type SaveAppConfigFunc func(ctx context.Context, info *mdmlab.AppConfig) error

type GetEnrollSecretsFunc func(ctx context.Context, teamID *uint) ([]*mdmlab.EnrollSecret, error)

type ApplyEnrollSecretsFunc func(ctx context.Context, teamID *uint, secrets []*mdmlab.EnrollSecret) error

type AggregateEnrollSecretPerTeamFunc func(ctx context.Context) ([]*mdmlab.EnrollSecret, error)

type GetYaraRulesFunc func(ctx context.Context) ([]mdmlab.YaraRule, error)

type ApplyYaraRulesFunc func(ctx context.Context, rules []mdmlab.YaraRule) error

type YaraRuleByNameFunc func(ctx context.Context, name string) (*mdmlab.YaraRule, error)

type NewInviteFunc func(ctx context.Context, i *mdmlab.Invite) (*mdmlab.Invite, error)

type ListInvitesFunc func(ctx context.Context, opt mdmlab.ListOptions) ([]*mdmlab.Invite, error)

type InviteFunc func(ctx context.Context, id uint) (*mdmlab.Invite, error)

type InviteByEmailFunc func(ctx context.Context, email string) (*mdmlab.Invite, error)

type InviteByTokenFunc func(ctx context.Context, token string) (*mdmlab.Invite, error)

type DeleteInviteFunc func(ctx context.Context, id uint) error

type UpdateInviteFunc func(ctx context.Context, id uint, i *mdmlab.Invite) (*mdmlab.Invite, error)

type ListScheduledQueriesInPackWithStatsFunc func(ctx context.Context, id uint, opts mdmlab.ListOptions) ([]*mdmlab.ScheduledQuery, error)

type NewScheduledQueryFunc func(ctx context.Context, sq *mdmlab.ScheduledQuery, opts ...mdmlab.OptionalArg) (*mdmlab.ScheduledQuery, error)

type SaveScheduledQueryFunc func(ctx context.Context, sq *mdmlab.ScheduledQuery) (*mdmlab.ScheduledQuery, error)

type DeleteScheduledQueryFunc func(ctx context.Context, id uint) error

type ScheduledQueryFunc func(ctx context.Context, id uint) (*mdmlab.ScheduledQuery, error)
...
type QueryResultRowsFunc func(ctx context.Context, queryID uint, filter mdmlab.TeamFilter) ([]*mdmlab.ScheduledQueryResultRow, error)

type QueryResultRowsForHostFunc func(ctx context.Context, queryID uint, hostID uint) ([]*mdmlab.ScheduledQueryResultRow, error)
...
type OverwriteQueryResultRowsFunc func(ctx context.Context, rows []*mdmlab.ScheduledQueryResultRow, maxQueryReportRows int) error

type CleanupDiscardedQueryResultsFunc func(ctx context.Context) error

type NewTeamFunc func(ctx context.Context, team *mdmlab.Team) (*mdmlab.Team, error)

type SaveTeamFunc func(ctx context.Context, team *mdmlab.Team) (*mdmlab.Team, error)

type TeamFunc func(ctx context.Context, tid uint) (*mdmlab.Team, error)

type TeamWithoutExtrasFunc func(ctx context.Context, tid uint) (*mdmlab.Team, error)

type DeleteTeamFunc func(ctx context.Context, tid uint) error

type TeamByNameFunc func(ctx context.Context, name string) (*mdmlab.Team, error)

type TeamByFilenameFunc func(ctx context.Context, filename string) (*mdmlab.Team, error)

type ListTeamsFunc func(ctx context.Context, filter mdmlab.TeamFilter, opt mdmlab.ListOptions) ([]*mdmlab.Team, error)

type TeamsSummaryFunc func(ctx context.Context) ([]*mdmlab.TeamSummary, error)

type SearchTeamsFunc func(ctx context.Context, filter mdmlab.TeamFilter, matchQuery string, omit ...uint) ([]*mdmlab.Team, error)

type TeamEnrollSecretsFunc func(ctx context.Context, teamID uint) ([]*mdmlab.EnrollSecret, error)

type DeleteIntegrationsFromTeamsFunc func(ctx context.Context, deletedIntgs mdmlab.Integrations) error

type TeamExistsFunc func(ctx context.Context, teamID uint) (bool, error)

type ListSoftwareTitlesFunc func(ctx context.Context, opt mdmlab.SoftwareTitleListOptions, tmFilter mdmlab.TeamFilter) ([]mdmlab.SoftwareTitleListResult, int, *mdmlab.PaginationMetadata, error)

type SoftwareTitleByIDFunc func(ctx context.Context, id uint, teamID *uint, tmFilter mdmlab.TeamFilter) (*mdmlab.SoftwareTitle, error)
...
type ListSoftwareForVulnDetectionFunc func(ctx context.Context, filter mdmlab.VulnSoftwareFilter) ([]mdmlab.Software, error)

type ListSoftwareVulnerabilitiesByHostIDsSourceFunc func(ctx context.Context, hostIDs []uint, source mdmlab.VulnerabilitySource) (map[uint][]mdmlab.SoftwareVulnerability, error)

type LoadHostSoftwareFunc func(ctx context.Context, host *mdmlab.Host, includeCVEScores bool) error

type AllSoftwareIteratorFunc func(ctx context.Context, query mdmlab.SoftwareIterQueryOptions) (mdmlab.SoftwareIterator, error)

type UpsertSoftwareCPEsFunc func(ctx context.Context, cpes []mdmlab.SoftwareCPE) (int64, error)

type DeleteSoftwareCPEsFunc func(ctx context.Context, cpes []mdmlab.SoftwareCPE) (int64, error)

type ListSoftwareCPEsFunc func(ctx context.Context) ([]mdmlab.SoftwareCPE, error)

type InsertSoftwareVulnerabilityFunc func(ctx context.Context, vuln mdmlab.SoftwareVulnerability, source mdmlab.VulnerabilitySource) (bool, error)

type SoftwareByIDFunc func(ctx context.Context, id uint, teamID *uint, includeCVEScores bool, tmFilter *mdmlab.TeamFilter) (*mdmlab.Software, error)

type ListSoftwareByHostIDShortFunc func(ctx context.Context, hostID uint) ([]mdmlab.Software, error)
...
type HostVulnSummariesBySoftwareIDsFunc func(ctx context.Context, softwareIDs []uint) ([]mdmlab.HostVulnerabilitySummary, error)

type HostsByCVEFunc func(ctx context.Context, cve string) ([]mdmlab.HostVulnerabilitySummary, error)

type InsertCVEMetaFunc func(ctx context.Context, cveMeta []mdmlab.CVEMeta) error

type ListCVEsFunc func(ctx context.Context, maxAge time.Duration) ([]mdmlab.CVEMeta, error)

type ListHostSoftwareFunc func(ctx context.Context, host *mdmlab.Host, opts mdmlab.HostSoftwareTitleListOptions) ([]*mdmlab.HostSoftwareWithInstaller, *mdmlab.PaginationMetadata, error)

type IsSoftwareInstallerLabelScopedFunc func(ctx context.Context, installerID uint, hostID uint) (bool, error)

type SetHostSoftwareInstallResultFunc func(ctx context.Context, result *mdmlab.HostSoftwareInstallResultPayload) error

type UploadedSoftwareExistsFunc func(ctx context.Context, bundleIdentifier string, teamID *uint) (bool, error)

type GetHostOperatingSystemFunc func(ctx context.Context, hostID uint) (*mdmlab.OperatingSystem, error)

type ListOperatingSystemsFunc func(ctx context.Context) ([]mdmlab.OperatingSystem, error)

type ListOperatingSystemsForPlatformFunc func(ctx context.Context, platform string) ([]mdmlab.OperatingSystem, error)

type UpdateHostOperatingSystemFunc func(ctx context.Context, hostID uint, hostOS mdmlab.OperatingSystem) error
...
type NewActivityFunc func(ctx context.Context, user *mdmlab.User, activity mdmlab.ActivityDetails, details []byte, createdAt time.Time) error

type ListActivitiesFunc func(ctx context.Context, opt mdmlab.ListActivitiesOptions) ([]*mdmlab.Activity, *mdmlab.PaginationMetadata, error)

type MarkActivitiesAsStreamedFunc func(ctx context.Context, activityIDs []uint) error

type ListHostUpcomingActivitiesFunc func(ctx context.Context, hostID uint, opt mdmlab.ListOptions) ([]*mdmlab.Activity, *mdmlab.PaginationMetadata, error)

type ListHostPastActivitiesFunc func(ctx context.Context, hostID uint, opt mdmlab.ListOptions) ([]*mdmlab.Activity, *mdmlab.PaginationMetadata, error)

type IsExecutionPendingForHostFunc func(ctx context.Context, hostID uint, scriptID uint) (bool, error)

type ShouldSendStatisticsFunc func(ctx context.Context, frequency time.Duration, config config.MDMlabConfig) (mdmlab.StatisticsPayload, bool, error)

type RecordStatisticsSentFunc func(ctx context.Context) error

type CleanupStatisticsFunc func(ctx context.Context) error

type ApplyPolicySpecsFunc func(ctx context.Context, authorID uint, specs []*mdmlab.PolicySpec) error

type NewGlobalPolicyFunc func(ctx context.Context, authorID *uint, args mdmlab.PolicyPayload) (*mdmlab.Policy, error)

type PolicyFunc func(ctx context.Context, id uint) (*mdmlab.Policy, error)

type PolicyLiteFunc func(ctx context.Context, id uint) (*mdmlab.PolicyLite, error)

type SavePolicyFunc func(ctx context.Context, p *mdmlab.Policy, shouldRemoveAllPolicyMemberships bool, removePolicyStats bool) error

type ListGlobalPoliciesFunc func(ctx context.Context, opts mdmlab.ListOptions) ([]*mdmlab.Policy, error)

type PoliciesByIDFunc func(ctx context.Context, ids []uint) (map[uint]*mdmlab.Policy, error)
...
type PolicyQueriesForHostFunc func(ctx context.Context, host *mdmlab.Host) (map[string]string, error)

type GetTeamHostsPolicyMembershipsFunc func(ctx context.Context, domain string, teamID uint, policyIDs []uint, hostID *uint) ([]mdmlab.HostPolicyMembershipData, error)

type GetPoliciesWithAssociatedInstallerFunc func(ctx context.Context, teamID uint, policyIDs []uint) ([]mdmlab.PolicySoftwareInstallerData, error)

type GetPoliciesWithAssociatedVPPFunc func(ctx context.Context, teamID uint, policyIDs []uint) ([]mdmlab.PolicyVPPData, error)

type GetPoliciesWithAssociatedScriptFunc func(ctx context.Context, teamID uint, policyIDs []uint) ([]mdmlab.PolicyScriptData, error)

type GetCalendarPoliciesFunc func(ctx context.Context, teamID uint) ([]mdmlab.PolicyCalendarData, error)

type AsyncBatchInsertPolicyMembershipFunc func(ctx context.Context, batch []mdmlab.PolicyMembershipResult) error
...
type MigrationStatusFunc func(ctx context.Context) (*mdmlab.MigrationStatus, error)

type ListSoftwareFunc func(ctx context.Context, opt mdmlab.SoftwareListOptions) ([]mdmlab.Software, *mdmlab.PaginationMetadata, error)

type CountSoftwareFunc func(ctx context.Context, opt mdmlab.SoftwareListOptions) (int, error)

type DeleteSoftwareVulnerabilitiesFunc func(ctx context.Context, vulnerabilities []mdmlab.SoftwareVulnerability) error

type DeleteOutOfDateVulnerabilitiesFunc func(ctx context.Context, source mdmlab.VulnerabilitySource, duration time.Duration) error

type CreateOrUpdateCalendarEventFunc func(ctx context.Context, uuid string, email string, startTime time.Time, endTime time.Time, data []byte, timeZone *string, hostID uint, webhookStatus mdmlab.CalendarWebhookStatus) (*mdmlab.CalendarEvent, error)

type GetCalendarEventFunc func(ctx context.Context, email string) (*mdmlab.CalendarEvent, error)

type GetCalendarEventDetailsByUUIDFunc func(ctx context.Context, uuid string) (*mdmlab.CalendarEventDetails, error)
...
type GetHostCalendarEventFunc func(ctx context.Context, hostID uint) (*mdmlab.HostCalendarEvent, *mdmlab.CalendarEvent, error)

type GetHostCalendarEventByEmailFunc func(ctx context.Context, email string) (*mdmlab.HostCalendarEvent, *mdmlab.CalendarEvent, error)

type UpdateHostCalendarWebhookStatusFunc func(ctx context.Context, hostID uint, status mdmlab.CalendarWebhookStatus) error

type ListCalendarEventsFunc func(ctx context.Context, teamID *uint) ([]*mdmlab.CalendarEvent, error)

type ListOutOfDateCalendarEventsFunc func(ctx context.Context, t time.Time) ([]*mdmlab.CalendarEvent, error)

type NewTeamPolicyFunc func(ctx context.Context, teamID uint, authorID *uint, args mdmlab.PolicyPayload) (*mdmlab.Policy, error)

type ListTeamPoliciesFunc func(ctx context.Context, teamID uint, opts mdmlab.ListOptions, iopts mdmlab.ListOptions) (teamPolicies []*mdmlab.Policy, inheritedPolicies []*mdmlab.Policy, err error)

type ListMergedTeamPoliciesFunc func(ctx context.Context, teamID uint, opts mdmlab.ListOptions) ([]*mdmlab.Policy, error)

type DeleteTeamPoliciesFunc func(ctx context.Context, teamID uint, ids []uint) ([]uint, error)

type TeamPolicyFunc func(ctx context.Context, teamID uint, policyID uint) (*mdmlab.Policy, error)
...
type DBLocksFunc func(ctx context.Context) ([]*mdmlab.DBLock, error)

type GetLatestCronStatsFunc func(ctx context.Context, name string) ([]mdmlab.CronStats, error)

type InsertCronStatsFunc func(ctx context.Context, statsType mdmlab.CronStatsType, name string, instance string, status mdmlab.CronStatsStatus) (int, error)

type UpdateCronStatsFunc func(ctx context.Context, id int, status mdmlab.CronStatsStatus, cronErrors *mdmlab.CronScheduleErrors) error

type UpdateAllCronStatsForInstanceFunc func(ctx context.Context, instance string, fromStatus mdmlab.CronStatsStatus, toStatus mdmlab.CronStatsStatus) error
...
type LoadHostByNodeKeyFunc func(ctx context.Context, nodeKey string) (*mdmlab.Host, error)

type LoadHostByOrbitNodeKeyFunc func(ctx context.Context, nodeKey string) (*mdmlab.Host, error)

type HostLiteFunc func(ctx context.Context, hostID uint) (*mdmlab.Host, error)

type UpdateHostOsqueryIntervalsFunc func(ctx context.Context, hostID uint, intervals mdmlab.HostOsqueryIntervals) error

type TeamAgentOptionsFunc func(ctx context.Context, teamID uint) (*json.RawMessage, error)

type TeamFeaturesFunc func(ctx context.Context, teamID uint) (*mdmlab.Features, error)

type TeamMDMConfigFunc func(ctx context.Context, teamID uint) (*mdmlab.TeamMDM, error)

type SaveHostPackStatsFunc func(ctx context.Context, teamID *uint, hostID uint, stats []mdmlab.PackStats) error

type AsyncBatchSaveHostsScheduledQueryStatsFunc func(ctx context.Context, stats map[uint][]mdmlab.ScheduledQueryStats, batchSize int) (int, error)

type UpdateHostSoftwareFunc func(ctx context.Context, hostID uint, software []mdmlab.Software) (*mdmlab.UpdateHostSoftwareDBResult, error)

type UpdateHostSoftwareInstalledPathsFunc func(ctx context.Context, hostID uint, reported map[string]struct{}, mutationResults *mdmlab.UpdateHostSoftwareDBResult) error

type UpdateHostFunc func(ctx context.Context, host *mdmlab.Host) error

type ListScheduledQueriesInPackFunc func(ctx context.Context, packID uint) (mdmlab.ScheduledQueryList, error)
...
type RecordPolicyQueryExecutionsFunc func(ctx context.Context, host *mdmlab.Host, results map[uint]*bool, updated time.Time, deferredSaveHost bool) error

type RecordLabelQueryExecutionsFunc func(ctx context.Context, host *mdmlab.Host, results map[uint]*bool, t time.Time, deferredSaveHost bool) error

type SaveHostUsersFunc func(ctx context.Context, hostID uint, users []mdmlab.HostUser) error
...
type SetOrUpdateMDMDataFunc func(ctx context.Context, hostID uint, isServer bool, enrolled bool, serverURL string, installedFromDep bool, name string, mdmlabEnrollRef string) error

type UpdateMDMDataFunc func(ctx context.Context, hostID uint, enrolled bool) error

type SetOrUpdateHostEmailsFromMdmIdpAccountsFunc func(ctx context.Context, hostID uint, mdmlabEnrollmentRef string) error
...
type SetOrUpdateHostDiskEncryptionKeyFunc func(ctx context.Context, host *mdmlab.Host, encryptedBase64Key string, clientError string, decryptable *bool) error

type SaveLUKSDataFunc func(ctx context.Context, host *mdmlab.Host, encryptedBase64Passphrase string, encryptedBase64Salt string, keySlot uint) error

type GetUnverifiedDiskEncryptionKeysFunc func(ctx context.Context) ([]mdmlab.HostDiskEncryptionKey, error)
...
type GetHostDiskEncryptionKeyFunc func(ctx context.Context, hostID uint) (*mdmlab.HostDiskEncryptionKey, error)
...
type GetHostCertAssociationsToExpireFunc func(ctx context.Context, expiryDays int, limit int) ([]mdmlab.SCEPIdentityAssociation, error)

type SetCommandForPendingSCEPRenewalFunc func(ctx context.Context, assocs []mdmlab.SCEPIdentityAssociation, cmdUUID string) error

type CleanSCEPRenewRefsFunc func(ctx context.Context, hostUUID string) error

type UpdateHostMDMProfilesVerificationFunc func(ctx context.Context, host *mdmlab.Host, toVerify []string, toFail []string, toRetry []string) error

type GetHostMDMProfilesExpectedForVerificationFunc func(ctx context.Context, host *mdmlab.Host) (map[string]*mdmlab.ExpectedMDMProfile, error)

type GetHostMDMProfilesRetryCountsFunc func(ctx context.Context, host *mdmlab.Host) ([]mdmlab.HostMDMProfileRetryCount, error)

type GetHostMDMProfileRetryCountByCommandUUIDFunc func(ctx context.Context, host *mdmlab.Host, cmdUUID string) (mdmlab.HostMDMProfileRetryCount, error)
...
type GetHostOrbitInfoFunc func(ctx context.Context, hostID uint) (*mdmlab.HostOrbitInfo, error)

type ReplaceHostDeviceMappingFunc func(ctx context.Context, id uint, mappings []*mdmlab.HostDeviceMapping, source string) error

type ReplaceHostBatteriesFunc func(ctx context.Context, id uint, mappings []*mdmlab.HostBattery) error

type VerifyEnrollSecretFunc func(ctx context.Context, secret string) (*mdmlab.EnrollSecret, error)

type IsEnrollSecretAvailableFunc func(ctx context.Context, secret string, new bool, teamID *uint) (bool, error)

type EnrollHostFunc func(ctx context.Context, isMDMEnabled bool, osqueryHostId string, hardwareUUID string, hardwareSerial string, nodeKey string, teamID *uint, cooldown time.Duration) (*mdmlab.Host, error)

type EnrollOrbitFunc func(ctx context.Context, isMDMEnabled bool, hostInfo mdmlab.OrbitHostInfo, orbitNodeKey string, teamID *uint) (*mdmlab.Host, error)

type SerialUpdateHostFunc func(ctx context.Context, host *mdmlab.Host) error

type NewJobFunc func(ctx context.Context, job *mdmlab.Job) (*mdmlab.Job, error)

type GetQueuedJobsFunc func(ctx context.Context, maxNumJobs int, now time.Time) ([]*mdmlab.Job, error)

type UpdateJobFunc func(ctx context.Context, id uint, job *mdmlab.Job) (*mdmlab.Job, error)

type InnoDBStatusFunc func(ctx context.Context) (string, error)

type ProcessListFunc func(ctx context.Context) ([]mdmlab.MySQLProcess, error)

type ListWindowsUpdatesByHostIDFunc func(ctx context.Context, hostID uint) ([]mdmlab.WindowsUpdate, error)

type InsertWindowsUpdatesFunc func(ctx context.Context, hostID uint, updates []mdmlab.WindowsUpdate) error

type ListOSVulnerabilitiesByOSFunc func(ctx context.Context, osID uint) ([]mdmlab.OSVulnerability, error)

type ListVulnsByOsNameAndVersionFunc func(ctx context.Context, name string, version string, includeCVSS bool) (mdmlab.Vulnerabilities, error)

type InsertOSVulnerabilitiesFunc func(ctx context.Context, vulnerabilities []mdmlab.OSVulnerability, source mdmlab.VulnerabilitySource) (int64, error)

type DeleteOSVulnerabilitiesFunc func(ctx context.Context, vulnerabilities []mdmlab.OSVulnerability) error

type InsertOSVulnerabilityFunc func(ctx context.Context, vuln mdmlab.OSVulnerability, source mdmlab.VulnerabilitySource) (bool, error)

type DeleteOutOfDateOSVulnerabilitiesFunc func(ctx context.Context, source mdmlab.VulnerabilitySource, duration time.Duration) error

type ListVulnerabilitiesFunc func(ctx context.Context, opt mdmlab.VulnListOptions) ([]mdmlab.VulnerabilityWithMetadata, *mdmlab.PaginationMetadata, error)

type VulnerabilityFunc func(ctx context.Context, cve string, teamID *uint, includeCVEScores bool) (*mdmlab.VulnerabilityWithMetadata, error)

type CountVulnerabilitiesFunc func(ctx context.Context, opt mdmlab.VulnListOptions) (uint, error)

type UpdateVulnerabilityHostCountsFunc func(ctx context.Context, maxRoutines int) error

type IsCVEKnownToMDMlabFunc func(ctx context.Context, cve string) (bool, error)

type NewMDMAppleConfigProfileFunc func(ctx context.Context, p mdmlab.MDMAppleConfigProfile) (*mdmlab.MDMAppleConfigProfile, error)

type BulkUpsertMDMAppleConfigProfilesFunc func(ctx context.Context, payload []*mdmlab.MDMAppleConfigProfile) error

type GetMDMAppleConfigProfileByDeprecatedIDFunc func(ctx context.Context, profileID uint) (*mdmlab.MDMAppleConfigProfile, error)

type GetMDMAppleConfigProfileFunc func(ctx context.Context, profileUUID string) (*mdmlab.MDMAppleConfigProfile, error)

type GetMDMAppleDeclarationFunc func(ctx context.Context, declUUID string) (*mdmlab.MDMAppleDeclaration, error)

type ListMDMAppleConfigProfilesFunc func(ctx context.Context, teamID *uint) ([]*mdmlab.MDMAppleConfigProfile, error)
...
type BulkDeleteMDMAppleHostsConfigProfilesFunc func(ctx context.Context, payload []*mdmlab.MDMAppleProfilePayload) error
...
type GetHostMDMAppleProfilesFunc func(ctx context.Context, hostUUID string) ([]mdmlab.HostMDMAppleProfile, error)

type CleanupDiskEncryptionKeysOnTeamChangeFunc func(ctx context.Context, hostIDs []uint, newTeamID *uint) error

type NewMDMAppleEnrollmentProfileFunc func(ctx context.Context, enrollmentPayload mdmlab.MDMAppleEnrollmentProfilePayload) (*mdmlab.MDMAppleEnrollmentProfile, error)

type GetMDMAppleEnrollmentProfileByTokenFunc func(ctx context.Context, token string) (*mdmlab.MDMAppleEnrollmentProfile, error)

type GetMDMAppleEnrollmentProfileByTypeFunc func(ctx context.Context, typ mdmlab.MDMAppleEnrollmentType) (*mdmlab.MDMAppleEnrollmentProfile, error)

type ListMDMAppleEnrollmentProfilesFunc func(ctx context.Context) ([]*mdmlab.MDMAppleEnrollmentProfile, error)

type GetMDMAppleCommandResultsFunc func(ctx context.Context, commandUUID string) ([]*mdmlab.MDMCommandResult, error)

type ListMDMAppleCommandsFunc func(ctx context.Context, tmFilter mdmlab.TeamFilter, listOpts *mdmlab.MDMCommandListOptions) ([]*mdmlab.MDMAppleCommand, error)

type NewMDMAppleInstallerFunc func(ctx context.Context, name string, size int64, manifest string, installer []byte, urlToken string) (*mdmlab.MDMAppleInstaller, error)

type MDMAppleInstallerFunc func(ctx context.Context, token string) (*mdmlab.MDMAppleInstaller, error)

type MDMAppleInstallerDetailsByIDFunc func(ctx context.Context, id uint) (*mdmlab.MDMAppleInstaller, error)

type DeleteMDMAppleInstallerFunc func(ctx context.Context, id uint) error

type MDMAppleInstallerDetailsByTokenFunc func(ctx context.Context, token string) (*mdmlab.MDMAppleInstaller, error)

type ListMDMAppleInstallersFunc func(ctx context.Context) ([]mdmlab.MDMAppleInstaller, error)

type BatchSetMDMAppleProfilesFunc func(ctx context.Context, tmID *uint, profiles []*mdmlab.MDMAppleConfigProfile) error

type MDMAppleListDevicesFunc func(ctx context.Context) ([]mdmlab.MDMAppleDevice, error)

type UpsertMDMAppleHostDEPAssignmentsFunc func(ctx context.Context, hosts []mdmlab.Host, abmTokenID uint) error

type IngestMDMAppleDevicesFromDEPSyncFunc func(ctx context.Context, devices []godep.Device, abmTokenID uint, macOSTeam *mdmlab.Team, iosTeam *mdmlab.Team, ipadTeam *mdmlab.Team) (int64, error)

type IngestMDMAppleDeviceFromOTAEnrollmentFunc func(ctx context.Context, teamID *uint, deviceInfo mdmlab.MDMAppleMachineInfo) error

type MDMAppleUpsertHostFunc func(ctx context.Context, mdmHost *mdmlab.Host) error

type RestoreMDMApplePendingDEPHostFunc func(ctx context.Context, host *mdmlab.Host) error
...
type GetHostDEPAssignmentFunc func(ctx context.Context, hostID uint) (*mdmlab.HostDEPAssignment, error)

type GetNanoMDMEnrollmentFunc func(ctx context.Context, id string) (*mdmlab.NanoEnrollment, error)

type IncreasePolicyAutomationIterationFunc func(ctx context.Context, policyID uint) error

type OutdatedAutomationBatchFunc func(ctx context.Context) ([]mdmlab.PolicyFailure, error)

type ListMDMAppleProfilesToInstallFunc func(ctx context.Context) ([]*mdmlab.MDMAppleProfilePayload, error)

type ListMDMAppleProfilesToRemoveFunc func(ctx context.Context) ([]*mdmlab.MDMAppleProfilePayload, error)

type BulkUpsertMDMAppleHostProfilesFunc func(ctx context.Context, payload []*mdmlab.MDMAppleBulkUpsertHostProfilePayload) error

type BulkSetPendingMDMHostProfilesFunc func(ctx context.Context, hostIDs []uint, teamIDs []uint, profileUUIDs []string, hostUUIDs []string) (updates mdmlab.MDMProfilesUpdates, err error)
...
type UpdateOrDeleteHostMDMAppleProfileFunc func(ctx context.Context, profile *mdmlab.HostMDMAppleProfile) error

type GetMDMAppleCommandRequestTypeFunc func(ctx context.Context, commandUUID string) (string, error)

type GetMDMAppleProfilesSummaryFunc func(ctx context.Context, teamID *uint) (*mdmlab.MDMProfilesSummary, error)

type InsertMDMIdPAccountFunc func(ctx context.Context, account *mdmlab.MDMIdPAccount) error

type GetMDMIdPAccountByUUIDFunc func(ctx context.Context, uuid string) (*mdmlab.MDMIdPAccount, error)

type GetMDMIdPAccountByEmailFunc func(ctx context.Context, email string) (*mdmlab.MDMIdPAccount, error)

type GetMDMAppleFileVaultSummaryFunc func(ctx context.Context, teamID *uint) (*mdmlab.MDMAppleFileVaultSummary, error)

type InsertMDMAppleBootstrapPackageFunc func(ctx context.Context, bp *mdmlab.MDMAppleBootstrapPackage, pkgStore mdmlab.MDMBootstrapPackageStore) error

type CopyDefaultMDMAppleBootstrapPackageFunc func(ctx context.Context, ac *mdmlab.AppConfig, toTeamID uint) error

type DeleteMDMAppleBootstrapPackageFunc func(ctx context.Context, teamID uint) error

type GetMDMAppleBootstrapPackageMetaFunc func(ctx context.Context, teamID uint) (*mdmlab.MDMAppleBootstrapPackage, error)

type GetMDMAppleBootstrapPackageBytesFunc func(ctx context.Context, token string, pkgStore mdmlab.MDMBootstrapPackageStore) (*mdmlab.MDMAppleBootstrapPackage, error)

type GetMDMAppleBootstrapPackageSummaryFunc func(ctx context.Context, teamID uint) (*mdmlab.MDMAppleBootstrapPackageSummary, error)
...
type CleanupUnusedBootstrapPackagesFunc func(ctx context.Context, pkgStore mdmlab.MDMBootstrapPackageStore, removeCreatedBefore time.Time) error

type GetHostMDMMacOSSetupFunc func(ctx context.Context, hostID uint) (*mdmlab.HostMDMMacOSSetup, error)

type MDMGetEULAMetadataFunc func(ctx context.Context) (*mdmlab.MDMEULA, error)

type MDMGetEULABytesFunc func(ctx context.Context, token string) (*mdmlab.MDMEULA, error)

type MDMInsertEULAFunc func(ctx context.Context, eula *mdmlab.MDMEULA) error

type MDMDeleteEULAFunc func(ctx context.Context, token string) error

type SetOrUpdateMDMAppleSetupAssistantFunc func(ctx context.Context, asst *mdmlab.MDMAppleSetupAssistant) (*mdmlab.MDMAppleSetupAssistant, error)

type GetMDMAppleSetupAssistantFunc func(ctx context.Context, teamID *uint) (*mdmlab.MDMAppleSetupAssistant, error)
...
type GetMatchingHostSerialsFunc func(ctx context.Context, serials []string) (map[string]*mdmlab.Host, error)
...
type MDMAppleDDMDeclarationsTokenFunc func(ctx context.Context, hostUUID string) (*mdmlab.MDMAppleDDMDeclarationsToken, error)

type MDMAppleDDMDeclarationItemsFunc func(ctx context.Context, hostUUID string) ([]mdmlab.MDMAppleDDMDeclarationItem, error)

type MDMAppleDDMDeclarationsResponseFunc func(ctx context.Context, identifier string, hostUUID string) (*mdmlab.MDMAppleDeclaration, error)

type MDMAppleBatchSetHostDeclarationStateFunc func(ctx context.Context) ([]string, error)

type MDMAppleStoreDDMStatusReportFunc func(ctx context.Context, hostUUID string, updates []*mdmlab.MDMAppleHostDeclaration) error

type MDMAppleSetPendingDeclarationsAsFunc func(ctx context.Context, hostUUID string, status *mdmlab.MDMDeliveryStatus, detail string) error

type GetMDMAppleOSUpdatesSettingsByHostSerialFunc func(ctx context.Context, hostSerial string) (*mdmlab.AppleOSUpdateSettings, error)

type InsertMDMConfigAssetsFunc func(ctx context.Context, assets []mdmlab.MDMConfigAsset, tx sqlx.ExtContext) error

type GetAllMDMConfigAssetsByNameFunc func(ctx context.Context, assetNames []mdmlab.MDMAssetName, queryerContext sqlx.QueryerContext) (map[mdmlab.MDMAssetName]mdmlab.MDMConfigAsset, error)

type GetAllMDMConfigAssetsHashesFunc func(ctx context.Context, assetNames []mdmlab.MDMAssetName) (map[mdmlab.MDMAssetName]string, error)

type DeleteMDMConfigAssetsByNameFunc func(ctx context.Context, assetNames []mdmlab.MDMAssetName) error

type HardDeleteMDMConfigAssetFunc func(ctx context.Context, assetName mdmlab.MDMAssetName) error

type ReplaceMDMConfigAssetsFunc func(ctx context.Context, assets []mdmlab.MDMConfigAsset, tx sqlx.ExtContext) error

type GetABMTokenByOrgNameFunc func(ctx context.Context, orgName string) (*mdmlab.ABMToken, error)

type SaveABMTokenFunc func(ctx context.Context, tok *mdmlab.ABMToken) error

type InsertVPPTokenFunc func(ctx context.Context, tok *mdmlab.VPPTokenData) (*mdmlab.VPPTokenDB, error)

type ListVPPTokensFunc func(ctx context.Context) ([]*mdmlab.VPPTokenDB, error)

type GetVPPTokenFunc func(ctx context.Context, tokenID uint) (*mdmlab.VPPTokenDB, error)

type GetVPPTokenByTeamIDFunc func(ctx context.Context, teamID *uint) (*mdmlab.VPPTokenDB, error)

type UpdateVPPTokenTeamsFunc func(ctx context.Context, id uint, teams []uint) (*mdmlab.VPPTokenDB, error)

type UpdateVPPTokenFunc func(ctx context.Context, id uint, tok *mdmlab.VPPTokenData) (*mdmlab.VPPTokenDB, error)
...
type InsertABMTokenFunc func(ctx context.Context, tok *mdmlab.ABMToken) (*mdmlab.ABMToken, error)

type ListABMTokensFunc func(ctx context.Context) ([]*mdmlab.ABMToken, error)

type DeleteABMTokenFunc func(ctx context.Context, tokenID uint) error

type GetABMTokenByIDFunc func(ctx context.Context, tokenID uint) (*mdmlab.ABMToken, error)
...
type MDMWindowsInsertEnrolledDeviceFunc func(ctx context.Context, device *mdmlab.MDMWindowsEnrolledDevice) error

type MDMWindowsDeleteEnrolledDeviceFunc func(ctx context.Context, mdmDeviceHWID string) error

type MDMWindowsGetEnrolledDeviceWithDeviceIDFunc func(ctx context.Context, mdmDeviceID string) (*mdmlab.MDMWindowsEnrolledDevice, error)

type MDMWindowsDeleteEnrolledDeviceWithDeviceIDFunc func(ctx context.Context, mdmDeviceID string) error

type MDMWindowsInsertCommandForHostsFunc func(ctx context.Context, hostUUIDs []string, cmd *mdmlab.MDMWindowsCommand) error

type MDMWindowsGetPendingCommandsFunc func(ctx context.Context, deviceID string) ([]*mdmlab.MDMWindowsCommand, error)

type MDMWindowsSaveResponseFunc func(ctx context.Context, deviceID string, enrichedSyncML mdmlab.EnrichedSyncML) error

type GetMDMWindowsCommandResultsFunc func(ctx context.Context, commandUUID string) ([]*mdmlab.MDMCommandResult, error)

type UpdateMDMWindowsEnrollmentsHostUUIDFunc func(ctx context.Context, hostUUID string, mdmDeviceID string) error

type GetMDMWindowsConfigProfileFunc func(ctx context.Context, profileUUID string) (*mdmlab.MDMWindowsConfigProfile, error)
...
type GetHostMDMWindowsProfilesFunc func(ctx context.Context, hostUUID string) ([]mdmlab.HostMDMWindowsProfile, error)

type ListMDMConfigProfilesFunc func(ctx context.Context, teamID *uint, opt mdmlab.ListOptions) ([]*mdmlab.MDMConfigProfilePayload, *mdmlab.PaginationMetadata, error)

type ResendHostMDMProfileFunc func(ctx context.Context, hostUUID string, profileUUID string) error

type GetHostMDMProfileInstallStatusFunc func(ctx context.Context, hostUUID string, profileUUID string) (mdmlab.MDMDeliveryStatus, error)

type GetLinuxDiskEncryptionSummaryFunc func(ctx context.Context, teamID *uint) (mdmlab.MDMLinuxDiskEncryptionSummary, error)

type GetMDMCommandPlatformFunc func(ctx context.Context, commandUUID string) (string, error)

type ListMDMCommandsFunc func(ctx context.Context, tmFilter mdmlab.TeamFilter, listOpts *mdmlab.MDMCommandListOptions) ([]*mdmlab.MDMCommand, error)

type GetMDMWindowsBitLockerSummaryFunc func(ctx context.Context, teamID *uint) (*mdmlab.MDMWindowsBitLockerSummary, error)

type GetMDMWindowsBitLockerStatusFunc func(ctx context.Context, host *mdmlab.Host) (*mdmlab.HostMDMDiskEncryption, error)

type GetMDMWindowsProfilesSummaryFunc func(ctx context.Context, teamID *uint) (*mdmlab.MDMProfilesSummary, error)

type ListMDMWindowsProfilesToInstallFunc func(ctx context.Context) ([]*mdmlab.MDMWindowsProfilePayload, error)

type ListMDMWindowsProfilesToRemoveFunc func(ctx context.Context) ([]*mdmlab.MDMWindowsProfilePayload, error)

type BulkUpsertMDMWindowsHostProfilesFunc func(ctx context.Context, payload []*mdmlab.MDMWindowsBulkUpsertHostProfilePayload) error

type GetMDMWindowsProfilesContentsFunc func(ctx context.Context, profileUUIDs []string) (map[string][]byte, error)

type BulkDeleteMDMWindowsHostsConfigProfilesFunc func(ctx context.Context, payload []*mdmlab.MDMWindowsProfilePayload) error

type NewMDMWindowsConfigProfileFunc func(ctx context.Context, cp mdmlab.MDMWindowsConfigProfile) (*mdmlab.MDMWindowsConfigProfile, error)

type SetOrUpdateMDMWindowsConfigProfileFunc func(ctx context.Context, cp mdmlab.MDMWindowsConfigProfile) error

type BatchSetMDMProfilesFunc func(ctx context.Context, tmID *uint, macProfiles []*mdmlab.MDMAppleConfigProfile, winProfiles []*mdmlab.MDMWindowsConfigProfile, macDeclarations []*mdmlab.MDMAppleDeclaration) (updates mdmlab.MDMProfilesUpdates, err error)

type NewMDMAppleDeclarationFunc func(ctx context.Context, declaration *mdmlab.MDMAppleDeclaration) (*mdmlab.MDMAppleDeclaration, error)

type SetOrUpdateMDMAppleDeclarationFunc func(ctx context.Context, declaration *mdmlab.MDMAppleDeclaration) (*mdmlab.MDMAppleDeclaration, error)

type NewHostScriptExecutionRequestFunc func(ctx context.Context, request *mdmlab.HostScriptRequestPayload) (*mdmlab.HostScriptResult, error)

type NewInternalScriptExecutionRequestFunc func(ctx context.Context, request *mdmlab.HostScriptRequestPayload) (*mdmlab.HostScriptResult, error)

type SetHostScriptExecutionResultFunc func(ctx context.Context, result *mdmlab.HostScriptResultPayload) (hsr *mdmlab.HostScriptResult, action string, err error)

type GetHostScriptExecutionResultFunc func(ctx context.Context, execID string) (*mdmlab.HostScriptResult, error)

type ListPendingHostScriptExecutionsFunc func(ctx context.Context, hostID uint, onlyShowInternal bool) ([]*mdmlab.HostScriptResult, error)

type NewScriptFunc func(ctx context.Context, script *mdmlab.Script) (*mdmlab.Script, error)

type ScriptFunc func(ctx context.Context, id uint) (*mdmlab.Script, error)
...
type ListScriptsFunc func(ctx context.Context, teamID *uint, opt mdmlab.ListOptions) ([]*mdmlab.Script, *mdmlab.PaginationMetadata, error)

type GetScriptIDByNameFunc func(ctx context.Context, name string, teamID *uint) (uint, error)

type GetHostScriptDetailsFunc func(ctx context.Context, hostID uint, teamID *uint, opts mdmlab.ListOptions, hostPlatform string) ([]*mdmlab.HostScriptDetail, *mdmlab.PaginationMetadata, error)

type BatchSetScriptsFunc func(ctx context.Context, tmID *uint, scripts []*mdmlab.Script) ([]mdmlab.ScriptResponse, error)

type GetHostLockWipeStatusFunc func(ctx context.Context, host *mdmlab.Host) (*mdmlab.HostLockWipeStatus, error)

type LockHostViaScriptFunc func(ctx context.Context, request *mdmlab.HostScriptRequestPayload, hostMDMlabPlatform string) error

type UnlockHostViaScriptFunc func(ctx context.Context, request *mdmlab.HostScriptRequestPayload, hostMDMlabPlatform string) error

type UnlockHostManuallyFunc func(ctx context.Context, hostID uint, hostMDMlabPlatform string, ts time.Time) error
...
type WipeHostViaScriptFunc func(ctx context.Context, request *mdmlab.HostScriptRequestPayload, hostMDMlabPlatform string) error

type WipeHostViaWindowsMDMFunc func(ctx context.Context, host *mdmlab.Host, cmd *mdmlab.MDMWindowsCommand) error
...
type GetSoftwareInstallDetailsFunc func(ctx context.Context, executionId string) (*mdmlab.SoftwareInstallDetails, error)

type ListPendingSoftwareInstallsFunc func(ctx context.Context, hostID uint) ([]string, error)

type GetHostLastInstallDataFunc func(ctx context.Context, hostID uint, installerID uint) (*mdmlab.HostLastInstallData, error)

type MatchOrCreateSoftwareInstallerFunc func(ctx context.Context, payload *mdmlab.UploadSoftwareInstallerPayload) (installerID uint, titleID uint, err error)

type GetSoftwareInstallerMetadataByIDFunc func(ctx context.Context, id uint) (*mdmlab.SoftwareInstaller, error)

type ValidateOrbitSoftwareInstallerAccessFunc func(ctx context.Context, hostID uint, installerID uint) (bool, error)

type GetSoftwareInstallerMetadataByTeamAndTitleIDFunc func(ctx context.Context, teamID *uint, titleID uint, withScriptContents bool) (*mdmlab.SoftwareInstaller, error)

type GetSoftwareInstallersWithoutPackageIDsFunc func(ctx context.Context) (map[uint]string, error)

type UpdateSoftwareInstallerWithoutPackageIDsFunc func(ctx context.Context, id uint, payload mdmlab.UploadSoftwareInstallerPayload) error
...
type SaveInstallerUpdatesFunc func(ctx context.Context, payload *mdmlab.UpdateSoftwareInstallerPayload) error

type UpdateInstallerSelfServiceFlagFunc func(ctx context.Context, selfService bool, id uint) error

type GetVPPAppByTeamAndTitleIDFunc func(ctx context.Context, teamID *uint, titleID uint) (*mdmlab.VPPApp, error)

type GetVPPAppMetadataByTeamAndTitleIDFunc func(ctx context.Context, teamID *uint, titleID uint) (*mdmlab.VPPAppStoreApp, error)

type MapAdamIDsPendingInstallFunc func(ctx context.Context, hostID uint) (map[string]struct{}, error)

type GetTitleInfoFromVPPAppsTeamsIDFunc func(ctx context.Context, vppAppsTeamsID uint) (*mdmlab.PolicySoftwareTitle, error)

type GetVPPAppMetadataByAdamIDAndPlatformFunc func(ctx context.Context, adamID string, platform mdmlab.AppleDevicePlatform) (*mdmlab.VPPApp, error)

type DeleteSoftwareInstallerFunc func(ctx context.Context, id uint) error

type DeleteVPPAppFromTeamFunc func(ctx context.Context, teamID *uint, appID mdmlab.VPPAppID) error

type GetSummaryHostSoftwareInstallsFunc func(ctx context.Context, installerID uint) (*mdmlab.SoftwareInstallerStatusSummary, error)

type GetSummaryHostVPPAppInstallsFunc func(ctx context.Context, teamID *uint, appID mdmlab.VPPAppID) (*mdmlab.VPPAppStatusSummary, error)

type GetSoftwareInstallResultsFunc func(ctx context.Context, resultsUUID string) (*mdmlab.HostSoftwareInstallerResult, error)

type CleanupUnusedSoftwareInstallersFunc func(ctx context.Context, softwareInstallStore mdmlab.SoftwareInstallerStore, removeCreatedBefore time.Time) error

type BatchSetSoftwareInstallersFunc func(ctx context.Context, tmID *uint, installers []*mdmlab.UploadSoftwareInstallerPayload) error

type GetSoftwareInstallersFunc func(ctx context.Context, tmID uint) ([]mdmlab.SoftwarePackageResponse, error)

type HasSelfServiceSoftwareInstallersFunc func(ctx context.Context, platform string, teamID *uint) (bool, error)

type BatchInsertVPPAppsFunc func(ctx context.Context, apps []*mdmlab.VPPApp) error

type GetAssignedVPPAppsFunc func(ctx context.Context, teamID *uint) (map[mdmlab.VPPAppID]mdmlab.VPPAppTeam, error)

type GetVPPAppsFunc func(ctx context.Context, teamID *uint) ([]mdmlab.VPPAppResponse, error)

type SetTeamVPPAppsFunc func(ctx context.Context, teamID *uint, appIDs []mdmlab.VPPAppTeam) error

type InsertVPPAppWithTeamFunc func(ctx context.Context, app *mdmlab.VPPApp, teamID *uint) (*mdmlab.VPPApp, error)

type InsertHostVPPSoftwareInstallFunc func(ctx context.Context, hostID uint, appID mdmlab.VPPAppID, commandUUID string, associatedEventID string, selfService bool, policyID *uint) error

type GetPastActivityDataForVPPAppInstallFunc func(ctx context.Context, commandResults *mdm.CommandResults) (*mdmlab.User, *mdmlab.ActivityInstalledAppStoreApp, error)

type GetVPPTokenByLocationFunc func(ctx context.Context, loc string) (*mdmlab.VPPTokenDB, error)

type SetSetupExperienceSoftwareTitlesFunc func(ctx context.Context, teamID uint, titleIDs []uint) error

type ListSetupExperienceSoftwareTitlesFunc func(ctx context.Context, teamID uint, opts mdmlab.ListOptions) ([]mdmlab.SoftwareTitleListResult, int, *mdmlab.PaginationMetadata, error)
...
type ListSetupExperienceResultsByHostUUIDFunc func(ctx context.Context, hostUUID string) ([]*mdmlab.SetupExperienceStatusResult, error)

type UpdateSetupExperienceStatusResultFunc func(ctx context.Context, status *mdmlab.SetupExperienceStatusResult) error

type EnqueueSetupExperienceItemsFunc func(ctx context.Context, hostUUID string, teamID uint) (bool, error)

type GetSetupExperienceScriptFunc func(ctx context.Context, teamID *uint) (*mdmlab.Script, error)

type GetSetupExperienceScriptByIDFunc func(ctx context.Context, scriptID uint) (*mdmlab.Script, error)

type SetSetupExperienceScriptFunc func(ctx context.Context, script *mdmlab.Script) error

type DeleteSetupExperienceScriptFunc func(ctx context.Context, teamID *uint) error

type MaybeUpdateSetupExperienceScriptStatusFunc func(ctx context.Context, hostUUID string, executionID string, status mdmlab.SetupExperienceStatusResultStatus) (bool, error)

type MaybeUpdateSetupExperienceSoftwareInstallStatusFunc func(ctx context.Context, hostUUID string, executionID string, status mdmlab.SetupExperienceStatusResultStatus) (bool, error)

type MaybeUpdateSetupExperienceVPPStatusFunc func(ctx context.Context, hostUUID string, commandUUID string, status mdmlab.SetupExperienceStatusResultStatus) (bool, error)

type ListAvailableMDMlabMaintainedAppsFunc func(ctx context.Context, teamID *uint, opt mdmlab.ListOptions) ([]mdmlab.MaintainedApp, *mdmlab.PaginationMetadata, error)

type GetMaintainedAppByIDFunc func(ctx context.Context, appID uint) (*mdmlab.MaintainedApp, error)

type UpsertMaintainedAppFunc func(ctx context.Context, app *mdmlab.MaintainedApp) (*mdmlab.MaintainedApp, error)

type BulkUpsertMDMManagedCertificatesFunc func(ctx context.Context, payload []*mdmlab.MDMBulkUpsertManagedCertificatePayload) error

type GetHostMDMCertificateProfileFunc func(ctx context.Context, hostUUID string, profileUUID string) (*mdmlab.HostMDMCertificateProfile, error)

type CleanUpMDMManagedCertificatesFunc func(ctx context.Context) error

type UpsertSecretVariablesFunc func(ctx context.Context, secretVariables []mdmlab.SecretVariable) error

type GetSecretVariablesFunc func(ctx context.Context, names []string) ([]mdmlab.SecretVariable, error)
...
type DataStore struct {
	...
	IsHostConnectedToMDMlabMDMFunc        IsHostConnectedToMDMlabMDMFunc
	IsHostConnectedToMDMlabMDMFuncInvoked bool

	AreHostsConnectedToMDMlabMDMFunc        AreHostsConnectedToMDMlabMDMFunc
	AreHostsConnectedToMDMlabMDMFuncInvoked bool
	...
	IsCVEKnownToMDMlabFunc        IsCVEKnownToMDMlabFunc
	IsCVEKnownToMDMlabFuncInvoked bool
	...
	ListAvailableMDMlabMaintainedAppsFunc        ListAvailableMDMlabMaintainedAppsFunc
	ListAvailableMDMlabMaintainedAppsFuncInvoked bool
...
func (s *DataStore) NewCarve(ctx context.Context, metadata *mdmlab.CarveMetadata) (*mdmlab.CarveMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateCarve(ctx context.Context, metadata *mdmlab.CarveMetadata) error {
	s.mu.Lock()
...
func (s *DataStore) Carve(ctx context.Context, carveId int64) (*mdmlab.CarveMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) CarveBySessionId(ctx context.Context, sessionId string) (*mdmlab.CarveMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) CarveByName(ctx context.Context, name string) (*mdmlab.CarveMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) ListCarves(ctx context.Context, opt mdmlab.CarveListOptions) ([]*mdmlab.CarveMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) NewBlock(ctx context.Context, metadata *mdmlab.CarveMetadata, blockId int64, data []byte) error {
	s.mu.Lock()
...
func (s *DataStore) GetBlock(ctx context.Context, metadata *mdmlab.CarveMetadata, blockId int64) ([]byte, error) {
	s.mu.Lock()
...
func (s *DataStore) NewUser(ctx context.Context, user *mdmlab.User) (*mdmlab.User, error) {
	s.mu.Lock()
...
func (s *DataStore) ListUsers(ctx context.Context, opt mdmlab.UserListOptions) ([]*mdmlab.User, error) {
	s.mu.Lock()
...
func (s *DataStore) UserByEmail(ctx context.Context, email string) (*mdmlab.User, error) {
	s.mu.Lock()
...
func (s *DataStore) UserByID(ctx context.Context, id uint) (*mdmlab.User, error) {
	s.mu.Lock()
...
func (s *DataStore) SaveUser(ctx context.Context, user *mdmlab.User) error {
	s.mu.Lock()
...
func (s *DataStore) SaveUsers(ctx context.Context, users []*mdmlab.User) error {
	s.mu.Lock()
...
func (s *DataStore) UserSettings(ctx context.Context, userID uint) (*mdmlab.UserSettings, error) {
	s.mu.Lock()
...
func (s *DataStore) ApplyQueries(ctx context.Context, authorID uint, queries []*mdmlab.Query, queriesToDiscardResults map[uint]struct{}) error {
	s.mu.Lock()
...
func (s *DataStore) NewQuery(ctx context.Context, query *mdmlab.Query, opts ...mdmlab.OptionalArg) (*mdmlab.Query, error) {
	s.mu.Lock()
...
func (s *DataStore) SaveQuery(ctx context.Context, query *mdmlab.Query, shouldDiscardResults bool, shouldDeleteStats bool) error {
	s.mu.Lock()
...
func (s *DataStore) Query(ctx context.Context, id uint) (*mdmlab.Query, error) {
	s.mu.Lock()
...
func (s *DataStore) ListQueries(ctx context.Context, opt mdmlab.ListQueryOptions) ([]*mdmlab.Query, int, *mdmlab.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) ListScheduledQueriesForAgents(ctx context.Context, teamID *uint, queryReportsDisabled bool) ([]*mdmlab.Query, error) {
	s.mu.Lock()
...
func (s *DataStore) QueryByName(ctx context.Context, teamID *uint, name string) (*mdmlab.Query, error) {
	s.mu.Lock()
...
func (s *DataStore) GetLiveQueryStats(ctx context.Context, queryID uint, hostIDs []uint) ([]*mdmlab.LiveQueryStats, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateLiveQueryStats(ctx context.Context, queryID uint, stats []*mdmlab.LiveQueryStats) error {
	s.mu.Lock()
...
func (s *DataStore) CalculateAggregatedPerfStatsPercentiles(ctx context.Context, aggregate mdmlab.AggregatedStatsType, queryID uint) error {
	s.mu.Lock()
...
func (s *DataStore) NewDistributedQueryCampaign(ctx context.Context, camp *mdmlab.DistributedQueryCampaign) (*mdmlab.DistributedQueryCampaign, error) {
	s.mu.Lock()
...
func (s *DataStore) DistributedQueryCampaign(ctx context.Context, id uint) (*mdmlab.DistributedQueryCampaign, error) {
	s.mu.Lock()
...
func (s *DataStore) SaveDistributedQueryCampaign(ctx context.Context, camp *mdmlab.DistributedQueryCampaign) error {
	s.mu.Lock()
...
func (s *DataStore) DistributedQueryCampaignTargetIDs(ctx context.Context, id uint) (targets *mdmlab.HostTargets, err error) {
	s.mu.Lock()
...
func (s *DataStore) NewDistributedQueryCampaignTarget(ctx context.Context, target *mdmlab.DistributedQueryCampaignTarget) (*mdmlab.DistributedQueryCampaignTarget, error) {
	s.mu.Lock()
...
func (s *DataStore) DistributedQueryCampaignsForQuery(ctx context.Context, queryID uint) ([]*mdmlab.DistributedQueryCampaign, error) {
	s.mu.Lock()
...
func (s *DataStore) ApplyPackSpecs(ctx context.Context, specs []*mdmlab.PackSpec) error {
	s.mu.Lock()
...
func (s *DataStore) GetPackSpecs(ctx context.Context) ([]*mdmlab.PackSpec, error) {
	s.mu.Lock()
...
func (s *DataStore) GetPackSpec(ctx context.Context, name string) (*mdmlab.PackSpec, error) {
	s.mu.Lock()
...
func (s *DataStore) NewPack(ctx context.Context, pack *mdmlab.Pack, opts ...mdmlab.OptionalArg) (*mdmlab.Pack, error) {
	s.mu.Lock()
...
func (s *DataStore) SavePack(ctx context.Context, pack *mdmlab.Pack) error {
	s.mu.Lock()
...
func (s *DataStore) Pack(ctx context.Context, pid uint) (*mdmlab.Pack, error) {
	s.mu.Lock()
...
func (s *DataStore) ListPacks(ctx context.Context, opt mdmlab.PackListOptions) ([]*mdmlab.Pack, error) {
	s.mu.Lock()
...
func (s *DataStore) PackByName(ctx context.Context, name string, opts ...mdmlab.OptionalArg) (*mdmlab.Pack, bool, error) {
	s.mu.Lock()
...
func (s *DataStore) ListPacksForHost(ctx context.Context, hid uint) (packs []*mdmlab.Pack, err error) {
	s.mu.Lock()
...
func (s *DataStore) ApplyLabelSpecs(ctx context.Context, specs []*mdmlab.LabelSpec) error {
	s.mu.Lock()
...
func (s *DataStore) GetLabelSpecs(ctx context.Context) ([]*mdmlab.LabelSpec, error) {
	s.mu.Lock()
...
func (s *DataStore) GetLabelSpec(ctx context.Context, name string) (*mdmlab.LabelSpec, error) {
	s.mu.Lock()
...
func (s *DataStore) NewLabel(ctx context.Context, Label *mdmlab.Label, opts ...mdmlab.OptionalArg) (*mdmlab.Label, error) {
	s.mu.Lock()
...
func (s *DataStore) SaveLabel(ctx context.Context, label *mdmlab.Label, teamFilter mdmlab.TeamFilter) (*mdmlab.Label, []uint, error) {
	s.mu.Lock()
...
func (s *DataStore) Label(ctx context.Context, lid uint, teamFilter mdmlab.TeamFilter) (*mdmlab.Label, []uint, error) {
	s.mu.Lock()
...
func (s *DataStore) ListLabels(ctx context.Context, filter mdmlab.TeamFilter, opt mdmlab.ListOptions) ([]*mdmlab.Label, error) {
	s.mu.Lock()
...
func (s *DataStore) LabelsSummary(ctx context.Context) ([]*mdmlab.LabelSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) LabelQueriesForHost(ctx context.Context, host *mdmlab.Host) (map[string]string, error) {
	s.mu.Lock()
...
func (s *DataStore) ListLabelsForHost(ctx context.Context, hid uint) ([]*mdmlab.Label, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHostsInLabel(ctx context.Context, filter mdmlab.TeamFilter, lid uint, opt mdmlab.HostListOptions) ([]*mdmlab.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) ListUniqueHostsInLabels(ctx context.Context, filter mdmlab.TeamFilter, labels []uint) ([]*mdmlab.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) SearchLabels(ctx context.Context, filter mdmlab.TeamFilter, query string, omit ...uint) ([]*mdmlab.Label, error) {
	s.mu.Lock()
...
func (s *DataStore) LabelsByName(ctx context.Context, names []string) (map[string]*mdmlab.Label, error) {
	s.mu.Lock()
...
func (s *DataStore) NewHost(ctx context.Context, host *mdmlab.Host) (*mdmlab.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) Host(ctx context.Context, id uint) (*mdmlab.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostHealth(ctx context.Context, id uint) (*mdmlab.HostHealth, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHosts(ctx context.Context, filter mdmlab.TeamFilter, opt mdmlab.HostListOptions) ([]*mdmlab.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHostsLiteByUUIDs(ctx context.Context, filter mdmlab.TeamFilter, uuids []string) ([]*mdmlab.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHostsLiteByIDs(ctx context.Context, ids []uint) ([]*mdmlab.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHostUsers(ctx context.Context, hostID uint) ([]mdmlab.HostUser, error) {
	s.mu.Lock()
...
func (s *DataStore) SearchHosts(ctx context.Context, filter mdmlab.TeamFilter, query string, omit ...uint) ([]*mdmlab.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) GenerateHostStatusStatistics(ctx context.Context, filter mdmlab.TeamFilter, now time.Time, platform *string, lowDiskSpace *int) (*mdmlab.HostSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) HostIDsByIdentifier(ctx context.Context, filter mdmlab.TeamFilter, hostnames []string) ([]uint, error) {
	s.mu.Lock()
...
func (s *DataStore) HostIDsByOSVersion(ctx context.Context, osVersion mdmlab.OSVersion, offset int, limit int) ([]uint, error) {
	s.mu.Lock()
...
func (s *DataStore) HostByIdentifier(ctx context.Context, identifier string) (*mdmlab.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) HostLiteByIdentifier(ctx context.Context, identifier string) (*mdmlab.HostLite, error) {
	s.mu.Lock()
...
func (s *DataStore) HostLiteByID(ctx context.Context, id uint) (*mdmlab.HostLite, error) {
	s.mu.Lock()
...
func (s *DataStore) CountHosts(ctx context.Context, filter mdmlab.TeamFilter, opt mdmlab.HostListOptions) (int, error) {
	s.mu.Lock()
...
func (s *DataStore) CountHostsInLabel(ctx context.Context, filter mdmlab.TeamFilter, lid uint, opt mdmlab.HostListOptions) (int, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHostDeviceMapping(ctx context.Context, id uint) ([]*mdmlab.HostDeviceMapping, error) {
	s.mu.Lock()
...
func (s *DataStore) SetOrUpdateCustomHostDeviceMapping(ctx context.Context, hostID uint, email string, source string) ([]*mdmlab.HostDeviceMapping, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHostBatteries(ctx context.Context, id uint) ([]*mdmlab.HostBattery, error) {
	s.mu.Lock()
...
func (s *DataStore) ListUpcomingHostMaintenanceWindows(ctx context.Context, hid uint) ([]*mdmlab.HostMaintenanceWindow, error) {
	s.mu.Lock()
...
func (s *DataStore) LoadHostByDeviceAuthToken(ctx context.Context, authToken string, tokenTTL time.Duration) (*mdmlab.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) FailingPoliciesCount(ctx context.Context, host *mdmlab.Host) (uint, error) {
	s.mu.Lock()
...
func (s *DataStore) ListPoliciesForHost(ctx context.Context, host *mdmlab.Host) ([]*mdmlab.HostPolicy, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostMunkiIssues(ctx context.Context, hostID uint) ([]*mdmlab.HostMunkiIssue, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDM(ctx context.Context, hostID uint) (*mdmlab.HostMDM, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMCheckinInfo(ctx context.Context, hostUUID string) (*mdmlab.HostMDMCheckinInfo, error) {
	s.mu.Lock()
...
func (s *DataStore) ListIOSAndIPadOSToRefetch(ctx context.Context, refetchInterval time.Duration) (devices []mdmlab.AppleDevicesToRefetch, err error) {
	s.mu.Lock()
...
func (s *DataStore) AddHostMDMCommands(ctx context.Context, commands []mdmlab.HostMDMCommand) error {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMCommands(ctx context.Context, hostID uint) (commands []mdmlab.HostMDMCommand, err error) {
	s.mu.Lock()
...
func (s *DataStore) RemoveHostMDMCommand(ctx context.Context, command mdmlab.HostMDMCommand) error {
	s.mu.Lock()
...
func (s *DataStore) IsHostConnectedToMDMlabMDM(ctx context.Context, host *mdmlab.Host) (bool, error) {
	s.mu.Lock()
	s.IsHostConnectedToMDMlabMDMFuncInvoked = true
	s.mu.Unlock()
	return s.IsHostConnectedToMDMlabMDMFunc(ctx, host)
}

func (s *DataStore) AreHostsConnectedToMDMlabMDM(ctx context.Context, hosts []*mdmlab.Host) (map[string]bool, error) {
	s.mu.Lock()
	s.AreHostsConnectedToMDMlabMDMFuncInvoked = true
	s.mu.Unlock()
	return s.AreHostsConnectedToMDMlabMDMFunc(ctx, hosts)
}

func (s *DataStore) AggregatedMunkiVersion(ctx context.Context, teamID *uint) ([]mdmlab.AggregatedMunkiVersion, time.Time, error) {
	s.mu.Lock()
...
func (s *DataStore) AggregatedMunkiIssues(ctx context.Context, teamID *uint) ([]mdmlab.AggregatedMunkiIssue, time.Time, error) {
	s.mu.Lock()
...
func (s *DataStore) AggregatedMDMStatus(ctx context.Context, teamID *uint, platform string) (mdmlab.AggregatedMDMStatus, time.Time, error) {
	s.mu.Lock()
...
func (s *DataStore) AggregatedMDMSolutions(ctx context.Context, teamID *uint, platform string) ([]mdmlab.AggregatedMDMSolutions, time.Time, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMunkiIssue(ctx context.Context, munkiIssueID uint) (*mdmlab.MunkiIssue, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMSolution(ctx context.Context, mdmID uint) (*mdmlab.MDMSolution, error) {
	s.mu.Lock()
...
func (s *DataStore) OSVersions(ctx context.Context, teamFilter *mdmlab.TeamFilter, platform *string, name *string, version *string) (*mdmlab.OSVersions, error) {
	s.mu.Lock()
...
func (s *DataStore) OSVersionsByCVE(ctx context.Context, cve string, teamID *uint) ([]*mdmlab.VulnerableOS, time.Time, error) {
	s.mu.Lock()
...
func (s *DataStore) SoftwareByCVE(ctx context.Context, cve string, teamID *uint) ([]*mdmlab.VulnerableSoftware, time.Time, error) {
	s.mu.Lock()
...
func (s *DataStore) OSVersion(ctx context.Context, osVersionID uint, teamFilter *mdmlab.TeamFilter) (*mdmlab.OSVersion, *time.Time, error) {
	s.mu.Lock()
...
func (s *DataStore) CountHostsInTargets(ctx context.Context, filter mdmlab.TeamFilter, targets mdmlab.HostTargets, now time.Time) (mdmlab.TargetMetrics, error) {
	s.mu.Lock()
...
func (s *DataStore) HostIDsInTargets(ctx context.Context, filter mdmlab.TeamFilter, targets mdmlab.HostTargets) ([]uint, error) {
	s.mu.Lock()
...
func (s *DataStore) NewPasswordResetRequest(ctx context.Context, req *mdmlab.PasswordResetRequest) (*mdmlab.PasswordResetRequest, error) {
	s.mu.Lock()
...
func (s *DataStore) FindPasswordResetByToken(ctx context.Context, token string) (*mdmlab.PasswordResetRequest, error) {
	s.mu.Lock()
...
func (s *DataStore) SessionByKey(ctx context.Context, key string) (*mdmlab.Session, error) {
	s.mu.Lock()
...
func (s *DataStore) SessionByID(ctx context.Context, id uint) (*mdmlab.Session, error) {
	s.mu.Lock()
...
func (s *DataStore) ListSessionsForUser(ctx context.Context, id uint) ([]*mdmlab.Session, error) {
	s.mu.Lock()
...
func (s *DataStore) NewSession(ctx context.Context, userID uint, sessionKeySize int) (*mdmlab.Session, error) {
	s.mu.Lock()
...
func (s *DataStore) DestroySession(ctx context.Context, session *mdmlab.Session) error {
	s.mu.Lock()
...
func (s *DataStore) MarkSessionAccessed(ctx context.Context, session *mdmlab.Session) error {
	s.mu.Lock()
...
func (s *DataStore) SessionByMFAToken(ctx context.Context, token string, sessionKeySize int) (*mdmlab.Session, *mdmlab.User, error) {
	s.mu.Lock()
...
func (s *DataStore) NewAppConfig(ctx context.Context, info *mdmlab.AppConfig) (*mdmlab.AppConfig, error) {
	s.mu.Lock()
...
func (s *DataStore) AppConfig(ctx context.Context) (*mdmlab.AppConfig, error) {
	s.mu.Lock()
...
func (s *DataStore) SaveAppConfig(ctx context.Context, info *mdmlab.AppConfig) error {
	s.mu.Lock()
...
func (s *DataStore) GetEnrollSecrets(ctx context.Context, teamID *uint) ([]*mdmlab.EnrollSecret, error) {
	s.mu.Lock()
...
func (s *DataStore) ApplyEnrollSecrets(ctx context.Context, teamID *uint, secrets []*mdmlab.EnrollSecret) error {
	s.mu.Lock()
...
func (s *DataStore) AggregateEnrollSecretPerTeam(ctx context.Context) ([]*mdmlab.EnrollSecret, error) {
	s.mu.Lock()
...
func (s *DataStore) GetYaraRules(ctx context.Context) ([]mdmlab.YaraRule, error) {
	s.mu.Lock()
...
func (s *DataStore) ApplyYaraRules(ctx context.Context, rules []mdmlab.YaraRule) error {
	s.mu.Lock()
...
func (s *DataStore) YaraRuleByName(ctx context.Context, name string) (*mdmlab.YaraRule, error) {
	s.mu.Lock()
...
func (s *DataStore) NewInvite(ctx context.Context, i *mdmlab.Invite) (*mdmlab.Invite, error) {
	s.mu.Lock()
...
func (s *DataStore) ListInvites(ctx context.Context, opt mdmlab.ListOptions) ([]*mdmlab.Invite, error) {
	s.mu.Lock()
...
func (s *DataStore) Invite(ctx context.Context, id uint) (*mdmlab.Invite, error) {
	s.mu.Lock()
...
func (s *DataStore) InviteByEmail(ctx context.Context, email string) (*mdmlab.Invite, error) {
	s.mu.Lock()
...
func (s *DataStore) InviteByToken(ctx context.Context, token string) (*mdmlab.Invite, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateInvite(ctx context.Context, id uint, i *mdmlab.Invite) (*mdmlab.Invite, error) {
	s.mu.Lock()
...
func (s *DataStore) ListScheduledQueriesInPackWithStats(ctx context.Context, id uint, opts mdmlab.ListOptions) ([]*mdmlab.ScheduledQuery, error) {
	s.mu.Lock()
...
func (s *DataStore) NewScheduledQuery(ctx context.Context, sq *mdmlab.ScheduledQuery, opts ...mdmlab.OptionalArg) (*mdmlab.ScheduledQuery, error) {
	s.mu.Lock()
...
func (s *DataStore) SaveScheduledQuery(ctx context.Context, sq *mdmlab.ScheduledQuery) (*mdmlab.ScheduledQuery, error) {
	s.mu.Lock()
...
func (s *DataStore) ScheduledQuery(ctx context.Context, id uint) (*mdmlab.ScheduledQuery, error) {
	s.mu.Lock()
...
func (s *DataStore) QueryResultRows(ctx context.Context, queryID uint, filter mdmlab.TeamFilter) ([]*mdmlab.ScheduledQueryResultRow, error) {
	s.mu.Lock()
...
func (s *DataStore) QueryResultRowsForHost(ctx context.Context, queryID uint, hostID uint) ([]*mdmlab.ScheduledQueryResultRow, error) {
	s.mu.Lock()
...
func (s *DataStore) OverwriteQueryResultRows(ctx context.Context, rows []*mdmlab.ScheduledQueryResultRow, maxQueryReportRows int) error {
	s.mu.Lock()
...
func (s *DataStore) NewTeam(ctx context.Context, team *mdmlab.Team) (*mdmlab.Team, error) {
	s.mu.Lock()
...
func (s *DataStore) SaveTeam(ctx context.Context, team *mdmlab.Team) (*mdmlab.Team, error) {
	s.mu.Lock()
...
func (s *DataStore) Team(ctx context.Context, tid uint) (*mdmlab.Team, error) {
	s.mu.Lock()
...
func (s *DataStore) TeamWithoutExtras(ctx context.Context, tid uint) (*mdmlab.Team, error) {
	s.mu.Lock()
...
func (s *DataStore) TeamByName(ctx context.Context, name string) (*mdmlab.Team, error) {
	s.mu.Lock()
...
func (s *DataStore) TeamByFilename(ctx context.Context, filename string) (*mdmlab.Team, error) {
	s.mu.Lock()
...
func (s *DataStore) ListTeams(ctx context.Context, filter mdmlab.TeamFilter, opt mdmlab.ListOptions) ([]*mdmlab.Team, error) {
	s.mu.Lock()
...
func (s *DataStore) TeamsSummary(ctx context.Context) ([]*mdmlab.TeamSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) SearchTeams(ctx context.Context, filter mdmlab.TeamFilter, matchQuery string, omit ...uint) ([]*mdmlab.Team, error) {
	s.mu.Lock()
...
func (s *DataStore) TeamEnrollSecrets(ctx context.Context, teamID uint) ([]*mdmlab.EnrollSecret, error) {
	s.mu.Lock()
...
func (s *DataStore) DeleteIntegrationsFromTeams(ctx context.Context, deletedIntgs mdmlab.Integrations) error {
	s.mu.Lock()
...
func (s *DataStore) ListSoftwareTitles(ctx context.Context, opt mdmlab.SoftwareTitleListOptions, tmFilter mdmlab.TeamFilter) ([]mdmlab.SoftwareTitleListResult, int, *mdmlab.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) SoftwareTitleByID(ctx context.Context, id uint, teamID *uint, tmFilter mdmlab.TeamFilter) (*mdmlab.SoftwareTitle, error) {
	s.mu.Lock()
...
func (s *DataStore) ListSoftwareForVulnDetection(ctx context.Context, filter mdmlab.VulnSoftwareFilter) ([]mdmlab.Software, error) {
	s.mu.Lock()
...
func (s *DataStore) ListSoftwareVulnerabilitiesByHostIDsSource(ctx context.Context, hostIDs []uint, source mdmlab.VulnerabilitySource) (map[uint][]mdmlab.SoftwareVulnerability, error) {
	s.mu.Lock()
...
func (s *DataStore) LoadHostSoftware(ctx context.Context, host *mdmlab.Host, includeCVEScores bool) error {
	s.mu.Lock()
...
func (s *DataStore) AllSoftwareIterator(ctx context.Context, query mdmlab.SoftwareIterQueryOptions) (mdmlab.SoftwareIterator, error) {
	s.mu.Lock()
...
func (s *DataStore) UpsertSoftwareCPEs(ctx context.Context, cpes []mdmlab.SoftwareCPE) (int64, error) {
	s.mu.Lock()
...
func (s *DataStore) DeleteSoftwareCPEs(ctx context.Context, cpes []mdmlab.SoftwareCPE) (int64, error) {
	s.mu.Lock()
...
func (s *DataStore) ListSoftwareCPEs(ctx context.Context) ([]mdmlab.SoftwareCPE, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertSoftwareVulnerability(ctx context.Context, vuln mdmlab.SoftwareVulnerability, source mdmlab.VulnerabilitySource) (bool, error) {
	s.mu.Lock()
...
func (s *DataStore) SoftwareByID(ctx context.Context, id uint, teamID *uint, includeCVEScores bool, tmFilter *mdmlab.TeamFilter) (*mdmlab.Software, error) {
	s.mu.Lock()
...
func (s *DataStore) ListSoftwareByHostIDShort(ctx context.Context, hostID uint) ([]mdmlab.Software, error) {
	s.mu.Lock()
...
func (s *DataStore) HostVulnSummariesBySoftwareIDs(ctx context.Context, softwareIDs []uint) ([]mdmlab.HostVulnerabilitySummary, error) {
	s.mu.Lock()
...
func (s *DataStore) HostsByCVE(ctx context.Context, cve string) ([]mdmlab.HostVulnerabilitySummary, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertCVEMeta(ctx context.Context, cveMeta []mdmlab.CVEMeta) error {
	s.mu.Lock()
...
func (s *DataStore) ListCVEs(ctx context.Context, maxAge time.Duration) ([]mdmlab.CVEMeta, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHostSoftware(ctx context.Context, host *mdmlab.Host, opts mdmlab.HostSoftwareTitleListOptions) ([]*mdmlab.HostSoftwareWithInstaller, *mdmlab.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) SetHostSoftwareInstallResult(ctx context.Context, result *mdmlab.HostSoftwareInstallResultPayload) error {
	s.mu.Lock()
...
func (s *DataStore) GetHostOperatingSystem(ctx context.Context, hostID uint) (*mdmlab.OperatingSystem, error) {
	s.mu.Lock()
...
func (s *DataStore) ListOperatingSystems(ctx context.Context) ([]mdmlab.OperatingSystem, error) {
	s.mu.Lock()
...
func (s *DataStore) ListOperatingSystemsForPlatform(ctx context.Context, platform string) ([]mdmlab.OperatingSystem, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateHostOperatingSystem(ctx context.Context, hostID uint, hostOS mdmlab.OperatingSystem) error {
	s.mu.Lock()
...
func (s *DataStore) NewActivity(ctx context.Context, user *mdmlab.User, activity mdmlab.ActivityDetails, details []byte, createdAt time.Time) error {
	s.mu.Lock()
...
func (s *DataStore) ListActivities(ctx context.Context, opt mdmlab.ListActivitiesOptions) ([]*mdmlab.Activity, *mdmlab.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHostUpcomingActivities(ctx context.Context, hostID uint, opt mdmlab.ListOptions) ([]*mdmlab.Activity, *mdmlab.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHostPastActivities(ctx context.Context, hostID uint, opt mdmlab.ListOptions) ([]*mdmlab.Activity, *mdmlab.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) ShouldSendStatistics(ctx context.Context, frequency time.Duration, config config.MDMlabConfig) (mdmlab.StatisticsPayload, bool, error) {
	s.mu.Lock()
...
func (s *DataStore) ApplyPolicySpecs(ctx context.Context, authorID uint, specs []*mdmlab.PolicySpec) error {
	s.mu.Lock()
...
func (s *DataStore) NewGlobalPolicy(ctx context.Context, authorID *uint, args mdmlab.PolicyPayload) (*mdmlab.Policy, error) {
	s.mu.Lock()
...
func (s *DataStore) Policy(ctx context.Context, id uint) (*mdmlab.Policy, error) {
	s.mu.Lock()
...
func (s *DataStore) PolicyLite(ctx context.Context, id uint) (*mdmlab.PolicyLite, error) {
	s.mu.Lock()
...
func (s *DataStore) SavePolicy(ctx context.Context, p *mdmlab.Policy, shouldRemoveAllPolicyMemberships bool, removePolicyStats bool) error {
	s.mu.Lock()
...
func (s *DataStore) ListGlobalPolicies(ctx context.Context, opts mdmlab.ListOptions) ([]*mdmlab.Policy, error) {
	s.mu.Lock()
...
func (s *DataStore) PoliciesByID(ctx context.Context, ids []uint) (map[uint]*mdmlab.Policy, error) {
	s.mu.Lock()
...
func (s *DataStore) PolicyQueriesForHost(ctx context.Context, host *mdmlab.Host) (map[string]string, error) {
	s.mu.Lock()
...
func (s *DataStore) GetTeamHostsPolicyMemberships(ctx context.Context, domain string, teamID uint, policyIDs []uint, hostID *uint) ([]mdmlab.HostPolicyMembershipData, error) {
	s.mu.Lock()
...
func (s *DataStore) GetPoliciesWithAssociatedInstaller(ctx context.Context, teamID uint, policyIDs []uint) ([]mdmlab.PolicySoftwareInstallerData, error) {
	s.mu.Lock()
...
func (s *DataStore) GetPoliciesWithAssociatedVPP(ctx context.Context, teamID uint, policyIDs []uint) ([]mdmlab.PolicyVPPData, error) {
	s.mu.Lock()
...
func (s *DataStore) GetPoliciesWithAssociatedScript(ctx context.Context, teamID uint, policyIDs []uint) ([]mdmlab.PolicyScriptData, error) {
	s.mu.Lock()
...
func (s *DataStore) GetCalendarPolicies(ctx context.Context, teamID uint) ([]mdmlab.PolicyCalendarData, error) {
	s.mu.Lock()
...
func (s *DataStore) AsyncBatchInsertPolicyMembership(ctx context.Context, batch []mdmlab.PolicyMembershipResult) error {
	s.mu.Lock()
...
func (s *DataStore) MigrationStatus(ctx context.Context) (*mdmlab.MigrationStatus, error) {
	s.mu.Lock()
...
func (s *DataStore) ListSoftware(ctx context.Context, opt mdmlab.SoftwareListOptions) ([]mdmlab.Software, *mdmlab.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) CountSoftware(ctx context.Context, opt mdmlab.SoftwareListOptions) (int, error) {
	s.mu.Lock()
...
func (s *DataStore) DeleteSoftwareVulnerabilities(ctx context.Context, vulnerabilities []mdmlab.SoftwareVulnerability) error {
	s.mu.Lock()
...
func (s *DataStore) DeleteOutOfDateVulnerabilities(ctx context.Context, source mdmlab.VulnerabilitySource, duration time.Duration) error {
	s.mu.Lock()
...
func (s *DataStore) CreateOrUpdateCalendarEvent(ctx context.Context, uuid string, email string, startTime time.Time, endTime time.Time, data []byte, timeZone *string, hostID uint, webhookStatus mdmlab.CalendarWebhookStatus) (*mdmlab.CalendarEvent, error) {
	s.mu.Lock()
...
func (s *DataStore) GetCalendarEvent(ctx context.Context, email string) (*mdmlab.CalendarEvent, error) {
	s.mu.Lock()
...
func (s *DataStore) GetCalendarEventDetailsByUUID(ctx context.Context, uuid string) (*mdmlab.CalendarEventDetails, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostCalendarEvent(ctx context.Context, hostID uint) (*mdmlab.HostCalendarEvent, *mdmlab.CalendarEvent, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostCalendarEventByEmail(ctx context.Context, email string) (*mdmlab.HostCalendarEvent, *mdmlab.CalendarEvent, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateHostCalendarWebhookStatus(ctx context.Context, hostID uint, status mdmlab.CalendarWebhookStatus) error {
	s.mu.Lock()
...
func (s *DataStore) ListCalendarEvents(ctx context.Context, teamID *uint) ([]*mdmlab.CalendarEvent, error) {
	s.mu.Lock()
...
func (s *DataStore) ListOutOfDateCalendarEvents(ctx context.Context, t time.Time) ([]*mdmlab.CalendarEvent, error) {
	s.mu.Lock()
...
func (s *DataStore) NewTeamPolicy(ctx context.Context, teamID uint, authorID *uint, args mdmlab.PolicyPayload) (*mdmlab.Policy, error) {
	s.mu.Lock()
...
func (s *DataStore) ListTeamPolicies(ctx context.Context, teamID uint, opts mdmlab.ListOptions, iopts mdmlab.ListOptions) (teamPolicies []*mdmlab.Policy, inheritedPolicies []*mdmlab.Policy, err error) {
	s.mu.Lock()
...
func (s *DataStore) ListMergedTeamPolicies(ctx context.Context, teamID uint, opts mdmlab.ListOptions) ([]*mdmlab.Policy, error) {
	s.mu.Lock()
...
func (s *DataStore) TeamPolicy(ctx context.Context, teamID uint, policyID uint) (*mdmlab.Policy, error) {
	s.mu.Lock()
...
func (s *DataStore) DBLocks(ctx context.Context) ([]*mdmlab.DBLock, error) {
	s.mu.Lock()
...
func (s *DataStore) GetLatestCronStats(ctx context.Context, name string) ([]mdmlab.CronStats, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertCronStats(ctx context.Context, statsType mdmlab.CronStatsType, name string, instance string, status mdmlab.CronStatsStatus) (int, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateCronStats(ctx context.Context, id int, status mdmlab.CronStatsStatus, cronErrors *mdmlab.CronScheduleErrors) error {
	s.mu.Lock()
...
func (s *DataStore) UpdateAllCronStatsForInstance(ctx context.Context, instance string, fromStatus mdmlab.CronStatsStatus, toStatus mdmlab.CronStatsStatus) error {
	s.mu.Lock()
...
func (s *DataStore) LoadHostByNodeKey(ctx context.Context, nodeKey string) (*mdmlab.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) LoadHostByOrbitNodeKey(ctx context.Context, nodeKey string) (*mdmlab.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) HostLite(ctx context.Context, hostID uint) (*mdmlab.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateHostOsqueryIntervals(ctx context.Context, hostID uint, intervals mdmlab.HostOsqueryIntervals) error {
	s.mu.Lock()
...
func (s *DataStore) TeamFeatures(ctx context.Context, teamID uint) (*mdmlab.Features, error) {
	s.mu.Lock()
...
func (s *DataStore) TeamMDMConfig(ctx context.Context, teamID uint) (*mdmlab.TeamMDM, error) {
	s.mu.Lock()
...
func (s *DataStore) SaveHostPackStats(ctx context.Context, teamID *uint, hostID uint, stats []mdmlab.PackStats) error {
	s.mu.Lock()
...
func (s *DataStore) AsyncBatchSaveHostsScheduledQueryStats(ctx context.Context, stats map[uint][]mdmlab.ScheduledQueryStats, batchSize int) (int, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateHostSoftware(ctx context.Context, hostID uint, software []mdmlab.Software) (*mdmlab.UpdateHostSoftwareDBResult, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateHostSoftwareInstalledPaths(ctx context.Context, hostID uint, reported map[string]struct{}, mutationResults *mdmlab.UpdateHostSoftwareDBResult) error {
	s.mu.Lock()
...
func (s *DataStore) UpdateHost(ctx context.Context, host *mdmlab.Host) error {
	s.mu.Lock()
...
func (s *DataStore) ListScheduledQueriesInPack(ctx context.Context, packID uint) (mdmlab.ScheduledQueryList, error) {
	s.mu.Lock()
...
func (s *DataStore) RecordPolicyQueryExecutions(ctx context.Context, host *mdmlab.Host, results map[uint]*bool, updated time.Time, deferredSaveHost bool) error {
	s.mu.Lock()
...
func (s *DataStore) RecordLabelQueryExecutions(ctx context.Context, host *mdmlab.Host, results map[uint]*bool, t time.Time, deferredSaveHost bool) error {
	s.mu.Lock()
...
func (s *DataStore) SaveHostUsers(ctx context.Context, hostID uint, users []mdmlab.HostUser) error {
	s.mu.Lock()
...
func (s *DataStore) SetOrUpdateMDMData(ctx context.Context, hostID uint, isServer bool, enrolled bool, serverURL string, installedFromDep bool, name string, mdmlabEnrollRef string) error {
	s.mu.Lock()
	s.SetOrUpdateMDMDataFuncInvoked = true
	s.mu.Unlock()
	return s.SetOrUpdateMDMDataFunc(ctx, hostID, isServer, enrolled, serverURL, installedFromDep, name, mdmlabEnrollRef)
}
...
func (s *DataStore) SetOrUpdateHostEmailsFromMdmIdpAccounts(ctx context.Context, hostID uint, mdmlabEnrollmentRef string) error {
	s.mu.Lock()
	s.SetOrUpdateHostEmailsFromMdmIdpAccountsFuncInvoked = true
	s.mu.Unlock()
	return s.SetOrUpdateHostEmailsFromMdmIdpAccountsFunc(ctx, hostID, mdmlabEnrollmentRef)
}
...
func (s *DataStore) SetOrUpdateHostDiskEncryptionKey(ctx context.Context, host *mdmlab.Host, encryptedBase64Key string, clientError string, decryptable *bool) error {
	s.mu.Lock()
...
func (s *DataStore) SaveLUKSData(ctx context.Context, host *mdmlab.Host, encryptedBase64Passphrase string, encryptedBase64Salt string, keySlot uint) error {
	s.mu.Lock()
...
func (s *DataStore) GetUnverifiedDiskEncryptionKeys(ctx context.Context) ([]mdmlab.HostDiskEncryptionKey, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostDiskEncryptionKey(ctx context.Context, hostID uint) (*mdmlab.HostDiskEncryptionKey, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostCertAssociationsToExpire(ctx context.Context, expiryDays int, limit int) ([]mdmlab.SCEPIdentityAssociation, error) {
	s.mu.Lock()
...
func (s *DataStore) SetCommandForPendingSCEPRenewal(ctx context.Context, assocs []mdmlab.SCEPIdentityAssociation, cmdUUID string) error {
	s.mu.Lock()
...
func (s *DataStore) UpdateHostMDMProfilesVerification(ctx context.Context, host *mdmlab.Host, toVerify []string, toFail []string, toRetry []string) error {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMProfilesExpectedForVerification(ctx context.Context, host *mdmlab.Host) (map[string]*mdmlab.ExpectedMDMProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMProfilesRetryCounts(ctx context.Context, host *mdmlab.Host) ([]mdmlab.HostMDMProfileRetryCount, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMProfileRetryCountByCommandUUID(ctx context.Context, host *mdmlab.Host, cmdUUID string) (mdmlab.HostMDMProfileRetryCount, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostOrbitInfo(ctx context.Context, hostID uint) (*mdmlab.HostOrbitInfo, error) {
	s.mu.Lock()
...
func (s *DataStore) ReplaceHostDeviceMapping(ctx context.Context, id uint, mappings []*mdmlab.HostDeviceMapping, source string) error {
	s.mu.Lock()
...
func (s *DataStore) ReplaceHostBatteries(ctx context.Context, id uint, mappings []*mdmlab.HostBattery) error {
	s.mu.Lock()
...
func (s *DataStore) VerifyEnrollSecret(ctx context.Context, secret string) (*mdmlab.EnrollSecret, error) {
	s.mu.Lock()
...
func (s *DataStore) EnrollHost(ctx context.Context, isMDMEnabled bool, osqueryHostId string, hardwareUUID string, hardwareSerial string, nodeKey string, teamID *uint, cooldown time.Duration) (*mdmlab.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) EnrollOrbit(ctx context.Context, isMDMEnabled bool, hostInfo mdmlab.OrbitHostInfo, orbitNodeKey string, teamID *uint) (*mdmlab.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) SerialUpdateHost(ctx context.Context, host *mdmlab.Host) error {
	s.mu.Lock()
...
func (s *DataStore) NewJob(ctx context.Context, job *mdmlab.Job) (*mdmlab.Job, error) {
	s.mu.Lock()
...
func (s *DataStore) GetQueuedJobs(ctx context.Context, maxNumJobs int, now time.Time) ([]*mdmlab.Job, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateJob(ctx context.Context, id uint, job *mdmlab.Job) (*mdmlab.Job, error) {
	s.mu.Lock()
...
func (s *DataStore) ProcessList(ctx context.Context) ([]mdmlab.MySQLProcess, error) {
	s.mu.Lock()
...
func (s *DataStore) ListWindowsUpdatesByHostID(ctx context.Context, hostID uint) ([]mdmlab.WindowsUpdate, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertWindowsUpdates(ctx context.Context, hostID uint, updates []mdmlab.WindowsUpdate) error {
	s.mu.Lock()
...
func (s *DataStore) ListOSVulnerabilitiesByOS(ctx context.Context, osID uint) ([]mdmlab.OSVulnerability, error) {
	s.mu.Lock()
...
func (s *DataStore) ListVulnsByOsNameAndVersion(ctx context.Context, name string, version string, includeCVSS bool) (mdmlab.Vulnerabilities, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertOSVulnerabilities(ctx context.Context, vulnerabilities []mdmlab.OSVulnerability, source mdmlab.VulnerabilitySource) (int64, error) {
	s.mu.Lock()
...
func (s *DataStore) DeleteOSVulnerabilities(ctx context.Context, vulnerabilities []mdmlab.OSVulnerability) error {
	s.mu.Lock()
...
func (s *DataStore) InsertOSVulnerability(ctx context.Context, vuln mdmlab.OSVulnerability, source mdmlab.VulnerabilitySource) (bool, error) {
	s.mu.Lock()
...
func (s *DataStore) DeleteOutOfDateOSVulnerabilities(ctx context.Context, source mdmlab.VulnerabilitySource, duration time.Duration) error {
	s.mu.Lock()
...
func (s *DataStore) ListVulnerabilities(ctx context.Context, opt mdmlab.VulnListOptions) ([]mdmlab.VulnerabilityWithMetadata, *mdmlab.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) Vulnerability(ctx context.Context, cve string, teamID *uint, includeCVEScores bool) (*mdmlab.VulnerabilityWithMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) CountVulnerabilities(ctx context.Context, opt mdmlab.VulnListOptions) (uint, error) {
	s.mu.Lock()
...
func (s *DataStore) IsCVEKnownToMDMlab(ctx context.Context, cve string) (bool, error) {
	s.mu.Lock()
	s.IsCVEKnownToMDMlabFuncInvoked = true
	s.mu.Unlock()
	return s.IsCVEKnownToMDMlabFunc(ctx, cve)
}

func (s *DataStore) NewMDMAppleConfigProfile(ctx context.Context, p mdmlab.MDMAppleConfigProfile) (*mdmlab.MDMAppleConfigProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) BulkUpsertMDMAppleConfigProfiles(ctx context.Context, payload []*mdmlab.MDMAppleConfigProfile) error {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleConfigProfileByDeprecatedID(ctx context.Context, profileID uint) (*mdmlab.MDMAppleConfigProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleConfigProfile(ctx context.Context, profileUUID string) (*mdmlab.MDMAppleConfigProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleDeclaration(ctx context.Context, declUUID string) (*mdmlab.MDMAppleDeclaration, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMAppleConfigProfiles(ctx context.Context, teamID *uint) ([]*mdmlab.MDMAppleConfigProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) BulkDeleteMDMAppleHostsConfigProfiles(ctx context.Context, payload []*mdmlab.MDMAppleProfilePayload) error {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMAppleProfiles(ctx context.Context, hostUUID string) ([]mdmlab.HostMDMAppleProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) NewMDMAppleEnrollmentProfile(ctx context.Context, enrollmentPayload mdmlab.MDMAppleEnrollmentProfilePayload) (*mdmlab.MDMAppleEnrollmentProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleEnrollmentProfileByToken(ctx context.Context, token string) (*mdmlab.MDMAppleEnrollmentProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleEnrollmentProfileByType(ctx context.Context, typ mdmlab.MDMAppleEnrollmentType) (*mdmlab.MDMAppleEnrollmentProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMAppleEnrollmentProfiles(ctx context.Context) ([]*mdmlab.MDMAppleEnrollmentProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleCommandResults(ctx context.Context, commandUUID string) ([]*mdmlab.MDMCommandResult, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMAppleCommands(ctx context.Context, tmFilter mdmlab.TeamFilter, listOpts *mdmlab.MDMCommandListOptions) ([]*mdmlab.MDMAppleCommand, error) {
	s.mu.Lock()
...
func (s *DataStore) NewMDMAppleInstaller(ctx context.Context, name string, size int64, manifest string, installer []byte, urlToken string) (*mdmlab.MDMAppleInstaller, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleInstaller(ctx context.Context, token string) (*mdmlab.MDMAppleInstaller, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleInstallerDetailsByID(ctx context.Context, id uint) (*mdmlab.MDMAppleInstaller, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleInstallerDetailsByToken(ctx context.Context, token string) (*mdmlab.MDMAppleInstaller, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMAppleInstallers(ctx context.Context) ([]mdmlab.MDMAppleInstaller, error) {
	s.mu.Lock()
...
func (s *DataStore) BatchSetMDMAppleProfiles(ctx context.Context, tmID *uint, profiles []*mdmlab.MDMAppleConfigProfile) error {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleListDevices(ctx context.Context) ([]mdmlab.MDMAppleDevice, error) {
	s.mu.Lock()
...
func (s *DataStore) UpsertMDMAppleHostDEPAssignments(ctx context.Context, hosts []mdmlab.Host, abmTokenID uint) error {
	s.mu.Lock()
...
func (s *DataStore) IngestMDMAppleDevicesFromDEPSync(ctx context.Context, devices []godep.Device, abmTokenID uint, macOSTeam *mdmlab.Team, iosTeam *mdmlab.Team, ipadTeam *mdmlab.Team) (int64, error) {
	s.mu.Lock()
...
func (s *DataStore) IngestMDMAppleDeviceFromOTAEnrollment(ctx context.Context, teamID *uint, deviceInfo mdmlab.MDMAppleMachineInfo) error {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleUpsertHost(ctx context.Context, mdmHost *mdmlab.Host) error {
	s.mu.Lock()
...
func (s *DataStore) RestoreMDMApplePendingDEPHost(ctx context.Context, host *mdmlab.Host) error {
	s.mu.Lock()
...
func (s *DataStore) GetHostDEPAssignment(ctx context.Context, hostID uint) (*mdmlab.HostDEPAssignment, error) {
	s.mu.Lock()
...
func (s *DataStore) GetNanoMDMEnrollment(ctx context.Context, id string) (*mdmlab.NanoEnrollment, error) {
	s.mu.Lock()
...
func (s *DataStore) OutdatedAutomationBatch(ctx context.Context) ([]mdmlab.PolicyFailure, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMAppleProfilesToInstall(ctx context.Context) ([]*mdmlab.MDMAppleProfilePayload, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMAppleProfilesToRemove(ctx context.Context) ([]*mdmlab.MDMAppleProfilePayload, error) {
	s.mu.Lock()
...
func (s *DataStore) BulkUpsertMDMAppleHostProfiles(ctx context.Context, payload []*mdmlab.MDMAppleBulkUpsertHostProfilePayload) error {
	s.mu.Lock()
...
func (s *DataStore) BulkSetPendingMDMHostProfiles(ctx context.Context, hostIDs []uint, teamIDs []uint, profileUUIDs []string, hostUUIDs []string) (updates mdmlab.MDMProfilesUpdates, err error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateOrDeleteHostMDMAppleProfile(ctx context.Context, profile *mdmlab.HostMDMAppleProfile) error {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleProfilesSummary(ctx context.Context, teamID *uint) (*mdmlab.MDMProfilesSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertMDMIdPAccount(ctx context.Context, account *mdmlab.MDMIdPAccount) error {
	s.mu.Lock()
...
func (s *DataStore) GetMDMIdPAccountByUUID(ctx context.Context, uuid string) (*mdmlab.MDMIdPAccount, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMIdPAccountByEmail(ctx context.Context, email string) (*mdmlab.MDMIdPAccount, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleFileVaultSummary(ctx context.Context, teamID *uint) (*mdmlab.MDMAppleFileVaultSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertMDMAppleBootstrapPackage(ctx context.Context, bp *mdmlab.MDMAppleBootstrapPackage, pkgStore mdmlab.MDMBootstrapPackageStore) error {
	s.mu.Lock()
...
func (s *DataStore) CopyDefaultMDMAppleBootstrapPackage(ctx context.Context, ac *mdmlab.AppConfig, toTeamID uint) error {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleBootstrapPackageMeta(ctx context.Context, teamID uint) (*mdmlab.MDMAppleBootstrapPackage, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleBootstrapPackageBytes(ctx context.Context, token string, pkgStore mdmlab.MDMBootstrapPackageStore) (*mdmlab.MDMAppleBootstrapPackage, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleBootstrapPackageSummary(ctx context.Context, teamID uint) (*mdmlab.MDMAppleBootstrapPackageSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) CleanupUnusedBootstrapPackages(ctx context.Context, pkgStore mdmlab.MDMBootstrapPackageStore, removeCreatedBefore time.Time) error {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMMacOSSetup(ctx context.Context, hostID uint) (*mdmlab.HostMDMMacOSSetup, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMGetEULAMetadata(ctx context.Context) (*mdmlab.MDMEULA, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMGetEULABytes(ctx context.Context, token string) (*mdmlab.MDMEULA, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMInsertEULA(ctx context.Context, eula *mdmlab.MDMEULA) error {
	s.mu.Lock()
...
func (s *DataStore) SetOrUpdateMDMAppleSetupAssistant(ctx context.Context, asst *mdmlab.MDMAppleSetupAssistant) (*mdmlab.MDMAppleSetupAssistant, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleSetupAssistant(ctx context.Context, teamID *uint) (*mdmlab.MDMAppleSetupAssistant, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMatchingHostSerials(ctx context.Context, serials []string) (map[string]*mdmlab.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleDDMDeclarationsToken(ctx context.Context, hostUUID string) (*mdmlab.MDMAppleDDMDeclarationsToken, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleDDMDeclarationItems(ctx context.Context, hostUUID string) ([]mdmlab.MDMAppleDDMDeclarationItem, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleDDMDeclarationsResponse(ctx context.Context, identifier string, hostUUID string) (*mdmlab.MDMAppleDeclaration, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleStoreDDMStatusReport(ctx context.Context, hostUUID string, updates []*mdmlab.MDMAppleHostDeclaration) error {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleSetPendingDeclarationsAs(ctx context.Context, hostUUID string, status *mdmlab.MDMDeliveryStatus, detail string) error {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleOSUpdatesSettingsByHostSerial(ctx context.Context, hostSerial string) (*mdmlab.AppleOSUpdateSettings, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertMDMConfigAssets(ctx context.Context, assets []mdmlab.MDMConfigAsset, tx sqlx.ExtContext) error {
	s.mu.Lock()
...
func (s *DataStore) GetAllMDMConfigAssetsByName(ctx context.Context, assetNames []mdmlab.MDMAssetName, queryerContext sqlx.QueryerContext) (map[mdmlab.MDMAssetName]mdmlab.MDMConfigAsset, error) {
	s.mu.Lock()
...
func (s *DataStore) GetAllMDMConfigAssetsHashes(ctx context.Context, assetNames []mdmlab.MDMAssetName) (map[mdmlab.MDMAssetName]string, error) {
	s.mu.Lock()
...
func (s *DataStore) DeleteMDMConfigAssetsByName(ctx context.Context, assetNames []mdmlab.MDMAssetName) error {
	s.mu.Lock()
...
func (s *DataStore) HardDeleteMDMConfigAsset(ctx context.Context, assetName mdmlab.MDMAssetName) error {
	s.mu.Lock()
...
func (s *DataStore) ReplaceMDMConfigAssets(ctx context.Context, assets []mdmlab.MDMConfigAsset, tx sqlx.ExtContext) error {
	s.mu.Lock()
...
func (s *DataStore) GetABMTokenByOrgName(ctx context.Context, orgName string) (*mdmlab.ABMToken, error) {
	s.mu.Lock()
...
func (s *DataStore) SaveABMToken(ctx context.Context, tok *mdmlab.ABMToken) error {
	s.mu.Lock()
...
func (s *DataStore) InsertVPPToken(ctx context.Context, tok *mdmlab.VPPTokenData) (*mdmlab.VPPTokenDB, error) {
	s.mu.Lock()
...
func (s *DataStore) ListVPPTokens(ctx context.Context) ([]*mdmlab.VPPTokenDB, error) {
	s.mu.Lock()
...
func (s *DataStore) GetVPPToken(ctx context.Context, tokenID uint) (*mdmlab.VPPTokenDB, error) {
	s.mu.Lock()
...
func (s *DataStore) GetVPPTokenByTeamID(ctx context.Context, teamID *uint) (*mdmlab.VPPTokenDB, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateVPPTokenTeams(ctx context.Context, id uint, teams []uint) (*mdmlab.VPPTokenDB, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateVPPToken(ctx context.Context, id uint, tok *mdmlab.VPPTokenData) (*mdmlab.VPPTokenDB, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertABMToken(ctx context.Context, tok *mdmlab.ABMToken) (*mdmlab.ABMToken, error) {
	s.mu.Lock()
...
func (s *DataStore) ListABMTokens(ctx context.Context) ([]*mdmlab.ABMToken, error) {
	s.mu.Lock()
...
func (s *DataStore) GetABMTokenByID(ctx context.Context, tokenID uint) (*mdmlab.ABMToken, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMWindowsInsertEnrolledDevice(ctx context.Context, device *mdmlab.MDMWindowsEnrolledDevice) error {
	s.mu.Lock()
...
func (s *DataStore) MDMWindowsGetEnrolledDeviceWithDeviceID(ctx context.Context, mdmDeviceID string) (*mdmlab.MDMWindowsEnrolledDevice, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMWindowsInsertCommandForHosts(ctx context.Context, hostUUIDs []string, cmd *mdmlab.MDMWindowsCommand) error {
	s.mu.Lock()
...
func (s *DataStore) MDMWindowsGetPendingCommands(ctx context.Context, deviceID string) ([]*mdmlab.MDMWindowsCommand, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMWindowsSaveResponse(ctx context.Context, deviceID string, enrichedSyncML mdmlab.EnrichedSyncML) error {
	s.mu.Lock()
...
func (s *DataStore) GetMDMWindowsCommandResults(ctx context.Context, commandUUID string) ([]*mdmlab.MDMCommandResult, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMWindowsConfigProfile(ctx context.Context, profileUUID string) (*mdmlab.MDMWindowsConfigProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMWindowsProfiles(ctx context.Context, hostUUID string) ([]mdmlab.HostMDMWindowsProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMConfigProfiles(ctx context.Context, teamID *uint, opt mdmlab.ListOptions) ([]*mdmlab.MDMConfigProfilePayload, *mdmlab.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMProfileInstallStatus(ctx context.Context, hostUUID string, profileUUID string) (mdmlab.MDMDeliveryStatus, error) {
	s.mu.Lock()
...
func (s *DataStore) GetLinuxDiskEncryptionSummary(ctx context.Context, teamID *uint) (mdmlab.MDMLinuxDiskEncryptionSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMCommands(ctx context.Context, tmFilter mdmlab.TeamFilter, listOpts *mdmlab.MDMCommandListOptions) ([]*mdmlab.MDMCommand, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMWindowsBitLockerSummary(ctx context.Context, teamID *uint) (*mdmlab.MDMWindowsBitLockerSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMWindowsBitLockerStatus(ctx context.Context, host *mdmlab.Host) (*mdmlab.HostMDMDiskEncryption, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMWindowsProfilesSummary(ctx context.Context, teamID *uint) (*mdmlab.MDMProfilesSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMWindowsProfilesToInstall(ctx context.Context) ([]*mdmlab.MDMWindowsProfilePayload, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMWindowsProfilesToRemove(ctx context.Context) ([]*mdmlab.MDMWindowsProfilePayload, error) {
	s.mu.Lock()
...
func (s *DataStore) BulkUpsertMDMWindowsHostProfiles(ctx context.Context, payload []*mdmlab.MDMWindowsBulkUpsertHostProfilePayload) error {
	s.mu.Lock()
...
func (s *DataStore) BulkDeleteMDMWindowsHostsConfigProfiles(ctx context.Context, payload []*mdmlab.MDMWindowsProfilePayload) error {
	s.mu.Lock()
...
func (s *DataStore) NewMDMWindowsConfigProfile(ctx context.Context, cp mdmlab.MDMWindowsConfigProfile) (*mdmlab.MDMWindowsConfigProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) SetOrUpdateMDMWindowsConfigProfile(ctx context.Context, cp mdmlab.MDMWindowsConfigProfile) error {
	s.mu.Lock()
...
func (s *DataStore) BatchSetMDMProfiles(ctx context.Context, tmID *uint, macProfiles []*mdmlab.MDMAppleConfigProfile, winProfiles []*mdmlab.MDMWindowsConfigProfile, macDeclarations []*mdmlab.MDMAppleDeclaration) (updates mdmlab.MDMProfilesUpdates, err error) {
	s.mu.Lock()
...
func (s *DataStore) NewMDMAppleDeclaration(ctx context.Context, declaration *mdmlab.MDMAppleDeclaration) (*mdmlab.MDMAppleDeclaration, error) {
	s.mu.Lock()
...
func (s *DataStore) SetOrUpdateMDMAppleDeclaration(ctx context.Context, declaration *mdmlab.MDMAppleDeclaration) (*mdmlab.MDMAppleDeclaration, error) {
	s.mu.Lock()
...
func (s *DataStore) NewHostScriptExecutionRequest(ctx context.Context, request *mdmlab.HostScriptRequestPayload) (*mdmlab.HostScriptResult, error) {
	s.mu.Lock()
...
func (s *DataStore) NewInternalScriptExecutionRequest(ctx context.Context, request *mdmlab.HostScriptRequestPayload) (*mdmlab.HostScriptResult, error) {
	s.mu.Lock()
...
func (s *DataStore) SetHostScriptExecutionResult(ctx context.Context, result *mdmlab.HostScriptResultPayload) (hsr *mdmlab.HostScriptResult, action string, err error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostScriptExecutionResult(ctx context.Context, execID string) (*mdmlab.HostScriptResult, error) {
	s.mu.Lock()
...
func (s *DataStore) ListPendingHostScriptExecutions(ctx context.Context, hostID uint, onlyShowInternal bool) ([]*mdmlab.HostScriptResult, error) {
	s.mu.Lock()
...
func (s *DataStore) NewScript(ctx context.Context, script *mdmlab.Script) (*mdmlab.Script, error) {
	s.mu.Lock()
...
func (s *DataStore) Script(ctx context.Context, id uint) (*mdmlab.Script, error) {
	s.mu.Lock()
...
func (s *DataStore) ListScripts(ctx context.Context, teamID *uint, opt mdmlab.ListOptions) ([]*mdmlab.Script, *mdmlab.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostScriptDetails(ctx context.Context, hostID uint, teamID *uint, opts mdmlab.ListOptions, hostPlatform string) ([]*mdmlab.HostScriptDetail, *mdmlab.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) BatchSetScripts(ctx context.Context, tmID *uint, scripts []*mdmlab.Script) ([]mdmlab.ScriptResponse, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostLockWipeStatus(ctx context.Context, host *mdmlab.Host) (*mdmlab.HostLockWipeStatus, error) {
	s.mu.Lock()
...
func (s *DataStore) LockHostViaScript(ctx context.Context, request *mdmlab.HostScriptRequestPayload, hostMDMlabPlatform string) error {
	s.mu.Lock()
	s.LockHostViaScriptFuncInvoked = true
	s.mu.Unlock()
	return s.LockHostViaScriptFunc(ctx, request, hostMDMlabPlatform)
}

func (s *DataStore) UnlockHostViaScript(ctx context.Context, request *mdmlab.HostScriptRequestPayload, hostMDMlabPlatform string) error {
	s.mu.Lock()
	s.UnlockHostViaScriptFuncInvoked = true
	s.mu.Unlock()
	return s.UnlockHostViaScriptFunc(ctx, request, hostMDMlabPlatform)
}

func (s *DataStore) UnlockHostManually(ctx context.Context, hostID uint, hostMDMlabPlatform string, ts time.Time) error {
	s.mu.Lock()
	s.UnlockHostManuallyFuncInvoked = true
	s.mu.Unlock()
	return s.UnlockHostManuallyFunc(ctx, hostID, hostMDMlabPlatform, ts)
}
...
func (s *DataStore) WipeHostViaScript(ctx context.Context, request *mdmlab.HostScriptRequestPayload, hostMDMlabPlatform string) error {
	s.mu.Lock()
	s.WipeHostViaScriptFuncInvoked = true
	s.mu.Unlock()
	return s.WipeHostViaScriptFunc(ctx, request, hostMDMlabPlatform)
}

func (s *DataStore) WipeHostViaWindowsMDM(ctx context.Context, host *mdmlab.Host, cmd *mdmlab.MDMWindowsCommand) error {
	s.mu.Lock()
...
func (s *DataStore) GetSoftwareInstallDetails(ctx context.Context, executionId string) (*mdmlab.SoftwareInstallDetails, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostLastInstallData(ctx context.Context, hostID uint, installerID uint) (*mdmlab.HostLastInstallData, error) {
	s.mu.Lock()
...
func (s *DataStore) MatchOrCreateSoftwareInstaller(ctx context.Context, payload *mdmlab.UploadSoftwareInstallerPayload) (installerID uint, titleID uint, err error) {
	s.mu.Lock()
...
func (s *DataStore) GetSoftwareInstallerMetadataByID(ctx context.Context, id uint) (*mdmlab.SoftwareInstaller, error) {
	s.mu.Lock()
...
func (s *DataStore) GetSoftwareInstallerMetadataByTeamAndTitleID(ctx context.Context, teamID *uint, titleID uint, withScriptContents bool) (*mdmlab.SoftwareInstaller, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateSoftwareInstallerWithoutPackageIDs(ctx context.Context, id uint, payload mdmlab.UploadSoftwareInstallerPayload) error {
	s.mu.Lock()
...
func (s *DataStore) SaveInstallerUpdates(ctx context.Context, payload *mdmlab.UpdateSoftwareInstallerPayload) error {
	s.mu.Lock()
...
func (s *DataStore) GetVPPAppByTeamAndTitleID(ctx context.Context, teamID *uint, titleID uint) (*mdmlab.VPPApp, error) {
	s.mu.Lock()
...
func (s *DataStore) GetVPPAppMetadataByTeamAndTitleID(ctx context.Context, teamID *uint, titleID uint) (*mdmlab.VPPAppStoreApp, error) {
	s.mu.Lock()
...
func (s *DataStore) GetTitleInfoFromVPPAppsTeamsID(ctx context.Context, vppAppsTeamsID uint) (*mdmlab.PolicySoftwareTitle, error) {
	s.mu.Lock()
...
func (s *DataStore) GetVPPAppMetadataByAdamIDAndPlatform(ctx context.Context, adamID string, platform mdmlab.AppleDevicePlatform) (*mdmlab.VPPApp, error) {
	s.mu.Lock()
...
func (s *DataStore) DeleteVPPAppFromTeam(ctx context.Context, teamID *uint, appID mdmlab.VPPAppID) error {
	s.mu.Lock()
...
func (s *DataStore) GetSummaryHostSoftwareInstalls(ctx context.Context, installerID uint) (*mdmlab.SoftwareInstallerStatusSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) GetSummaryHostVPPAppInstalls(ctx context.Context, teamID *uint, appID mdmlab.VPPAppID) (*mdmlab.VPPAppStatusSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) GetSoftwareInstallResults(ctx context.Context, resultsUUID string) (*mdmlab.HostSoftwareInstallerResult, error) {
	s.mu.Lock()
...
func (s *DataStore) CleanupUnusedSoftwareInstallers(ctx context.Context, softwareInstallStore mdmlab.SoftwareInstallerStore, removeCreatedBefore time.Time) error {
	s.mu.Lock()
...
func (s *DataStore) BatchSetSoftwareInstallers(ctx context.Context, tmID *uint, installers []*mdmlab.UploadSoftwareInstallerPayload) error {
	s.mu.Lock()
...
func (s *DataStore) GetSoftwareInstallers(ctx context.Context, tmID uint) ([]mdmlab.SoftwarePackageResponse, error) {
	s.mu.Lock()
...
func (s *DataStore) BatchInsertVPPApps(ctx context.Context, apps []*mdmlab.VPPApp) error {
	s.mu.Lock()
...
func (s *DataStore) GetAssignedVPPApps(ctx context.Context, teamID *uint) (map[mdmlab.VPPAppID]mdmlab.VPPAppTeam, error) {
	s.mu.Lock()
...
func (s *DataStore) GetVPPApps(ctx context.Context, teamID *uint) ([]mdmlab.VPPAppResponse, error) {
	s.mu.Lock()
...
func (s *DataStore) SetTeamVPPApps(ctx context.Context, teamID *uint, appIDs []mdmlab.VPPAppTeam) error {
	s.mu.Lock()
...
func (s *DataStore) InsertVPPAppWithTeam(ctx context.Context, app *mdmlab.VPPApp, teamID *uint) (*mdmlab.VPPApp, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertHostVPPSoftwareInstall(ctx context.Context, hostID uint, appID mdmlab.VPPAppID, commandUUID string, associatedEventID string, selfService bool, policyID *uint) error {
	s.mu.Lock()
...
func (s *DataStore) GetPastActivityDataForVPPAppInstall(ctx context.Context, commandResults *mdm.CommandResults) (*mdmlab.User, *mdmlab.ActivityInstalledAppStoreApp, error) {
	s.mu.Lock()
...
func (s *DataStore) GetVPPTokenByLocation(ctx context.Context, loc string) (*mdmlab.VPPTokenDB, error) {
	s.mu.Lock()
...
func (s *DataStore) ListSetupExperienceSoftwareTitles(ctx context.Context, teamID uint, opts mdmlab.ListOptions) ([]mdmlab.SoftwareTitleListResult, int, *mdmlab.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) ListSetupExperienceResultsByHostUUID(ctx context.Context, hostUUID string) ([]*mdmlab.SetupExperienceStatusResult, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateSetupExperienceStatusResult(ctx context.Context, status *mdmlab.SetupExperienceStatusResult) error {
	s.mu.Lock()
...
func (s *DataStore) GetSetupExperienceScript(ctx context.Context, teamID *uint) (*mdmlab.Script, error) {
	s.mu.Lock()
...
func (s *DataStore) GetSetupExperienceScriptByID(ctx context.Context, scriptID uint) (*mdmlab.Script, error) {
	s.mu.Lock()
...
func (s *DataStore) SetSetupExperienceScript(ctx context.Context, script *mdmlab.Script) error {
	s.mu.Lock()
...
func (s *DataStore) MaybeUpdateSetupExperienceScriptStatus(ctx context.Context, hostUUID string, executionID string, status mdmlab.SetupExperienceStatusResultStatus) (bool, error) {
	s.mu.Lock()
...
func (s *DataStore) MaybeUpdateSetupExperienceSoftwareInstallStatus(ctx context.Context, hostUUID string, executionID string, status mdmlab.SetupExperienceStatusResultStatus) (bool, error) {
	s.mu.Lock()
...
func (s *DataStore) MaybeUpdateSetupExperienceVPPStatus(ctx context.Context, hostUUID string, commandUUID string, status mdmlab.SetupExperienceStatusResultStatus) (bool, error) {
	s.mu.Lock()
...
func (s *DataStore) ListAvailableMDMlabMaintainedApps(ctx context.Context, teamID *uint, opt mdmlab.ListOptions) ([]mdmlab.MaintainedApp, *mdmlab.PaginationMetadata, error) {
	s.mu.Lock()
	s.ListAvailableMDMlabMaintainedAppsFuncInvoked = true
	s.mu.Unlock()
	return s.ListAvailableMDMlabMaintainedAppsFunc(ctx, teamID, opt)
}

func (s *DataStore) GetMaintainedAppByID(ctx context.Context, appID uint) (*mdmlab.MaintainedApp, error) {
	s.mu.Lock()
...
func (s *DataStore) UpsertMaintainedApp(ctx context.Context, app *mdmlab.MaintainedApp) (*mdmlab.MaintainedApp, error) {
	s.mu.Lock()
...
func (s *DataStore) BulkUpsertMDMManagedCertificates(ctx context.Context, payload []*mdmlab.MDMBulkUpsertManagedCertificatePayload) error {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMCertificateProfile(ctx context.Context, hostUUID string, profileUUID string) (*mdmlab.HostMDMCertificateProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) UpsertSecretVariables(ctx context.Context, secretVariables []mdmlab.SecretVariable) error {
	s.mu.Lock()
...
func (s *DataStore) GetSecretVariables(ctx context.Context, names []string) ([]mdmlab.SecretVariable, error) {
	s.mu.Lock()
