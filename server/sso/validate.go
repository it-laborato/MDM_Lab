...
type Validator interface {
	ValidateSignature(auth mdmlab.Auth) (mdmlab.Auth, error)
	ValidateResponse(auth mdmlab.Auth) error
}
...
func (v *validator) ValidateResponse(auth mdmlab.Auth) error {
	info := auth.(*resp)
...
func (v *validator) ValidateSignature(auth mdmlab.Auth) (mdmlab.Auth, error) {
	info := auth.(*resp)
...
func ValidateAudiences(metadata Metadata, auth mdmlab.Auth, audiences ...string) error {
