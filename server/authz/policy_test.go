...
const (
	read          = mdmlab.ActionRead
	list          = mdmlab.ActionList
	write         = mdmlab.ActionWrite
	writeRole     = mdmlab.ActionWriteRole
	run           = mdmlab.ActionRun
	runNew        = mdmlab.ActionRunNew
	changePwd     = mdmlab.ActionChangePassword
	selectiveRead = mdmlab.ActionSelectiveRead
	selectiveList = mdmlab.ActionSelectiveList
)
...
func TestAuthorizeSession(t *testing.T) {
	...
	session := &mdmlab.Session{UserID: 42}
	runTestCases(t, []authTestCase{
		...
		{user: test.UserMaintainer, object: &mdmlab.Session{UserID: test.UserMaintainer.ID}, action: read, allow: true},
		{user: test.UserMaintainer, object: &mdmlab.Session{UserID: test.UserMaintainer.ID}, action: write, allow: true},
		...
		{user: test.UserNoRoles, object: &mdmlab.Session{UserID: test.UserNoRoles.ID}, action: read, allow: true},
		{user: test.UserNoRoles, object: &mdmlab.Session{UserID: test.UserNoRoles.ID}, action: write, allow: true},
		...
		{user: test.UserObserver, object: &mdmlab.Session{UserID: test.UserObserver.ID}, action: read, allow: true},
		{user: test.UserObserver, object: &mdmlab.Session{UserID: test.UserObserver.ID}, action: write, allow: true},
		...
		{user: test.UserObserverPlus, object: &mdmlab.Session{UserID: test.UserObserverPlus.ID}, action: read, allow: true},
		{user: test.UserObserverPlus, object: &mdmlab.Session{UserID: test.UserObserverPlus.ID}, action: write, allow: true},
	})
}
...
func TestAuthorizeUser(t *testing.T) {
	...
	newUser := &mdmlab.User{}
	user := &mdmlab.User{ID: 42}
	newTeamUser := &mdmlab.User{
		Teams: []mdmlab.UserTeam{{Team: mdmlab.Team{ID: 1}, Role: mdmlab.RoleObserver}},
	}
	teamAdmin := &mdmlab.User{
		ID:    101,
		Teams: []mdmlab.UserTeam{{Team: mdmlab.Team{ID: 1}, Role: mdmlab.RoleAdmin}},
	}
...
func TestAuthorizeEnrollSecret(t *testing.T) {
	...
	teamAdmin := &mdmlab.User{
		Teams: []mdmlab.UserTeam{
			{Team: mdmlab.Team{ID: 1}, Role: mdmlab.RoleAdmin},
		},
	}
	teamMaintainer := &mdmlab.User{
		Teams: []mdmlab.UserTeam{
			{Team: mdmlab.Team{ID: 1}, Role: mdmlab.RoleMaintainer},
		},
	}
	teamObserver := &mdmlab.User{
		Teams: []mdmlab.UserTeam{
			{Team: mdmlab.Team{ID: 1}, Role: mdmlab.RoleObserver},
		},
	}
	teamObserverPlus := &mdmlab.User{
		Teams: []mdmlab.UserTeam{
			{Team: mdmlab.Team{ID: 1}, Role: mdmlab.RoleObserverPlus},
		},
	}
	teamGitOps := &mdmlab.User{
		Teams: []mdmlab.UserTeam{
			{Team: mdmlab.Team{ID: 1}, Role: mdmlab.RoleGitOps},
		},
	}
	globalSecret := &mdmlab.EnrollSecret{TeamID: nil}
	teamSecret := &mdmlab.EnrollSecret{TeamID: ptr.Uint(1)}
	runTestCases(t, []authTestCase{
		// No access
...
func TestAuthorizeTeam(t *testing.T) {
	...
	team := &mdmlab.Team{} // Empty team is used to "list teams"
	team1 := &mdmlab.Team{ID: 1}
	team2 := &mdmlab.Team{ID: 2}
	runTestCases(t, []authTestCase{
...
func TestAuthorizeSoftwareInventory(t *testing.T) {
	...
	softwareInventory := &mdmlab.AuthzSoftwareInventory{}
	runTestCases(t, []authTestCase{
...
func TestAuthorizeSoftwareInstaller(t *testing.T) {
	...
	noTeamInstaller := &mdmlab.SoftwareInstaller{}
	team1Installer := &mdmlab.SoftwareInstaller{TeamID: ptr.Uint(1)}
	team2Installer := &mdmlab.SoftwareInstaller{TeamID: ptr.Uint(2)}
	runTestCases(t, []authTestCase{
...
func TestAuthorizeHostSoftwareInstallerResult(t *testing.T) {
	...
	noTeamInstallResult := &mdmlab.HostSoftwareInstallerResultAuthz{}
	team1InstallResult := &mdmlab.HostSoftwareInstallerResultAuthz{HostTeamID: ptr.Uint(1)}
	team2InstallResult := &mdmlab.HostSoftwareInstallerResultAuthz{HostTeamID: ptr.Uint(2)}
	runTestCases(t, []authTestCase{
		// Write permissions
...
func TestAuthorizeHost(t *testing.T) {
	...
	host := &mdmlab.Host{}
	hostTeam1 := &mdmlab.Host{TeamID: ptr.Uint(1)}
	hostTeam2 := &mdmlab.Host{TeamID: ptr.Uint(2)}
	runTestCases(t, []authTestCase{
		// No access
...
func TestAuthorizeQuery(t *testing.T) {
	...
	twoTeamsAdminObs := &mdmlab.User{
		ID: 103,
		Teams: []mdmlab.UserTeam{
			{Team: mdmlab.Team{ID: 1}, Role: mdmlab.RoleAdmin},
			{Team: mdmlab.Team{ID: 2}, Role: mdmlab.RoleObserver},
		},
	}
	teamObserverPlus := &mdmlab.User{
		ID: 104,
	...
	globalQueryNoTargets := &mdmlab.TargetedQuery{
		Query: globalQuery,
	}

	globalQueryTargetedToTeam1 := &mdmlab.TargetedQuery{
		HostTargets: mdmlab.HostTargets{TeamIDs: []uint{1}},
		Query:       globalQuery,
	}
	globalQueryTargetedToTeam1AndTeam2 := &mdmlab.TargetedQuery{
		HostTargets: mdmlab.HostTargets{TeamIDs: []uint{1, 2}},
		Query:       globalQuery,
	}
	globalQueryTargetedToTeam2 := &mdmlab.TargetedQuery{
		HostTargets: mdmlab.HostTargets{TeamIDs: []uint{2}},
		Query:       globalQuery,
	}
	globalQueryTargetedToTeam1AndTeam2AndTeam3 := &mdmlab.TargetedQuery{
		HostTargets: mdmlab.HostTargets{TeamIDs: []uint{1, 2, 3}},
		Query:       globalQuery,
	}

	globalObserverQuery := &mdmlab.Query{
		ObserverCanRun: true,
	}
	globalObserverQueryEmptyTargets := &mdmlab.TargetedQuery{
		Query: globalObserverQuery,
	}
	globalObserverQueryTargetedToTeam1 := &mdmlab.TargetedQuery{
		HostTargets: mdmlab.HostTargets{TeamIDs: []uint{1}},
		Query:       globalObserverQuery,
	}
	globalObserverQueryTargetedToTeam1AndTeam2 := &mdmlab.TargetedQuery{
		HostTargets: mdmlab.HostTargets{TeamIDs: []uint{1, 2}},
		Query:       globalObserverQuery,
	}
	globalObserverQueryTargetedToTeam2 := &mdmlab.TargetedQuery{
		HostTargets: mdmlab.HostTargets{TeamIDs: []uint{2}},
		Query:       globalObserverQuery,
	}
	globalObserverQueryTargetedToTeam1AndTeam2AndTeam3 := &mdmlab.TargetedQuery{
		HostTargets: mdmlab.HostTargets{TeamIDs: []uint{1, 2, 3}},
		Query:       globalObserverQuery,
	}

	teamAdminQuery := &mdmlab.Query{
		ID:             1,
		AuthorID:       ptr.Uint(teamAdmin.ID),
		ObserverCanRun: false,
		TeamID:         ptr.Uint(1),
	}
	teamMaintQuery := &mdmlab.Query{
		ID:             2,
		AuthorID:       ptr.Uint(teamMaintainer.ID),
		ObserverCanRun: false,
		TeamID:         ptr.Uint(1),
	}
	globalAdminQuery := &mdmlab.Query{ID: 3, AuthorID: ptr.Uint(test.UserAdmin.ID), ObserverCanRun: false}
	globalGitOpsQuery := &mdmlab.Query{ID: 4, AuthorID: ptr.Uint(test.UserGitOps.ID), ObserverCanRun: false}
	teamGitOpsQuery := &mdmlab.Query{
		ID: 5, AuthorID: ptr.Uint(teamGitOps.ID),
		ObserverCanRun: false,
		TeamID:         ptr.Uint(1),
	}
	observerQueryOnTeam3 := &mdmlab.Query{
		ID:             6,
		ObserverCanRun: true,
		TeamID:         ptr.Uint(3),
	}
	observerQueryOnTeam3TargetedToTeam3 := &mdmlab.TargetedQuery{
		HostTargets: mdmlab.HostTargets{TeamIDs: []uint{3}},
		Query:       observerQueryOnTeam3,
	}
	observerQueryOnTeam3TargetedToTeam2 := &mdmlab.TargetedQuery{
		HostTargets: mdmlab.HostTargets{TeamIDs: []uint{2}},
		Query:       observerQueryOnTeam3,
	}
	observerQueryOnTeam3TargetedToTeam1 := &mdmlab.TargetedQuery{
		HostTargets: mdmlab.HostTargets{TeamIDs: []uint{1}},
		Query:       observerQueryOnTeam3,
	}
	observerQueryOnTeam1 := &mdmlab.Query{
		ID:             7,
		ObserverCanRun: true,
		TeamID:         ptr.Uint(1),
	}
	observerQueryOnTeam1TargetedToTeam1 := &mdmlab.TargetedQuery{
		HostTargets: mdmlab.HostTargets{TeamIDs: []uint{1}},
		Query:       observerQueryOnTeam1,
	}
	observerQueryOnTeam1TargetedToTeam2 := &mdmlab.TargetedQuery{
		HostTargets: mdmlab.HostTargets{TeamIDs: []uint{2}},
		Query:       observerQueryOnTeam1,
	}
...
func TestAuthorizeTeamPolicy(t *testing.T) {
	...
	team1Policy := &mdmlab.Policy{
		PolicyData: mdmlab.PolicyData{
			TeamID: ptr.Uint(1),
		},
	}
	team2Policy := &mdmlab.Policy{
		PolicyData: mdmlab.PolicyData{
			TeamID: ptr.Uint(2),
		},
	}
...
func TestAuthorizeMDMConfigProfile(t *testing.T) {
	...
	globalProfile := &mdmlab.MDMConfigProfileAuthz{}
	team1Profile := &mdmlab.MDMConfigProfileAuthz{
		TeamID: ptr.Uint(1),
	}
	runTestCases(t, []authTestCase{
...
func TestAuthorizeMDMAppleSettings(t *testing.T) {
	...
	globalSettings := &mdmlab.MDMAppleSettingsPayload{}
	team1Settings := &mdmlab.MDMAppleSettingsPayload{
		TeamID: ptr.Uint(1),
	}
	runTestCases(t, []authTestCase{
...
func TestAuthorizeMDMAppleSetupAssistant(t *testing.T) {
	...
	globalSettings := &mdmlab.MDMAppleSetupAssistant{}
	team1Settings := &mdmlab.MDMAppleSetupAssistant{
		TeamID: ptr.Uint(1),
	}
	runTestCases(t, []authTestCase{
		{user: test.UserNoRoles, object: globalSettings, action: write, allow: false},
...
func TestAuthorizeMDMAppleBootstrapPackage(t *testing.T) {
	...
	globalSettings := &mdmlab.MDMAppleBootstrapPackage{}
	team1Settings := &mdmlab.MDMAppleBootstrapPackage{
		TeamID: 1,
	}
	runTestCases(t, []authTestCase{
		{user: test.UserNoRoles, object: globalSettings, action: write, allow: false},
...
func assertAuthorized(t *testing.T, user *mdmlab.User, object, action interface{}) {
	t.Helper()
...
func assertUnauthorized(t *testing.T, user *mdmlab.User, object, action interface{}) {
	t.Helper()
...
func TestAuthorizeMDMCommand(t *testing.T) {
	...
	globalCommand := &mdmlab.MDMCommandAuthz{}
	team1Command := &mdmlab.MDMCommandAuthz{
		TeamID: ptr.Uint(1),
	}
	runTestCases(t, []authTestCase{
...
func TestAuthorizeHostScriptResult(t *testing.T) {
	...
	globalScript := &mdmlab.HostScriptResult{}
	globalSavedScript := &mdmlab.HostScriptResult{ScriptID: ptr.Uint(1)}
	team1Script := &mdmlab.HostScriptResult{TeamID: ptr.Uint(1)}
	team1SavedScript := &mdmlab.HostScriptResult{TeamID: ptr.Uint(1), ScriptID: ptr.Uint(1)}
...
func TestAuthorizeScript(t *testing.T) {
	...
	globalScript := &mdmlab.Script{}
	team1Script := &mdmlab.Script{
		TeamID: ptr.Uint(1),
	}
	runTestCases(t, []authTestCase{
		{user: test.UserNoRoles, object: globalScript, action: write, allow: false},
...
func TestJSONToInterfaceUser(t *testing.T) {
	...
	subject, err := jsonToInterface(&mdmlab.User{GlobalRole: ptr.String(mdmlab.RoleAdmin)})
	require.NoError(t, err)
	{
		subject := subject.(map[string]interface{})
		assert.Equal(t, mdmlab.RoleAdmin, subject["global_role"])
		assert.Nil(t, subject["teams"])
	}

	subject, err = jsonToInterface(&mdmlab.User{
		Teams: []mdmlab.UserTeam{
			{Team: mdmlab.Team{ID: 3}, Role: mdmlab.RoleObserver},
			{Team: mdmlab.Team{ID: 42}, Role: mdmlab.RoleMaintainer},
		},
	})
	require.NoError(t, err)
	{
		...
		assert.Equal(t, mdmlab.RoleObserver, subject["teams"].([]interface{})[0].(map[string]interface{})["role"])
		assert.Equal(t, json.Number("3"), subject["teams"].([]interface{})[0].(map[string]interface{})["id"])
		assert.Equal(t, mdmlab.RoleMaintainer, subject["teams"].([]interface{})[1].(map[string]interface{})["role"])
...
func TestHostHealth(t *testing.T) {
	...
	hostHealth := &mdmlab.HostHealth{TeamID: ptr.Uint(1)}
	runTestCases(t, []authTestCase{
