...
// "mdmlab prepare db" command can reuse this job.
...
func extractVPPTokenFromMigration(migratedToken *mdmlab.VPPTokenDB) (tokData *mdmlab.VPPTokenData, didUpdateMetadata bool, err error) {
	var vppTokenData mdmlab.VPPTokenData
	...
	var vppTokenRaw mdmlab.VPPTokenRaw
