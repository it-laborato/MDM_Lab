...
# Go to the [Software|{{ .MDMlabURL }}/software/manage] page in MDMlab.
...
This issue was created automatically by your MDMlab Jira integration.
`)),
...
func (j *Jira) runFailingPolicy(ctx context.Context, cli JiraClient, args jiraArgs) error {
	tplArgs := newFailingPoliciesTplArgs(j.MDMlabURL, args.FailingPolicy)
...
func QueueJiraFailingPolicyJob(ctx context.Context, ds mdmlab.Datastore, logger kitlog.Logger,
