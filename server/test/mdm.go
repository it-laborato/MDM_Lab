...
func CreateVPPTokenData(expiration time.Time, orgName, location string) (*mdmlab.VPPTokenData, error) {
	...
	return &mdmlab.VPPTokenData{Token: base64Token, Location: location}, nil
}

func CreateInsertGlobalVPPToken(t *testing.T, ds mdmlab.Datastore) *mdmlab.VPPTokenDB {
