...
func TestListCarves(t *testing.T) {
	...
	// admin user
	carves, err := svc.ListCarves(test.UserContext(ctx, test.UserAdmin), mdmlab.CarveListOptions{})
	require.NoError(t, err)
	require.Len(t, carves, 2)

	// only global admin can read carves
	_, err = svc.ListCarves(test.UserContext(ctx, test.UserNoRoles), mdmlab.CarveListOptions{})
	require.Error(t, err)
	require.Contains(t, err.Error(), authz.ForbiddenErrorMessage)

	// no user in context
	_, err = svc.ListCarves(ctx, mdmlab.CarveListOptions{})
	require.Error(t, err)
	require.Contains(t, err.Error(), authz.ForbiddenErrorMessage)
}
...
func TestGetCarve(t *testing.T) {
	...
	ds.CarveFunc = func(ctx context.Context, id int64) (*mdmlab.CarveMetadata, error) {
		return &mdmlab.CarveMetadata{
			ID: id,
		}, nil
	}
...
func TestCarveGetBlock(t *testing.T) {
	...
	ds.GetBlockFunc = func(ctx context.Context, carve *mdmlab.CarveMetadata, blockId int64) ([]byte, error) {
...
func TestCarveBegin(t *testing.T) {
	...
	payload := mdmlab.CarveBeginPayload{
		BlockCount: 23,
		BlockSize:  64,
		CarveSize:  23 * 64,
		RequestId:  "carve_request",
	...
	expectedMetadata := mdmlab.CarveMetadata{
		ID:         7,
		HostId:     host.ID,
		BlockCount: 23,
		BlockSize:  64,
	...
	ms.NewCarveFunc = func(ctx context.Context, metadata *mdmlab.CarveMetadata) (*mdmlab.CarveMetadata, error) {
		metadata.ID = 7
		return metadata, nil
	}
...
func TestCarveBeginEmptyError(t *testing.T) {
	...
	ctx := hostctx.NewContext(context.Background(), &mdmlab.Host{ID: 1})
	...
	_, err := svc.CarveBegin(ctx, mdmlab.CarveBeginPayload{})
	require.Error(t, err)
...
func TestCarveBeginMissingHostError(t *testing.T) {
	...
	_, err := svc.CarveBegin(context.Background(), mdmlab.CarveBeginPayload{})
	require.Error(t, err)
...
func TestCarveCarveBlockGetCarveError(t *testing.T) {
	...
	ms := new(mock.Store)
	svc := &Service{carveStore: ms}
	ms.CarveBySessionIdFunc = func(ctx context.Context, sessionId string) (*mdmlab.CarveMetadata, error) {
		return nil, errors.New("ouch!")
	}

	payload := mdmlab.CarveBlockPayload{
...
func TestCarveCarveBlockBlockCountExceedError(t *testing.T) {
	...
	ms.UpdateCarveFunc = func(ctx context.Context, carve *mdmlab.CarveMetadata) error {
...
func TestCarveCarveBlockNewBlockError(t *testing.T) {
	...
	ms.NewBlockFunc = func(ctx context.Context, carve *mdmlab.CarveMetadata, blockId int64, data []byte) error {
