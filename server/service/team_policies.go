...
func teamPolicyEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
	req := request.(*teamPolicyRequest)
	resp, err := svc.NewTeamPolicy(ctx, req.TeamID, mdmlab.NewTeamPolicyPayload{
		QueryID:               req.QueryID,
		Name:                  req.Name,
		Query:                 req.Query,
...
func (svc Service) NewTeamPolicy(ctx context.Context, teamID uint, tp mdmlab.NewTeamPolicyPayload) (*mdmlab.Policy, error) {
...
func (svc *Service) populatePolicyInstallSoftware(ctx context.Context, p *mdmlab.Policy) error {
	if p.SoftwareInstallerID != nil {
		...
		p.InstallSoftware = &mdmlab.PolicySoftwareTitle{
...
func (svc *Service) populatePolicyRunScript(ctx context.Context, p *mdmlab.Policy) error {
	if p.ScriptID == nil {
		return nil
	}
	...
	p.RunScript = &mdmlab.PolicyScript{ID: *p.ScriptID, Name: scriptMetadata.Name}
	return nil
}

func (svc *Service) newTeamPolicyPayloadToPolicyPayload(ctx context.Context, teamID uint, p mdmlab.NewTeamPolicyPayload) (mdmlab.PolicyPayload, error) {
	softwareInstallerID, vppAppsTeamsID, err := svc.getInstallerOrVPPAppForTitle(ctx, &teamID, p.SoftwareTitleID)
	if err != nil {
		return mdmlab.PolicyPayload{}, err
	}
	return mdmlab.PolicyPayload{
		QueryID:               p.QueryID,
		Name:                  p.Name,
		Query:                 p.Query,
		Critical:              p.Critical,
...
type listTeamPoliciesRequest struct {
	...
	InheritedOrderDirection mdmlab.OrderDirection `query:"inherited_order_direction,optional"`
...
type listTeamPoliciesResponse struct {
	...
	InheritedPolicies []*mdmlab.Policy `json:"inherited_policies,omitempty"`
	Err               error           `json:"error,omitempty"`
}

func (r listTeamPoliciesResponse) error() error { return r.Err }

func listTeamPoliciesEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
	req := request.(*listTeamPoliciesRequest)

	inheritedListOptions := mdmlab.ListOptions{
...
func (svc *Service) ListTeamPolicies(ctx context.Context, teamID uint, opts mdmlab.ListOptions, iopts mdmlab.ListOptions, mergeInherited bool) (teamPolicies, inheritedPolicies []*mdmlab.Policy, err error) {
	if err := svc.authz.Authorize(ctx, &mdmlab.Policy{
		PolicyData: mdmlab.PolicyData{
			TeamID: ptr.Uint(teamID),
		},
...
func countTeamPoliciesEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func getTeamPolicyByIDEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc Service) GetTeamPolicyByIDQueries(ctx context.Context, teamID uint, policyID uint) (*mdmlab.Policy, error) {
	if err := svc.authz.Authorize(ctx, &mdmlab.Policy{
		PolicyData: mdmlab.PolicyData{
			TeamID: ptr.Uint(teamID),
		},
...
func deleteTeamPoliciesEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func modifyTeamPolicyEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) ModifyTeamPolicy(ctx context.Context, teamID uint, id uint, p mdmlab.ModifyPolicyPayload) (*mdmlab.Policy, error) {
	return svc.modifyPolicy(ctx, &teamID, id, p)
}

func checkTeamID(teamID *uint, policy *mdmlab.Policy) bool {
	return policy != nil && reflect.DeepEqual(teamID, policy.TeamID)
}

func (svc *Service) modifyPolicy(ctx context.Context, teamID *uint, id uint, p mdmlab.ModifyPolicyPayload) (*mdmlab.Policy, error) {
	if err := svc.authz.Authorize(ctx, &mdmlab.Policy{
		PolicyData: mdmlab.PolicyData{
			TeamID: teamID,
		},
	...
	if err := svc.NewActivity(
		ctx,
		authz.UserFromContext(ctx),
		mdmlab.ActivityTypeEditedPolicy{
			ID:   policy.ID,
			Name: policy.Name,
		},
	); err != nil {
...
func (svc *Service) getInstallerOrVPPAppForTitle(ctx context.Context, teamID *uint, softwareTitleID *uint) (installerID *uint, vppAppsTeamsID *uint, err error) {
	...
	if softwareTitle.AppStoreApp != nil {
		if softwareTitle.AppStoreApp.Platform != mdmlab.MacOSPlatform {
			return nil, nil, ctxerr.Wrap(ctx, &mdmlab.BadRequestError{
				Message: fmt.Sprintf(
