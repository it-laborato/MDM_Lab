...
type AuthenticateHostFunc func(ctx context.Context, nodeKey string) (host *mdmlab.Host, debug bool, err error)
...
type SubmitDistributedQueryResultsFunc func(ctx context.Context, results mdmlab.OsqueryDistributedQueryResults, statuses map[string]mdmlab.OsqueryStatus, messages map[string]string, stats map[string]*mdmlab.Stats) (err error)
...
func (s *TLSService) AuthenticateHost(ctx context.Context, nodeKey string) (host *mdmlab.Host, debug bool, err error) {
	s.mu.Lock()
...
func (s *TLSService) SubmitDistributedQueryResults(ctx context.Context, results mdmlab.OsqueryDistributedQueryResults, statuses map[string]mdmlab.OsqueryStatus, messages map[string]string, stats map[string]*mdmlab.Stats) (err error) {
	s.mu.Lock()
...
func (s *TLSService) YaraRuleByName(ctx context.Context, name string) (*mdmlab.YaraRule, error) {
	s.mu.Lock()
