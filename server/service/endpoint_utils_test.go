...
func TestEndpointer(t *testing.T) {
	...
	ds.UserByIDFunc = func(ctx context.Context, id uint) (*mdmlab.User, error) {
		return &mdmlab.User{GlobalRole: ptr.String(mdmlab.RoleAdmin)}, nil
	}
	...
	e := newUserAuthenticatedEndpointer(svc, mdmlabAPIOptions, r, "v1", "2021-11")
	nopHandler := func(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
		setAuthCheckedOnPreAuthErr(ctx)
		return stringErrorer("nop"), nil
	}
	overrideHandler := func(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
		setAuthCheckedOnPreAuthErr(ctx)
		return stringErrorer("override"), nil
	}

	// Regular path, no plan to deprecate
	e.GET("/api/_version_/mdmlab/path1", nopHandler, struct{}{})

	// New path, we want it only available starting from the specified version
	e.StartingAtVersion("2021-11").GET("/api/_version_/mdmlab/newpath", nopHandler, struct{}{})

	// Path that was in v1, but was changed in 2021-11
	e.EndingAtVersion("v1").GET("/api/_version_/mdmlab/overriddenpath", nopHandler, struct{}{})
	e.StartingAtVersion("2021-11").GET("/api/_version_/mdmlab/overriddenpath", overrideHandler, struct{}{})

	// Path that got deprecated
	e.EndingAtVersion("v1").GET("/api/_version_/mdmlab/deprecated", nopHandler, struct{}{})
	// Path that got deprecated but in the latest version
	e.EndingAtVersion("2021-11").GET("/api/_version_/mdmlab/deprecated-soon", nopHandler, struct{}{})

	// Aliasing works with versioning too
	e.WithAltPaths("/api/_version_/mdmlab/something/{fff}").GET("/api/_version_/mdmlab/somethings/{fff}", nopHandler, struct{}{})
	...
	mustMatch := []struct {
		...
		{method: "GET", path: "/api/v1/mdmlab/path1"},
		{method: "GET", path: "/api/2021-11/mdmlab/path1"},
		{method: "GET", path: "/api/latest/mdmlab/path1"},

		{method: "GET", path: "/api/2021-11/mdmlab/newpath"},
		{method: "GET", path: "/api/latest/mdmlab/newpath"},

		{method: "GET", path: "/api/v1/mdmlab/deprecated"},

		{method: "GET", path: "/api/v1/mdmlab/deprecated-soon"},
		{method: "GET", path: "/api/2021-11/mdmlab/deprecated-soon"},
		{method: "GET", path: "/api/latest/mdmlab/deprecated-soon"},

		{method: "GET", path: "/api/v1/mdmlab/overriddenpath"},
		{method: "GET", path: "/api/2021-11/mdmlab/overriddenpath", overridden: true},
		{method: "GET", path: "/api/latest/mdmlab/overriddenpath", overridden: true},

		{method: "GET", path: "/api/v1/mdmlab/something/aaa"},
		{method: "GET", path: "/api/2021-11/mdmlab/something/aaa"},
		{method: "GET", path: "/api/latest/mdmlab/something/aaa"},
		{method: "GET", path: "/api/v1/mdmlab/somethings/aaa"},
		{method: "GET", path: "/api/2021-11/mdmlab/somethings/aaa"},
		{method: "GET", path: "/api/latest/mdmlab/somethings/aaa"},
	}
	...
	mustNotMatch := []struct {
		...
		{method: "POST", path: "/api/v1/mdmlab/path1"},
		{method: "GET", path: "/api/v1/mdmlab/qwejoqiwejqiowehioqwe"},
		{method: "GET", path: "/api/v1/qwejoqiwejqiowehioqwe"},

		{method: "GET", path: "/api/v1/mdmlab/newpath"},

		{method: "GET", path: "/api/2021-11/mdmlab/deprecated"},
		{method: "GET", path: "/api/latest/mdmlab/deprecated"},
	}
...
func TestEndpointerCustomMiddleware(t *testing.T) {
	...
	e := newNoAuthEndpointer(svc, mdmlabAPIOptions, r, "v1")
	e.GET("/none/", func(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
		buf.WriteString("H1")
		return nil, nil
	}, nil)
	...
	e.WithCustomMiddleware(
		...
		GET("/mw/", func(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
			buf.WriteString("H2")
			return nil, nil
		}, nil)
