...
func getScheduledQueriesInPackEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) GetScheduledQueriesInPack(ctx context.Context, id uint, opts mdmlab.ListOptions) ([]*mdmlab.ScheduledQuery, error) {
...
func scheduleQueryEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
	req := request.(*scheduleQueryRequest)

	scheduled, err := svc.ScheduleQuery(ctx, &mdmlab.ScheduledQuery{
		PackID:   req.PackID,
		QueryID:  req.QueryID,
...
func (svc *Service) ScheduleQuery(ctx context.Context, sq *mdmlab.ScheduledQuery) (*mdmlab.ScheduledQuery, error) {
...
func (svc *Service) unauthorizedScheduleQuery(ctx context.Context, sq *mdmlab.ScheduledQuery) (*mdmlab.ScheduledQuery, error) {
	if sq.Interval < 1 || sq.Interval > mdmlab.MaxScheduledQueryInterval {
	...
	if sq.Name == "" {
		...
		packQueries, err := svc.ds.ListScheduledQueriesInPackWithStats(ctx, sq.PackID, mdmlab.ListOptions{})
		if err != nil {
...
func findNextNameForQuery(name string, scheduled []*mdmlab.ScheduledQuery) string {
...
func getScheduledQueryEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) GetScheduledQuery(ctx context.Context, id uint) (*mdmlab.ScheduledQuery, error) {
	// Scheduled queries are currently authorized the same as packs.
	if err := svc.authz.Authorize(ctx, &mdmlab.Pack{}, mdmlab.ActionRead); err != nil {
		return nil, err
	}
...
func modifyScheduledQueryEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) ModifyScheduledQuery(ctx context.Context, id uint, p mdmlab.ScheduledQueryPayload) (*mdmlab.ScheduledQuery, error) {
	// Scheduled queries are currently authorized the same as packs.
	if err := svc.authz.Authorize(ctx, &mdmlab.Pack{}, mdmlab.ActionWrite); err != nil {
		return nil, err
	}
...
func (svc *Service) unauthorizedModifyScheduledQuery(ctx context.Context, id uint, p mdmlab.ScheduledQueryPayload) (*mdmlab.ScheduledQuery, error) {
	if p.Interval != nil {
		if *p.Interval < 1 || *p.Interval > mdmlab.MaxScheduledQueryInterval {
...
func deleteScheduledQueryEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
