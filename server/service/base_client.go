...
type baseClient struct {
	...
	serverCapabilities mdmlab.CapabilityMap
	...
	// modified afterwards.
	clientCapabilities mdmlab.CapabilityMap
}
...
func (bc *baseClient) setServerCapabilities(response *http.Response) {
	capabilities := response.Header.Get(mdmlab.CapabilitiesHeader)
	bc.serverCapabilities.PopulateFromString(capabilities)
}

func (bc *baseClient) GetServerCapabilities() mdmlab.CapabilityMap {
...
func (bc *baseClient) setClientCapabilitiesHeader(req *http.Request) {
	...
	req.Header.Set(mdmlab.CapabilitiesHeader, bc.clientCapabilities.String())
}
...
func newBaseClient(
	...
	if mdmlabClientCert != nil {
		tlsConfig.Certificates = []tls.Certificate{*mdmlabClientCert}
	}
