...
func (e setupAlreadyErr) Error() string {
	return "MDMlab has already been setup"
}
...
func (e notSetupErr) Error() string {
	return "The MDMlab instance is not set up yet"
}
...
// TODO: we have a similar but different interface in the mdmlab package,
// mdmlab.NotFoundError - at the very least, the NotFound method should be the
