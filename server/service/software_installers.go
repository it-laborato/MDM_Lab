...
func (updateSoftwareInstallerRequest) DecodeRequest(ctx context.Context, r *http.Request) (interface{}, error) {
	...
	if err != nil {
		...
		if errors.As(err, &nerr) && nerr.Timeout() {
			return nil, mdmlab.NewUserMessageError(
	...
	if r.MultipartForm.File["software"] != nil || len(r.MultipartForm.File["software"]) > 0 {
		...
		if decoded.File.Size > mdmlab.MaxSoftwareInstallerSize {
	...
	if ok {
		...
		if err != nil {
			return nil, &mdmlab.BadRequestError{Message: fmt.Sprintf("Invalid team_id: %s", val[0])}
		}
	...
	if ok && len(val) > 0 && val[0] != "" {
		...
		if err != nil {
			return nil, &mdmlab.BadRequestError{Message: fmt.Sprintf("failed to decode self_service bool in multipart form: %s", err.Error())}
		}
	...
	inclAny, existsInclAny = r.MultipartForm.Value[string(mdmlab.LabelsIncludeAny)]
	switch {
	case !existsInclAny:
	...
	exclAny, existsExclAny = r.MultipartForm.Value[string(mdmlab.LabelsExcludeAny)]
	switch {
	case !existsExclAny:
...
func updateSoftwareInstallerEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
	req := request.(*updateSoftwareInstallerRequest)

	payload := &mdmlab.UpdateSoftwareInstallerPayload{
		TitleID:           req.TitleID,
		TeamID:            req.TeamID,
	...
	if req.File != nil {
		...
		tfr, err := mdmlab.NewTempFileReader(ff, nil)
		if err != nil {
			return uploadSoftwareInstallerResponse{Err: err}, nil
		}
		defer tfr.Close()
...
func (uploadSoftwareInstallerRequest) DecodeRequest(ctx context.Context, r *http.Request) (interface{}, error) {
	...
	if ok && len(val) > 0 && val[0] != "" {
		parsed, err := strconv.ParseBool(val[0])
		if err != nil {
			return nil, &mdmlab.BadRequestError{Message: fmt.Sprintf("failed to decode automatic_install bool in multipart form: %s", err.Error())}
		}
...
func uploadSoftwareInstallerEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func deleteSoftwareInstallerEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func getSoftwareInstallerEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func getSoftwareInstallerTokenEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
	req := request.(*getSoftwareInstallerRequest)
...
func downloadSoftwareInstallerEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) GetSoftwareInstallerTokenMetadata(ctx context.Context, _ string, _ uint) (*mdmlab.SoftwareInstallerTokenMetadata,
	error,
) {
	// skipauth: No authorization check needed due to implementation returning
	// only license error.
...
func (svc *Service) GetSoftwareInstallerMetadata(ctx context.Context, _ bool, _ uint, _ *uint) (*mdmlab.SoftwareInstaller, error) {
	// skipauth: No authorization check needed due to implementation returning
	// only license error.
	svc.authz.SkipAuthorization(ctx)
...
type getSoftwareInstallerResponse struct {
	SoftwareInstaller *mdmlab.SoftwareInstaller `json:"software_installer,omitempty"`
	Err               error                    `json:"error,omitempty"`
}
...
type orbitDownloadSoftwareInstallerResponse struct {
	...
	payload *mdmlab.DownloadSoftwareInstallerPayload
}
...
func (svc *Service) DownloadSoftwareInstaller(ctx context.Context, _ bool, _ string, _ uint,
	_ *uint) (*mdmlab.DownloadSoftwareInstallerPayload,
	error,
) {
	// skipauth: No authorization check needed due to implementation returning
	// only license error.
...
func installSoftwareTitleEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) GetVPPTokenIfCanInstallVPPApps(ctx context.Context, appleDevice bool, host *mdmlab.Host) (string, error) {
	return "", mdmlab.ErrMissingLicense // called downstream of auth checks so doesn't need skipauth
}
...
func uninstallSoftwareTitleEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
type getSoftwareInstallResultsResponse struct {
	Err     error                              `json:"error,omitempty"`
	Results *mdmlab.HostSoftwareInstallerResult `json:"results,omitempty"`
}

func (r getSoftwareInstallResultsResponse) error() error { return r.Err }

func getSoftwareInstallResultsEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
type batchSetSoftwareInstallersRequest struct {
	...
	Software []*mdmlab.SoftwareInstallerPayload `json:"software"`
}
...
func batchSetSoftwareInstallersEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) BatchSetSoftwareInstallers(ctx context.Context, tmName string, payloads []*mdmlab.SoftwareInstallerPayload, dryRun bool) (string, error) {
	// skipauth: No authorization check needed due to implementation returning
	// only license error.
	svc.authz.SkipAuthorization(ctx)
...
type batchSetSoftwareInstallersResultResponse struct {
	...
	Packages []mdmlab.SoftwarePackageResponse `json:"packages"`
...
func batchSetSoftwareInstallersResultEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
type mdmlabSelfServiceSoftwareInstallRequest struct {
	Token           string `url:"token"`
	SoftwareTitleID uint   `url:"software_title_id"`
}

func (r *mdmlabSelfServiceSoftwareInstallRequest) deviceAuthToken() string {
	return r.Token
}
...
func submitSelfServiceSoftwareInstall(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
	...
	req := request.(*mdmlabSelfServiceSoftwareInstallRequest)
...
func (svc *Service) HasSelfServiceSoftwareInstallers(ctx context.Context, host *mdmlab.Host) (bool, error) {
...
type batchAssociateAppStoreAppsRequest struct {
	...
	Apps     []mdmlab.VPPBatchPayload `json:"app_store_apps"`
}
...
func (b *batchAssociateAppStoreAppsRequest) DecodeBody(ctx context.Context, r io.Reader, u url.Values, c []*x509.Certificate) error {
	if err := json.NewDecoder(r).Decode(b); err != nil {
		...
		if errors.As(err, &typeErr) {
			return ctxerr.Wrap(ctx, mdmlab.NewUserMessageError(fmt.Errorf("Couldn't edit software. %q must be a %s, found %s", typeErr.Field, typeErr.Type.String(), typeErr.Value), http.StatusBadRequest))
		}
	}
...
type batchAssociateAppStoreAppsResponse struct {
	Apps []mdmlab.VPPAppResponse `json:"app_store_apps"`
	Err  error                  `json:"error,omitempty"`
}

func (r batchAssociateAppStoreAppsResponse) error() error { return r.Err }

func batchAssociateAppStoreAppsEndpoint(ctx context.Context, request any, svc mdmlab.Service) (errorer, error) {
