...
type setupRequest struct {
	Admin        *mdmlab.UserPayload `json:"admin"`
	OrgInfo      *mdmlab.OrgInfo     `json:"org_info"`
	ServerURL    *string            `json:"server_url,omitempty"`
	EnrollSecret *string            `json:"osquery_enroll_secret,omitempty"`
}

type setupResponse struct {
	Admin        *mdmlab.User    `json:"admin,omitempty"`
	OrgInfo      *mdmlab.OrgInfo `json:"org_info,omitempty"`
...
func makeSetupEndpoint(svc mdmlab.Service, logger kitlog.Logger) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		adminPayload.GlobalRole = ptr.String(mdmlab.RoleAdmin)
