...
func hostDetailResponseForHost(ctx context.Context, svc mdmlab.Service, host *mdmlab.HostDetail) (*HostDetailResponse, error) {
...
type listHostsResponse struct {
	...
	MDMSolution *mdmlab.MDMSolution `json:"mobile_device_management_solution,omitempty"`
	...
	// payload.
	MunkiIssue *mdmlab.MunkiIssue `json:"munki_issue,omitempty"`
...
func listHostsEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
	...
	var softwareTitle *mdmlab.SoftwareTitle
	...
	var munkiIssue *mdmlab.MunkiIssue
	if req.Opts.MunkiIssueIDFilter != nil {
		var err error
		munkiIssue, err = svc.GetMunkiIssue(ctx, *req.Opts.MunkiIssueIDFilter)
		if err != nil && !mdmlab.IsNotFound(err) { // ignore not found, just return nil for the munki issue in that case
			return listHostsResponse{Err: err}, nil
		}
	}
...
func (svc *Service) GetMDMSolution(ctx context.Context, mdmID uint) (*mdmlab.MDMSolution, error) {
...
func (svc *Service) GetMunkiIssue(ctx context.Context, munkiIssueID uint) (*mdmlab.MunkiIssue, error) {
	// require list hosts permission to view this information
	if err := svc.authz.Authorize(ctx, &mdmlab.Host{}, mdmlab.ActionList); err != nil {
		return nil, err
	}
...
func (svc *Service) ListHosts(ctx context.Context, opt mdmlab.HostListOptions) ([]*mdmlab.Host, error) {
	if err := svc.authz.Authorize(ctx, &mdmlab.Host{}, mdmlab.ActionList); err != nil {
		return nil, err
	}
...
func deleteHostsEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) DeleteHosts(ctx context.Context, ids []uint, filter *map[string]interface{}) error {
	...
	if len(ids) == 0 && lid == nil && opts == nil {
		return &mdmlab.BadRequestError{Message: "list of ids or filters must be specified"}
	}

	if len(ids) > 0 && (lid != nil || (opts != nil && !opts.Empty())) {
		return &mdmlab.BadRequestError{Message: "Cannot specify a list of ids and filters at the same time"}
	}

	doDelete := func(hostIDs []uint, hosts []*mdmlab.Host) error {
...
func countHostsEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) CountHosts(ctx context.Context, labelID *uint, opts mdmlab.HostListOptions) (int, error) {
	if err := svc.authz.Authorize(ctx, &mdmlab.Host{}, mdmlab.ActionList); err != nil {
		return 0, err
	}
...
func (svc *Service) countHostFromFilters(ctx context.Context, labelID *uint, opt mdmlab.HostListOptions) (int, error) {
	vc, ok := viewer.FromContext(ctx)
	if !ok {
		return 0, mdmlab.ErrNoContext
	}
	filter := mdmlab.TeamFilter{User: vc.User, IncludeObserver: true}
...
func searchHostsEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
	...
	results := []*mdmlab.HostResponse{}

	for _, h := range hosts {
		results = append(results, mdmlab.HostResponseForHostCheap(h))
	}
...
func (svc *Service) SearchHosts(ctx context.Context, matchQuery string, queryID *uint, excludedHostIDs []uint) ([]*mdmlab.Host, error) {
	if err := svc.authz.Authorize(ctx, &mdmlab.Host{}, mdmlab.ActionList); err != nil {
		return nil, err
	}
...
func getHostEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) checkWriteForHostIDs(ctx context.Context, ids []uint) error {
	for _, id := range ids {
		...
		// Authorize again with team loaded now that we have team_id
		if err := svc.authz.Authorize(ctx, host, mdmlab.ActionWrite); err != nil {
			return err
		}
	}
	return nil
...
// Get Host Lite
// //////////////////////////////////////////////////////////////////////////////
func (svc *Service) GetHostLite(ctx context.Context, id uint) (*mdmlab.Host, error) {
	if err := svc.authz.Authorize(ctx, &mdmlab.Host{}, mdmlab.ActionList); err != nil {
		return nil, err
	}
...
func getHostSummaryEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) GetHostSummary(ctx context.Context, teamID *uint, platform *string, lowDiskSpace *int) (*mdmlab.HostSummary, error) {
	if lowDiskSpace != nil {
	...
	filter := mdmlab.TeamFilter{User: vc.User, IncludeObserver: true, TeamID: teamID}
	...
	var builtinLabels []*mdmlab.LabelSummary
	for _, l := range labelsSummary {
		if l.LabelType == mdmlab.LabelTypeBuiltIn {
...
func hostByIdentifierEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) HostByIdentifier(ctx context.Context, identifier string, opts mdmlab.HostDetailOptions) (*mdmlab.HostDetail, error) {
	...
	// Authorize again with team loaded now that we have team_id
	if err := svc.authz.Authorize(ctx, host, mdmlab.ActionSelectiveRead); err != nil {
		return nil, err
	}
...
func deleteHostEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func addHostsToTeamEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) AddHostsToTeam(ctx context.Context, teamID *uint, hostIDs []uint, skipBulkPending bool) error {
	...
	// teams.
	if err := svc.authz.Authorize(ctx, &mdmlab.Host{TeamID: teamID}, mdmlab.ActionWrite); err != nil {
		return err
	}
...
func (svc *Service) createTransferredHostsActivity(ctx context.Context, teamID *uint, hostIDs []uint, hostNames []string) error {
	...
	if len(hostNames) == 0 {
		...
		hostsByID := make(map[uint]*mdmlab.Host, len(hosts))
		for _, h := range hosts {
			hostsByID[h.ID] = h
		}
	...
	if err := svc.NewActivity(
		...
		mdmlab.ActivityTypeTransferredHostsToTeam{
			TeamID:           teamID,
			TeamName:         teamName,
			HostIDs:          hostIDs,
...
func addHostsToTeamByFilterEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) AddHostsToTeamByFilter(ctx context.Context, teamID *uint, filters *map[string]interface{}) error {
	...
	if opt == nil {
		return &mdmlab.BadRequestError{Message: "filters must be specified"}
	}
...
func refetchHostEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) RefetchHost(ctx context.Context, id uint) error {
	...
	// iOS and iPadOS refetch are not authenticated with device token because these devices do not have MDMlab Desktop,
	...
	if !svc.authz.IsAuthenticatedWith(ctx, authzctx.AuthnDeviceToken) {
		...
		// We verify mdmlab.ActionRead instead of mdmlab.ActionWrite because we want to allow
	...
	if host != nil && (host.Platform == "ios" || host.Platform == "ipados") {
		...
		for _, cmd := range commands {
			...
			case mdmlab.RefetchDeviceCommandUUIDPrefix:
				doDeviceInfoRefetch = false
			case mdmlab.RefetchAppsCommandUUIDPrefix:
				doAppRefetch = false
			}
		}
		...
		hostMDMCommands := make([]mdmlab.HostMDMCommand, 0, 2)
		cmdUUID := uuid.NewString()
		if doAppRefetch {
			err = svc.mdmAppleCommander.InstalledApplicationList(ctx, []string{host.UUID}, mdmlab.RefetchAppsCommandUUIDPrefix+cmdUUID)
			if err != nil {
				return ctxerr.Wrap(ctx, err, "refetch apps with MDM")
			}
			hostMDMCommands = append(hostMDMCommands, mdmlab.HostMDMCommand{
				HostID:      host.ID,
		...
		if doDeviceInfoRefetch {
			...
			err = svc.mdmAppleCommander.DeviceInformation(ctx, []string{host.UUID}, mdmlab.RefetchDeviceCommandUUIDPrefix+cmdUUID)
			if err != nil {
...
func (svc *Service) verifyMDMConfiguredAndConnected(ctx context.Context, host *mdmlab.Host) error {
	if err := svc.VerifyMDMAppleConfigured(ctx); err != nil {
		if errors.Is(err, mdmlab.ErrMDMNotConfigured) {
			err = mdmlab.NewInvalidArgumentError("id", mdmlab.AppleMDMNotConfiguredMessage).WithStatus(http.StatusBadRequest)
		}
	...
	if !connected {
		return ctxerr.Wrap(ctx,
			mdmlab.NewInvalidArgumentError("id", "Host does not have MDM turned on."))
	}
	return nil
}

func (svc *Service) getHostDetails(ctx context.Context, host *mdmlab.Host, opts mdmlab.HostDetailOptions) (*mdmlab.HostDetail, error) {
	...
	var nextMw *mdmlab.HostMaintenanceWindow
	if len(mws) > 0 {
		nextMw = mws[0]
	}
	...
	if opts.IncludePolicies {
		...
		if hp == nil {
			hp = []*mdmlab.HostPolicy{}
		}

		policies = &hp
	}

	// If MDMlab MDM is enabled and configured, we want to include MDM profiles,
	...
	var profiles []mdmlab.HostMDMProfile
	if ac.MDM.EnabledAndConfigured || ac.MDM.WindowsEnabledAndConfigured {
		host.MDM.OSSettings = &mdmlab.HostMDMOSSettings{}
		...
		case "windows":
			...
			if profs == nil {
				profs = []mdmlab.HostMDMWindowsProfile{}
			}
			for _, p := range profs {
				p.Detail = mdmlab.HostMDMProfileDetail(p.Detail).Message()
		...
		case "darwin", "ios", "ipados":
			if ac.MDM.EnabledAndConfigured {
				...
				host.MDM.PopulateOSSettingsAndMacOSSettings(profs, mobileconfig.MDMlabFileVaultPayloadIdentifier)

				for _, p := range profs {
					if p.Identifier == mobileconfig.MDMlabFileVaultPayloadIdentifier {
	...
	if host.IsLUKSSupported() {
		...
		if eDE {
			...
			if status.Status != nil && *status.Status == mdmlab.DiskEncryptionVerified {
				host.MDM.EncryptionKeyAvailable = true
			}
		}
	}

	var macOSSetup *mdmlab.HostMDMMacOSSetup
	if ac.MDM.EnabledAndConfigured && license.IsPremium(ctx) {
		...
		if err != nil {
			...
			macOSSetup = &mdmlab.HostMDMMacOSSetup{}
		}
	}
...
func getHostQueryReportEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) GetHostQueryReportResults(ctx context.Context, hostID uint, queryID uint) ([]mdmlab.HostQueryReportResult, *time.Time, error) {
	query, err := svc.ds.Query(ctx, queryID)
	if err != nil {
		setAuthCheckedOnPreAuthErr(ctx)
		return nil, nil, ctxerr.Wrap(ctx, err, "get query from datastore")
	}
	if err := svc.authz.Authorize(ctx, query, mdmlab.ActionRead); err != nil {
		return nil, nil, err
	}
	...
	if len(rows) == 0 {
		return []mdmlab.HostQueryReportResult{}, nil, nil
	}

	var lastFetched *time.Time
	result := make([]mdmlab.HostQueryReportResult, 0, len(rows))
	for _, row := range rows {
		...
		if row.Data != nil {
			...
			result = append(result, mdmlab.HostQueryReportResult{Columns: columns})
		}
	}
...
func (svc *Service) hostIDsAndNamesFromFilters(ctx context.Context, opt mdmlab.HostListOptions, lid *uint) ([]uint, []string, []*mdmlab.Host, error) {
	vc, ok := viewer.FromContext(ctx)
	if !ok {
		return nil, nil, nil, mdmlab.ErrNoContext
	}
	filter := mdmlab.TeamFilter{User: vc.User, IncludeObserver: true}
...
func listHostDeviceMappingEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) ListHostDeviceMapping(ctx context.Context, id uint) ([]*mdmlab.HostDeviceMapping, error) {
	if !svc.authz.IsAuthenticatedWith(ctx, authzctx.AuthnDeviceToken) {
		if err := svc.authz.Authorize(ctx, &mdmlab.Host{}, mdmlab.ActionList); err != nil {
			return nil, err
		}
...
func putHostDeviceMappingEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) SetCustomHostDeviceMapping(ctx context.Context, hostID uint, email string) ([]*mdmlab.HostDeviceMapping, error) {
	...
	source := mdmlab.DeviceMappingCustomOverride
	if isInstallerSource {
		source = mdmlab.DeviceMappingCustomInstaller
	}
...
func getHostMDM(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func getHostMDMSummary(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func getMacadminsDataEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) MacadminsData(ctx context.Context, id uint) (*mdmlab.MacadminsData, error) {
	if !svc.authz.IsAuthenticatedWith(ctx, authzctx.AuthnDeviceToken) {
		if err := svc.authz.Authorize(ctx, &mdmlab.Host{}, mdmlab.ActionList); err != nil {
			return nil, err
		}
	...
	var munkiInfo *mdmlab.HostMunkiInfo
	switch version, err := svc.ds.GetHostMunkiVersion(ctx, id); {
	case err != nil && !mdmlab.IsNotFound(err):
		return nil, err
	case err == nil:
		munkiInfo = &mdmlab.HostMunkiInfo{Version: version}
	}

	var mdm *mdmlab.HostMDM
	...
	var munkiIssues []*mdmlab.HostMunkiIssue
...
func getAggregatedMacadminsDataEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) AggregatedMacadminsData(ctx context.Context, teamID *uint) (*mdmlab.AggregatedMacadminsData, error) {
	if err := svc.authz.Authorize(ctx, &mdmlab.Host{TeamID: teamID}, mdmlab.ActionList); err != nil {
		return nil, err
	}
	...
	agg := &mdmlab.AggregatedMacadminsData{}
...
func (svc *Service) MDMData(ctx context.Context, id uint) (*mdmlab.HostMDM, error) {
	if err := svc.authz.Authorize(ctx, &mdmlab.Host{}, mdmlab.ActionList); err != nil {
		return nil, err
	}
...
func (svc *Service) AggregatedMDMData(ctx context.Context, teamID *uint, platform string) (mdmlab.AggregatedMDMData, error) {
	if err := svc.authz.Authorize(ctx, &mdmlab.Host{TeamID: teamID}, mdmlab.ActionList); err != nil {
		return mdmlab.AggregatedMDMData{}, err
	}
	...
	return mdmlab.AggregatedMDMData{
		MDMStatus:       mdmStatus,
			...
			for i, rec := range recs {
				for _, col := range r.Columns {
					...
					if !ok {
						...
						encodeError(ctx, &mdmlab.BadRequestError{Message: fmt.Sprintf("invalid column name: %q", col)}, w)
						return
					}
...
func hostsReportEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
	...
	if req.Format != "csv" {
		...
		err := ctxerr.Wrap(ctx, mdmlab.NewInvalidArgumentError("format", "unsupported or unspecified report format").
	...
	hostResps := make([]*mdmlab.HostResponse, len(hosts))
	for i, h := range hosts {
...
func (svc *Service) ListLabelsForHost(ctx context.Context, hostID uint) ([]*mdmlab.Label, error) {
	// require list hosts permission to view this information
	if err := svc.authz.Authorize(ctx, &mdmlab.Host{}, mdmlab.ActionList); err != nil {
		return nil, err
	}
...
func osVersionsEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) OSVersions(ctx context.Context, teamID *uint, platform *string, name *string, version *string, opts mdmlab.ListOptions, includeCVSS bool) (*mdmlab.OSVersions, int, *mdmlab.PaginationMetadata, error) {
	...
	if name != nil && version == nil {
		return nil, count, nil, &mdmlab.BadRequestError{Message: "Cannot specify os_name without os_version"}
	}

	if name == nil && version != nil {
		return nil, count, nil, &mdmlab.BadRequestError{Message: "Cannot specify os_version without os_name"}
	}

	if opts.OrderKey != "" && opts.OrderKey != "hosts_count" {
		return nil, count, nil, &mdmlab.BadRequestError{Message: "Invalid order key"}
	}
	...
	if teamID != nil {
		...
		if *teamID != 0 {
			...
			if err != nil {
				...
				return nil, count, nil, mdmlab.NewInvalidArgumentError("team_id", fmt.Sprintf("team %d does not exist", *teamID)).
	...
	vc, ok := viewer.FromContext(ctx)
	if !ok {
		return nil, count, nil, mdmlab.ErrNoContext
	}
	osVersions, err := svc.ds.OSVersions(
		ctx, &mdmlab.TeamFilter{
			User:            vc.User,
	...
	if opts.OrderKey == "hosts_count" && opts.OrderDirection == mdmlab.OrderAscending {
	...
	var metaData *mdmlab.PaginationMetadata
	osVersions.OSVersions, metaData = paginateOSVersions(osVersions.OSVersions, opts)

	return osVersions, count, metaData, nil
}

func paginateOSVersions(slice []mdmlab.OSVersion, opts mdmlab.ListOptions) ([]mdmlab.OSVersion, *mdmlab.PaginationMetadata) {
	metaData := &mdmlab.PaginationMetadata{
	...
	if start >= uint(len(slice)) {
		return []mdmlab.OSVersion{}, metaData
	}
...
func getOSVersionEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) OSVersion(ctx context.Context, osID uint, teamID *uint, includeCVSS bool) (*mdmlab.OSVersion, *time.Time, error) {
	...
	if teamID != nil && *teamID != 0 {
		...
		if err != nil {
			...
			return nil, nil, mdmlab.NewInvalidArgumentError("team_id", fmt.Sprintf("team %d does not exist", *teamID)).
				WithStatus(http.StatusNotFound)
		}
	}
	...
	if err != nil {
		if mdmlab.IsNotFound(err) {
			// We return an empty result here to be consistent with the mdmlab/os_versions behavior.
...
func (svc *Service) populateOSVersionDetails(ctx context.Context, osVersion *mdmlab.OSVersion, includeCVSS bool) error {
	...
	osVersion.Vulnerabilities = make(mdmlab.Vulnerabilities, 0) // avoid null in JSON
...
func getHostEncryptionKey(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) HostEncryptionKey(ctx context.Context, id uint) (*mdmlab.HostDiskEncryptionKey, error) {
	if err := svc.authz.Authorize(ctx, &mdmlab.Host{}, mdmlab.ActionList); err != nil {
		return nil, err
	}
	...
	var key *mdmlab.HostDiskEncryptionKey
	if host.IsLUKSSupported() {
	...
	err = svc.NewActivity(
		ctx,
		authz.UserFromContext(ctx),
		mdmlab.ActivityTypeReadHostDiskEncryptionKey{
			HostID:          host.ID,
...
func (svc *Service) decryptForMDMPlatform(ctx context.Context, host *mdmlab.Host) (*mdmlab.HostDiskEncryptionKey, error) {
...
func getHostHealthEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) GetHostHealth(ctx context.Context, id uint) (*mdmlab.HostHealth, error) {
	svc.authz.SkipAuthorization(ctx)
	...
	if err := svc.authz.Authorize(ctx, hh, mdmlab.ActionRead); err != nil {
		return nil, err
	}
...
func (svc *Service) HostLiteByIdentifier(ctx context.Context, identifier string) (*mdmlab.HostLite, error) {
	if err := svc.authz.Authorize(ctx, &mdmlab.Host{}, mdmlab.ActionList); err != nil {
		return nil, err
	}
	...
	if err := svc.authz.Authorize(ctx, mdmlab.Host{
		TeamID: host.TeamID,
...
func (svc *Service) HostLiteByID(ctx context.Context, id uint) (*mdmlab.HostLite, error) {
	if err := svc.authz.Authorize(ctx, &mdmlab.Host{}, mdmlab.ActionList); err != nil {
		return nil, err
	}
...
func hostListOptionsFromFilters(filter *map[string]interface{}) (*mdmlab.HostListOptions, *uint, error) {
	var labelID *uint
	...
	for k, v := range *filter {
		...
		case "status":
			...
			if !mdmlab.HostStatus(status).IsValid() {
				return nil, nil, badRequest("status must be one of: new, online, offline, missing")
			}
			opt.StatusFilter = mdmlab.HostStatus(status)
		case "query":
			query, ok := v.(string)
			if !ok {
...
func addLabelsToHostEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) AddLabelsToHost(ctx context.Context, id uint, labelNames []string) error {
	...
	if err := svc.authz.Authorize(ctx, host, mdmlab.ActionWriteHostLabel); err != nil {
...
func removeLabelsFromHostEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func getHostSoftwareEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) ListHostSoftware(ctx context.Context, hostID uint, opts mdmlab.HostSoftwareTitleListOptions) ([]*mdmlab.HostSoftwareWithInstaller, *mdmlab.PaginationMetadata, error) {
	...
	if !svc.authz.IsAuthenticatedWith(ctx, authzctx.AuthnDeviceToken) {
		...
		if !ok {
			return nil, nil, ctxerr.Wrap(ctx, mdmlab.NewAuthRequiredError("internal error: missing host from request context"))
		}
		host = h
	}

	mdmEnrolled, err := svc.ds.IsHostConnectedToMDMlabMDM(ctx, host)
	if err != nil {
