...
func main() {
	detailQueriesMap := osquery_utils.GetDetailQueries(context.Background(),
		...
		&mdmlab.AppConfig{MDM: mdmlab.MDM{EnabledAndConfigured: true}},
		&mdmlab.Features{
...
Following is a summary of the detail queries hardcoded in MDMlab used to populate the device details:
