...
type listCarvesRequest struct {
	ListOptions mdmlab.CarveListOptions `url:"carve_options"`
}

type listCarvesResponse struct {
	Carves []mdmlab.CarveMetadata `json:"carves"`
	Err    error                 `json:"error,omitempty"`
}

func (r listCarvesResponse) error() error { return r.Err }

func listCarvesEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) ListCarves(ctx context.Context, opt mdmlab.CarveListOptions) ([]*mdmlab.CarveMetadata, error) {
	if err := svc.authz.Authorize(ctx, &mdmlab.CarveMetadata{}, mdmlab.ActionRead); err != nil {
		return nil, err
	}
...
type getCarveResponse struct {
	Carve mdmlab.CarveMetadata `json:"carve"`
	Err   error               `json:"error,omitempty"`
}

func (r getCarveResponse) error() error { return r.Err }

func getCarveEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) GetCarve(ctx context.Context, id int64) (*mdmlab.CarveMetadata, error) {
	if err := svc.authz.Authorize(ctx, &mdmlab.CarveMetadata{}, mdmlab.ActionRead); err != nil {
		return nil, err
	}
...
func getCarveBlockEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func carveBeginEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) CarveBegin(ctx context.Context, payload mdmlab.CarveBeginPayload) (*mdmlab.CarveMetadata, error) {
...
func carveBlockEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) CarveBlock(ctx context.Context, payload mdmlab.CarveBlockPayload) error {
	// skipauth: Authorization is currently for user endpoints only.
	svc.authz.SkipAuthorization(ctx)
...
func (svc *Service) validateCarveBlock(payload mdmlab.CarveBlockPayload, carve *mdmlab.CarveMetadata) error {
