...
func (nopProfileMatcher) PreassignProfile(ctx context.Context, pld mdmlab.MDMApplePreassignProfilePayload) error {
	return nil
}

func (nopProfileMatcher) RetrieveProfiles(ctx context.Context, extHostID string) (mdmlab.MDMApplePreassignHostProfiles, error) {
	return mdmlab.MDMApplePreassignHostProfiles{}, nil
}

func setupAppleMDMService(t *testing.T, license *mdmlab.LicenseInfo) (mdmlab.Service, context.Context, *mock.Store) {
	ds := new(mock.Store)
	...
	ds.GetMDMAppleEnrollmentProfileByTokenFunc = func(ctx context.Context, token string) (*mdmlab.MDMAppleEnrollmentProfile, error) {
		return nil, nil
	}
	ds.NewMDMAppleEnrollmentProfileFunc = func(ctx context.Context, enrollmentPayload mdmlab.MDMAppleEnrollmentProfilePayload) (*mdmlab.MDMAppleEnrollmentProfile, error) {
		return &mdmlab.MDMAppleEnrollmentProfile{
			ID:            1,
			Token:         "foo",
			Type:          mdmlab.MDMAppleEnrollmentTypeManual,
	...
	ds.ListMDMAppleEnrollmentProfilesFunc = func(ctx context.Context) ([]*mdmlab.MDMAppleEnrollmentProfile, error) {
		return nil, nil
	}
	ds.NewMDMAppleInstallerFunc = func(ctx context.Context, name string, size int64, manifest string, installer []byte, urlToken string) (*mdmlab.MDMAppleInstaller, error) {
		return nil, nil
	}
	ds.MDMAppleInstallerFunc = func(ctx context.Context, token string) (*mdmlab.MDMAppleInstaller, error) {
		return nil, nil
	}
	ds.MDMAppleInstallerDetailsByIDFunc = func(ctx context.Context, id uint) (*mdmlab.MDMAppleInstaller, error) {
		return nil, nil
	}
	ds.DeleteMDMAppleInstallerFunc = func(ctx context.Context, id uint) error {
		return nil
	}
	ds.MDMAppleInstallerDetailsByTokenFunc = func(ctx context.Context, token string) (*mdmlab.MDMAppleInstaller, error) {
		return nil, nil
	}
	ds.ListMDMAppleInstallersFunc = func(ctx context.Context) ([]mdmlab.MDMAppleInstaller, error) {
		return nil, nil
	}
	ds.MDMAppleListDevicesFunc = func(ctx context.Context) ([]mdmlab.MDMAppleDevice, error) {
		return nil, nil
	}
	ds.GetNanoMDMEnrollmentFunc = func(ctx context.Context, hostUUID string) (*mdmlab.NanoEnrollment, error) {
		return &mdmlab.NanoEnrollment{Enabled: false}, nil
	}
	ds.GetMDMAppleCommandRequestTypeFunc = func(ctx context.Context, commandUUID string) (string, error) {
		return "", nil
	}
	ds.MDMGetEULAMetadataFunc = func(ctx context.Context) (*mdmlab.MDMEULA, error) {
		return &mdmlab.MDMEULA{}, nil
	}
	ds.MDMGetEULABytesFunc = func(ctx context.Context, token string) (*mdmlab.MDMEULA, error) {
		return &mdmlab.MDMEULA{}, nil
	}
	ds.MDMInsertEULAFunc = func(ctx context.Context, eula *mdmlab.MDMEULA) error {
		return nil
	}
	...
	ds.GetAllMDMConfigAssetsByNameFunc = func(ctx context.Context, assetNames []mdmlab.MDMAssetName,
		...
		return map[mdmlab.MDMAssetName]mdmlab.MDMConfigAsset{
			...
			mdmlab.MDMAssetCACert:   {Value: certPEM},
			mdmlab.MDMAssetCAKey:    {Value: keyPEM},
		}, nil
	}
...
func TestAppleMDMAuthorization(t *testing.T) {
	svc, ctx, ds := setupAppleMDMService(t, &mdmlab.LicenseInfo{Tier: mdmlab.TierPremium})

	ds.GetEnrollSecretsFunc = func(ctx context.Context, teamID *uint) ([]*mdmlab.EnrollSecret, error) {
		return []*mdmlab.EnrollSecret{
			{
				Secret: "abcd",
				TeamID: nil,
			},
	...
	testAuthdMethods := func(t *testing.T, user *mdmlab.User, shouldFailWithAuth bool) {
	...
	require.NoError(t, err)
	// Generating a new key pair does not actually make any changes to mdmlab, or expose any
	...
	ctx = test.HostContext(context.Background(), &mdmlab.Host{})
	_, err = svc.GetDeviceMDMAppleEnrollmentProfile(ctx)
	require.NoError(t, err)
	...
	ds.ListHostsLiteByUUIDsFunc = func(ctx context.Context, filter mdmlab.TeamFilter, uuids []string) ([]*mdmlab.Host, error) {
		...
		for _, uuid := range uuids {
			...
			if tmID == 0 {
				hosts = append(hosts, &mdmlab.Host{UUID: uuid, TeamID: nil})
			} else {
				hosts = append(hosts, &mdmlab.Host{UUID: uuid, TeamID: &tmID})
			}
		}
		return hosts, nil
	}
...
<dict>
	...
	t.Run("EnqueueMDMAppleCommand", func(t *testing.T) {
		...
		ctx = license.NewContext(ctx, &mdmlab.LicenseInfo{Tier: mdmlab.TierFree})
...
<dict>
    ...
    <string>uuid</string>
		...
		require.Error(t, err)
		require.ErrorContains(t, err, mdmlab.ErrMissingLicense.Error())
	})
	...
	getResults := func(commandUUID string) ([]*mdmlab.MDMCommandResult, error) {
		hosts := cmdUUIDToHostUUIDs[commandUUID]
		res := make([]*mdmlab.MDMCommandResult, 0, len(hosts))
		for _, h := range hosts {
			res = append(res, &mdmlab.MDMCommandResult{
				HostUUID: h,
			})
		}
		return res, nil
	...
	ds.GetMDMAppleCommandResultsFunc = func(ctx context.Context, commandUUID string) ([]*mdmlab.MDMCommandResult, error) {
	...
	t.Run("ListMDMAppleCommands", func(t *testing.T) {
		ds.ListMDMAppleCommandsFunc = func(ctx context.Context, tmFilter mdmlab.TeamFilter, opt *mdmlab.MDMCommandListOptions) ([]*mdmlab.MDMAppleCommand, error) {
			return []*mdmlab.MDMAppleCommand{
		...
		for _, c := range listCmdsCases {
			t.Run(c.desc, func(t *testing.T) {
				ctx = test.UserContext(ctx, c.user)
				res, err := svc.ListMDMAppleCommands(ctx, &mdmlab.MDMCommandListOptions{})
...
func TestMDMAppleConfigProfileAuthz(t *testing.T) {
	...
	ds.NewMDMAppleConfigProfileFunc = func(ctx context.Context, cp mdmlab.MDMAppleConfigProfile) (*mdmlab.MDMAppleConfigProfile, error) {
		return &cp, nil
	}
	ds.ListMDMAppleConfigProfilesFunc = func(ctx context.Context, teamID *uint) ([]*mdmlab.MDMAppleConfigProfile, error) {
		return nil, nil
	}
	ds.NewActivityFunc = func(context.Context, *mdmlab.User, mdmlab.ActivityDetails, []byte, time.Time) error {
		return nil
	}
	ds.GetMDMAppleProfilesSummaryFunc = func(context.Context, *uint) (*mdmlab.MDMProfilesSummary, error) {
		return nil, nil
	}
	...
	mockGetFuncWithTeamID := func(teamID uint) mock.GetMDMAppleConfigProfileFunc {
		return func(ctx context.Context, puid string) (*mdmlab.MDMAppleConfigProfile, error) {
			require.Equal(t, profUUID, puid)
			return &mdmlab.MDMAppleConfigProfile{TeamID: &teamID}, nil
		}
	}
	...
	mockTeamFuncWithUser := func(u *mdmlab.User) mock.TeamFunc {
		return func(ctx context.Context, teamID uint) (*mdmlab.Team, error) {
			if len(u.Teams) > 0 {
				for _, t := range u.Teams {
					if t.ID == teamID {
						return &mdmlab.Team{ID: teamID, Users: []mdmlab.TeamUser{{User: *u, Role: t.Role}}}, nil
					}
				}
			}
	...
	for _, tt := range testCases {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			_, err := svc.NewMDMAppleConfigProfile(ctx, 0, bytes.NewReader(mcBytes), nil, mdmlab.LabelsIncludeAll)
			checkShouldFail(err, tt.shouldFailGlobal)

			// test authz create new profile (team 1)
			_, err = svc.NewMDMAppleConfigProfile(ctx, 1, bytes.NewReader(mcBytes), nil, mdmlab.LabelsIncludeAll)
...
func TestNewMDMAppleConfigProfile(t *testing.T) {
	...
	cp, err := svc.NewMDMAppleConfigProfile(ctx, 0, r, nil, mdmlab.LabelsIncludeAll)
	require.NoError(t, err)
	require.Equal(t, "Foo", cp.Name)
	assert.Equal(t, identifier, cp.Identifier)
	require.Equal(t, mcBytes, []byte(cp.Mobileconfig))

	// Unsupported MDMlab variable
	mcBytes = mcBytesForTest("Foo", identifier, "UUID${FLEET_VAR_BOZO}")
	r = bytes.NewReader(mcBytes)
	_, err = svc.NewMDMAppleConfigProfile(ctx, 0, r, nil, mdmlab.LabelsIncludeAll)
	assert.ErrorContains(t, err, "MDMlab variable")
}
...
func TestNewMDMAppleDeclaration(t *testing.T) {
	...
	_, err := svc.NewMDMAppleDeclaration(ctx, 0, bytes.NewReader(b), nil, "name", mdmlab.LabelsIncludeAll)
	assert.ErrorContains(t, err, "MDMlab variable")

	ds.NewMDMAppleDeclarationFunc = func(ctx context.Context, d *mdmlab.MDMAppleDeclaration) (*mdmlab.MDMAppleDeclaration, error) {
		return d, nil
	}
	ds.NewActivityFunc = func(context.Context, *mdmlab.User, mdmlab.ActivityDetails, []byte, time.Time) error {
		return nil
	...
	d, err := svc.NewMDMAppleDeclaration(ctx, 0, bytes.NewReader(b), nil, "name", mdmlab.LabelsIncludeAll)
	require.NoError(t, err)
	assert.NotNil(t, d)
}
...
func TestHostDetailsMDMProfiles(t *testing.T) {
	...
	expected := []mdmlab.HostMDMAppleProfile{
		{HostUUID: "H057-UU1D-1337", Name: "NAME-5", ProfileUUID: "a" + uuid.NewString(), CommandUUID: "CMD-UU1D-5", Status: &mdmlab.MDMDeliveryPending, OperationType: mdmlab.MDMOperationTypeInstall, Detail: ""},
		{HostUUID: "H057-UU1D-1337", Name: "NAME-9", ProfileUUID: "a" + uuid.NewString(), CommandUUID: "CMD-UU1D-8", Status: &mdmlab.MDMDeliveryVerifying, OperationType: mdmlab.MDMOperationTypeInstall, Detail: ""},
		{HostUUID: "H057-UU1D-1337", Name: "NAME-13", ProfileUUID: "a" + uuid.NewString(), CommandUUID: "CMD-UU1D-13", Status: &mdmlab.MDMDeliveryFailed, OperationType: mdmlab.MDMOperationTypeRemove, Detail: "Error removing profile"},
	}
	...
	ds.GetHostMDMAppleProfilesFunc = func(ctx context.Context, hostUUID string) ([]mdmlab.HostMDMAppleProfile, error) {
		...
		return []mdmlab.HostMDMAppleProfile{}, nil
	}
	ds.HostFunc = func(ctx context.Context, hostID uint) (*mdmlab.Host, error) {
		if hostID == uint(42) {
			return &mdmlab.Host{ID: uint(42), UUID: "H057-UU1D-1337", Platform: "darwin"}, nil
		}
		return &mdmlab.Host{ID: hostID, UUID: "WR0N6-UU1D", Platform: "darwin"}, nil
	}
	ds.HostByIdentifierFunc = func(ctx context.Context, identifier string) (*mdmlab.Host, error) {
		if identifier == "h0571d3n71f13r" {
			return &mdmlab.Host{ID: uint(42), UUID: "H057-UU1D-1337", Platform: "darwin"}, nil
		}
		return &mdmlab.Host{ID: uint(21), UUID: "WR0N6-UU1D", Platform: "darwin"}, nil
	}
	...
	expectedNilSlice := []mdmlab.HostMDMAppleProfile(nil)
	expectedEmptySlice := []mdmlab.HostMDMAppleProfile{}
	...
	for _, c := range cases {
		t.Run(c.name, func(t *testing.T) {
			ds.AppConfigFunc = func(context.Context) (*mdmlab.AppConfig, error) {
				return &mdmlab.AppConfig{MDM: mdmlab.MDM{EnabledAndConfigured: c.mdmEnabled}}, nil
			}
			...
			var gotHost *mdmlab.HostDetail
			if c.hostID != nil {
				h, err := svc.GetHost(ctx, *c.hostID, mdmlab.HostDetailOptions{})
				require.NoError(t, err)
				require.True(t, ds.HostFuncInvoked)
				gotHost = h
			}
			if c.hostIdentifier != nil {
				h, err := svc.HostByIdentifier(ctx, *c.hostIdentifier, mdmlab.HostDetailOptions{})
				require.NoError(t, err)
			...
			if !c.mdmEnabled {
				var ep []mdmlab.HostMDMProfile
				switch c.expected {
				case &expectedNilSlice:
					ns := []mdmlab.HostMDMProfile(nil)
					ep = ns
				case &expectedEmptySlice:
					ep = []mdmlab.HostMDMProfile{}
				default:
			...
			ep := make([]mdmlab.HostMDMProfile, 0, len(*gotHost.MDM.Profiles))
			for _, p := range *c.expected {
				ep = append(ep, p.ToHostMDMProfile(gotHost.Platform))
			}
...
func TestMDMCommandAuthz(t *testing.T) {
	...
	ds.HostLiteFunc = func(ctx context.Context, hostID uint) (*mdmlab.Host, error) {
		switch hostID {
		case 1:
			return &mdmlab.Host{UUID: "test-host-team-1", TeamID: ptr.Uint(1)}, nil
		default:
			return &mdmlab.Host{UUID: "test-host-no-team"}, nil
		}
	}

	ds.GetHostMDMCheckinInfoFunc = func(ctx context.Context, hostUUID string) (*mdmlab.HostMDMCheckinInfo, error) {
		return &mdmlab.HostMDMCheckinInfo{Platform: "darwin"}, nil
	}
	...
	ds.GetNanoMDMEnrollmentFunc = func(ctx context.Context, hostUUID string) (*mdmlab.NanoEnrollment, error) {
		...
		// that is initially enrolled to MDMlab's MDM.
		enroll := mdmlab.NanoEnrollment{
...
func TestMDMAuthenticateManualEnrollment(t *testing.T) {
	...
	ds.MDMAppleUpsertHostFunc = func(ctx context.Context, mdmHost *mdmlab.Host) error {
	...
	ds.GetHostMDMCheckinInfoFunc = func(ct context.Context, hostUUID string) (*mdmlab.HostMDMCheckinInfo, error) {
		require.Equal(t, uuid, hostUUID)
		return &mdmlab.HostMDMCheckinInfo{
	...
	ds.NewActivityFunc = func(
		...
		a, ok := activity.(*mdmlab.ActivityTypeMDMEnrolled)
		require.True(t, ok)
		require.Nil(t, user)
		...
		require.Equal(t, mdmlab.MDMPlatformApple, a.MDMPlatform)
		return nil
	}
...
func TestMDMTokenUpdate(t *testing.T) {
	...
	ds.GetNanoMDMEnrollmentFunc = func(ctx context.Context, hostUUID string) (*mdmlab.NanoEnrollment, error) {
		return &mdmlab.NanoEnrollment{Enabled: true, Type: "Device", TokenUpdateTally: 1}, nil
	}
	...
	ds.NewJobFunc = func(ctx context.Context, j *mdmlab.Job) (*mdmlab.Job, error) {
		return j, nil
	}
...
func TestMDMCheckout(t *testing.T) {
	...
	ds.NewActivityFunc = func(
		...
		a, ok := activity.(*mdmlab.ActivityTypeMDMUnenrolled)
		require.True(t, ok)
		require.Nil(t, user)
...
func TestMDMCommandAndReportResultsProfileHandling(t *testing.T) {
	...
	cases := []struct {
		...
		want        *mdmlab.HostMDMAppleProfile
		prevRetries uint
	}{
		{
			status:      "Acknowledged",
	...
	for i, c := range cases {
		t.Run(fmt.Sprintf("%s%s-%d", c.requestType, c.status, i), func(t *testing.T) {
			...
			ds.UpdateOrDeleteHostMDMAppleProfileFunc = func(ctx context.Context, profile *mdmlab.HostMDMAppleProfile) error {
				c.want.CommandUUID = commandUUID
				c.want.HostUUID = hostUUID
				require.Equal(t, c.want, profile)
				return nil
			}
			ds.GetHostMDMProfileRetryCountByCommandUUIDFunc = func(ctx context.Context, host *mdmlab.Host, cmdUUID string) (mdmlab.HostMDMProfileRetryCount, error) {
				require.Equal(t, hostUUID, host.UUID)
				require.Equal(t, commandUUID, cmdUUID)
				return mdmlab.HostMDMProfileRetryCount{ProfileIdentifier: profileIdentifier, Retries: c.prevRetries}, nil
			}
			ds.UpdateHostMDMProfilesVerificationFunc = func(ctx context.Context, host *mdmlab.Host, toVerify, toFail, toRetry []string) error {
				require.Equal(t, hostUUID, host.UUID)
...
func TestMDMBatchSetAppleProfiles(t *testing.T) {
	...
	ds.TeamByNameFunc = func(ctx context.Context, name string) (*mdmlab.Team, error) {
		return &mdmlab.Team{ID: 1, Name: name}, nil
	}
	ds.TeamFunc = func(ctx context.Context, id uint) (*mdmlab.Team, error) {
		return &mdmlab.Team{ID: id, Name: "team"}, nil
	}
	ds.BatchSetMDMAppleProfilesFunc = func(ctx context.Context, teamID *uint, profiles []*mdmlab.MDMAppleConfigProfile) error {
		return nil
	}
	ds.NewActivityFunc = func(
		ctx context.Context, user *mdmlab.User, activity mdmlab.ActivityDetails, details []byte, createdAt time.Time,
	...
	ds.ListMDMConfigProfilesFunc = func(ctx context.Context, tid *uint, opt mdmlab.ListOptions) ([]*mdmlab.MDMConfigProfilePayload, *mdmlab.PaginationMetadata, error) {
		return nil, nil, nil
	}
	...
	for name := range mdmlabmdm.MDMlabReservedProfileNames() {
	...
	for _, tt := range testCases {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := viewer.NewContext(ctx, viewer.Viewer{User: tt.user})
			tier := mdmlab.TierFree
			if tt.premium {
				tier = mdmlab.TierPremium
			}
			ctx = license.NewContext(ctx, &mdmlab.LicenseInfo{Tier: tier})
...
func TestUpdateMDMAppleSettings(t *testing.T) {
	...
	ds.SaveAppConfigFunc = func(ctx context.Context, appConfig *mdmlab.AppConfig) error {
		return nil
	}
	...
	testCases := []struct {
	...
	}{
		{
			...
			false,
			nil,
			mdmlab.ErrMissingLicense.Error(),
		},
		{
...
func TestUpdateMDMAppleSetup(t *testing.T) {
	setupTest := func(tier string) (mdmlab.Service, context.Context, *mock.Store) {
		svc, ctx, ds := setupAppleMDMService(t, &mdmlab.LicenseInfo{Tier: tier})
		ds.TeamFunc = func(ctx context.Context, id uint) (*mdmlab.Team, error) {
			return &mdmlab.Team{ID: id, Name: "team"}, nil
		}
		ds.SaveTeamFunc = func(ctx context.Context, team *mdmlab.Team) (*mdmlab.Team, error) {
	...
	t.Run("FreeTier", func(t *testing.T) {
		freeTestCases := []testCase{
			{
				...
				&mdmlab.User{GlobalRole: ptr.String(mdmlab.RoleAdmin)},
				nil,
				"Requires MDMlab Premium license",
			},
			{
				"global maintainer",
				&mdmlab.User{GlobalRole: ptr.String(mdmlab.RoleMaintainer)},
		...
		svc, ctx, _ := setupTest(mdmlab.TierFree)
		for _, tt := range freeTestCases {
			t.Run(tt.name, func(t *testing.T) {
				// prepare the context with the user and license
				ctx := viewer.NewContext(ctx, viewer.Viewer{User: tt.user})
				err := svc.UpdateMDMAppleSetup(ctx, mdmlab.MDMAppleSetupPayload{TeamID: tt.teamID})
				if tt.wantErr == "" {
					require.NoError(t, err)
					return
				}
	...
	t.Run("PremiumTier", func(t *testing.T) {
		...
		svc, ctx, _ := setupTest(mdmlab.TierPremium)
...
func TestMDMAppleReconcileAppleProfiles(t *testing.T) {
	...
	ds.GetAllMDMConfigAssetsByNameFunc = func(ctx context.Context, assetNames []mdmlab.MDMAssetName,
		...
		require.NoError(t, err)
		return map[mdmlab.MDMAssetName]mdmlab.MDMConfigAsset{
			mdmlab.MDMAssetCACert: {Value: pemCert},
			mdmlab.MDMAssetCAKey:  {Value: pemKey},
		}, nil
	}
	...
	expectedContents1 := []byte("test-content-1") // used for MDMlab variable substitution
	...
	ds.ListMDMAppleProfilesToInstallFunc = func(ctx context.Context) ([]*mdmlab.MDMAppleProfilePayload, error) {
		return []*mdmlab.MDMAppleProfilePayload{
	...
	ds.ListMDMAppleProfilesToRemoveFunc = func(ctx context.Context) ([]*mdmlab.MDMAppleProfilePayload, error) {
		return []*mdmlab.MDMAppleProfilePayload{
	...
	ds.BulkDeleteMDMAppleHostsConfigProfilesFunc = func(ctx context.Context, payload []*mdmlab.MDMAppleProfilePayload) error {
	...
	var enqueueFailForOp mdmlab.MDMOperationType
	var mu sync.Mutex
	mdmStorage.EnqueueCommandFunc = func(ctx context.Context, id []string, cmd *mdm.CommandWithSubtype) (map[string]error, error) {
		...
		switch {
		case enqueueFailForOp == mdmlab.MDMOperationTypeInstall && cmd.Command.Command.RequestType == "InstallProfile":
			return nil, errors.New("enqueue error")
		case enqueueFailForOp == mdmlab.MDMOperationTypeRemove && cmd.Command.Command.RequestType == "RemoveProfile":
			return nil, errors.New("enqueue error")
		}
		return nil, nil
	}
	...
	mdmStorage.GetAllMDMConfigAssetsByNameFunc = func(ctx context.Context, assetNames []mdmlab.MDMAssetName,
		_ sqlx.QueryerContext,
	) (map[mdmlab.MDMAssetName]mdmlab.MDMConfigAsset, error) {
	...
	var failedCall bool
	var failedCheck func([]*mdmlab.MDMAppleBulkUpsertHostProfilePayload)
	ds.BulkUpsertMDMAppleHostProfilesFunc = func(ctx context.Context, payload []*mdmlab.MDMAppleBulkUpsertHostProfilePayload) error {
		if failedCall {
			failedCheck(payload)
			return nil
		}
		...
		copies := make([]*mdmlab.MDMAppleBulkUpsertHostProfilePayload, len(payload))
		for i, p := range payload {
			if p.OperationType == mdmlab.MDMOperationTypeInstall {
				...
				require.Equal(t, mdmlab.MDMOperationTypeRemove, p.OperationType)
		...
		require.ElementsMatch(t, []*mdmlab.MDMAppleBulkUpsertHostProfilePayload{
			{
				ProfileUUID:       p1,
	...
	ds.BulkUpsertMDMAppleConfigProfilesFunc = func(ctx context.Context, p []*mdmlab.MDMAppleConfigProfile) error {
		return nil
	}

	ds.AggregateEnrollSecretPerTeamFunc = func(ctx context.Context) ([]*mdmlab.EnrollSecret, error) {
		return []*mdmlab.EnrollSecret{}, nil
	}
	...
	t.Run("success", func(t *testing.T) {
		var failedCount int
		failedCall = false
		failedCheck = func(payload []*mdmlab.MDMAppleBulkUpsertHostProfilePayload) {
			failedCount++
	...
	t.Run("fail enqueue remove ops", func(t *testing.T) {
		...
		enqueueFailForOp = mdmlab.MDMOperationTypeRemove
		err := ReconcileAppleProfiles(ctx, ds, cmdr, kitlog.NewNopLogger())
		require.NoError(t, err)
		require.Equal(t, 1, failedCount)
		checkAndReset(t, true, &ds.ListMDMAppleProfilesToInstallFuncInvoked)
	...
	t.Run("fail enqueue install ops", func(t *testing.T) {
		...
		enqueueFailForOp = mdmlab.MDMOperationTypeInstall
		err := ReconcileAppleProfiles(ctx, ds, cmdr, kitlog.NewNopLogger())
		require.NoError(t, err)
		require.Equal(t, 1, failedCount)
		checkAndReset(t, true, &ds.ListMDMAppleProfilesToInstallFuncInvoked)
	...
	ctx = license.NewContext(ctx, &mdmlab.LicenseInfo{Tier: mdmlab.TierPremium})
	ds.BulkUpsertMDMManagedCertificatesFunc = func(ctx context.Context, payload []*mdmlab.MDMBulkUpsertManagedCertificatePayload) error {
		assert.Empty(t, payload)
		return nil
	}

	t.Run("replace $FLEET_VAR_"+MDMlabVarNDESSCEPProxyURL, func(t *testing.T) {
		var upsertCount int
		failedCall = false
		failedCheck = func(payload []*mdmlab.MDMAppleBulkUpsertHostProfilePayload) {
			upsertCount++
		...
		enqueueFailForOp = ""
		newContents := "$FLEET_VAR_" + MDMlabVarNDESSCEPProxyURL
	...
	t.Run("preprocessor fails on $FLEET_VAR_"+MDMlabVarHostEndUserEmailIDP, func(t *testing.T) {
		var failedCount int
		failedCall = false
		failedCheck = func(payload []*mdmlab.MDMAppleBulkUpsertHostProfilePayload) {
			failedCount++
		...
		enqueueFailForOp = ""
		newContents := "$FLEET_VAR_" + MDMlabVarHostEndUserEmailIDP
		originalContents1 := contents1
		contents1 = []byte(newContents)
		t.Cleanup(func() {
			contents1 = originalContents1
	...
	t.Run("bad $FLEET_VAR", func(t *testing.T) {
		...
		failedCheck = func(payload []*mdmlab.MDMAppleBulkUpsertHostProfilePayload) {
			...
			for _, p := range payload {
				assert.Equal(t, mdmlab.MDMDeliveryFailed, *p.Status)
...
func TestPreprocessProfileContents(t *testing.T) {
	...
	hostProfilesToInstallMap := make(map[hostProfileUUID]*mdmlab.MDMAppleBulkUpsertHostProfilePayload, 1)
	hostProfilesToInstallMap[hostProfileUUID{HostUUID: hostUUID, ProfileUUID: "p1"}] = &mdmlab.MDMAppleBulkUpsertHostProfilePayload{
		ProfileUUID:       "p1",
		ProfileIdentifier: "com.add.profile",
		HostUUID:          hostUUID,
		OperationType:     mdmlab.MDMOperationTypeInstall,
	...
	profileContents := map[string]mobileconfig.Mobileconfig{
		"p1": []byte("$FLEET_VAR_" + MDMlabVarNDESSCEPProxyURL),
	}

	var updatedPayload *mdmlab.MDMAppleBulkUpsertHostProfilePayload
	ds.BulkUpsertMDMAppleHostProfilesFunc = func(ctx context.Context, payload []*mdmlab.MDMAppleBulkUpsertHostProfilePayload) error {
		...
		for _, p := range payload {
			...
			assert.Equal(t, mdmlab.MDMOperationTypeInstall, p.OperationType)
		}
		return nil
	}
	...
	ds.GetAllMDMConfigAssetsByNameFunc = func(ctx context.Context,
		assetNames []mdmlab.MDMAssetName, _ sqlx.QueryerContext,
	) (map[mdmlab.MDMAssetName]mdmlab.MDMConfigAsset, error) {
		return map[mdmlab.MDMAssetName]mdmlab.MDMConfigAsset{
			mdmlab.MDMAssetNDESPassword: {Value: []byte(ndesPassword)},
		}, nil
	}

	ds.BulkUpsertMDMAppleHostProfilesFunc = nil
	var updatedProfile *mdmlab.HostMDMAppleProfile
	ds.UpdateOrDeleteHostMDMAppleProfileFunc = func(ctx context.Context, profile *mdmlab.HostMDMAppleProfile) error {
		updatedProfile = profile
		require.NotNil(t, updatedProfile.Status)
		assert.Equal(t, mdmlab.MDMDeliveryFailed, *updatedProfile.Status)
		assert.Equal(t, cmdUUID, updatedProfile.CommandUUID)
		assert.Equal(t, hostUUID, updatedProfile.HostUUID)
		assert.Equal(t, mdmlab.MDMOperationTypeInstall, updatedProfile.OperationType)
		return nil
	}
	ds.BulkUpsertMDMManagedCertificatesFunc = func(ctx context.Context, payload []*mdmlab.MDMBulkUpsertManagedCertificatePayload) error {
		assert.Empty(t, payload)
	...
	profileContents = map[string]mobileconfig.Mobileconfig{
		"p1": []byte("$FLEET_VAR_" + MDMlabVarNDESSCEPChallenge),
	}
	getNDESSCEPChallenge = func(ctx context.Context, proxy mdmlab.NDESSCEPProxyIntegration) (string, error) {
	...
	assert.Contains(t, updatedProfile.Detail, "FLEET_VAR_"+MDMlabVarNDESSCEPChallenge)
	...
	profileContents = map[string]mobileconfig.Mobileconfig{
		"p1": []byte("$FLEET_VAR_" + MDMlabVarHostEndUserEmailIDP),
	}
	updatedProfile = nil
	populateTargets()
	err = preprocessProfileContents(ctx, appCfg, ds, targets, profileContents, hostProfilesToInstallMap)
	require.NoError(t, err)
	require.NotNil(t, updatedProfile)
	assert.Contains(t, updatedProfile.Detail, "FLEET_VAR_"+MDMlabVarHostEndUserEmailIDP)
	...
	profileContents = map[string]mobileconfig.Mobileconfig{
		"p1": []byte("$FLEET_VAR_" + MDMlabVarNDESSCEPProxyURL),
		"p2": []byte("$FLEET_VAR_" + MDMlabVarHostEndUserEmailIDP),
	...
	addProfileToInstall := func(hostUUID, profileUUID, profileIdentifier string) {
		...
		}] = &mdmlab.MDMAppleBulkUpsertHostProfilePayload{
			ProfileUUID:       profileUUID,
	...
	ds.BulkUpsertMDMAppleHostProfilesFunc = func(ctx context.Context, payload []*mdmlab.MDMAppleBulkUpsertHostProfilePayload) error {
		for _, p := range payload {
			require.NotNil(t, p.Status)
			if mdmlab.MDMDeliveryFailed == *p.Status {
				assert.Equal(t, cmdUUID, p.CommandUUID)
			} else {
				assert.NotEqual(t, cmdUUID, p.CommandUUID)
			}
...
func TestAppleMDMFileVaultEscrowFunctions(t *testing.T) {
	...
	require.ErrorIs(t, mdmlab.ErrMissingLicense, err)
...
func TestEnsureMDMlabdConfig(t *testing.T) {
	...
	t.Run("no enroll secret found", func(t *testing.T) {
		...
		ds.BulkUpsertMDMAppleConfigProfilesFunc = func(ctx context.Context, ps []*mdmlab.MDMAppleConfigProfile) error {
			require.Empty(t, ps)
			return nil
		}
		err := ensureMDMlabProfiles(ctx, ds, logger, signingCert.Certificate[0])
		require.NoError(t, err)
	...
	t.Run("uses the enroll secret of each team if available", func(t *testing.T) {
		...
		ds.BulkUpsertMDMAppleConfigProfilesFunc = func(ctx context.Context, ps []*mdmlab.MDMAppleConfigProfile) error {
			...
			var mdmlabd, mdmlabCA []*mdmlab.MDMAppleConfigProfile
			for _, p := range ps {
				switch p.Identifier {
				case mobileconfig.MDMlabdConfigPayloadIdentifier:
					mdmlabd = append(mdmlabd, p)
				case mobileconfig.MDMlabCARootConfigPayloadIdentifier:
					mdmlabCA = append(mdmlabCA, p)
				}
			}
			require.Len(t, mdmlabd, 3)
			require.Len(t, mdmlabCA, 3)

			for i, p := range mdmlabd {
	...
	t.Run("if the team doesn't have an enroll secret, fallback to no team", func(t *testing.T) {
		...
		ds.BulkUpsertMDMAppleConfigProfilesFunc = func(ctx context.Context, ps []*mdmlab.MDMAppleConfigProfile) error {
			...
			require.Len(t, mdmlabd, 2)
			require.Len(t, mdmlabCA, 2)
...
func TestMDMAppleSetupAssistant(t *testing.T) {
	...
	ds.GetMDMAppleSetupAssistantFunc = func(ctx context.Context, teamID *uint) (*mdmlab.MDMAppleSetupAssistant, error) {
		return &mdmlab.MDMAppleSetupAssistant{}, nil
	}
	...
	for _, tt := range testCases {
		t.Run(tt.name, func(t *testing.T) {
			...
			_, err = svc.SetOrUpdateMDMAppleSetupAssistant(ctx, &mdmlab.MDMAppleSetupAssistant{
				Name:    "test",
...
func TestMDMApplePreassignEndpoints(t *testing.T) {
	svc, ctx, _ := setupAppleMDMService(t, &mdmlab.LicenseInfo{Tier: mdmlab.TierPremium})
	...
	for _, tt := range testCases {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := svc.MDMApplePreassignProfile(ctx, mdmlab.MDMApplePreassignProfilePayload{
...
func setupTest(t *testing.T) (context.Context, kitlog.Logger, *mock.Store, *config.MDMlabConfig, *mdmmock.MDMAppleStore, *apple_mdm.MDMAppleCommander) {
	ctx := context.Background()
	logger := kitlog.NewNopLogger()
	cfg := config.TestConfig()
	ds := new(mock.Store)
...
func TestRenewSCEPCertificatesBranches(t *testing.T) {
	tests := []struct {
		name               string
		customExpectations func(*testing.T, *mock.Store, *config.MDMlabConfig, *mdmmock.MDMAppleStore, *apple_mdm.MDMAppleCommander)
		expectedError      bool
	}{
		{
			name: "No Certs to Renew",
			customExpectations: func(t *testing.T, ds *mock.Store, cfg *config.MDMlabConfig, appleStore *mdmmock.MDMAppleStore, commander *apple_mdm.MDMAppleCommander) {
				ds.GetHostCertAssociationsToExpireFunc = func(ctx context.Context, expiryDays int, limit int) ([]mdmlab.SCEPIdentityAssociation, error) {
					return nil, nil
				}
			},
			expectedError: false,
		...
		},
		{
			...
			customExpectations: func(t *testing.T, ds *mock.Store, cfg *config.MDMlabConfig, appleStore *mdmmock.MDMAppleStore, commander *apple_mdm.MDMAppleCommander) {
				...
				ds.GetHostCertAssociationsToExpireFunc = func(ctx context.Context, expiryDays int, limit int) ([]mdmlab.SCEPIdentityAssociation, error) {
					return []mdmlab.SCEPIdentityAssociation{{HostUUID: "hostUUID1", EnrollReference: ""}}, nil
				}
				...
				ds.SetCommandForPendingSCEPRenewalFunc = func(ctx context.Context, assocs []mdmlab.SCEPIdentityAssociation, cmdUUID string) error {
		...
		},
		{
			...
			customExpectations: func(t *testing.T, ds *mock.Store, cfg *config.MDMlabConfig, appleStore *mdmmock.MDMAppleStore, commander *apple_mdm.MDMAppleCommander) {
				var wantCommandUUID string
				ds.GetHostCertAssociationsToExpireFunc = func(ctx context.Context, expiryDays int, limit int) ([]mdmlab.SCEPIdentityAssociation, error) {
					return []mdmlab.SCEPIdentityAssociation{{HostUUID: "hostUUID2", EnrollReference: "ref1"}}, nil
				}
				appleStore.EnqueueCommandFunc = func(ctx context.Context, id []string, cmd *mdm.CommandWithSubtype) (map[string]error,
					error) {
					require.Equal(t, "InstallProfile", cmd.Command.Command.RequestType)
		...
		},
		{
			...
			customExpectations: func(t *testing.T, ds *mock.Store, cfg *config.MDMlabConfig, appleStore *mdmmock.MDMAppleStore, commander *apple_mdm.MDMAppleCommander) {
				ds.GetHostCertAssociationsToExpireFunc = func(ctx context.Context, expiryDays int, limit int) ([]mdmlab.SCEPIdentityAssociation, error) {
					return []mdmlab.SCEPIdentityAssociation{{HostUUID: "hostUUID1", EnrollReference: "ref1"}}, nil
				}
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			ds.GetHostCertAssociationsToExpireFunc = func(ctx context.Context, expiryDays int, limit int) ([]mdmlab.SCEPIdentityAssociation, error) {
				return []mdmlab.SCEPIdentityAssociation{}, nil
			}
...
func TestMDMCommandAndReportResultsIOSIPadOSRefetch(t *testing.T) {
	...
	hostID := uint(42)
	hostUUID := "ABC-DEF-GHI"
	commandUUID := mdmlab.RefetchDeviceCommandUUIDPrefix + "UUID"
	...
	ds.UpdateHostFunc = func(ctx context.Context, host *mdmlab.Host) error {
	...
	ds.UpdateHostOperatingSystemFunc = func(ctx context.Context, hostID uint, hostOS mdmlab.OperatingSystem) error {
		require.Equal(t, hostID, hostID)
	...
	ds.RemoveHostMDMCommandFunc = func(ctx context.Context, command mdmlab.HostMDMCommand) error {
		assert.Equal(t, hostID, command.HostID)
		assert.Equal(t, mdmlab.RefetchDeviceCommandUUIDPrefix, command.CommandType)
		return nil
	}
...
func TestCheckMDMAppleEnrollmentWithMinimumOSVersion(t *testing.T) {
	...
	for _, tt := range testCases {
		t.Run(tt.name, func(t *testing.T) {
			t.Run("settings minimum equal to latest", func(t *testing.T) {
				ds.GetMDMAppleOSUpdatesSettingsByHostSerialFunc = func(ctx context.Context, serial string) (*mdmlab.AppleOSUpdateSettings, error) {
					return &mdmlab.AppleOSUpdateSettings{
				...
				if tt.updateRequired != nil {
					require.Equal(t, &mdmlab.MDMAppleSoftwareUpdateRequired{
						Code:    mdmlab.MDMAppleSoftwareUpdateRequiredCode,
			...
			t.Run("minimum not set", func(t *testing.T) {
				ds.GetMDMAppleOSUpdatesSettingsByHostSerialFunc = func(ctx context.Context, serial string) (*mdmlab.AppleOSUpdateSettings, error) {
					return &mdmlab.AppleOSUpdateSettings{}, nil
				}
				sur, err := svc.CheckMDMAppleEnrollmentWithMinimumOSVersion(ctx, tt.machineInfo)
				require.NoError(t, err)
				require.Nil(t, sur)
	...
	t.Run("gdmf server is down", func(t *testing.T) {
		...
		for _, tt := range testCases {
			t.Run(tt.name, func(t *testing.T) {
				ds.GetMDMAppleOSUpdatesSettingsByHostSerialFunc = func(ctx context.Context, serial string) (*mdmlab.AppleOSUpdateSettings, error) {
					return &mdmlab.AppleOSUpdateSettings{MinimumVersion: optjson.SetString(latestMacOSVersion)}, nil
				}
