...
func TestGetMDMApple(t *testing.T) {
	...
	ds.GetAllMDMConfigAssetsByNameFunc = func(ctx context.Context, assetNames []mdmlab.MDMAssetName,
		...
		return map[mdmlab.MDMAssetName]mdmlab.MDMConfigAsset{
			mdmlab.MDMAssetAPNSCert: {Name: mdmlab.MDMAssetAPNSCert, Value: certPEM},
			mdmlab.MDMAssetAPNSKey:  {Name: mdmlab.MDMAssetAPNSKey, Value: keyPEM},
	...
	require.Equal(t, &mdmlab.AppleMDM{
...
func TestMDMAppleAuthorization(t *testing.T) {
	...
	ds.InsertMDMConfigAssetsFunc = func(ctx context.Context, assets []mdmlab.MDMConfigAsset, _ sqlx.ExtContext) error { return nil }

	ds.AppConfigFunc = func(ctx context.Context) (*mdmlab.AppConfig, error) {
		return &mdmlab.AppConfig{OrgInfo: mdmlab.OrgInfo{OrgName: "Nurv"}}, nil
	}
	...
	ds.GetVPPTokenFunc = func(ctx context.Context, id uint) (*mdmlab.VPPTokenDB, error) {
		return nil, &notFoundErr{}
	}

	ds.DeleteMDMConfigAssetsByNameFunc = func(ctx context.Context, assetNames []mdmlab.MDMAssetName) error { return nil }
...
func TestVerifyMDMAppleConfigured(t *testing.T) {
	...
	ds.AppConfigFunc = func(ctx context.Context) (*mdmlab.AppConfig, error) {
		return &mdmlab.AppConfig{MDM: mdmlab.MDM{EnabledAndConfigured: false}}, nil
	}
	err := svc.VerifyMDMAppleConfigured(ctx)
	require.ErrorIs(t, err, mdmlab.ErrMDMNotConfigured)
...
func TestVerifyMDMWindowsConfigured(t *testing.T) {
	...
	ctx := authz_ctx.NewContext(baseCtx, authzCtx)
	ds.AppConfigFunc = func(ctx context.Context) (*mdmlab.AppConfig, error) {
		return &mdmlab.AppConfig{MDM: mdmlab.MDM{WindowsEnabledAndConfigured: false}}, nil
	}
...
func TestMicrosoftWSTEPConfig(t *testing.T) {
	...
	ds.WSTEPStoreCertificateFunc = func(ctx context.Context, name string, crt *x509.Certificate) error {
		...
		require.Equal(t, "MDMlab", crt.Subject.OrganizationalUnit[0])
		return nil
	}
	...
	require.Equal(t, "MDMlab", parsedCert.Subject.OrganizationalUnit[0])
}
...
func TestRunMDMCommandAuthz(t *testing.T) {
	...
	singleUnenrolledHost := []*mdmlab.Host{{ID: 1, TeamID: ptr.Uint(1), UUID: "a", Platform: "darwin"}}
	team1And2UnenrolledHosts := []*mdmlab.Host{{ID: 1, TeamID: ptr.Uint(1), UUID: "a"}, {ID: 2, TeamID: ptr.Uint(2), UUID: "b"}}
	team2And3UnenrolledHosts := []*mdmlab.Host{{ID: 2, TeamID: ptr.Uint(2), UUID: "b"}, {ID: 3, TeamID: ptr.Uint(3), UUID: "c"}}
	...
	userTeamMaintainerTeam1And2 := &mdmlab.User{
		ID: 100,
	...
	userTeamAdminTeam1And2 := &mdmlab.User{
		ID: 101,
		Teams: []mdmlab.UserTeam{
			{
				Team: mdmlab.Team{ID: 1},
	...
	userTeamAdminTeam1ObserverTeam2 := &mdmlab.User{
		ID: 102,
		Teams: []mdmlab.UserTeam{
			{
				Team: mdmlab.Team{ID: 1},
...
func TestRunMDMCommandValidations(t *testing.T) {
	...
	enrolledMDMInfo := &mdmlab.HostMDM{Enrolled: true, InstalledFromDep: false, Name: mdmlab.WellKnownMDMMDMlab, IsServer: false}
	singleUnenrolledHost := []*mdmlab.Host{{ID: 0xf1337, TeamID: ptr.Uint(1), UUID: "unenrolled"}}
	differentPlatformsHosts := []*mdmlab.Host{
		{ID: 1, UUID: "a", Platform: "darwin"},
		{ID: 2, UUID: "b", Platform: "windows"},
	}
	linuxSingleHost := []*mdmlab.Host{{ID: 1, TeamID: ptr.Uint(1), UUID: "a", Platform: "linux"}}
	windowsSingleHost := []*mdmlab.Host{{ID: 1, TeamID: ptr.Uint(1), UUID: "a", Platform: "windows"}}
	macosSingleHost := []*mdmlab.Host{{ID: 1, TeamID: ptr.Uint(1), UUID: "a", Platform: "darwin"}}
	...
	cases := []struct {
		...
		{"no hosts", []*mdmlab.Host{}, false, "No hosts targeted."},
...
func TestMDMCommonAuthorization(t *testing.T) {
	...
	ds.GetMDMAppleFileVaultSummaryFunc = func(ctx context.Context, teamID *uint) (*mdmlab.MDMAppleFileVaultSummary, error) {
		return &mdmlab.MDMAppleFileVaultSummary{}, nil
	}
	ds.GetMDMWindowsBitLockerSummaryFunc = func(ctx context.Context, teamID *uint) (*mdmlab.MDMWindowsBitLockerSummary, error) {
		return &mdmlab.MDMWindowsBitLockerSummary{}, nil
	}
	ds.GetMDMWindowsProfilesSummaryFunc = func(ctx context.Context, teamID *uint) (*mdmlab.MDMProfilesSummary, error) {
		return &mdmlab.MDMProfilesSummary{}, nil
	}

	ds.GetLinuxDiskEncryptionSummaryFunc = func(ctx context.Context, teamID *uint) (mdmlab.MDMLinuxDiskEncryptionSummary, error) {
		return mdmlab.MDMLinuxDiskEncryptionSummary{}, nil
	}
...
func TestEnqueueWindowsMDMCommand(t *testing.T) {
	...
	cases := []struct {
		...
		{"premium command, non premium license", false, `
			...
			</Exec>`, "Requires MDMlab Premium license", ""},
...
func TestGetMDMDiskEncryptionSummary(t *testing.T) {
	...
	ds.GetMDMAppleFileVaultSummaryFunc = func(ctx context.Context, teamID *uint) (*mdmlab.MDMAppleFileVaultSummary, error) {
		...
		return &mdmlab.MDMAppleFileVaultSummary{Verified: 1, Verifying: 2, ActionRequired: 3, Failed: 4, Enforcing: 5, RemovingEnforcement: 6}, nil
	}
	ds.GetMDMWindowsBitLockerSummaryFunc = func(ctx context.Context, teamID *uint) (*mdmlab.MDMWindowsBitLockerSummary, error) {
		require.Nil(t, teamID)
		// Use default zeros verifying, action_required, or removing_enforcement
		return &mdmlab.MDMWindowsBitLockerSummary{Verified: 7, Failed: 8, Enforcing: 9}, nil
	}
	ds.AreHostsConnectedToMDMlabMDMFunc = func(ctx context.Context, hosts []*mdmlab.Host) (map[string]bool, error) {
		res := make(map[string]bool, len(hosts))
		for _, h := range hosts {
	...
	ds.GetLinuxDiskEncryptionSummaryFunc = func(ctx context.Context, teamID *uint) (mdmlab.MDMLinuxDiskEncryptionSummary, error) {
		require.Nil(t, teamID)
		return mdmlab.MDMLinuxDiskEncryptionSummary{Verified: 1, ActionRequired: 2, Failed: 3}, nil
	}
	...
	require.Equal(t, *des, mdmlab.MDMDiskEncryptionSummary{
...
func TestMDMWindowsConfigProfileAuthz(t *testing.T) {
	...
	ds.GetMDMWindowsConfigProfileFunc = func(ctx context.Context, pid string) (*mdmlab.MDMWindowsConfigProfile, error) {
		var tid uint
		if pid == "team-1" {
			tid = 1
		}
		return &mdmlab.MDMWindowsConfigProfile{
			ProfileUUID: pid,
			TeamID:      &tid,
		}, nil
	}
	...
	ds.NewMDMWindowsConfigProfileFunc = func(ctx context.Context, cp mdmlab.MDMWindowsConfigProfile) (*mdmlab.MDMWindowsConfigProfile, error) {
		return &cp, nil
	}
	ds.ListMDMConfigProfilesFunc = func(ctx context.Context, teamID *uint, opt mdmlab.ListOptions) ([]*mdmlab.MDMConfigProfilePayload, *mdmlab.PaginationMetadata, error) {
		return nil, nil, nil
	}
	...
	for _, tt := range testCases {
		t.Run(tt.name, func(t *testing.T) {
			...
			_, _, err = svc.ListMDMConfigProfiles(ctx, nil, mdmlab.ListOptions{})
			checkShouldFail(t, err, tt.shouldFailGlobalRead)

			// test authz list config profiles (team 1)
			_, _, err = svc.ListMDMConfigProfiles(ctx, ptr.Uint(1), mdmlab.ListOptions{})
			checkShouldFail(t, err, tt.shouldFailTeamRead)

			// test authz create new profile (no team)
			_, err = svc.NewMDMWindowsConfigProfile(ctx, 0, "prof", strings.NewReader(winProfContent), nil, mdmlab.LabelsIncludeAll)
			checkShouldFail(t, err, tt.shouldFailGlobalWrite)

			// test authz create new profile (team 1)
			_, err = svc.NewMDMWindowsConfigProfile(ctx, 1, "prof", strings.NewReader(winProfContent), nil, mdmlab.LabelsIncludeAll)
...
func TestUploadWindowsMDMConfigProfileValidations(t *testing.T) {
	...
	cases := []struct {
		...
		{"unsupported MDMlab variable", 0, `<Replace>$FLEET_VAR_BOZO</Replace>`, true, "MDMlab variable"},
	...
	for _, c := range cases {
		t.Run(c.desc, func(t *testing.T) {
			...
			ctx = test.UserContext(ctx, test.UserAdmin)
			_, err := svc.NewMDMWindowsConfigProfile(ctx, c.tmID, "foo", strings.NewReader(c.profile), nil, mdmlab.LabelsIncludeAll)
			if c.wantErr != "" {
				require.Error(t, err)
				require.ErrorContains(t, err, c.wantErr)
			} else {
...
func TestMDMBatchSetProfiles(t *testing.T) {
	...
	ds.BatchSetMDMProfilesFunc = func(ctx context.Context, tmID *uint, macProfiles []*mdmlab.MDMAppleConfigProfile,
		winProfiles []*mdmlab.MDMWindowsConfigProfile, macDecls []*mdmlab.MDMAppleDeclaration,
	) (updates mdmlab.MDMProfilesUpdates, err error) {
		return mdmlab.MDMProfilesUpdates{}, nil
	}
	...
	testCases := []struct {
		...
		teamID   *uint
		teamName *string
		profiles []mdmlab.MDMProfileBatchPayload
		wantErr  string
	}{
		{
			"global admin",
		...
		{
			"unsupported Apple config profile MDMlab variable",
			&mdmlab.User{GlobalRole: ptr.String(mdmlab.RoleAdmin)},
			false,
			nil,
			nil,
		...
		{
			"unsupported Apple declaration MDMlab variable",
			&mdmlab.User{GlobalRole: ptr.String(mdmlab.RoleAdmin)},
			false,
			nil,
			nil,
		...
		{
			"unsupported Windows MDMlab variable",
			&mdmlab.User{GlobalRole: ptr.String(mdmlab.RoleAdmin)},
			false,
			nil,
			nil,
...
func TestValidateProfiles(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			profiles := make(map[int]mdmlab.MDMProfileBatchPayload, len(tt.profiles))
...
func TestMDMResendConfigProfileAuthz(t *testing.T) {
	...
	ds.HostLiteFunc = func(ctx context.Context, hid uint) (*mdmlab.Host, error) {
		if hid == 1 {
			return &mdmlab.Host{ID: hid, UUID: "host-uuid-1", Platform: "darwin", TeamID: ptr.Uint(1)}, nil
		} else if hid == 1337 {
			return &mdmlab.Host{ID: hid, UUID: "host-uuid-no-team", Platform: "darwin", TeamID: nil}, nil
		}
		return nil, &notFoundErr{}
	}
	ds.GetMDMAppleConfigProfileFunc = func(ctx context.Context, pid string) (*mdmlab.MDMAppleConfigProfile, error) {
		var tid uint
	...
	ds.GetHostMDMProfileInstallStatusFunc = func(ctx context.Context, hostUUID string, profUUID string) (mdmlab.MDMDeliveryStatus, error) {
		return mdmlab.MDMDeliveryFailed, nil
	}
...
func TestBatchSetMDMProfilesLabels(t *testing.T) {
	...
	ds.BatchSetMDMProfilesFunc = func(ctx context.Context, tmID *uint, macProfiles []*mdmlab.MDMAppleConfigProfile, winProfiles []*mdmlab.MDMWindowsConfigProfile, macDeclarations []*mdmlab.MDMAppleDeclaration) (updates mdmlab.MDMProfilesUpdates, err error) {
	...
	ds.BulkSetPendingMDMHostProfilesFunc = func(ctx context.Context, hostIDs, teamIDs []uint, profileUUIDs, hostUUIDs []string) (updates mdmlab.MDMProfilesUpdates, err error) {
		return mdmlab.MDMProfilesUpdates{}, nil
	}
	var labelID uint
