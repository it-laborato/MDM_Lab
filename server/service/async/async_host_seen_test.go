...
func testCollectHostsLastSeen(t *testing.T, ds *mysql.Datastore, pool mdmlab.RedisPool) {
...
func testRecordHostLastSeenSync(t *testing.T, ds *mock.Store, pool mdmlab.RedisPool) {
	ctx := context.Background()
...
func testRecordHostLastSeenAsync(t *testing.T, ds *mock.Store, pool mdmlab.RedisPool) {
	ctx := context.Background()
