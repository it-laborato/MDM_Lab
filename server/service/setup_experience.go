...
func putSetupExperienceSoftware(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func getSetupExperienceSoftware(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func getSetupExperienceScriptEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func setSetupExperienceScriptEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func deleteSetupExperienceScriptEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) SetupExperienceNextStep(ctx context.Context, hostUUID string) (bool, error) {
	...
	return false, mdmlab.ErrMissingLicense
}
...
func maybeUpdateSetupExperienceStatus(ctx context.Context, ds mdmlab.Datastore, result interface{}, requireTerminalStatus bool) (bool, error) {
	switch v := result.(type) {
	case mdmlab.SetupExperienceScriptResult:
	...
	case mdmlab.SetupExperienceSoftwareInstallResult:
		status := v.SetupExperienceStatus()
		fmt.Println(status)
		if !status.IsValid() {
			return false, fmt.Errorf("invalid status: %s", status)
	...
	case mdmlab.SetupExperienceVPPInstallResult:
