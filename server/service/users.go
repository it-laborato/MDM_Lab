...
type createUserResponse struct {
	User *mdmlab.User `json:"user,omitempty"`
...
func createUserEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
var errMailerRequiredForMFA = badRequest("Email must be set up to enable MDMlab MFA")

func (svc *Service) CreateUser(ctx context.Context, p mdmlab.UserPayload) (*mdmlab.User, *string, error) {
	var teams []mdmlab.UserTeam
	if p.Teams != nil {
		teams = *p.Teams
	}
	if err := svc.authz.Authorize(ctx, &mdmlab.User{Teams: teams}, mdmlab.ActionWrite); err != nil {
		return nil, nil, err
	}
		...
		for _, userTeam := range teams {
			...
			if !ok {
				return nil, nil, ctxerr.Wrap(
					ctx, mdmlab.NewInvalidArgumentError("teams.id", fmt.Sprintf("team with id %d does not exist", userTeam.Team.ID)),
				)
			}
		}
	}
...
func createUserFromInviteEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
	req := request.(*createUserRequest)
...
func (svc *Service) CreateUserFromInvite(ctx context.Context, p mdmlab.UserPayload) (*mdmlab.User, error) {
...
type listUsersRequest struct {
	ListOptions mdmlab.UserListOptions `url:"user_options"`
}

type listUsersResponse struct {
	Users []mdmlab.User `json:"users"`
	Err   error        `json:"error,omitempty"`
}

func (r listUsersResponse) error() error { return r.Err }

func listUsersEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) ListUsers(ctx context.Context, opt mdmlab.UserListOptions) ([]*mdmlab.User, error) {
	user := &mdmlab.User{}
	if opt.TeamID != 0 {
		user.Teams = []mdmlab.UserTeam{{Team: mdmlab.Team{ID: opt.TeamID}}}
	}
	if err := svc.authz.Authorize(ctx, user, mdmlab.ActionRead); err != nil {
		return nil, err
	}
...
func meEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
	...
	if err != nil {
		if errors.Is(err, mdmlab.ErrMissingLicense) {
	...
	var userSettings *mdmlab.UserSettings
...
func (svc *Service) AuthenticatedUser(ctx context.Context) (*mdmlab.User, error) {
	vc, ok := viewer.FromContext(ctx)
	if !ok {
		return nil, mdmlab.ErrNoContext
	}

	if err := svc.authz.Authorize(ctx, &mdmlab.User{ID: vc.UserID()}, mdmlab.ActionRead); err != nil {
		return nil, err
	}

	if !vc.IsLoggedIn() {
		return nil, mdmlab.NewPermissionError("not logged in")
	}
	return vc.User, nil
}
...
type getUserResponse struct {
	User           *mdmlab.User          `json:"user,omitempty"`
	AvailableTeams []*mdmlab.TeamSummary `json:"available_teams"`
	Settings       *mdmlab.UserSettings  `json:"settings,omitempty"`
	Err            error                `json:"error,omitempty"`
}

func (r getUserResponse) error() error { return r.Err }

func getUserEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) GetUserSettings(ctx context.Context, userID uint) (*mdmlab.UserSettings, error) {
	if err := svc.authz.Authorize(ctx, &mdmlab.User{ID: userID}, mdmlab.ActionRead); err != nil {
		return nil, err
	}
...
func (svc *Service) User(ctx context.Context, id uint) (*mdmlab.User, error) {
...
func modifyUserEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) ModifyUser(ctx context.Context, userID uint, p mdmlab.UserPayload) (*mdmlab.User, error) {
	...
	if err := svc.authz.Authorize(ctx, user, mdmlab.ActionWrite); err != nil {
		return nil, err
	}
	...
	if p.GlobalRole != nil || p.Teams != nil {
		if err := svc.authz.Authorize(ctx, user, mdmlab.ActionWriteRole); err != nil {
			return nil, err
		}
		...
		if err := mdmlab.ValidateUserRoles(false, p, *license); err != nil {
			return nil, ctxerr.Wrap(ctx, err, "validate role")
		}
	}

	if p.NewPassword != nil {
		if err := svc.authz.Authorize(ctx, user, mdmlab.ActionChangePassword); err != nil {
			return nil, err
		}
		if err := mdmlab.ValidatePasswordRequirements(*p.NewPassword); err != nil {
			return nil, ctxerr.Wrap(ctx, mdmlab.NewInvalidArgumentError("new_password", err.Error()))
		}
		if ownUser {
			...
			if err := vc.User.ValidatePassword(*p.NewPassword); err == nil {
				return nil, ctxerr.Wrap(ctx, mdmlab.NewInvalidArgumentError("new_password", "Cannot reuse old password"))
			}
			if err := vc.User.ValidatePassword(*p.Password); err != nil {
				return nil, ctxerr.Wrap(ctx, mdmlab.NewPermissionError("incorrect password"))
			}
		}
	}
	...
	if p.GlobalRole != nil && *p.GlobalRole != "" {
		if currentUser.GlobalRole == nil {
			return nil, authz.ForbiddenWithInternal(
				...
				currentUser, user, mdmlab.ActionWriteRole,
			)
		}

		if p.Teams != nil && len(*p.Teams) > 0 {
			return nil, mdmlab.NewInvalidArgumentError("teams", "may not be specified with global_role")
		}
		user.GlobalRole = p.GlobalRole
		user.Teams = []mdmlab.UserTeam{}
	} else if p.Teams != nil {
	...
	if err := mdmlab.LogRoleChangeActivities(ctx, svc, adminUser, oldGlobalRole, oldTeams, user); err != nil {
		return nil, err
	}
...
func deleteUserEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) DeleteUser(ctx context.Context, id uint) error {
	...
	if err := svc.NewActivity(
		ctx,
		adminUser,
		mdmlab.ActivityTypeDeletedUser{
			UserID:    user.ID,
			UserName:  user.Name,
...
func requirePasswordResetEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) RequirePasswordReset(ctx context.Context, uid uint, require bool) (*mdmlab.User, error) {
	if err := svc.authz.Authorize(ctx, &mdmlab.User{ID: uid}, mdmlab.ActionWrite); err != nil {
		return nil, err
	}
...
func changePasswordEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) ChangePassword(ctx context.Context, oldPass, newPass string) error {
	...
	if err := svc.authz.Authorize(ctx, vc.User, mdmlab.ActionChangePassword); err != nil {
		return err
	}

	if oldPass == "" {
		return ctxerr.Wrap(ctx, mdmlab.NewInvalidArgumentError("old_password", "Old password cannot be empty"))
	}
	if newPass == "" {
		return ctxerr.Wrap(ctx, mdmlab.NewInvalidArgumentError("new_password", "New password cannot be empty"))
	}
	if err := mdmlab.ValidatePasswordRequirements(newPass); err != nil {
		return ctxerr.Wrap(ctx, mdmlab.NewInvalidArgumentError("new_password", err.Error()))
	}
	...
	if err := vc.User.ValidatePassword(newPass); err == nil {
		return ctxerr.Wrap(ctx, mdmlab.NewInvalidArgumentError("new_password", "Cannot reuse old password"))
	}
	if err := vc.User.ValidatePassword(oldPass); err != nil {
		return ctxerr.Wrap(ctx, mdmlab.NewInvalidArgumentError("old_password", "old password does not match"))
	}
...
func getInfoAboutSessionsForUserEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) GetInfoAboutSessionsForUser(ctx context.Context, id uint) ([]*mdmlab.Session, error) {
	if err := svc.authz.Authorize(ctx, &mdmlab.Session{UserID: id}, mdmlab.ActionRead); err != nil {
		return nil, err
	}

	var validatedSessions []*mdmlab.Session
...
func deleteSessionsForUserEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) DeleteSessionsForUser(ctx context.Context, id uint) error {
	if err := svc.authz.Authorize(ctx, &mdmlab.Session{UserID: id}, mdmlab.ActionWrite); err != nil {
		return err
	}
...
func changeEmailEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) ChangeUserEmail(ctx context.Context, token string) (string, error) {
	...
	if err := svc.authz.Authorize(ctx, &mdmlab.User{ID: vc.UserID()}, mdmlab.ActionWrite); err != nil {
		return "", err
	}
...
func isAdminOfTheModifiedTeams(currentUser *mdmlab.User, originalUserTeams, newUserTeams []mdmlab.UserTeam) bool {
	// Global admins can modify all user teams roles.
	if currentUser.GlobalRole != nil && *currentUser.GlobalRole == mdmlab.RoleAdmin {
		return true
	}
...
func (svc *Service) modifyEmailAddress(ctx context.Context, user *mdmlab.User, email string, password *string) error {
	// password requirement handled in validation middleware
	if password != nil {
		err := user.ValidatePassword(*password)
		if err != nil {
			return mdmlab.NewPermissionError("incorrect password")
		}
	}
	...
	changeEmail := mdmlab.Email{
		Subject:      "Confirm MDMlab Email Change",
		To:           []string{email},
...
func (svc *Service) saveUser(ctx context.Context, user *mdmlab.User) error {
...
func performRequiredPasswordResetEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) PerformRequiredPasswordReset(ctx context.Context, password string) (*mdmlab.User, error) {
	vc, ok := viewer.FromContext(ctx)
	if !ok {
	...
	if !vc.CanPerformPasswordReset() {
		svc.authz.SkipAuthorization(ctx)
		return nil, mdmlab.NewPermissionError("cannot reset password")
	}
	user := vc.User
	...
	if user.SSOEnabled {
		...
		err := mdmlab.NewPermissionError("password reset for single sign on user not allowed")
		return nil, ctxerr.Wrap(ctx, err)
	}
	if !user.IsAdminForcedPasswordReset() {
		// should never happen because this would get caught by the
		// CanPerformPasswordReset check above
		err := mdmlab.NewPermissionError("cannot reset password")
		return nil, ctxerr.Wrap(ctx, err)
	}

	// prevent setting the same password
	if err := user.ValidatePassword(password); err == nil {
		return nil, mdmlab.NewInvalidArgumentError("new_password", "Cannot reuse old password")
	}

	if err := mdmlab.ValidatePasswordRequirements(password); err != nil {
		return nil, mdmlab.NewInvalidArgumentError("new_password", "Password does not meet required criteria: Must include 12 characters, at least 1 number (e.g. 0 - 9), and at least 1 symbol (e.g. &*#).")
	}
...
// performed.
func (svc *Service) setNewPassword(ctx context.Context, user *mdmlab.User, password string) error {
...
func resetPasswordEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) ResetPassword(ctx context.Context, token, password string) error {
	...
	if token == "" {
		return ctxerr.Wrap(ctx, mdmlab.NewInvalidArgumentError("token", "Token cannot be empty field"))
	}
	if password == "" {
		return ctxerr.Wrap(ctx, mdmlab.NewInvalidArgumentError("new_password", "New password cannot be empty field"))
	}
	if err := mdmlab.ValidatePasswordRequirements(password); err != nil {
		return ctxerr.Wrap(ctx, mdmlab.NewInvalidArgumentError("new_password", err.Error()))
	}
	...
	if err != nil {
		return ctxerr.Wrap(ctx, mdmlab.NewAuthFailedError(err.Error()), "find password reset request by token")
	}
	user, err := svc.ds.UserByID(ctx, reset.UserID)
	if err != nil {
		return ctxerr.Wrap(ctx, mdmlab.NewAuthFailedError(err.Error()), "find user by id")
	}
	...
	// prevent setting the same password
	if err := user.ValidatePassword(password); err == nil {
		return mdmlab.NewInvalidArgumentError("new_password", "Cannot reuse old password")
	}

	// password requirements are validated as part of `setNewPassword``
	err = svc.setNewPassword(ctx, user, password)
	if err != nil {
		return mdmlab.NewInvalidArgumentError("new_password", err.Error())
	}
...
func forgotPasswordEndpoint(ctx context.Context, request interface{}, svc mdmlab.Service) (errorer, error) {
...
func (svc *Service) RequestPasswordReset(ctx context.Context, email string) error {
	...
	request := &mdmlab.PasswordResetRequest{
		UserID: user.ID,
		Token:  token,
	}
	...
	resetEmail := mdmlab.Email{
		Subject:      "Reset Your MDMlab Password",
