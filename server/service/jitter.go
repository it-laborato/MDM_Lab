...
// jitterHashTable implements a data structure that allows a mdmlab to generate a static jitter value
...
// Hosts that have been placed in a bucket remain in that bucket for as long as the mdmlab instance is
// running.
...
// The main caveat of this approach is that it works at the mdmlab instance. So depending on what
