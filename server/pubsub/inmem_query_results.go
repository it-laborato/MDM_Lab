...
var _ mdmlab.QueryResultStore = &inmemQueryResults{}
...
func (im *inmemQueryResults) WriteResult(result mdmlab.DistributedQueryResult) error {
...
func (im *inmemQueryResults) ReadChannel(ctx context.Context, campaign mdmlab.DistributedQueryCampaign) (<-chan interface{}, error) {
