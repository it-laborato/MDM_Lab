...
// Capability represents a concrete feature of MDMlab.
...
// The following are the capabilities that MDMlab supports. These can be used by
// the MDMlab server, Orbit or MDMlab Desktop to communicate that a given feature
// is supported.
const (
	...
	// `/api/mdmlab/orbit`, and allow enrolling a host through Orbit among other
	// functionality.
...
const CapabilitiesHeader = "X-MDMlab-Capabilities"
