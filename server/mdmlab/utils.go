...
func WriteExpiredLicenseBanner(w io.Writer) {
	...
	warningColor.Fprintf(
		w,
		"Your license for MDMlab Premium is about to expire. If you’d like to renew or have questions about "+
			"downgrading, please navigate to "+
			"https://mdmlabdm.com/docs/using-mdmlab/faq#how-do-i-downgrade-from-mdmlab-premium-to-mdmlab-free and "+
			"contact us for help.",
	)
