...
// DesktopSummary is a summary of the status of a host that's used by MDMlab
...
// DesktopNotifications are notifications that the mdmlab server sends to
// MDMlab Desktop so that it can run commands or more generally react to this
// information.
...
// DesktopConfig is a subset of AppConfig with information relevant to MDMlab
// Desktop to operate.
...
// DesktopMDMConfig is a subset of mdmlab.MDM with configuration that's relevant
// to MDMlab Desktop to operate.
...
// DesktopMDMConfig is a subset of mdmlab.OrgInfo with configuration that's relevant
// to MDMlab Desktop to operate.
