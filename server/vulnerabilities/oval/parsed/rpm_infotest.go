...
// return nil.
func (t *RpmInfoTest) Eval(packages []mdmlab.Software) ([]mdmlab.Software, error) {
	if len(packages) == 0 {
		return nil, nil
	}
...
func (t *RpmInfoTest) matches(software []mdmlab.Software) (int, int, []mdmlab.Software, error) {
	var nObjects int
	var nState int
