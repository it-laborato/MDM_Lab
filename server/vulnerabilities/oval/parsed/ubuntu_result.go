...
func (r UbuntuResult) Eval(ver mdmlab.OSVersion, software []mdmlab.Software) ([]mdmlab.SoftwareVulnerability, error) {
...
func (r UbuntuResult) EvalKernel(software []mdmlab.Software) ([]mdmlab.SoftwareVulnerability, error) {
