...
func (p Products) GetMatchForOS(ctx context.Context, os mdmlab.OperatingSystem) (string, error) {
	...
	for pID, product := range p {
		...
		// updated after an upgrade to mdmlab v4.44.0 or later
...
func NewProductFromOS(os mdmlab.OperatingSystem) Product {
