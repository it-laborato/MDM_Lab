...
// stored in our Github NVD repo (https://github.com/mdmlabdm/nvd/releases)
...
// Note asset stored in our Github NVD repo (https://github.com/mdmlabdm/nvd/releases)
...
// (https://github.com/mdmlabdm/nvd/releases) and collects all assets that start with 'prefix',
