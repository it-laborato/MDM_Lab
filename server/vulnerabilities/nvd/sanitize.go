...
func sanitizeSoftwareName(s *mdmlab.Software) string {
...
func productVariations(s *mdmlab.Software) []string {
	var r []string
...
func vendorVariations(s *mdmlab.Software) []string {
	var r []string
	rSet := make(map[string]bool)
...
func targetSW(s *mdmlab.Software) string {
	switch s.Source {
	case "apps":
		return "macos"
