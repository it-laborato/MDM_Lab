...
func NewContext(ctx context.Context, lic *mdmlab.LicenseInfo) context.Context {
...
func FromContext(ctx context.Context) (*mdmlab.LicenseInfo, bool) {
	v, ok := ctx.Value(licenseKey).(*mdmlab.LicenseInfo)
	return v, ok
}
