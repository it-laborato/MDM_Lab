...
type mdmlabSESSender interface {
...
func getFromSES(e mdmlab.Email) (string, error) {
...
func (s *sesSender) SendEmail(e mdmlab.Email) error {
	if s.client == nil {
...
func (s *sesSender) CanSendEmail(smtpSettings mdmlab.SMTPSettings) bool {
	return s.client != nil
}
...
func (s *sesSender) sendMail(e mdmlab.Email, msg []byte) error {
