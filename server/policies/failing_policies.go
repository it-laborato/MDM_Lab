...
func TriggerFailingPoliciesAutomation(
	...
	sendFunc func(*mdmlab.Policy, FailingPolicyAutomationConfig) error,
) error {
...
func makeTeamConfigCache(ds mdmlab.Datastore, globalIntgs mdmlab.Integrations) func(ctx context.Context, teamID uint) (FailingPolicyAutomationConfig, error) {
...
func getActiveAutomation(webhook mdmlab.FailingPoliciesWebhookSettings, intgs mdmlab.Integrations) FailingPolicyAutomationType {
