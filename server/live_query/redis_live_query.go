...
// is a bitfield representing _all_ the hosts in mdmlab.
//
...
//
// We believe that normal mdmlab usage has many hosts, and a small
...
func NewRedisLiveQuery(pool mdmlab.RedisPool, logger kitlog.Logger, memCacheExp time.Duration) *redisLiveQuery {
