...
var testFunctions = [...]func(*testing.T, mdmlab.LiveQueryStore){
	testLiveQuery,
...
func testLiveQuery(t *testing.T, store mdmlab.LiveQueryStore) {
...
func testLiveQueryNoTargets(t *testing.T, store mdmlab.LiveQueryStore) {
	assert.Error(t, store.RunQuery("test", "select 1", []uint{}))
}

func testLiveQueryStopQuery(t *testing.T, store mdmlab.LiveQueryStore) {
...
func testLiveQueryExpiredQuery(t *testing.T, store mdmlab.LiveQueryStore) {
...
func testLiveQueryOnlyExpired(t *testing.T, store mdmlab.LiveQueryStore) {
	oldModulo := cleanupExpiredQueriesModulo
	cleanupExpiredQueriesModulo = 1 // run the cleanup each time
	t.Cleanup(func() { cleanupExpiredQueriesModulo = oldModulo })
...
func testLiveQueryCleanupInactive(t *testing.T, store mdmlab.LiveQueryStore) {
