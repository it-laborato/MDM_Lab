...
func alwaysMDMlabErrors() error { return ctxerr.New(ctx, "always mdmlab errors") }
...
func TestHashErrMDMlabError(t *testing.T) {
	...
	t.Run("HashWrapped", func(t *testing.T) {
		// hashing a mdmlab error that wraps a root error hashes to the same
...
func TestUnwrapAll(t *testing.T) {
	...
	eerr := ctxerr.Wrap(ctx, gerr, "mdmlab wrap")
	eerr2 := ctxerr.Wrap(ctx, eerr, "mdmlab wrap 2")
...
func testErrorHandlerCollectsErrors(t *testing.T, pool mdmlab.RedisPool, wd string, flush bool) {
  ...
  \{
    ...
    \},
    "stack": \[
      "github\.com\/mdmlabdm\/mdmlab\/v4\/server\/errorstore\.alwaysNewError \(errors_test\.go\:\d+\)",
      "github\.com\/mdmlabdm\/mdmlab\/v4\/server\/errorstore\.testErrorHandlerCollectsErrors \(errors_test\.go\:\d+\)",
      "github\.com\/mdmlabdm\/mdmlab\/v4\/server\/errorstore\.TestErrorHandler\.func\d\.\d \(errors_test\.go\:\d+\)",
      ".+",
      ".+"
    \]
  \}
...
func testErrorHandlerCollectsDifferentErrors(t *testing.T, pool mdmlab.RedisPool, wd string, flush bool) {
	ctx, cancelFunc := context.WithCancel(context.Background())
	defer cancelFunc()
  ...
  \{
    ...
    \},
    "stack": \[
      "github\.com\/mdmlabdm\/mdmlab\/v4\/server\/errorstore\.alwaysNewErrorTwo \(errors_test\.go\:\d+\)",
      "github\.com\/mdmlabdm\/mdmlab\/v4\/server\/errorstore\.testErrorHandlerCollectsDifferentErrors \(errors_test\.go\:\d+\)",
      "github\.com\/mdmlabdm\/mdmlab\/v4\/server\/errorstore\.TestErrorHandler\.func\d\.\d \(errors_test\.go\:\d+\)",
      ".+",
      ".+"
    \]
