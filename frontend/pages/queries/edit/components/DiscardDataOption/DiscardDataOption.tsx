...
const DiscardDataOption = ({
  ...
  const renderHelpText = () => (
    <div className="help-text">
      {disable ? (
        <>
          This setting is ignored because query reports in Mdmlab have been{" "}
          <TooltipWrapper
            tipContent={
              <>
                A Mdmlab administrator can enable query reports under <br />
                <b>
      ...
      {["differential", "differential_ignore_removals"].includes(
        ...
        <InfoBanner color="purple-bold-border">
          <>
            ...
            is enabled. This query&apos;s results will not be saved in Mdmlab.
          </>
        </InfoBanner>
      )}
      <Checkbox
