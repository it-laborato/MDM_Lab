...
const WebAddress = ({
  ...
  const validateForm = () => {
    ...
    if (!serverURL) {
      errors.server_url = "Mdmlab server URL must be present";
  ...
  return (
    <div className={baseClass}>
      <div className={`${baseClass}__section`}>
        <SectionHeader title="Mdmlab web address" />
        <form onSubmit={onFormSubmit} autoComplete="off">
          <InputField
            label="Mdmlab app URL"
            helpText={
              <>
            ...
            tooltip="The base URL of this instance for use in Mdmlab links."
          />
          <Button
            type="submit"
            variant="brand"
