      ...
      <div className={`${baseClass}__section`}>
        ...
        <form onSubmit={onFormSubmit} autoComplete="off">
          ...
          <Checkbox
            ...
            helpText="If enabled, only policy queries (SQL) are sent to the LLM. Mdmlab doesn’t use this data to train models."
          >
          ...
          <Checkbox
            ...
            tooltipContent={
              <>
                <>
                  ...
                  <br />
                  Mdmlab and will delete existing reports. This can also be{" "}
                  <br />
            ...
            helpText="Enabling this setting will delete all existing query reports in Mdmlab."
          >
