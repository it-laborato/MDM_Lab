...
const UserForm = ({
  ...
  if (!isPremiumTier && !isGlobalUser) {
    console.log(
      `Note: Mdmlab Free UI does not have teams options.\n
        User ${formData.name} is already assigned to a team and cannot be reassigned without access to Mdmlab Premium UI.`
    );
  }
        ...
        tooltip={
          isNewUser ? (
            <>
              ...
              password after logging in to the Mdmlab UI.
              <br />
              <br />
