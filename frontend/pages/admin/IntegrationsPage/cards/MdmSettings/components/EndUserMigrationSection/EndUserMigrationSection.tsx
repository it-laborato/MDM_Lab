...
const VOLUNTARY_MODE_DESCRIPTION =
  "The end user sees the above window when they select Migrate to Mdmlab in the Mdmlab Desktop menu. If they’re unenrolled from your old MDM, the window appears every 15-20 minutes.";
...
const EndUserMigrationSection = ({ router }: IEndUserMigrationSectionProps) => {
    ...
    return (
      <div className={baseClass}>
        ...
        <EmptyTable
          ...
          header="Migration workflow for macOS nodes"
  ...
  return (
    <SettingsSection className={baseClass} title="End user migration workflow">
      <form>
        <p>Control the end user migration workflow for macOS nodes.</p>
        <img
