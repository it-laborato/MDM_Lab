        ...
        <div className={`${baseClass}__section-instructions`}>
          ...
          <p>
            ...
            <ul>
              ...
              <li>
                Enter &quot;Mdmlab calendar events&quot; as the project name.
              </li>
              <li>
          ...
          <p>
            ...
            <ul>
              ...
              <li>
                Set the service account name to &quot;Mdmlab calendar
                events&quot;.
              </li>
              <li>
          ...
          <p className={`${baseClass}__configuration`}>
            5. Configure your service account integration in Mdmlab using the
            form below.
            <ul>
              <li>
