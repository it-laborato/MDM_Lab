    ...
    if (!lastFetched) {
      ...
      return (
        <EmptyTable
          ...
          info={`Mdmlab is collecting query results from ${hostName}. Check back later.`}
        />
      );
    }
    if (reportClipped) {
      return (
        <EmptyTable
          ...
          info="This query has paused reporting in Mdmlab, and no results were saved for this host."
        />
      );
    }
    return (
