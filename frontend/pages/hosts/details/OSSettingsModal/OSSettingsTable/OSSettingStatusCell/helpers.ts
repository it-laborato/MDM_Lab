...
const APPLE_PROFILE_VERIFIED_DISPLAY_CONFIG: ProfileDisplayOption = {
  ...
  tooltip: (innerProps) =>
    innerProps.isDiskEncryptionProfile
      ? "The host turned disk encryption on and sent the key to Mdmlab. " +
        "Mdmlab verified."
      : "The host applied the setting. Mdmlab verified.",
} as const;
...
const MAC_PROFILE_VERIFYING_DISPLAY_CONFIG: ProfileDisplayOption = {
  ...
  tooltip: (innerProps) =>
    innerProps.isDiskEncryptionProfile
      ...
      : "The host acknowledged the MDM command to apply the setting. Mdmlab is " +
...
export const WINDOWS_DISK_ENCRYPTION_DISPLAY_CONFIG: WindowsDiskEncryptionDisplayConfig = {
  verified: {
    ...
    iconName: "success",
    tooltip: () =>
      "The host turned disk encryption on and sent the key to Mdmlab. Mdmlab verified.",
  },
  verifying: {
    statusText: "Verifying",
    iconName: "success-outline",
    tooltip: () =>
      "The host acknowledged the MDM command to turn on disk encryption. Mdmlab is verifying with " +
