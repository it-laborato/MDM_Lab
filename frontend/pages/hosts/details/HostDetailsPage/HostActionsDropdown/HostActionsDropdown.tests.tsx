...
describe("Host Actions Dropdown", () => {
  ...
  describe("Turn off MDM action", () => {
    ...
    it("does not render the action when the host is enrolled in a non Mdmlab MDM solution", async () => {
      const render = createCustomRenderer({
        context: {
          app: {
            isMacMdmEnabledAndConfigured: true,
  ...
  describe("Lock action", () => {
    ...
    it("does not render when the host is not enrolled in a Mdmlab MDM solution", async () => {
      const render = createCustomRenderer({
        context: {
          app: {
            isPremiumTier: true,
  ...
  describe("Unlock action", () => {
    ...
    it("does not renders when a macOS host but does not have Mdmlab mac mdm enabled and configured", async () => {
      const render = createCustomRenderer({
        context: {
          app: {
            isPremiumTier: true,
  ...
  describe("Wipe action", () => {
    ...
    it("does not renders when a windows host but does not have Mdmlab windows mdm enabled and configured", async () => {
      const render = createCustomRenderer({
        context: {
          app: {
            isPremiumTier: true,
    ...
    it("does not render for a macOS host if Mdmlab Apple MDM is not enabled and configured", async () => {
      const render = createCustomRenderer({
        context: {
          app: {
            isPremiumTier: true,
