...
const ManagePolicyPage = ({
  ...
  const getAutomationsDropdownOptions = (configPresent: boolean) => {
    ...
    if (!isPremiumTier) {
      disabledInstallTooltipContent = "Available in Mdmlab Premium.";
      disabledCalendarTooltipContent = "Available in Mdmlab Premium.";
      disabledRunScriptTooltipContent = "Available in Mdmlab Premium.";
