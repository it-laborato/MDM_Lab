...
const baseClass = "transfer-node-modal";
...
const TransferNodeModal = ({
  ...
  isUpdating,
  multipleNodes,
}: ITransferNodeModal): JSX.Element => {
  ...
  const onSubmitTransferNode = useCallback(() => {
  ...
  return (
    <Modal onExit={onCancel} title="Transfer nodes" className={baseClass}>
      <form className={`${baseClass}__form`}>
        <Dropdown
          wrapperClassName={`${baseClass}__team-dropdown-wrapper`}
          label={`Transfer ${multipleNodes ? "selected nodes" : "node"} to:`}
