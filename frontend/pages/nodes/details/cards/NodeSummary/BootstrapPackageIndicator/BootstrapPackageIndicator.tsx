...
const STATUS_DISPLAY_OPTIONS = {
  installed: {
    ...
    tipContent: (
      <span className={`${baseClass}__tooltip`}>
        The node acknowledged the MDM command to install bootstrap package.
      </span>
    ),
  },
  pending: {
    ...
    tipContent: (
      <span className={`${baseClass}__tooltip`}>
        Bootstrap package is installing or will install when the node comes
        online.
      </span>
    ),
  },
  failed: {
    ...
    tipContent: (
      <span className={`${baseClass}__tooltip`}>
        The node failed to install bootstrap package. To view errors, select{" "}
        <b>Failed</b>.
      </span>
    ),
  },
