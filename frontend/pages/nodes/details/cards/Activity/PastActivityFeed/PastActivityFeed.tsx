...
import { ActivityType, INodePastActivity } from "interfaces/activity";
import { INodePastActivitiesResponse } from "services/entities/activities";
...
interface IPastActivityFeedProps {
  activities?: INodePastActivitiesResponse;
  isError?: boolean;
...
const PastActivityFeed = ({
  ...
  return (
    <div className={baseClass}>
      <div>
        {activitiesList.map((activity: INodePastActivity) => {
