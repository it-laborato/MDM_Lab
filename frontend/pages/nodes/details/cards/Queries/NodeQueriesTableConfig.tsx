...
import ReportUpdatedCell from "pages/nodes/details/cards/Queries/ReportUpdatedCell";
import Icon from "components/Icon";
import { Link } from "react-router";
import PATHS from "router/paths";

interface INodeQueriesTableData extends Partial<IQueryStats> {
...
interface IRowProps {
  row: {
    original: INodeQueriesTableData;
  };
}
