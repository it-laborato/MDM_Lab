...
import { INodeScript, ILastExecution } from "interfaces/script";
...
export const generateTableColumnConfigs = (
  ...
  onSelectAction: (value: string, script: INodeScript) => void
) => {
  return [
    {
      title: "Name",
