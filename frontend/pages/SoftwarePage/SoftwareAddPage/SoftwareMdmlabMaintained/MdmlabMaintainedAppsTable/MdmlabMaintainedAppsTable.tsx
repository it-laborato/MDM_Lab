...
import { ISoftwareMdmlabMaintainedAppsResponse } from "services/entities/software";
...
interface IMdmlabMaintainedAppsTableProps {
  teamId: number;
  isLoading: boolean;
  query: string;
  perPage: number;
  ...
  data?: ISoftwareMdmlabMaintainedAppsResponse;
}

interface IRowProps {
  original: IMdmlabMaintainedApp;
}

const MdmlabMaintainedAppsTable = ({
  teamId,
  isLoading,
  data,
  router,
  ...
  orderKey,
  currentPage,
}: IMdmlabMaintainedAppsTableProps) => {
      ...
      <>
        ...
        {data?.apps_updated_at && (
          <LastUpdatedText
            ...
            customTooltipText={
              <>
                The last time Mdmlab-maintained <br />
...
export default MdmlabMaintainedAppsTable;
