...
import softwareAPI, {
  ISoftwareMdmlabMaintainedAppsQueryParams,
  ISoftwareMdmlabMaintainedAppsResponse,
...
const SoftwareMdmlabMaintained = ({
  currentTeamId,
  router,
  location,
}: ISoftwareMdmlabMaintainedProps) => {
  ...
  >(
    ...
    ({ queryKey: [queryKey] }) => {
      return softwareAPI.getMdmlabMaintainedApps(omit(queryKey, "scope"));
    },
    {
...
export default SoftwareMdmlabMaintained;
