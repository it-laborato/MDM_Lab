...
interface IMdmlabAppDetailsFormProps {
  ...
  onCancel: () => void;
  onSubmit: (formData: IMdmlabMaintainedAppFormData) => void;
}
...
export const InstallTypeSection = ({
  ...
  const AUTOMATIC_DISABLED_TOOLTIP = (
    <>
      Mdmlab can&apos;t create a policy to detect existing installations for
    ...
    <fieldset>
      ...
      {installType === "automatic" && isCustomPackage && (
        ...
        >
          ...
          Please create a test team in Mdmlab to verify a smooth installation.
        </InfoBanner>
      )}
    </fieldset>
  );
...
const MdmlabAppDetailsForm = ({
  ...
  onCancel,
  onSubmit,
}: IMdmlabAppDetailsFormProps) => {
  const [showAdvancedOptions, setShowAdvancedOptions] = useState(false);

  const [formData, setFormData] = useState<IMdmlabMaintainedAppFormData>({
    selfService: false,
    ...
    <form className={baseClass} onSubmit={onSubmitForm}>
      ...
      >
        <TooltipWrapper
          tipContent={
            <>
              End users can install from <b>Mdmlab Desktop {">"} Self-service</b>
              .
            </>
          }
        >
...
export default MdmlabAppDetailsForm;
