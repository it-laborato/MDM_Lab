...
const DEFAULT_VULNERABILITY: IVulnerability = {
  ...
  nodes_count: 1234,
  nodes_count_updated_at: "2023-12-20T15:23:57Z",
  details_link: "https://nvd.nist.gov/vuln/detail/CVE-2022-30190",
  cvss_score: 7.8, // Available in Mdmlab Premium
  epss_probability: 0.9729, // Available in Mdmlab Premium
  cisa_known_exploit: true, // Available in Mdmlab Premium
  cve_published: "2022-06-01T00:15:00Z", // Available in Mdmlab Premium
  cve_description:
    "Microsoft Windows Support Diagnostic Tool (MSDT) Remote Code Execution Vulnerability.", // Available in Mdmlab Premium
  resolved_in_version: "", // Available in Mdmlab Premium
};
