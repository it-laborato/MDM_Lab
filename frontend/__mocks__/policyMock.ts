...
const DEFAULT_POLICY_MOCK: IPolicyStats = {
  ...
  failing_node_count: 8,
  node_count_updated_at: "2023-11-30T19:05:13Z",
  webhook: "Off",
  has_run: true,
    ...
    policies: [
      {
        ...
        node_count_updated_at: "2023-12-20T15:23:57Z",
        webhook: "Off",
        has_run: true,
        next_update_ms: 3600000,
      ...
      },
      {
        ...
        passing_node_count: 10,
        failing_node_count: 9,
        node_count_updated_at: "2023-12-20T15:23:57Z",
        webhook: "Off",
        has_run: true,
        next_update_ms: 3600000,
