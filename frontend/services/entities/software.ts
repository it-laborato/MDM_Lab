...
import { IAddMdmlabMaintainedData } from "pages/SoftwarePage/SoftwareAddPage/SoftwareMdmlabMaintained/MdmlabMaintainedAppDetailsPage/MdmlabMaintainedAppDetailsPage";
...
export interface ISoftwareMdmlabMaintainedAppsQueryParams {
  team_id: number;
  query?: string;
  order_key?: string;
