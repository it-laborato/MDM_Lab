...
const DownloadInstallers = ({
  ...
  if (isDownloadSuccess) {
    ...
    return (
      <div className={`${baseClass}__success`}>
        ...
        <p>{`Run the installer on a ${installerPlatform}laptop, workstation, or server to add it to Mdmlab.`}</p>
  ...
  return (
    <div className={`${baseClass}`}>
      <p>Which platform is your node running?</p>
      ...
      >
        <>
          ...
          <TooltipWrapper
            tipContent={
              <p>Include Mdmlab Desktop if you&apos;re adding workstations.</p>
            }
          >
            Mdmlab Desktop
          </TooltipWrapper>
