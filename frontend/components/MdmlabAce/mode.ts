...
ace.define(
  ...
  function (acequire, exports, module) {
    ...
    var MdmlabHighlightRules = function () {
    ...
    oop.inherits(MdmlabHighlightRules, SqlHighlightRules);

    exports.MdmlabHighlightRules = MdmlabHighlightRules;
  }
);
...
ace.define(
  ...
  function (acequire, exports, module) {
    ...
    var Mode = function () {
      this.HighlightRules = MdmlabHighlightRules;
    };
