...
interface IMdmlabAvatarProps {
  className?: string;
}

/**
 * a simple component that can be used to display a the Mdmlab logo as an avatar
 */
const MdmlabAvatar = ({ className }: IMdmlabAvatarProps) => {
  return (
    <svg
      data-testid="mdmlab-avatar"
      className={className}
      width="32"
      height="32"
      viewBox="0 0 32 32"
...
const Avatar = ({
  ...
  return (
    <div className="avatar-wrapper">
      {useMdmlabAvatar ? (
        <MdmlabAvatar className={avatarClasses} />
      ) : (
        <img
          alt="User avatar"
