...
--carver_block_size=8000000`;
  ...
  "enroll_secret": {
    ...
    if (packageType === "deb") {
      packageTypeHelpText =
        "Install this package to add hosts to Mdmlab. For CentOS, Red Hat, and Fedora Linux, use --type=rpm.";
    } else if (packageType === "msi") {
      packageTypeHelpText =
        "Install this package to add hosts to Mdmlab. For Windows, this generates an MSI package.";
    } else if (packageType === "pkg") {
      packageTypeHelpText = "Install this package to add hosts to Mdmlab.";
    }
        ...
        <>
          ...
          <div className={`${baseClass}__advanced--installer`}>
            <InputField
              ...
              helpText="Distribute your package to add hosts to Mdmlab."
            />
          </div>
          <div>
