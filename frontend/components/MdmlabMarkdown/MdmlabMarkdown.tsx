...
interface IMdmlabMarkdownProps {
  markdown: string;
  className?: string;
  name?: string;
}
  ...
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        // Overrides code display to use MdmlabAce with Readonly overrides.
        code: ({ inline, children, ...props }) => {
          ...
          // full code blocks we want to use Mdmlab Ace.
