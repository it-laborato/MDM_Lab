...
import Mdmlab403 from "pages/errors/Mdmlab403";
import Mdmlab404 from "pages/errors/Mdmlab404";
...
import SoftwareMdmlabMaintained from "pages/SoftwarePage/SoftwareAddPage/SoftwareMdmlabMaintained";
...
import MdmlabMaintainedAppDetailsPage from "pages/SoftwarePage/SoftwareAddPage/SoftwareMdmlabMaintained/MdmlabMaintainedAppDetailsPage";
...
const routes = (
  <Router history={browserHistory}>
    ...
    <Route path="/404" component={Mdmlab404} />
    <Route path="/403" component={Mdmlab403} />
    <Route path="*" component={Mdmlab404} />
  </Router>
);
