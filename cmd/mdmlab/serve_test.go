...
func (s *safeStore) AppConfig(ctx context.Context) (*mdmlab.AppConfig, error) {
	s.mu.Lock()
...
func TestMaybeSendStatistics(t *testing.T) {
	...
	mdmlabConfig := config.MDMlabConfig{Osquery: config.OsqueryConfig{DetailUpdateInterval: 1 * time.Hour}}
	...
	ds.AppConfigFunc = func(ctx context.Context) (*mdmlab.AppConfig, error) {
		return &mdmlab.AppConfig{ServerSettings: mdmlab.ServerSettings{EnableAnalytics: true}}, nil
	}

	ds.ShouldSendStatisticsFunc = func(ctx context.Context, frequency time.Duration, config config.MDMlabConfig) (mdmlab.StatisticsPayload, bool, error) {
		return mdmlab.StatisticsPayload{
			...
			HostsEnrolledByOperatingSystem: map[string][]mdmlab.HostsCountByOSVersion{
				"linux": {
					mdmlab.HostsCountByOSVersion{Version: "1.2.3", NumEnrolled: 22},
				},
			},
			HostsEnrolledByOrbitVersion:   []mdmlab.HostsCountByOrbitVersion{},
			HostsEnrolledByOsqueryVersion: []mdmlab.HostsCountByOsqueryVersion{},
			StoredErrors:                  []byte(`[]`),
			Organization:                  "MDMlab",
			AIFeaturesDisabled:            true,
			MaintenanceWindowsEnabled:     true,
			MaintenanceWindowsConfigured:  true,
			NumHostsMDMlabDesktopEnabled:   1984,
		}, true, nil
	}
	recorded := false
...
func TestMaybeSendStatisticsSkipsSendingIfNotNeeded(t *testing.T) {
	...
	ds.ShouldSendStatisticsFunc = func(ctx context.Context, frequency time.Duration, cfg config.MDMlabConfig) (mdmlab.StatisticsPayload, bool, error) {
		return mdmlab.StatisticsPayload{}, false, nil
	}
	recorded := false
	ds.RecordStatisticsSentFunc = func(ctx context.Context) error {
		recorded = true
...
func TestMaybeSendStatisticsSkipsIfNotConfigured(t *testing.T) {
	...
	ctx := license.NewContext(context.Background(), &mdmlab.LicenseInfo{Tier: mdmlab.TierFree})
	err := trySendStatistics(ctx, ds, mdmlab.StatisticsFrequency, ts.URL, mdmlabConfig)
	require.NoError(t, err)
	assert.False(t, called)
}
...
func TestMaybeSendStatisticsSendsIfNotConfiguredForPremium(t *testing.T) {
	...
	ds.ShouldSendStatisticsFunc = func(ctx context.Context, frequency time.Duration, config config.MDMlabConfig) (mdmlab.StatisticsPayload, bool, error) {
		return mdmlab.StatisticsPayload{}, true, nil
	}
...
func TestAutomationsSchedule(t *testing.T) {
	...
	ds.TeamsSummaryFunc = func(ctx context.Context) ([]*mdmlab.TeamSummary, error) {
		return []*mdmlab.TeamSummary{}, nil
	}

	ds.OutdatedAutomationBatchFunc = func(ctx context.Context) ([]mdmlab.PolicyFailure, error) {
		return []mdmlab.PolicyFailure{}, nil
	}
	...
	ds.AppConfigFunc = func(ctx context.Context) (*mdmlab.AppConfig, error) {
		return &mdmlab.AppConfig{
			WebhookSettings: mdmlab.WebhookSettings{
				...
				Interval: mdmlab.Duration{Duration: 2 * time.Second},
			},
		}, nil
	}
...
func TestCronVulnerabilitiesCreatesDatabasesPath(t *testing.T) {
	...
	ds.AppConfigFunc = func(ctx context.Context) (*mdmlab.AppConfig, error) {
		return &mdmlab.AppConfig{
			Features: mdmlab.Features{EnableSoftwareInventory: true},
		}, nil
	}
	ds.InsertCVEMetaFunc = func(ctx context.Context, x []mdmlab.CVEMeta) error {
		return nil
	}
	ds.AllSoftwareIteratorFunc = func(ctx context.Context, query mdmlab.SoftwareIterQueryOptions) (mdmlab.SoftwareIterator, error) {
...
func (f *softwareIterator) Value() (*mdmlab.Software, error) {
...
`
	...
	appConfig := &mdmlab.AppConfig{
		...
		WebhookSettings: mdmlab.WebhookSettings{
			VulnerabilitiesWebhook: mdmlab.VulnerabilitiesWebhookSettings{
				Enable:         true,
	...
	ds.ListSoftwareCPEsFunc = func(ctx context.Context) ([]mdmlab.SoftwareCPE, error) {
		return []mdmlab.SoftwareCPE{
			{
				ID:         1,
				SoftwareID: 1,
	...
	ds.InsertSoftwareVulnerabilityFunc = func(ctx context.Context, vuln mdmlab.SoftwareVulnerability, src mdmlab.VulnerabilitySource) (bool, error) {
		return true, nil
	}
	ds.UpsertSoftwareCPEsFunc = func(ctx context.Context, cpes []mdmlab.SoftwareCPE) (int64, error) {
		return int64(0), nil
	}
	ds.DeleteSoftwareCPEsFunc = func(ctx context.Context, cpes []mdmlab.SoftwareCPE) (int64, error) {
		return int64(0), nil
	}
	ds.DeleteOutOfDateVulnerabilitiesFunc = func(ctx context.Context, source mdmlab.VulnerabilitySource, duration time.Duration) error {
		return nil
	}
	ds.OSVersionsFunc = func(
		ctx context.Context, teamFilter *mdmlab.TeamFilter, platform *string, name *string, version *string,
	) (*mdmlab.OSVersions, error) {
		return &mdmlab.OSVersions{
	...
	ds.HostIDsByOSVersionFunc = func(ctx context.Context, osVersion mdmlab.OSVersion, offset int, limit int) ([]uint, error) {
		if offset == 0 {
			return []uint{1}, nil
		}
		return []uint{}, nil
	}
	ds.ListSoftwareForVulnDetectionFunc = func(ctx context.Context, filter mdmlab.VulnSoftwareFilter) ([]mdmlab.Software, error) {
		return []mdmlab.Software{
			{
				ID:               1,
				Name:             "Twisted",
				Version:          "22.2.0",
	...
	ds.ListSoftwareVulnerabilitiesByHostIDsSourceFunc = func(ctx context.Context, hostIDs []uint, source mdmlab.VulnerabilitySource) (map[uint][]mdmlab.SoftwareVulnerability, error) {
		require.Equal(t, []uint{1}, hostIDs)
		require.Equal(t, mdmlab.UbuntuOVALSource, source)
		return map[uint][]mdmlab.SoftwareVulnerability{}, nil
	}
	ds.ListOperatingSystemsFunc = func(ctx context.Context) ([]mdmlab.OperatingSystem, error) {
		return []mdmlab.OperatingSystem{
			{
				ID:            1,
				Name:          "Ubuntu",
				Version:       "22.04.1 LTS",
	...
	ds.ListOperatingSystemsForPlatformFunc = func(ctx context.Context, platform string) ([]mdmlab.OperatingSystem, error) {
		return []mdmlab.OperatingSystem{}, nil
	}

	ds.DeleteOutOfDateOSVulnerabilitiesFunc = func(ctx context.Context, src mdmlab.VulnerabilitySource, d time.Duration) error {
		return nil
	}

	ds.ListCVEsFunc = func(ctx context.Context, maxAge time.Duration) ([]mdmlab.CVEMeta, error) {
	...
	ds.HostVulnSummariesBySoftwareIDsFunc = func(ctx context.Context, softwareIDs []uint) ([]mdmlab.HostVulnerabilitySummary, error) {
		return []mdmlab.HostVulnerabilitySummary{
			{
				ID:          1,
				Hostname:    "1",
				DisplayName: "1",
...
func TestAutomationsScheduleLockDuration(t *testing.T) {
	...
	ds.AppConfigFunc = func(ctx context.Context) (*mdmlab.AppConfig, error) {
		ac := mdmlab.AppConfig{
			WebhookSettings: mdmlab.WebhookSettings{
				Interval: mdmlab.Duration{Duration: 1 * time.Hour},
			},
		}
		select {
		case <-intitalConfigLoaded:
			ac.WebhookSettings.Interval = mdmlab.Duration{Duration: expectedInterval}
		default:
			// initial config
...
func TestAutomationsScheduleIntervalChange(t *testing.T) {
	...
	ds.AppConfigFunc = func(ctx context.Context) (*mdmlab.AppConfig, error) {
		...
		return &mdmlab.AppConfig{
			WebhookSettings: mdmlab.WebhookSettings{
				Interval: mdmlab.Duration{Duration: interval.value},
			},
		}, nil
	}
...
func TestDebugMux(t *testing.T) {
	...
	cases := []struct {
		...
		{
			"only mdmlab auth handler, no token",
			debugMux{mdmlabAuthenticatedHandler: h1},
			"",
			200,
		},
		{
			"only mdmlab auth handler, with token",
			debugMux{mdmlabAuthenticatedHandler: h1},
			"token",
			200,
		},
		{
			...
			debugMux{mdmlabAuthenticatedHandler: h1, tokenAuthenticatedHandler: h2},
			"",
			200,
		},
		{
...
func TestCronActivitiesStreaming(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		as := []*mdmlab.Activity{a1, a2, a3}

		ds.ListActivitiesFunc = func(ctx context.Context, opt mdmlab.ListActivitiesOptions) ([]*mdmlab.Activity, *mdmlab.PaginationMetadata, error) {
			return as, nil, nil
		}
	...
	t.Run("bigger_than_batch", func(t *testing.T) {
		...
		as := make([]*mdmlab.Activity, ActivitiesToStreamBatchCount*2+1)
		for i := range as {
...
func TestVerifyDiskEncryptionKeysJob(t *testing.T) {
	...
	assets := map[mdmlab.MDMAssetName]mdmlab.MDMConfigAsset{
		mdmlab.MDMAssetCACert: {Value: testCertPEM},
		mdmlab.MDMAssetCAKey:  {Value: testKeyPEM},
	}
	...
	t.Run("able to decrypt", func(t *testing.T) {
		ds.GetUnverifiedDiskEncryptionKeysFunc = func(ctx context.Context) ([]mdmlab.HostDiskEncryptionKey, error) {
	...
	t.Run("unable to decrypt", func(t *testing.T) {
		ds.GetUnverifiedDiskEncryptionKeysFunc = func(ctx context.Context) ([]mdmlab.HostDiskEncryptionKey, error) {
			return []mdmlab.HostDiskEncryptionKey{{HostID: 1, Base64Encrypted: "RANDOM"}}, nil
		}
