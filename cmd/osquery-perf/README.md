...
```
go run ./cmd/osquery-perf/agent.go --enroll_secret riFaEoeLDuolUqHYWJdBVRoVBIKkMdNd --host_count 500 --start_period 300m --query_interval 60s --config_interval 5m
```
