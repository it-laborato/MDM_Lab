...
func setupCommand() *cli.Command {
	...
	return &cli.Command{
		Name:      "setup",
		Usage:     "Set up a MDMlab instance",
		UsageText: `mdmlabctl setup [options]`,
		Flags: []cli.Flag{
			&cli.StringFlag{
				Name:        "email",
		...
		Action: func(c *cli.Context) error {
			...
			token, err := mdmlab.Setup(flEmail, flName, flPassword, flOrgName)
			if err != nil {
			...
			fmt.Println("MDMlab Device Management Inc. periodically collects information about your instance.\nSending usage statistics from your MDMlab instance is optional and can be disabled in settings.")
			fmt.Println("[+] MDMlab setup successful and context configured!")
