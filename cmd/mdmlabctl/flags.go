...
const (
	...
	debugFlagName            = "debug"
	mdmlabCertificateFlagName = "mdmlab-certificate"
...
func mdmlabCertificateFlag() cli.Flag {
	return &cli.StringFlag{
		Name:    mdmlabCertificateFlagName,
		EnvVars: []string{"FLEET_CERTIFICATE"},
		Usage:   "Path of the TLS mdmlab certificate, can be used to provide additional connection debugging information",
	}
}

func getMDMlabCertificate(c *cli.Context) string {
	return c.String(mdmlabCertificateFlagName)
}
