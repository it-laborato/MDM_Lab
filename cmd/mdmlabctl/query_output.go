...
type outputWriter interface {
	WriteResult(res mdmlab.DistributedQueryResult) error
}
...
func (w *jsonWriter) WriteResult(res mdmlab.DistributedQueryResult) error {
	out := resultOutput{
...
type prettyWriter struct {
	results []mdmlab.DistributedQueryResult
...
func (w *prettyWriter) WriteResult(res mdmlab.DistributedQueryResult) error {
