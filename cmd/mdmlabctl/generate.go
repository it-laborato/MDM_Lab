...
const (
	apnsCSRPath         = "mdmlab-mdm-csr.csr"
	bmPublicKeyCertPath = "mdmlab-apple-mdm-bm-public-key.crt"
)
...
func generateMDMAppleCommand() *cli.Command {
	return &cli.Command{
		...
		Action: func(c *cli.Context) error {
			...
			// get the mdmlab API client first, so that any login requirement are met
