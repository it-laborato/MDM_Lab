...
var setCurrentUserSession = func(t *testing.T, ds *mock.Store, user *mdmlab.User) {
...
func TestGetTeams(t *testing.T) {
	...
	mdmlab.WriteExpiredLicenseBanner(&expiredBanner)
	require.Contains(t, expiredBanner.String(), "Your license for MDMlab Premium is about to expire")
	...
	testCases := []struct {
		...
		{
			"not expired license",
			&mdmlab.LicenseInfo{Tier: mdmlab.TierPremium, Expiration: time.Now().Add(24 * time.Hour)},
			false,
		},
		{
			"expired license",
...
func TestGetTeamsByName(t *testing.T) {
	_, ds := runServerWithMockedDS(t, &service.TestServerOpts{License: &mdmlab.LicenseInfo{Tier: mdmlab.TierPremium, Expiration: time.Now().Add(24 * time.Hour)}})
...
func TestGetHosts(t *testing.T) {
	...
	// this func is called when no host is specified i.e. `mdmlabctl get hosts --json`
	ds.ListHostsFunc = func(ctx context.Context, filter mdmlab.TeamFilter, opt mdmlab.HostListOptions) ([]*mdmlab.Host, error) {
		...
		hosts := []*mdmlab.Host{
			{
				UpdateCreateTimestamps: mdmlab.UpdateCreateTimestamps{
					CreateTimestamp: mdmlab.CreateTimestamp{CreatedAt: time.Time{}},
					UpdateTimestamp: mdmlab.UpdateTimestamp{UpdatedAt: time.Time{}},
				},
				HostSoftware:    mdmlab.HostSoftware{},
	...
	// these are run when host is specified `mdmlabctl get hosts --json test_host`
	...
	ds.ListLabelsForHostFunc = func(ctx context.Context, hid uint) ([]*mdmlab.Label, error) {
		return make([]*mdmlab.Label, 0), nil
	}
	ds.ListPacksForHostFunc = func(ctx context.Context, hid uint) (packs []*mdmlab.Pack, err error) {
		return make([]*mdmlab.Pack, 0), nil
	}
	ds.ListHostBatteriesFunc = func(ctx context.Context, hid uint) (batteries []*mdmlab.HostBattery, err error) {
		return nil, nil
	}
...
func TestGetConfig(t *testing.T) {
	...
	ds.AppConfigFunc = func(ctx context.Context) (*mdmlab.AppConfig, error) {
		return &mdmlab.AppConfig{
			Features:              mdmlab.Features{EnableHostUsers: true},
			VulnerabilitySettings: mdmlab.VulnerabilitySettings{DatabasesPath: "/some/path"},
	...
	t.Run("AppConfigAsTeamUsers", func(t *testing.T) {
		// test as team admin
		setCurrentUserSession(t, ds, &mdmlab.User{
			ID:         5,
...
func TestGetSoftwareTitles(t *testing.T) {
	...
	ds.ListSoftwareTitlesFunc = func(ctx context.Context, opt mdmlab.SoftwareTitleListOptions, tmFilter mdmlab.TeamFilter) ([]mdmlab.SoftwareTitleListResult, int, *mdmlab.PaginationMetadata, error) {
		...
		return []mdmlab.SoftwareTitleListResult{
			{
				Name:          "foo",
				...
				Versions: []mdmlab.SoftwareVersion{
					{
						Version:         "0.0.1",
						Vulnerabilities: &mdmlab.SliceString{"cve-123-456-001", "cve-123-456-002"},
					},
					{
						Version:         "0.0.2",
						Vulnerabilities: &mdmlab.SliceString{"cve-123-456-001"},
					},
					{
						Version:         "0.0.3",
						Vulnerabilities: &mdmlab.SliceString{"cve-123-456-003"},
					},
				},
			},
			{
...
func TestGetSoftwareVersions(t *testing.T) {
	...
	foo002 := mdmlab.Software{Name: "foo", Version: "0.0.2", Source: "chrome_extensions", ExtensionID: "xyz", Browser: "edge"}
	foo003 := mdmlab.Software{Name: "foo", Version: "0.0.3", Source: "chrome_extensions", GenerateCPE: "someothercpewithoutvulns"}
	bar003 := mdmlab.Software{Name: "bar", Version: "0.0.3", Source: "deb_packages", BundleIdentifier: "bundle"}
	...
	ds.ListSoftwareFunc = func(ctx context.Context, opt mdmlab.SoftwareListOptions) ([]mdmlab.Software, *mdmlab.PaginationMetadata, error) {
		gotTeamID = opt.TeamID
		return []mdmlab.Software{foo001, foo002, foo003, bar003}, &mdmlab.PaginationMetadata{}, nil
	}
...
Querying in MDMlab is becoming more powerful. To learn more, visit:
https://mdmlabdm.com/handbook/company/why-this-way#why-does-mdmlab-support-query-packs

To retrieve "Pack" data in a portable format for upgrading, run ` + "`mdmlabctl upgrade-packs`" + `.
`
	expectedYaml := `---
apiVersion: v1
kind: pack
...
func TestGetPack(t *testing.T) {
	...
	ds.PackByNameFunc = func(ctx context.Context, name string, opts ...mdmlab.OptionalArg) (*mdmlab.Pack, bool, error) {
		if name != "pack1" {
	...
	ds.GetPackSpecFunc = func(ctx context.Context, name string) (*mdmlab.PackSpec, error) {
		if name != "pack1" {
			return nil, nil
		}
		return &mdmlab.PackSpec{
	...
	for _, tc := range []struct {
		...
		},
		{
			...
			user: &mdmlab.User{
				...
				GlobalRole: nil,
				Teams:      []mdmlab.UserTeam{{Role: mdmlab.RoleObserver}},
			},
		},
		{
...
func TestEnrichedAppConfig(t *testing.T) {
	t.Run("deprecated fields", func(t *testing.T) {
		resp := []byte(`
      {
        ...
        "mdmlab_desktop": {
          "transparency_url": "https://mdmlabdm.com/transparency"
        },
    ...
    `)
		...
		var enriched mdmlab.EnrichedAppConfig
...
func TestGetAppleBM(t *testing.T) {
	...
	t.Run("premium license, single token", func(t *testing.T) {
		_, ds := runServerWithMockedDS(t, &service.TestServerOpts{License: &mdmlab.LicenseInfo{Tier: mdmlab.TierPremium}, DEPStorage: depStorage})
		ds.ListABMTokensFunc = func(ctx context.Context) ([]*mdmlab.ABMToken, error) {
			return []*mdmlab.ABMToken{
				{ID: 1},
			}, nil
		}
...
func TestGetCarves(t *testing.T) {
	...
	require.NoError(t, err)
	ds.ListCarvesFunc = func(ctx context.Context, opts mdmlab.CarveListOptions) ([]*mdmlab.CarveMetadata, error) {
		return []*mdmlab.CarveMetadata{
			{
				HostId:     1,
				Name:       "foobar",
				BlockCount: 10,
...
func TestGetCarve(t *testing.T) {
	...
	createdAt, err := time.Parse(time.RFC3339, "1999-03-10T02:45:06.371Z")
	require.NoError(t, err)
	ds.CarveFunc = func(ctx context.Context, carveID int64) (*mdmlab.CarveMetadata, error) {
		return &mdmlab.CarveMetadata{
			HostId:     1,
			Name:       "foobar",
			BlockCount: 10,
	...
	agentOpts := json.RawMessage(`
{
  ...
  "overrides": {
	...
	ds.ListTeamsFunc = func(ctx context.Context, filter mdmlab.TeamFilter, opt mdmlab.ListOptions) ([]*mdmlab.Team, error) {
		return []*mdmlab.Team{team1, team2}, nil
	}
	ds.AppConfigFunc = func(ctx context.Context) (*mdmlab.AppConfig, error) {
		return &mdmlab.AppConfig{AgentOptions: &agentOpts, MDM: mdmlab.MDM{EnabledAndConfigured: true}}, nil
	}
...
<plist version="1.0">
  ...
  <SyncHdr>
    ...
    <MsgID>2</MsgID>
    <Target>
      <LocURI>https://roperzh-mdmlab.ngrok.io/api/mdm/microsoft/management</LocURI>
    </Target>
    <Source>
  ...
  <SyncBody>
	...
	ds.GetMDMAppleCommandResultsFunc = func(ctx context.Context, commandUUID string) ([]*mdmlab.MDMCommandResult, error) {
		...
		case "fail-cmd":
			return nil, io.EOF
		default:
			return []*mdmlab.MDMCommandResult{
				{
					HostUUID:    "device1",
	...
	ds.GetMDMWindowsCommandResultsFunc = func(ctx context.Context, commandUUID string) ([]*mdmlab.MDMCommandResult, error) {
		switch commandUUID {
		case "empty-cmd":
			return nil, nil
		case "fail-cmd":
...
|           |                      |                |        |          |   <!-- CmdID generated by MDMlab -->                                                         |   <SyncHdr>                                                                        |
|           |                      |                |        |          |   <CmdID>90dbfca8-d4ac-40c9-bf57-ba5b8cbf1ce0</CmdID>                                       |     <VerDTD>1.2</VerDTD>                                                           |
|           |                      |                |        |          |   <Replace>                                                                                 |     <VerProto>DM/1.2</VerProto>                                                    |
|           |                      |                |        |          |     <!-- CmdID generated by MDMlab -->                                                       |     <SessionID>48</SessionID>                                                      |
|           |                      |                |        |          |     <CmdID>81a141b2-5064-4dc3-a51a-128b8caa5438</CmdID>                                     |     <MsgID>2</MsgID>                                                               |
|           |                      |                |        |          |     <Item>                                                                                  |     <Target>                                                                       |
|           |                      |                |        |          |       <Target>                                                                              |       <LocURI>https://roperzh-mdmlab.ngrok.io/api/mdm/microsoft/management</LocURI> |
...
func TestGetMDMCommands(t *testing.T) {
	...
	ds.ListMDMCommandsFunc = func(ctx context.Context, tmFilter mdmlab.TeamFilter, listOpts *mdmlab.MDMCommandListOptions) ([]*mdmlab.MDMCommand, error) {
		if empty || listErr != nil {
			return nil, listErr
		}

		if noHostErr != nil {
			return nil, errors.New(mdmlab.HostIdentiferNotFound)
		}
		...
		return []*mdmlab.MDMCommand{
			...
			// This represents a command generated by mdmlab as part of a Windows profile
			{
				HostUUID:    "h2",
				CommandUUID: "u3",
				UpdatedAt:   time.Date(2023, 4, 11, 9, 5, 0, 0, time.UTC),
	...
	require.NoError(t, err)
	require.Contains(t, buf.String(), "You haven't run any MDM commands. Run MDM commands with the `mdmlabctl mdm run-command` command.")
...
`))
	...
	expectIdentifier = true
	noHostErr = errors.New(mdmlab.HostIdentiferNotFound)
	_, err = runAppNoChecks([]string{"get", "mdm-commands", "--host", "foo"})
	require.Error(t, err)
	require.ErrorContains(t, err, mdmlab.HostIdentiferNotFound)
}
