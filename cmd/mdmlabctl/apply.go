...
func applyCommand() *cli.Command {
	...
	return &cli.Command{
		...
		UsageText: `mdmlabctl apply [options]`,
		Flags: []cli.Flag{
			&cli.StringFlag{
				Name:        "f",
		...
		Action: func(c *cli.Context) error {
			...
			_, _, _, _, err = mdmlabClient.ApplyGroup(c.Context, false, specs, baseDir, logf, nil, opts, teamsSoftwareInstallers, teamsVPPApps, teamsScripts)
			if err != nil {
				return err
			}
			return nil
