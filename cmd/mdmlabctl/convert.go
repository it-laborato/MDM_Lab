...
func specGroupFromPack(name string, inputPack mdmlab.PermissivePackContent) (*spec.Group, error) {
	specs := &spec.Group{
...
func convertCommand() *cli.Command {
	...
	return &cli.Command{
		Name:      "convert",
		Usage:     "Convert osquery packs into MDMlab queries",
		UsageText: `mdmlabctl convert [options]`,
		Flags: []cli.Flag{
			configFlag(),
			contextFlag(),
			&cli.StringFlag{
		...
		Action: func(c *cli.Context) error {
			...
			var pack mdmlab.PermissivePackContent
