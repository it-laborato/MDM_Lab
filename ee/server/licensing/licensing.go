...
const (
	...
	expectedIssuer    = "MDMlab Device Management Inc."
)
...
func LoadLicense(licenseKey string) (*mdmlab.LicenseInfo, error) {
	// No license key
	if licenseKey == "" {
		return &mdmlab.LicenseInfo{Tier: mdmlab.TierFree}, nil
	}
...
func validate(token *jwt.Token) (*mdmlab.LicenseInfo, error) {
