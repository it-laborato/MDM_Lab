...
func UpdatesCommand() *cli.Command {
	return &cli.Command{
		...
		Description: `mdmlabctl updates commands provide the initialization and management of a TUF-compliant update repository.

This functionality is licensed under the MDMlab EE License. Usage requires a current MDMlab EE subscription.`,
