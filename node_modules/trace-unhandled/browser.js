(function () {
    ...
    let loggerFunction = defaultLogger;
    function setLogger(loggerFn) {
        loggerFunction = loggerFn !== null && loggerFn !== void 0 ? loggerFn : defaultLogger;
    }
    function logger(reason, promise, pid = void 0) {
        ...
        loggerFunction(`${prefix}UnhandledPromiseRejectionWarning\n` +
    ...
    window.setTraceUnhandledLogger = setLogger;
